...
function deserializeDevicePinnersOrderByField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize DevicePinnersOrderByField" });
}
...
function deserializeDevicePinnersOrderDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize DevicePinnersOrderDirectionField" });
}
...
function deserializeDevicePinnersOrderField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"DevicePinnersOrderField\"" });
    }
    const by = val.by == void 0 ? void 0 : deserializeDevicePinnersOrderByField(val.by);
    const direction = val.direction == void 0 ? void 0 : deserializeDevicePinnersOrderDirectionField(val.direction);
...
function serializeDevicePinners(val) {
    return { ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item) {
        ...
        }), ["limit"]: val.limit, ["next_marker"]: val.nextMarker, ["order"]: val.order == void 0 ? val.order : val.order.map(function (item) {
...
function deserializeDevicePinners(val) {
    ...
    if (!(val.entries == void 0) && !(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"DevicePinners\"" });
    }
    ...
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"DevicePinners\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !(0, json_js_1.sdIsNumber)(val.next_marker)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"next_marker\" of type \"DevicePinners\"" });
    }
    const nextMarker = val.next_marker == void 0 ? void 0 : val.next_marker;
    if (!(val.order == void 0) && !(0, json_js_2.sdIsList)(val.order)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"order\" of type \"DevicePinners\"" });
    }
    const order = val.order == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.order) ? val.order.map(function (itm) {
