...
function deserializeCollectionsOrderDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollectionsOrderDirectionField" });
}
...
function deserializeCollectionsOrderField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CollectionsOrderField\"" });
    }
    if (!(val.by == void 0) && !(0, json_js_2.sdIsString)(val.by)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"by\" of type \"CollectionsOrderField\"" });
    }
    const by = val.by == void 0 ? void 0 : val.by;
    const direction = val.direction == void 0 ? void 0 : deserializeCollectionsOrderDirectionField(val.direction);
...
function deserializeCollections(val) {
    ...
    if (!(val.total_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"Collections\"" });
    }
    const totalCount = val.total_count == void 0 ? void 0 : val.total_count;
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"Collections\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.offset == void 0) && !(0, json_js_1.sdIsNumber)(val.offset)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"offset\" of type \"Collections\"" });
    }
    const offset = val.offset == void 0 ? void 0 : val.offset;
    if (!(val.order == void 0) && !(0, json_js_3.sdIsList)(val.order)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"order\" of type \"Collections\"" });
    }
    ...
    if (!(val.entries == void 0) && !(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"Collections\"" });
    }
