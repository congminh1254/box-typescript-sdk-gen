...
function deserializeLegalHoldPolicyMiniTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize LegalHoldPolicyMiniTypeField" });
}
...
function deserializeLegalHoldPolicyMini(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"LegalHoldPolicyMini\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"LegalHoldPolicyMini\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"LegalHoldPolicyMini\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"LegalHoldPolicyMini\" to be defined" });
    }
...
function deserializeLegalHoldPolicyMiniInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"LegalHoldPolicyMiniInput\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"LegalHoldPolicyMiniInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"LegalHoldPolicyMiniInput\"" });
    }
    const id = val.id;
