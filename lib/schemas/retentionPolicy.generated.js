...
function deserializeRetentionPolicyPolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyPolicyTypeField" });
}
...
function deserializeRetentionPolicyRetentionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyRetentionTypeField" });
}
...
function deserializeRetentionPolicyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyStatusField" });
}
...
function deserializeRetentionPolicyAssignmentCountsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyAssignmentCountsField\"" });
    }
    if (!(val.enterprise == void 0) && !(0, json_js_2.sdIsNumber)(val.enterprise)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"enterprise\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
    const enterprise = val.enterprise == void 0 ? void 0 : val.enterprise;
    if (!(val.folder == void 0) && !(0, json_js_2.sdIsNumber)(val.folder)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"folder\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
    const folder = val.folder == void 0 ? void 0 : val.folder;
    if (!(val.metadata_template == void 0) && !(0, json_js_2.sdIsNumber)(val.metadata_template)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"metadata_template\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
...
function serializeRetentionPolicy(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["description"]: val.description, ["policy_type"]: val.policyType == void 0 ? val.policyType : serializeRetentionPolicyPolicyTypeField(val.policyType), ["retention_type"]: val.retentionType == void 0 ? val.retentionType : serializeRetentionPolicyRetentionTypeField(val.retentionType), ["status"]: val.status == void 0 ? val.status : serializeRetentionPolicyStatusField(val.status), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt), ["can_owner_extend_retention"]: val.canOwnerExtendRetention, ["are_owners_notified"]: val.areOwnersNotified, ["custom_notification_recipients"]: val.customNotificationRecipients == void 0 ? val.customNotificationRecipients : val.customNotificationRecipients.map(function (item) {
            return (0, userMini_generated_js_1.serializeUserMini)(item);
        }), ["assignment_counts"]: val.assignmentCounts == void 0 ? val.assignmentCounts : serializeRetentionPolicyAssignmentCountsField(val.assignmentCounts) });
}
function deserializeRetentionPolicy(val) {
    ...
    if (!(val.description == void 0) && !(0, json_js_3.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_3.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_3.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.can_owner_extend_retention == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_owner_extend_retention)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_owner_extend_retention\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.are_owners_notified == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_owners_notified)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_owners_notified\" of type \"RetentionPolicy\"" });
    }
    const areOwnersNotified = val.are_owners_notified == void 0 ? void 0 : val.are_owners_notified;
    if (!(val.custom_notification_recipients == void 0) && !(0, json_js_4.sdIsList)(val.custom_notification_recipients)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"custom_notification_recipients\" of type \"RetentionPolicy\"" });
    }
    const customNotificationRecipients = val.custom_notification_recipients == void 0 ? void 0 : (0, json_js_4.sdIsList)(val.custom_notification_recipients) ? val.custom_notification_recipients.map(function (itm) {
    ...
    if (!(val.policy_name == void 0) && !(0, json_js_3.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.retention_length == void 0) && !(0, json_js_3.sdIsString)(val.retention_length)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"RetentionPolicy\"" });
    }
    const retentionLength = val.retention_length == void 0 ? void 0 : val.retention_length;
    const dispositionAction = val.disposition_action == void 0 ? void 0 : (0, retentionPolicyMini_generated_js_1.deserializeRetentionPolicyMiniDispositionActionField)(val.disposition_action);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicy\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicy\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicy\" to be defined" });
    }
