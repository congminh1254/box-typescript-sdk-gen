...
function deserializeFolderLocks(val) {
    ...
    if (!(val.entries == void 0) && !(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"FolderLocks\"" });
    }
    ...
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsString)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"limit\" of type \"FolderLocks\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !(0, json_js_1.sdIsString)(val.next_marker)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"next_marker\" of type \"FolderLocks\"" });
    }
