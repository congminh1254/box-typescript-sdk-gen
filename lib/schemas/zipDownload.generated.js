...
function deserializeZipDownloadNameConflictsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ZipDownloadNameConflictsTypeField" });
}
...
function deserializeZipDownloadNameConflictsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ZipDownloadNameConflictsField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ZipDownloadNameConflictsField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeZipDownloadNameConflictsTypeField(val.type);
    if (!(val.original_name == void 0) && !(0, json_js_1.sdIsString)(val.original_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"original_name\" of type \"ZipDownloadNameConflictsField\"" });
    }
    ...
    if (!(val.download_name == void 0) && !(0, json_js_1.sdIsString)(val.download_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"download_name\" of type \"ZipDownloadNameConflictsField\"" });
    }
...
function serializeZipDownload(val) {
    return { ["download_url"]: val.downloadUrl, ["status_url"]: val.statusUrl, ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : (0, utils_js_1.serializeDateTime)(val.expiresAt), ["name_conflicts"]: val.nameConflicts == void 0 ? val.nameConflicts : val.nameConflicts.map(function (item) {
...
function deserializeZipDownload(val) {
    ...
    if (!(val.download_url == void 0) && !(0, json_js_1.sdIsString)(val.download_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"download_url\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.status_url == void 0) && !(0, json_js_1.sdIsString)(val.status_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"status_url\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.expires_at == void 0) && !(0, json_js_1.sdIsString)(val.expires_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.name_conflicts == void 0) && !(0, json_js_2.sdIsList)(val.name_conflicts)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"name_conflicts\" of type \"ZipDownload\"" });
    }
    const nameConflicts = val.name_conflicts == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.name_conflicts) ? val.name_conflicts.map(function (itm) {
        return (0, json_js_2.sdIsList)(itm) ? itm.map(function (itm) {
