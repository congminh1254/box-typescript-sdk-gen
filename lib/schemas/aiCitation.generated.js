...
function deserializeAiCitation(val) {
    ...
    if (!(val.content == void 0) && !(0, json_js_1.sdIsString)(val.content)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content\" of type \"AiCitation\"" });
    }
    const content = val.content == void 0 ? void 0 : val.content;
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"AiCitation\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"AiCitation\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    return { content: content, id: id, type: type, name: name };
}
