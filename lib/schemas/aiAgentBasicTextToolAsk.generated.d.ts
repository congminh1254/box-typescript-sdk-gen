...
export declare function serializeAiAgentBasicTextToolAsk(val: AiAgentBasicTextToolAsk): SerializedData;
export declare function deserializeAiAgentBasicTextToolAsk(val: SerializedData): AiAgentBasicTextToolAsk;
