...
function deserializeCollectionCollectionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollectionCollectionTypeField" });
}
...
function deserializeCollection(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"Collection\"" });
    }
