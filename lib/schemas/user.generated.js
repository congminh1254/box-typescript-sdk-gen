...
function deserializeUserNotificationEmailField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UserNotificationEmailField\"" });
    }
    if (!(val.email == void 0) && !(0, json_js_3.sdIsString)(val.email)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email\" of type \"UserNotificationEmailField\"" });
    }
    const email = val.email == void 0 ? void 0 : val.email;
    if (!(val.is_confirmed == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_confirmed)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_confirmed\" of type \"UserNotificationEmailField\"" });
    }
...
function deserializeUser(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_3.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"User\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_3.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"User\"" });
    }
    ...
    if (!(val.language == void 0) && !(0, json_js_3.sdIsString)(val.language)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"language\" of type \"User\"" });
    }
    const language = val.language == void 0 ? void 0 : val.language;
    if (!(val.timezone == void 0) && !(0, json_js_3.sdIsString)(val.timezone)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"timezone\" of type \"User\"" });
    }
    const timezone = val.timezone == void 0 ? void 0 : val.timezone;
    if (!(val.space_amount == void 0) && !(0, json_js_2.sdIsNumber)(val.space_amount)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"space_amount\" of type \"User\"" });
    }
    ...
    if (!(val.space_used == void 0) && !(0, json_js_2.sdIsNumber)(val.space_used)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"space_used\" of type \"User\"" });
    }
    ...
    if (!(val.max_upload_size == void 0) && !(0, json_js_2.sdIsNumber)(val.max_upload_size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"max_upload_size\" of type \"User\"" });
    }
    ...
    if (!(val.job_title == void 0) && !(0, json_js_3.sdIsString)(val.job_title)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"job_title\" of type \"User\"" });
    }
    const jobTitle = val.job_title == void 0 ? void 0 : val.job_title;
    if (!(val.phone == void 0) && !(0, json_js_3.sdIsString)(val.phone)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"phone\" of type \"User\"" });
    }
    const phone = val.phone == void 0 ? void 0 : val.phone;
    if (!(val.address == void 0) && !(0, json_js_3.sdIsString)(val.address)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"address\" of type \"User\"" });
    }
    const address = val.address == void 0 ? void 0 : val.address;
    if (!(val.avatar_url == void 0) && !(0, json_js_3.sdIsString)(val.avatar_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"avatar_url\" of type \"User\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"User\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.login == void 0) && !(0, json_js_3.sdIsString)(val.login)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"login\" of type \"User\"" });
    }
    const login = val.login == void 0 ? void 0 : val.login;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"User\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"User\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"User\" to be defined" });
    }
