...
function serializeAiAgentAsk(val) {
    return { ["type"]: serializeAiAgentAskTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : (0, aiAgentLongTextTool_generated_js_1.serializeAiAgentLongTextTool)(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : (0, aiAgentBasicTextTool_generated_js_1.serializeAiAgentBasicTextTool)(val.basicText), ["long_text_multi"]: val.longTextMulti == void 0 ? val.longTextMulti : (0, aiAgentLongTextTool_generated_js_1.serializeAiAgentLongTextTool)(val.longTextMulti), ["basic_text_multi"]: val.basicTextMulti == void 0 ? val.basicTextMulti : (0, aiAgentBasicTextTool_generated_js_1.serializeAiAgentBasicTextTool)(val.basicTextMulti) };
}
function deserializeAiAgentAsk(val) {
    ...
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiAgentAsk\" to be defined" });
    }
    const type = deserializeAiAgentAskTypeField(val.type);
    const longText = val.long_text == void 0 ? void 0 : (0, aiAgentLongTextTool_generated_js_2.deserializeAiAgentLongTextTool)(val.long_text);
    const basicText = val.basic_text == void 0 ? void 0 : (0, aiAgentBasicTextTool_generated_js_2.deserializeAiAgentBasicTextTool)(val.basic_text);
    const longTextMulti = val.long_text_multi == void 0 ? void 0 : (0, aiAgentLongTextTool_generated_js_2.deserializeAiAgentLongTextTool)(val.long_text_multi);
    const basicTextMulti = val.basic_text_multi == void 0 ? void 0 : (0, aiAgentBasicTextTool_generated_js_2.deserializeAiAgentBasicTextTool)(val.basic_text_multi);
    return { type: type, longText: longText, basicText: basicText, longTextMulti: longTextMulti, basicTextMulti: basicTextMulti };
}
