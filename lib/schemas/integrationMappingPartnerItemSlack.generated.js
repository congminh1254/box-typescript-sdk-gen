...
function deserializeIntegrationMappingPartnerItemSlackTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize IntegrationMappingPartnerItemSlackTypeField" });
}
...
function deserializeIntegrationMappingPartnerItemSlack(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingPartnerItemSlack\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"IntegrationMappingPartnerItemSlack\" to be defined" });
    }
    const type = deserializeIntegrationMappingPartnerItemSlackTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingPartnerItemSlack\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingPartnerItemSlack\"" });
    }
    const id = val.id;
    if (!(val.slack_workspace_id == void 0) && !(0, json_js_1.sdIsString)(val.slack_workspace_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"slack_workspace_id\" of type \"IntegrationMappingPartnerItemSlack\"" });
    }
    ...
    if (!(val.slack_org_id == void 0) && !(0, json_js_1.sdIsString)(val.slack_org_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"slack_org_id\" of type \"IntegrationMappingPartnerItemSlack\"" });
    }
...
function deserializeIntegrationMappingPartnerItemSlackInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingPartnerItemSlackInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeIntegrationMappingPartnerItemSlackTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingPartnerItemSlackInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingPartnerItemSlackInput\"" });
    }
    const id = val.id;
    if (!(val.slack_workspace_id == void 0) && !(0, json_js_1.sdIsString)(val.slack_workspace_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"slack_workspace_id\" of type \"IntegrationMappingPartnerItemSlackInput\"" });
    }
    const slackWorkspaceId = val.slack_workspace_id == void 0 ? void 0 : val.slack_workspace_id;
    if (!(val.slack_org_id == void 0) && !(0, json_js_1.sdIsString)(val.slack_org_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"slack_org_id\" of type \"IntegrationMappingPartnerItemSlackInput\"" });
    }
    const slackOrgId = val.slack_org_id == void 0 ? void 0 : val.slack_org_id;
    return { type: type, id: id, slackWorkspaceId: slackWorkspaceId, slackOrgId: slackOrgId };
}
