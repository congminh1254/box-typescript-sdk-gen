...
function deserializeZipDownloadRequestItemsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ZipDownloadRequestItemsTypeField" });
}
...
function deserializeZipDownloadRequestItemsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ZipDownloadRequestItemsField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"ZipDownloadRequestItemsField\" to be defined" });
    }
    const type = deserializeZipDownloadRequestItemsTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"ZipDownloadRequestItemsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ZipDownloadRequestItemsField\"" });
    }
    const id = val.id;
...
function deserializeZipDownloadRequest(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ZipDownloadRequest\"" });
    }
    if (val.items == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"items\" of type \"ZipDownloadRequest\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.items)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"items\" of type \"ZipDownloadRequest\"" });
    }
    const items = (0, json_js_2.sdIsList)(val.items) ? val.items.map(function (itm) {
        return deserializeZipDownloadRequestItemsField(itm);
    }) : [];
    if (!(val.download_file_name == void 0) && !(0, json_js_1.sdIsString)(val.download_file_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"download_file_name\" of type \"ZipDownloadRequest\"" });
    }
