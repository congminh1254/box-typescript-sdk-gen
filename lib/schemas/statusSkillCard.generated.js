...
function deserializeStatusSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StatusSkillCardTypeField" });
}
...
function deserializeStatusSkillCardSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StatusSkillCardSkillCardTypeField" });
}
...
function deserializeStatusSkillCardSkillCardTitleField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardSkillCardTitleField\"" });
    }
    if (!(val.code == void 0) && !(0, json_js_1.sdIsString)(val.code)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"code\" of type \"StatusSkillCardSkillCardTitleField\"" });
    }
    const code = val.code == void 0 ? void 0 : val.code;
    if (val.message == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"message\" of type \"StatusSkillCardSkillCardTitleField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"StatusSkillCardSkillCardTitleField\"" });
    }
...
function deserializeStatusSkillCardStatusCodeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StatusSkillCardStatusCodeField" });
}
...
function deserializeStatusSkillCardStatusField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardStatusField\"" });
    }
    if (val.code == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"code\" of type \"StatusSkillCardStatusField\" to be defined" });
    }
    const code = deserializeStatusSkillCardStatusCodeField(val.code);
    if (!(val.message == void 0) && !(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"StatusSkillCardStatusField\"" });
    }
...
function deserializeStatusSkillCardSkillTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StatusSkillCardSkillTypeField" });
}
...
function deserializeStatusSkillCardSkillField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardSkillField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"StatusSkillCardSkillField\" to be defined" });
    }
    const type = deserializeStatusSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"StatusSkillCardSkillField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StatusSkillCardSkillField\"" });
    }
    const id = val.id;
...
function deserializeStatusSkillCardSkillFieldInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardSkillFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeStatusSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"StatusSkillCardSkillFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StatusSkillCardSkillFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeStatusSkillCardInvocationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StatusSkillCardInvocationTypeField" });
}
...
function deserializeStatusSkillCardInvocationField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardInvocationField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"StatusSkillCardInvocationField\" to be defined" });
    }
    const type = deserializeStatusSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"StatusSkillCardInvocationField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StatusSkillCardInvocationField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeStatusSkillCardInvocationFieldInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardInvocationFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeStatusSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"StatusSkillCardInvocationFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StatusSkillCardInvocationFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeStatusSkillCard(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"StatusSkillCard\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"StatusSkillCard\" to be defined" });
    }
    const type = deserializeStatusSkillCardTypeField(val.type);
    if (val.skill_card_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill_card_type\" of type \"StatusSkillCard\" to be defined" });
    }
    ...
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"StatusSkillCard\" to be defined" });
    }
    const status = deserializeStatusSkillCardStatusField(val.status);
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"StatusSkillCard\" to be defined" });
    }
    const skill = deserializeStatusSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"StatusSkillCard\" to be defined" });
    }
...
function deserializeStatusSkillCardInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StatusSkillCardInput\"" });
    }
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"StatusSkillCardInput\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    const type = val.type == void 0 ? void 0 : deserializeStatusSkillCardTypeField(val.type);
    const skillCardType = val.skillCardType == void 0 ? void 0 : deserializeStatusSkillCardSkillCardTypeField(val.skillCardType);
    const skillCardTitle = val.skill_card_title == void 0 ? void 0 : deserializeStatusSkillCardSkillCardTitleField(val.skill_card_title);
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"StatusSkillCardInput\" to be defined" });
    }
    const status = deserializeStatusSkillCardStatusField(val.status);
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"StatusSkillCardInput\" to be defined" });
    }
    const skill = deserializeStatusSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"StatusSkillCardInput\" to be defined" });
    }
    const invocation = deserializeStatusSkillCardInvocationField(val.invocation);
    return { createdAt: createdAt, type: type, skillCardType: skillCardType, skillCardTitle: skillCardTitle, status: status, skill: skill, invocation: invocation };
}
