...
function deserializeTranscriptSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TranscriptSkillCardTypeField" });
}
...
function deserializeTranscriptSkillCardSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TranscriptSkillCardSkillCardTypeField" });
}
...
function deserializeTranscriptSkillCardSkillCardTitleField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardSkillCardTitleField\"" });
    }
    if (!(val.code == void 0) && !(0, json_js_2.sdIsString)(val.code)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"code\" of type \"TranscriptSkillCardSkillCardTitleField\"" });
    }
    const code = val.code == void 0 ? void 0 : val.code;
    if (val.message == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"message\" of type \"TranscriptSkillCardSkillCardTitleField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"TranscriptSkillCardSkillCardTitleField\"" });
    }
...
function deserializeTranscriptSkillCardSkillTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TranscriptSkillCardSkillTypeField" });
}
...
function deserializeTranscriptSkillCardSkillField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardSkillField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"TranscriptSkillCardSkillField\" to be defined" });
    }
    const type = deserializeTranscriptSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"TranscriptSkillCardSkillField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TranscriptSkillCardSkillField\"" });
    }
    const id = val.id;
...
function deserializeTranscriptSkillCardSkillFieldInput(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardSkillFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeTranscriptSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"TranscriptSkillCardSkillFieldInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TranscriptSkillCardSkillFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeTranscriptSkillCardInvocationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TranscriptSkillCardInvocationTypeField" });
}
...
function deserializeTranscriptSkillCardInvocationField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardInvocationField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"TranscriptSkillCardInvocationField\" to be defined" });
    }
    const type = deserializeTranscriptSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"TranscriptSkillCardInvocationField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TranscriptSkillCardInvocationField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeTranscriptSkillCardInvocationFieldInput(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardInvocationFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeTranscriptSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"TranscriptSkillCardInvocationFieldInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TranscriptSkillCardInvocationFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeTranscriptSkillCardEntriesAppearsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardEntriesAppearsField\"" });
    }
    if (!(val.start == void 0) && !(0, json_js_1.sdIsNumber)(val.start)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"start\" of type \"TranscriptSkillCardEntriesAppearsField\"" });
    }
...
function deserializeTranscriptSkillCardEntriesField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardEntriesField\"" });
    }
    if (!(val.text == void 0) && !(0, json_js_2.sdIsString)(val.text)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text\" of type \"TranscriptSkillCardEntriesField\"" });
    }
    const text = val.text == void 0 ? void 0 : val.text;
    if (!(val.appears == void 0) && !(0, json_js_3.sdIsList)(val.appears)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"appears\" of type \"TranscriptSkillCardEntriesField\"" });
    }
...
function serializeTranscriptSkillCard(val) {
    return { ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["type"]: serializeTranscriptSkillCardTypeField(val.type), ["skill_card_type"]: serializeTranscriptSkillCardSkillCardTypeField(val.skillCardType), ["skill_card_title"]: val.skillCardTitle == void 0 ? val.skillCardTitle : serializeTranscriptSkillCardSkillCardTitleField(val.skillCardTitle), ["skill"]: serializeTranscriptSkillCardSkillField(val.skill), ["invocation"]: serializeTranscriptSkillCardInvocationField(val.invocation), ["duration"]: val.duration, ["entries"]: val.entries.map(function (item) {
            return serializeTranscriptSkillCardEntriesField(item);
        }) };
}
function deserializeTranscriptSkillCard(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCard\"" });
    }
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"TranscriptSkillCard\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"TranscriptSkillCard\" to be defined" });
    }
    const type = deserializeTranscriptSkillCardTypeField(val.type);
    if (val.skill_card_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill_card_type\" of type \"TranscriptSkillCard\" to be defined" });
    }
    ...
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"TranscriptSkillCard\" to be defined" });
    }
    const skill = deserializeTranscriptSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"TranscriptSkillCard\" to be defined" });
    }
    ...
    if (!(val.duration == void 0) && !(0, json_js_1.sdIsNumber)(val.duration)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"duration\" of type \"TranscriptSkillCard\"" });
    }
    const duration = val.duration == void 0 ? void 0 : val.duration;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"TranscriptSkillCard\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"TranscriptSkillCard\"" });
    }
...
function serializeTranscriptSkillCardInput(val) {
    return { ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["type"]: val.type == void 0 ? val.type : serializeTranscriptSkillCardTypeField(val.type), ["skillCardType"]: val.skillCardType == void 0 ? val.skillCardType : serializeTranscriptSkillCardSkillCardTypeField(val.skillCardType), ["skill_card_title"]: val.skillCardTitle == void 0 ? val.skillCardTitle : serializeTranscriptSkillCardSkillCardTitleField(val.skillCardTitle), ["skill"]: serializeTranscriptSkillCardSkillField(val.skill), ["invocation"]: serializeTranscriptSkillCardInvocationField(val.invocation), ["duration"]: val.duration, ["entries"]: val.entries.map(function (item) {
            return serializeTranscriptSkillCardEntriesField(item);
        }) };
}
function deserializeTranscriptSkillCardInput(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TranscriptSkillCardInput\"" });
    }
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"TranscriptSkillCardInput\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    const type = val.type == void 0 ? void 0 : deserializeTranscriptSkillCardTypeField(val.type);
    const skillCardType = val.skillCardType == void 0 ? void 0 : deserializeTranscriptSkillCardSkillCardTypeField(val.skillCardType);
    const skillCardTitle = val.skill_card_title == void 0 ? void 0 : deserializeTranscriptSkillCardSkillCardTitleField(val.skill_card_title);
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"TranscriptSkillCardInput\" to be defined" });
    }
    const skill = deserializeTranscriptSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"TranscriptSkillCardInput\" to be defined" });
    }
    const invocation = deserializeTranscriptSkillCardInvocationField(val.invocation);
    if (!(val.duration == void 0) && !(0, json_js_1.sdIsNumber)(val.duration)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"duration\" of type \"TranscriptSkillCardInput\"" });
    }
    const duration = val.duration == void 0 ? void 0 : val.duration;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"TranscriptSkillCardInput\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"TranscriptSkillCardInput\"" });
    }
    const entries = (0, json_js_3.sdIsList)(val.entries) ? val.entries.map(function (itm) {
        return deserializeTranscriptSkillCardEntriesField(itm);
    }) : [];
