...
function serializeSignRequestPrefillTag(val) {
    return { ["document_tag_id"]: val.documentTagId, ["text_value"]: val.textValue, ["checkbox_value"]: val.checkboxValue, ["date_value"]: val.dateValue == void 0 ? val.dateValue : (0, utils_js_1.serializeDate)(val.dateValue) };
}
function deserializeSignRequestPrefillTag(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SignRequestPrefillTag\"" });
    }
    if (!(val.document_tag_id == void 0) && !(0, json_js_2.sdIsString)(val.document_tag_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"document_tag_id\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.text_value == void 0) && !(0, json_js_2.sdIsString)(val.text_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text_value\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.checkbox_value == void 0) && !(0, json_js_1.sdIsBoolean)(val.checkbox_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"checkbox_value\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.date_value == void 0) && !(0, json_js_2.sdIsString)(val.date_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"date_value\" of type \"SignRequestPrefillTag\"" });
    }
