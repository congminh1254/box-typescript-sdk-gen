...
function deserializePostOAuth2Revoke(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"PostOAuth2Revoke\"" });
    }
    if (!(val.client_id == void 0) && !(0, json_js_1.sdIsString)(val.client_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_id\" of type \"PostOAuth2Revoke\"" });
    }
    ...
    if (!(val.client_secret == void 0) && !(0, json_js_1.sdIsString)(val.client_secret)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_secret\" of type \"PostOAuth2Revoke\"" });
    }
    const clientSecret = val.client_secret == void 0 ? void 0 : val.client_secret;
    if (!(val.token == void 0) && !(0, json_js_1.sdIsString)(val.token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"token\" of type \"PostOAuth2Revoke\"" });
    }
