...
function deserializeShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentTypeField" });
}
...
function deserializeShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeShieldInformationBarrierSegmentRestrictionMiniShieldInformationBarrierSegmentTypeField(val.type);
...
function deserializeShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentTypeField" });
}
...
function deserializeShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeShieldInformationBarrierSegmentRestrictionMiniRestrictedSegmentTypeField(val.type);
    return { id: id, type: type };
}
function serializeShieldInformationBarrierSegmentRestrictionMini(val) {
    ...
    if (!(0, json_js_2.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentRestrictionMini\"" });
    }
...
function deserializeShieldInformationBarrierSegmentRestrictionMini(val) {
    ...
    if (val.shield_information_barrier_segment == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"shield_information_barrier_segment\" of type \"ShieldInformationBarrierSegmentRestrictionMini\" to be defined" });
    }
    ...
    if (val.restricted_segment == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"restricted_segment\" of type \"ShieldInformationBarrierSegmentRestrictionMini\" to be defined" });
    }
    ...
    const type = val.type == void 0 ? void 0 : (0, shieldInformationBarrierSegmentRestrictionBase_generated_js_1.deserializeShieldInformationBarrierSegmentRestrictionBaseTypeField)(val.type);
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentRestrictionMini\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
