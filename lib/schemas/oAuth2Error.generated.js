...
function deserializeOAuth2Error(val) {
    ...
    if (!(val.error == void 0) && !(0, json_js_1.sdIsString)(val.error)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"error\" of type \"OAuth2Error\"" });
    }
    const error = val.error == void 0 ? void 0 : val.error;
    if (!(val.error_description == void 0) && !(0, json_js_1.sdIsString)(val.error_description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"error_description\" of type \"OAuth2Error\"" });
    }
