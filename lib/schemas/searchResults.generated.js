...
function deserializeSearchResultsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchResultsTypeField" });
}
function serializeSearchResults(val) {
    return { ["total_count"]: val.totalCount, ["limit"]: val.limit, ["offset"]: val.offset, ["type"]: serializeSearchResultsTypeField(val.type), ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item) {
...
function deserializeSearchResults(val) {
    ...
    if (!(val.total_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"SearchResults\"" });
    }
    const totalCount = val.total_count == void 0 ? void 0 : val.total_count;
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"SearchResults\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.offset == void 0) && !(0, json_js_1.sdIsNumber)(val.offset)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"offset\" of type \"SearchResults\"" });
    }
    const offset = val.offset == void 0 ? void 0 : val.offset;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"SearchResults\" to be defined" });
    }
    const type = deserializeSearchResultsTypeField(val.type);
    if (!(val.entries == void 0) && !(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"SearchResults\"" });
    }
...
function serializeSearchResultsInput(val) {
    return { ["total_count"]: val.totalCount, ["limit"]: val.limit, ["offset"]: val.offset, ["type"]: val.type == void 0 ? val.type : serializeSearchResultsTypeField(val.type), ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item) {
            return (0, fileFullOrFolderFullOrWebLink_generated_js_1.serializeFileFullOrFolderFullOrWebLink)(item);
        }) };
}
function deserializeSearchResultsInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SearchResultsInput\"" });
    }
    if (!(val.total_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"SearchResultsInput\"" });
    }
    const totalCount = val.total_count == void 0 ? void 0 : val.total_count;
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"SearchResultsInput\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.offset == void 0) && !(0, json_js_1.sdIsNumber)(val.offset)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"offset\" of type \"SearchResultsInput\"" });
    }
    const offset = val.offset == void 0 ? void 0 : val.offset;
    const type = val.type == void 0 ? void 0 : deserializeSearchResultsTypeField(val.type);
    if (!(val.entries == void 0) && !(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"SearchResultsInput\"" });
    }
    const entries = val.entries == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.entries) ? val.entries.map(function (itm) {
        return (0, fileFullOrFolderFullOrWebLink_generated_js_2.deserializeFileFullOrFolderFullOrWebLink)(itm);
    }) : [];
