...
function serializeIntegrationMappingSlackCreateRequest(val) {
    return { ["partner_item"]: (0, integrationMappingPartnerItemSlack_generated_js_1.serializeIntegrationMappingPartnerItemSlack)(val.partnerItem), ["box_item"]: (0, integrationMappingBoxItemSlack_generated_js_1.serializeIntegrationMappingBoxItemSlack)(val.boxItem), ["options"]: val.options == void 0 ? val.options : (0, integrationMappingSlackOptions_generated_js_1.serializeIntegrationMappingSlackOptions)(val.options) };
}
function deserializeIntegrationMappingSlackCreateRequest(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingSlackCreateRequest\"" });
    }
    if (val.partner_item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"partner_item\" of type \"IntegrationMappingSlackCreateRequest\" to be defined" });
    }
    ...
    if (val.box_item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"box_item\" of type \"IntegrationMappingSlackCreateRequest\" to be defined" });
    }
