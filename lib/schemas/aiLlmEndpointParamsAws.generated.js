...
function deserializeAiLlmEndpointParamsAwsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AiLlmEndpointParamsAwsTypeField" });
}
...
function deserializeAiLlmEndpointParamsAws(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiLlmEndpointParamsAws\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiLlmEndpointParamsAws\" to be defined" });
    }
    ...
    if (!(val.temperature == void 0) && !(0, json_js_1.sdIsNumber)(val.temperature)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"temperature\" of type \"AiLlmEndpointParamsAws\"" });
    }
    const temperature = val.temperature == void 0 ? void 0 : val.temperature;
    if (!(val.top_p == void 0) && !(0, json_js_1.sdIsNumber)(val.top_p)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_p\" of type \"AiLlmEndpointParamsAws\"" });
    }
    const topP = val.top_p == void 0 ? void 0 : val.top_p;
    return { type: type, temperature: temperature, topP: topP };
}
...
function deserializeAiLlmEndpointParamsAwsInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiLlmEndpointParamsAwsInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeAiLlmEndpointParamsAwsTypeField(val.type);
    if (!(val.temperature == void 0) && !(0, json_js_1.sdIsNumber)(val.temperature)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"temperature\" of type \"AiLlmEndpointParamsAwsInput\"" });
    }
    const temperature = val.temperature == void 0 ? void 0 : val.temperature;
    if (!(val.top_p == void 0) && !(0, json_js_1.sdIsNumber)(val.top_p)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_p\" of type \"AiLlmEndpointParamsAwsInput\"" });
    }
    const topP = val.top_p == void 0 ? void 0 : val.top_p;
    return { type: type, temperature: temperature, topP: topP };
}
