...
function serializeUserCollaborations(val) {
    ...
    if (!(0, json_js_3.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UserCollaborations\"" });
    }
    return Object.assign(Object.assign({}, base), { ["name"]: val.name, ["login"]: val.login, ["is_active"]: val.isActive });
}
function deserializeUserCollaborations(val) {
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"UserCollaborations\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.login == void 0) && !(0, json_js_2.sdIsString)(val.login)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"login\" of type \"UserCollaborations\"" });
    }
    const login = val.login == void 0 ? void 0 : val.login;
    if (!(val.is_active == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_active)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_active\" of type \"UserCollaborations\"" });
    }
    const isActive = val.is_active == void 0 ? void 0 : val.is_active;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"UserCollaborations\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UserCollaborations\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"UserCollaborations\" to be defined" });
    }
    const type = (0, userBase_generated_js_1.deserializeUserBaseTypeField)(val.type);
    return { name: name, login: login, isActive: isActive, id: id, type: type };
}
