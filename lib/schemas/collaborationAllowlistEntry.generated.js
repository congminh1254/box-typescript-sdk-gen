...
function deserializeCollaborationAllowlistEntryTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollaborationAllowlistEntryTypeField" });
}
...
function deserializeCollaborationAllowlistEntryDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollaborationAllowlistEntryDirectionField" });
}
...
function deserializeCollaborationAllowlistEntryEnterpriseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollaborationAllowlistEntryEnterpriseTypeField" });
}
...
function deserializeCollaborationAllowlistEntryEnterpriseField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CollaborationAllowlistEntryEnterpriseField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CollaborationAllowlistEntryEnterpriseField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeCollaborationAllowlistEntryEnterpriseTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CollaborationAllowlistEntryEnterpriseField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    return { id: id, type: type, name: name };
}
function serializeCollaborationAllowlistEntry(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeCollaborationAllowlistEntryTypeField(val.type), ["domain"]: val.domain, ["direction"]: val.direction == void 0 ? val.direction : serializeCollaborationAllowlistEntryDirectionField(val.direction), ["enterprise"]: val.enterprise == void 0 ? val.enterprise : serializeCollaborationAllowlistEntryEnterpriseField(val.enterprise), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt) };
}
function deserializeCollaborationAllowlistEntry(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CollaborationAllowlistEntry\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CollaborationAllowlistEntry\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    ...
    if (!(val.domain == void 0) && !(0, json_js_1.sdIsString)(val.domain)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"domain\" of type \"CollaborationAllowlistEntry\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"CollaborationAllowlistEntry\"" });
    }
