...
function deserializeWorkflowFlowsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsTypeField" });
}
...
function deserializeWorkflowFlowsTriggerTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsTriggerTypeField" });
}
...
function deserializeWorkflowFlowsTriggerTriggerTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsTriggerTriggerTypeField" });
}
...
function deserializeWorkflowFlowsTriggerScopeTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsTriggerScopeTypeField" });
}
...
function deserializeWorkflowFlowsTriggerScopeObjectTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsTriggerScopeObjectTypeField" });
}
...
function deserializeWorkflowFlowsTriggerScopeObjectField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsTriggerScopeObjectField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsTriggerScopeObjectTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFlowsTriggerScopeObjectField\"" });
    }
...
function deserializeWorkflowFlowsTriggerScopeField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsTriggerScopeField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsTriggerScopeTypeField(val.type);
    if (!(val.ref == void 0) && !(0, json_js_2.sdIsString)(val.ref)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"ref\" of type \"WorkflowFlowsTriggerScopeField\"" });
    }
    const ref = val.ref == void 0 ? void 0 : val.ref;
    const object = val.object == void 0 ? void 0 : deserializeWorkflowFlowsTriggerScopeObjectField(val.object);
    return { type: type, ref: ref, object: object };
}
function serializeWorkflowFlowsTriggerField(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeWorkflowFlowsTriggerTypeField(val.type), ["trigger_type"]: val.triggerType == void 0 ? val.triggerType : serializeWorkflowFlowsTriggerTriggerTypeField(val.triggerType), ["scope"]: val.scope == void 0 ? val.scope : val.scope.map(function (item) {
            return serializeWorkflowFlowsTriggerScopeField(item);
        }) };
}
function deserializeWorkflowFlowsTriggerField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsTriggerField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsTriggerTypeField(val.type);
    const triggerType = val.trigger_type == void 0 ? void 0 : deserializeWorkflowFlowsTriggerTriggerTypeField(val.trigger_type);
    if (!(val.scope == void 0) && !(0, json_js_3.sdIsList)(val.scope)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"scope\" of type \"WorkflowFlowsTriggerField\"" });
    }
    const scope = val.scope == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.scope) ? val.scope.map(function (itm) {
...
function deserializeWorkflowFlowsOutcomesTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsOutcomesTypeField" });
}
...
function deserializeWorkflowFlowsOutcomesActionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsOutcomesActionTypeField" });
}
...
function deserializeWorkflowFlowsOutcomesIfRejectedTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsOutcomesIfRejectedTypeField" });
}
...
function deserializeWorkflowFlowsOutcomesIfRejectedActionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WorkflowFlowsOutcomesIfRejectedActionTypeField" });
}
...
function deserializeWorkflowFlowsOutcomesIfRejectedField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsOutcomesIfRejectedField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFlowsOutcomesIfRejectedField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsOutcomesIfRejectedTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowFlowsOutcomesIfRejectedField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    const actionType = val.action_type == void 0 ? void 0 : deserializeWorkflowFlowsOutcomesIfRejectedActionTypeField(val.action_type);
    return { id: id, type: type, name: name, actionType: actionType };
}
function serializeWorkflowFlowsOutcomesField(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeWorkflowFlowsOutcomesTypeField(val.type), ["name"]: val.name, ["action_type"]: val.actionType == void 0 ? val.actionType : serializeWorkflowFlowsOutcomesActionTypeField(val.actionType), ["if_rejected"]: val.ifRejected == void 0 ? val.ifRejected : val.ifRejected.map(function (item) {
            return serializeWorkflowFlowsOutcomesIfRejectedField(item);
        }) };
}
function deserializeWorkflowFlowsOutcomesField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsOutcomesField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFlowsOutcomesField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsOutcomesTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowFlowsOutcomesField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    const actionType = val.action_type == void 0 ? void 0 : deserializeWorkflowFlowsOutcomesActionTypeField(val.action_type);
    if (!(val.if_rejected == void 0) && !(0, json_js_3.sdIsList)(val.if_rejected)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"if_rejected\" of type \"WorkflowFlowsOutcomesField\"" });
    }
    const ifRejected = val.if_rejected == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.if_rejected) ? val.if_rejected.map(function (itm) {
...
function serializeWorkflowFlowsField(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeWorkflowFlowsTypeField(val.type), ["trigger"]: val.trigger == void 0 ? val.trigger : serializeWorkflowFlowsTriggerField(val.trigger), ["outcomes"]: val.outcomes == void 0 ? val.outcomes : val.outcomes.map(function (item) {
            return serializeWorkflowFlowsOutcomesField(item);
        }), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userBase_generated_js_1.serializeUserBase)(val.createdBy) };
}
function deserializeWorkflowFlowsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WorkflowFlowsField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFlowsField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeWorkflowFlowsTypeField(val.type);
    const trigger = val.trigger == void 0 ? void 0 : deserializeWorkflowFlowsTriggerField(val.trigger);
    if (!(val.outcomes == void 0) && !(0, json_js_3.sdIsList)(val.outcomes)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"outcomes\" of type \"WorkflowFlowsField\"" });
    }
    const outcomes = val.outcomes == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.outcomes) ? val.outcomes.map(function (itm) {
        return deserializeWorkflowFlowsOutcomesField(itm);
    }) : [];
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WorkflowFlowsField\"" });
    }
...
function serializeWorkflow(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["flows"]: val.flows == void 0 ? val.flows : val.flows.map(function (item) {
...
function deserializeWorkflow(val) {
    ...
    if (!(val.flows == void 0) && !(0, json_js_3.sdIsList)(val.flows)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"flows\" of type \"Workflow\"" });
    }
    const flows = val.flows == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.flows) ? val.flows.map(function (itm) {
        return deserializeWorkflowFlowsField(itm);
    }) : [];
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"Workflow\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : (0, workflowMini_generated_js_1.deserializeWorkflowMiniTypeField)(val.type);
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"Workflow\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"Workflow\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.is_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_enabled\" of type \"Workflow\"" });
    }
