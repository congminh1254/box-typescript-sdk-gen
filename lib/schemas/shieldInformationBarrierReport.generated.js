...
function deserializeShieldInformationBarrierReportStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierReportStatusField" });
}
function serializeShieldInformationBarrierReport(val) {
    ...
    if (!(0, json_js_2.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReport\"" });
    }
    return Object.assign(Object.assign({}, base), { ["shield_information_barrier"]: val.shieldInformationBarrier == void 0 ? val.shieldInformationBarrier : (0, shieldInformationBarrierReference_generated_js_1.serializeShieldInformationBarrierReference)(val.shieldInformationBarrier), ["status"]: val.status == void 0 ? val.status : serializeShieldInformationBarrierReportStatusField(val.status), ["details"]: val.details == void 0 ? val.details : (0, shieldInformationBarrierReportDetails_generated_js_1.serializeShieldInformationBarrierReportDetails)(val.details), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userBase_generated_js_1.serializeUserBase)(val.createdBy), ["updated_at"]: val.updatedAt == void 0 ? val.updatedAt : (0, utils_js_1.serializeDateTime)(val.updatedAt) });
}
function deserializeShieldInformationBarrierReport(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReport\"" });
    }
    const shieldInformationBarrier = val.shield_information_barrier == void 0 ? void 0 : (0, shieldInformationBarrierReference_generated_js_2.deserializeShieldInformationBarrierReference)(val.shield_information_barrier);
    const status = val.status == void 0 ? void 0 : deserializeShieldInformationBarrierReportStatusField(val.status);
    const details = val.details == void 0 ? void 0 : (0, shieldInformationBarrierReportDetails_generated_js_2.deserializeShieldInformationBarrierReportDetails)(val.details);
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrierReport\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !(0, json_js_1.sdIsString)(val.updated_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrierReport\"" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierReport\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : (0, shieldInformationBarrierReportBase_generated_js_1.deserializeShieldInformationBarrierReportBaseTypeField)(val.type);
