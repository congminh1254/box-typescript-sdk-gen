...
export function serializeAiAgentBasicTextToolBase(val) {
    return {
        ...
        ['llm_endpoint_params']: val.llmEndpointParams == void 0
            ...
            : serializeAiLlmEndpointParamsAwsOrAiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi(val.llmEndpointParams),
    };
}
export function deserializeAiAgentBasicTextToolBase(val) {
    ...
    const llmEndpointParams = val.llm_endpoint_params == void 0
        ? void 0
        : deserializeAiLlmEndpointParamsAwsOrAiLlmEndpointParamsGoogleOrAiLlmEndpointParamsOpenAi(val.llm_endpoint_params);
    return {
        model: model,
