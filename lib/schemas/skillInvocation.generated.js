...
function serializeSkillInvocation(val) {
    return {
        ['type']: val.type == void 0 ? void 0 : serializeSkillInvocationTypeField(val.type),
        ['id']: val.id == void 0 ? void 0 : val.id,
        ...
        ['source']: val.source == void 0 ? void 0 : (0, fileOrFolder_generated_js_1.serializeFileOrFolder)(val.source),
        ['event']: val.event == void 0 ? void 0 : (0, event_generated_js_1.serializeEvent)(val.event),
    };
}
