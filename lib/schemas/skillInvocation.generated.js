...
function deserializeSkillInvocationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationTypeField" });
}
...
function deserializeSkillInvocationSkillTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationSkillTypeField" });
}
...
function deserializeSkillInvocationSkillField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationSkillField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"SkillInvocationSkillField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeSkillInvocationSkillTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"SkillInvocationSkillField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.api_key == void 0) && !(0, json_js_2.sdIsString)(val.api_key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"api_key\" of type \"SkillInvocationSkillField\"" });
    }
...
function deserializeSkillInvocationTokenReadTokenTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationTokenReadTokenTypeField" });
}
...
function deserializeSkillInvocationTokenReadField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationTokenReadField\"" });
    }
    if (!(val.access_token == void 0) && !(0, json_js_2.sdIsString)(val.access_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"access_token\" of type \"SkillInvocationTokenReadField\"" });
    }
    ...
    if (!(val.expires_in == void 0) && !(0, json_js_1.sdIsNumber)(val.expires_in)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"expires_in\" of type \"SkillInvocationTokenReadField\"" });
    }
    const expiresIn = val.expires_in == void 0 ? void 0 : val.expires_in;
    const tokenType = val.token_type == void 0 ? void 0 : deserializeSkillInvocationTokenReadTokenTypeField(val.token_type);
    if (!(val.restricted_to == void 0) && !(0, json_js_2.sdIsString)(val.restricted_to)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"restricted_to\" of type \"SkillInvocationTokenReadField\"" });
    }
...
function deserializeSkillInvocationTokenWriteTokenTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationTokenWriteTokenTypeField" });
}
...
function deserializeSkillInvocationTokenWriteField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationTokenWriteField\"" });
    }
    if (!(val.access_token == void 0) && !(0, json_js_2.sdIsString)(val.access_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"access_token\" of type \"SkillInvocationTokenWriteField\"" });
    }
    const accessToken = val.access_token == void 0 ? void 0 : val.access_token;
    if (!(val.expires_in == void 0) && !(0, json_js_1.sdIsNumber)(val.expires_in)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"expires_in\" of type \"SkillInvocationTokenWriteField\"" });
    }
    const expiresIn = val.expires_in == void 0 ? void 0 : val.expires_in;
    const tokenType = val.token_type == void 0 ? void 0 : deserializeSkillInvocationTokenWriteTokenTypeField(val.token_type);
    if (!(val.restricted_to == void 0) && !(0, json_js_2.sdIsString)(val.restricted_to)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"restricted_to\" of type \"SkillInvocationTokenWriteField\"" });
    }
    const restrictedTo = val.restricted_to == void 0 ? void 0 : val.restricted_to;
    return { accessToken: accessToken, expiresIn: expiresIn, tokenType: tokenType, restrictedTo: restrictedTo };
}
...
function deserializeSkillInvocationTokenField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationTokenField\"" });
    }
    const read = val.read == void 0 ? void 0 : deserializeSkillInvocationTokenReadField(val.read);
    const write = val.write == void 0 ? void 0 : deserializeSkillInvocationTokenWriteField(val.write);
...
function deserializeSkillInvocationStatusStateField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationStatusStateField" });
}
...
function deserializeSkillInvocationStatusField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationStatusField\"" });
    }
    const state = val.state == void 0 ? void 0 : deserializeSkillInvocationStatusStateField(val.state);
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"SkillInvocationStatusField\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.error_code == void 0) && !(0, json_js_2.sdIsString)(val.error_code)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"error_code\" of type \"SkillInvocationStatusField\"" });
    }
    ...
    if (!(val.additional_info == void 0) && !(0, json_js_2.sdIsString)(val.additional_info)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"additional_info\" of type \"SkillInvocationStatusField\"" });
    }
...
function deserializeSkillInvocationEnterpriseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SkillInvocationEnterpriseTypeField" });
}
...
function deserializeSkillInvocationEnterpriseField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SkillInvocationEnterpriseField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"SkillInvocationEnterpriseField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeSkillInvocationEnterpriseTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"SkillInvocationEnterpriseField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    return { id: id, type: type, name: name };
}
function serializeSkillInvocation(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeSkillInvocationTypeField(val.type), ["id"]: val.id, ["skill"]: val.skill == void 0 ? val.skill : serializeSkillInvocationSkillField(val.skill), ["token"]: val.token == void 0 ? val.token : serializeSkillInvocationTokenField(val.token), ["status"]: val.status == void 0 ? val.status : serializeSkillInvocationStatusField(val.status), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["trigger"]: val.trigger, ["enterprise"]: val.enterprise == void 0 ? val.enterprise : serializeSkillInvocationEnterpriseField(val.enterprise), ["source"]: val.source == void 0 ? val.source : (0, fileOrFolder_generated_js_1.serializeFileOrFolder)(val.source), ["event"]: val.event == void 0 ? val.event : (0, event_generated_js_1.serializeEvent)(val.event) };
}
function deserializeSkillInvocation(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"SkillInvocation\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"SkillInvocation\"" });
    }
    ...
    if (!(val.trigger == void 0) && !(0, json_js_2.sdIsString)(val.trigger)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trigger\" of type \"SkillInvocation\"" });
    }
