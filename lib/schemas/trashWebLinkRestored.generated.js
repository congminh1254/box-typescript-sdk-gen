...
function deserializeTrashWebLinkRestoredTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TrashWebLinkRestoredTypeField" });
}
...
function deserializeTrashWebLinkRestoredPathCollectionField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TrashWebLinkRestoredPathCollectionField\"" });
    }
    if (val.total_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"total_count\" of type \"TrashWebLinkRestoredPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"TrashWebLinkRestoredPathCollectionField\"" });
    }
    const totalCount = val.total_count;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"TrashWebLinkRestoredPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"TrashWebLinkRestoredPathCollectionField\"" });
    }
...
function deserializeTrashWebLinkRestored(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TrashWebLinkRestored\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (val.sequence_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"sequence_id\" of type \"TrashWebLinkRestored\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"TrashWebLinkRestored\"" });
    }
    const sequenceId = val.sequence_id;
    if (!(val.etag == void 0) && !(0, json_js_2.sdIsString)(val.etag)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"etag\" of type \"TrashWebLinkRestored\"" });
    }
    const etag = val.etag == void 0 ? void 0 : val.etag;
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"TrashWebLinkRestored\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.url == void 0) && !(0, json_js_2.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"TrashWebLinkRestored\"" });
    }
    ...
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"TrashWebLinkRestored\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (val.path_collection == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"path_collection\" of type \"TrashWebLinkRestored\" to be defined" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"TrashWebLinkRestored\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"TrashWebLinkRestored\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_2.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"TrashWebLinkRestored\"" });
    }
    const trashedAt = val.trashed_at == void 0 ? void 0 : val.trashed_at;
    if (!(val.purged_at == void 0) && !(0, json_js_2.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"TrashWebLinkRestored\"" });
    }
    ...
    if (!(val.shared_link == void 0) && !(0, json_js_2.sdIsString)(val.shared_link)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"shared_link\" of type \"TrashWebLinkRestored\"" });
    }
