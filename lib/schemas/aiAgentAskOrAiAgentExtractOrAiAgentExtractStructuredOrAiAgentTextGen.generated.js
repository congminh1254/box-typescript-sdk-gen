...
function deserializeAiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen\"" });
    }
    if (val.type == "ai_agent_ask") {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen" });
}
