...
function deserializePostOAuth2TokenRefreshAccessTokenGrantTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize PostOAuth2TokenRefreshAccessTokenGrantTypeField" });
}
...
function deserializePostOAuth2TokenRefreshAccessToken(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"PostOAuth2TokenRefreshAccessToken\"" });
    }
    if (val.grant_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"grant_type\" of type \"PostOAuth2TokenRefreshAccessToken\" to be defined" });
    }
    const grantType = deserializePostOAuth2TokenRefreshAccessTokenGrantTypeField(val.grant_type);
    if (val.client_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"client_id\" of type \"PostOAuth2TokenRefreshAccessToken\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.client_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_id\" of type \"PostOAuth2TokenRefreshAccessToken\"" });
    }
    const clientId = val.client_id;
    if (val.client_secret == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"client_secret\" of type \"PostOAuth2TokenRefreshAccessToken\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.client_secret)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_secret\" of type \"PostOAuth2TokenRefreshAccessToken\"" });
    }
    const clientSecret = val.client_secret;
    if (val.refresh_token == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"refresh_token\" of type \"PostOAuth2TokenRefreshAccessToken\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.refresh_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"refresh_token\" of type \"PostOAuth2TokenRefreshAccessToken\"" });
    }
...
function deserializePostOAuth2TokenRefreshAccessTokenInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"PostOAuth2TokenRefreshAccessTokenInput\"" });
    }
    const grantType = val.grantType == void 0 ? void 0 : deserializePostOAuth2TokenRefreshAccessTokenGrantTypeField(val.grantType);
    if (val.client_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"client_id\" of type \"PostOAuth2TokenRefreshAccessTokenInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.client_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_id\" of type \"PostOAuth2TokenRefreshAccessTokenInput\"" });
    }
    const clientId = val.client_id;
    if (val.client_secret == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"client_secret\" of type \"PostOAuth2TokenRefreshAccessTokenInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.client_secret)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_secret\" of type \"PostOAuth2TokenRefreshAccessTokenInput\"" });
    }
    const clientSecret = val.client_secret;
    if (val.refresh_token == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"refresh_token\" of type \"PostOAuth2TokenRefreshAccessTokenInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.refresh_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"refresh_token\" of type \"PostOAuth2TokenRefreshAccessTokenInput\"" });
    }
    const refreshToken = val.refresh_token;
    return { grantType: grantType, clientId: clientId, clientSecret: clientSecret, refreshToken: refreshToken };
}
