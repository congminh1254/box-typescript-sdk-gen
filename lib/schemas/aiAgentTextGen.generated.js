...
function deserializeAiAgentTextGenTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AiAgentTextGenTypeField" });
}
function serializeAiAgentTextGen(val) {
    return { ["type"]: serializeAiAgentTextGenTypeField(val.type), ["basic_gen"]: val.basicGen == void 0 ? val.basicGen : (0, aiAgentBasicGenTool_generated_js_1.serializeAiAgentBasicGenTool)(val.basicGen) };
}
function deserializeAiAgentTextGen(val) {
    ...
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiAgentTextGen\" to be defined" });
    }
    const type = deserializeAiAgentTextGenTypeField(val.type);
    const basicGen = val.basic_gen == void 0 ? void 0 : (0, aiAgentBasicGenTool_generated_js_2.deserializeAiAgentBasicGenTool)(val.basic_gen);
    return { type: type, basicGen: basicGen };
}
function serializeAiAgentTextGenInput(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeAiAgentTextGenTypeField(val.type), ["basic_gen"]: val.basicGen == void 0 ? val.basicGen : (0, aiAgentBasicGenTool_generated_js_1.serializeAiAgentBasicGenTool)(val.basicGen) };
}
function deserializeAiAgentTextGenInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentTextGenInput\"" });
    }
