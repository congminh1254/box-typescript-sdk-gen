...
function deserializeAiLlmEndpointParamsGoogleTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AiLlmEndpointParamsGoogleTypeField" });
}
...
function deserializeAiLlmEndpointParamsGoogle(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiLlmEndpointParamsGoogle\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiLlmEndpointParamsGoogle\" to be defined" });
    }
    ...
    if (!(val.temperature == void 0) && !(0, json_js_1.sdIsNumber)(val.temperature)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"temperature\" of type \"AiLlmEndpointParamsGoogle\"" });
    }
    const temperature = val.temperature == void 0 ? void 0 : val.temperature;
    if (!(val.top_p == void 0) && !(0, json_js_1.sdIsNumber)(val.top_p)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_p\" of type \"AiLlmEndpointParamsGoogle\"" });
    }
    const topP = val.top_p == void 0 ? void 0 : val.top_p;
    if (!(val.top_k == void 0) && !(0, json_js_1.sdIsNumber)(val.top_k)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_k\" of type \"AiLlmEndpointParamsGoogle\"" });
    }
    const topK = val.top_k == void 0 ? void 0 : val.top_k;
    return { type: type, temperature: temperature, topP: topP, topK: topK };
}
...
function deserializeAiLlmEndpointParamsGoogleInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiLlmEndpointParamsGoogleInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeAiLlmEndpointParamsGoogleTypeField(val.type);
    if (!(val.temperature == void 0) && !(0, json_js_1.sdIsNumber)(val.temperature)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"temperature\" of type \"AiLlmEndpointParamsGoogleInput\"" });
    }
    const temperature = val.temperature == void 0 ? void 0 : val.temperature;
    if (!(val.top_p == void 0) && !(0, json_js_1.sdIsNumber)(val.top_p)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_p\" of type \"AiLlmEndpointParamsGoogleInput\"" });
    }
    const topP = val.top_p == void 0 ? void 0 : val.top_p;
    if (!(val.top_k == void 0) && !(0, json_js_1.sdIsNumber)(val.top_k)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"top_k\" of type \"AiLlmEndpointParamsGoogleInput\"" });
    }
    const topK = val.top_k == void 0 ? void 0 : val.top_k;
    return { type: type, temperature: temperature, topP: topP, topK: topK };
}
