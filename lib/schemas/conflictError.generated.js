...
function serializeConflictErrorContextInfoField(val) {
    return { ["conflicts"]: val.conflicts == void 0 ? val.conflicts : val.conflicts.map(function (item) {
...
function deserializeConflictErrorContextInfoField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ConflictErrorContextInfoField\"" });
    }
    if (!(val.conflicts == void 0) && !(0, json_js_3.sdIsList)(val.conflicts)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"conflicts\" of type \"ConflictErrorContextInfoField\"" });
    }
    const conflicts = val.conflicts == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.conflicts) ? val.conflicts.map(function (itm) {
...
function deserializeConflictError(val) {
    ...
    if (!(val.status == void 0) && !(0, json_js_1.sdIsNumber)(val.status)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"status\" of type \"ConflictError\"" });
    }
    ...
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"ConflictError\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.context_info == void 0) && !(0, json_js_4.sdIsMap)(val.context_info)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"context_info\" of type \"ConflictError\"" });
    }
    const contextInfo = val.context_info == void 0 ? void 0 : (0, json_js_4.sdIsMap)(val.context_info) ? Object.fromEntries(Object.entries(val.context_info).map(([k, v]) => [k, function (v) {
            return v;
        }(v)])) : {};
    if (!(val.help_url == void 0) && !(0, json_js_2.sdIsString)(val.help_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"help_url\" of type \"ConflictError\"" });
    }
    const helpUrl = val.help_url == void 0 ? void 0 : val.help_url;
    if (!(val.request_id == void 0) && !(0, json_js_2.sdIsString)(val.request_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"request_id\" of type \"ConflictError\"" });
    }
