...
const clientError_generated_js_4 = require("./clientError.generated.js");
...
function serializeConflictError(val) {
    const base = (0, clientError_generated_js_4.serializeClientError)(val);
...
function deserializeConflictError(val) {
    ...
    const contextInfo = val.context_info == void 0
        ? void 0
        : (0, clientError_generated_js_3.deserializeClientErrorContextInfoField)(val.context_info);
