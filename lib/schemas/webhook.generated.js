...
function serializeWebhook(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["address"]: val.address, ["triggers"]: val.triggers == void 0 ? val.triggers : val.triggers.map(function (item) {
...
function deserializeWebhook(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Webhook\"" });
    }
    ...
    if (!(val.address == void 0) && !(0, json_js_1.sdIsString)(val.address)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"address\" of type \"Webhook\"" });
    }
    const address = val.address == void 0 ? void 0 : val.address;
    if (!(val.triggers == void 0) && !(0, json_js_2.sdIsList)(val.triggers)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"triggers\" of type \"Webhook\"" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"Webhook\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : (0, webhookMini_generated_js_1.deserializeWebhookMiniTypeField)(val.type);
    const target = val.target == void 0 ? void 0 : (0, webhookMini_generated_js_2.deserializeWebhookMiniTargetField)(val.target);
