...
function serializeTrashWebLink(val) {
    return {
        ['type']: val.type == void 0 ? void 0 : serializeTrashWebLinkTypeField(val.type),
        ['id']: val.id == void 0 ? void 0 : val.id,
        ['sequence_id']: val.sequenceId == void 0 ? void 0 : val.sequenceId,
        ['etag']: val.etag == void 0 ? void 0 : val.etag,
        ['name']: val.name == void 0 ? void 0 : val.name,
        ['url']: val.url == void 0 ? void 0 : val.url,
        ['parent']: val.parent == void 0 ? void 0 : (0, folderMini_generated_js_1.serializeFolderMini)(val.parent),
        ...
        ['owned_by']: val.ownedBy == void 0 ? void 0 : (0, userMini_generated_js_1.serializeUserMini)(val.ownedBy),
