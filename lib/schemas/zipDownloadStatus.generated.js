...
function deserializeZipDownloadStatusStateField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ZipDownloadStatusStateField" });
}
...
function deserializeZipDownloadStatus(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ZipDownloadStatus\"" });
    }
    if (!(val.total_file_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_file_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_file_count\" of type \"ZipDownloadStatus\"" });
    }
    const totalFileCount = val.total_file_count == void 0 ? void 0 : val.total_file_count;
    if (!(val.downloaded_file_count == void 0) && !(0, json_js_1.sdIsNumber)(val.downloaded_file_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"downloaded_file_count\" of type \"ZipDownloadStatus\"" });
    }
    const downloadedFileCount = val.downloaded_file_count == void 0 ? void 0 : val.downloaded_file_count;
    if (!(val.skipped_file_count == void 0) && !(0, json_js_1.sdIsNumber)(val.skipped_file_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"skipped_file_count\" of type \"ZipDownloadStatus\"" });
    }
    const skippedFileCount = val.skipped_file_count == void 0 ? void 0 : val.skipped_file_count;
    if (!(val.skipped_folder_count == void 0) && !(0, json_js_1.sdIsNumber)(val.skipped_folder_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"skipped_folder_count\" of type \"ZipDownloadStatus\"" });
    }
