...
function serializeFileFullPermissionsField(val) {
    return {
        ...
        ['can_view_annotations_all']: val.canViewAnnotationsAll == void 0 ? void 0 : val.canViewAnnotationsAll,
        ['can_view_annotations_self']: val.canViewAnnotationsSelf == void 0
            ? void 0
...
function deserializeFileFullPermissionsField(val) {
    ...
    if (!(val.can_annotate == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_annotate)) {
        throw new errors_js_1.BoxSdkError({
    ...
    if (!(val.can_comment == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_comment)) {
        throw new errors_js_1.BoxSdkError({
    ...
    if (!(val.can_upload == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_upload)) {
        throw new errors_js_1.BoxSdkError({
    ...
    if (!(val.can_view_annotations_all == void 0) &&
        !(0, json_js_1.sdIsBoolean)(val.can_view_annotations_all)) {
        throw new errors_js_1.BoxSdkError({
    ...
    if (!(val.can_view_annotations_self == void 0) &&
        !(0, json_js_1.sdIsBoolean)(val.can_view_annotations_self)) {
        throw new errors_js_1.BoxSdkError({
...
function serializeFileFullLockField(val) {
    return {
        ...
        ['type']: val.type == void 0 ? void 0 : serializeFileFullLockTypeField(val.type),
        ['created_by']: val.createdBy == void 0 ? void 0 : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy),
        ['created_at']: val.createdAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.createdAt),
        ['expired_at']: val.expiredAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.expiredAt),
...
function serializeFileFullWatermarkInfoField(val) {
    return {
        ['is_watermarked']: val.isWatermarked == void 0 ? void 0 : val.isWatermarked,
    };
}
                ...
                (function (v) {
                    return (0, json_js_5.sdIsMap)(v)
                        ? Object.fromEntries(Object.entries(v).map(([k, v]) => [
                            k,
                            (0, metadata_generated_js_1.deserializeMetadata)(v),
                        ]))
                        : {};
                })(v),
            ]))
...
function serializeFileFullRepresentationsEntriesField(val) {
    return {
        ...
        ['representation']: val.representation == void 0 ? void 0 : val.representation,
...
function serializeFileFull(val) {
    ...
    return Object.assign(Object.assign({}, base), {
        ['version_number']: val.versionNumber == void 0 ? void 0 : val.versionNumber,
        ...
        ['lock']: val.lock == void 0 ? void 0 : serializeFileFullLockField(val.lock),
        ...
        ['is_accessible_via_shared_link']: val.isAccessibleViaSharedLink == void 0
            ? void 0
        ...
        ['is_externally_owned']: val.isExternallyOwned == void 0 ? void 0 : val.isExternallyOwned,
        ['has_collaborations']: val.hasCollaborations == void 0 ? void 0 : val.hasCollaborations,
        ['metadata']: val.metadata == void 0
            ? void 0
            : serializeFileFullMetadataField(val.metadata),
        ['expires_at']: val.expiresAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.expiresAt),
        ...
        ['uploader_display_name']: val.uploaderDisplayName == void 0 ? void 0 : val.uploaderDisplayName,
