...
function deserializeAiAgentExtractStructuredTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AiAgentExtractStructuredTypeField" });
}
function serializeAiAgentExtractStructured(val) {
    return { ["type"]: serializeAiAgentExtractStructuredTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : (0, aiAgentLongTextTool_generated_js_1.serializeAiAgentLongTextTool)(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : (0, aiAgentBasicTextTool_generated_js_1.serializeAiAgentBasicTextTool)(val.basicText) };
}
function deserializeAiAgentExtractStructured(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentExtractStructured\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiAgentExtractStructured\" to be defined" });
    }
    ...
    return { type: type, longText: longText, basicText: basicText };
}
function serializeAiAgentExtractStructuredInput(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeAiAgentExtractStructuredTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : (0, aiAgentLongTextTool_generated_js_1.serializeAiAgentLongTextTool)(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : (0, aiAgentBasicTextTool_generated_js_1.serializeAiAgentBasicTextTool)(val.basicText) };
}
function deserializeAiAgentExtractStructuredInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentExtractStructuredInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeAiAgentExtractStructuredTypeField(val.type);
    const longText = val.long_text == void 0 ? void 0 : (0, aiAgentLongTextTool_generated_js_2.deserializeAiAgentLongTextTool)(val.long_text);
    const basicText = val.basic_text == void 0 ? void 0 : (0, aiAgentBasicTextTool_generated_js_2.deserializeAiAgentBasicTextTool)(val.basic_text);
    return { type: type, longText: longText, basicText: basicText };
}
