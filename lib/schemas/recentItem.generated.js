...
function serializeRecentItem(val) {
    return {
        ...
        ['interacted_at']: val.interactedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.interactedAt),
        ['interaction_shared_link']: val.interactionSharedLink == void 0 ? void 0 : val.interactionSharedLink,
    };
}
