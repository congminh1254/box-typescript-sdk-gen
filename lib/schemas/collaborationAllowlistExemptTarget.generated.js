...
function deserializeCollaborationAllowlistExemptTargetTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollaborationAllowlistExemptTargetTypeField" });
}
...
function deserializeCollaborationAllowlistExemptTargetEnterpriseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CollaborationAllowlistExemptTargetEnterpriseTypeField" });
}
...
function deserializeCollaborationAllowlistExemptTargetEnterpriseField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CollaborationAllowlistExemptTargetEnterpriseField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CollaborationAllowlistExemptTargetEnterpriseField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeCollaborationAllowlistExemptTargetEnterpriseTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CollaborationAllowlistExemptTargetEnterpriseField\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    return { id: id, type: type, name: name };
}
function serializeCollaborationAllowlistExemptTarget(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeCollaborationAllowlistExemptTargetTypeField(val.type), ["enterprise"]: val.enterprise == void 0 ? val.enterprise : serializeCollaborationAllowlistExemptTargetEnterpriseField(val.enterprise), ["user"]: val.user == void 0 ? val.user : (0, userMini_generated_js_1.serializeUserMini)(val.user), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt) };
}
function deserializeCollaborationAllowlistExemptTarget(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CollaborationAllowlistExemptTarget\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CollaborationAllowlistExemptTarget\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"CollaborationAllowlistExemptTarget\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_1.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"CollaborationAllowlistExemptTarget\"" });
    }
