...
function deserializeSignRequestSignerInputTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SignRequestSignerInputTypeField" });
}
...
function deserializeSignRequestSignerInputContentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SignRequestSignerInputContentTypeField" });
}
function serializeSignRequestSignerInput(val) {
    ...
    if (!(0, json_js_4.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SignRequestSignerInput\"" });
    }
    return Object.assign(Object.assign({}, base), { ["type"]: val.type == void 0 ? val.type : serializeSignRequestSignerInputTypeField(val.type), ["content_type"]: val.contentType == void 0 ? val.contentType : serializeSignRequestSignerInputContentTypeField(val.contentType), ["page_index"]: val.pageIndex, ["read_only"]: val.readOnly });
}
function deserializeSignRequestSignerInput(val) {
    ...
    if (val.page_index == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"page_index\" of type \"SignRequestSignerInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.page_index)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"page_index\" of type \"SignRequestSignerInput\"" });
    }
    const pageIndex = val.page_index;
    if (!(val.read_only == void 0) && !(0, json_js_1.sdIsBoolean)(val.read_only)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"read_only\" of type \"SignRequestSignerInput\"" });
    }
    ...
    if (!(val.document_tag_id == void 0) && !(0, json_js_3.sdIsString)(val.document_tag_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"document_tag_id\" of type \"SignRequestSignerInput\"" });
    }
    ...
    if (!(val.text_value == void 0) && !(0, json_js_3.sdIsString)(val.text_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text_value\" of type \"SignRequestSignerInput\"" });
    }
    ...
    if (!(val.checkbox_value == void 0) && !(0, json_js_1.sdIsBoolean)(val.checkbox_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"checkbox_value\" of type \"SignRequestSignerInput\"" });
    }
    ...
    if (!(val.date_value == void 0) && !(0, json_js_3.sdIsString)(val.date_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"date_value\" of type \"SignRequestSignerInput\"" });
    }
    const dateValue = val.date_value == void 0 ? void 0 : (0, utils_js_1.deserializeDate)(val.date_value);
    return { type: type, contentType: contentType, pageIndex: pageIndex, readOnly: readOnly, documentTagId: documentTagId, textValue: textValue, checkboxValue: checkboxValue, dateValue: dateValue };
}
