...
function deserializeGroupMiniGroupTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupMiniGroupTypeField" });
}
function serializeGroupMini(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["name"]: val.name, ["group_type"]: val.groupType == void 0 ? val.groupType : serializeGroupMiniGroupTypeField(val.groupType) });
}
function deserializeGroupMini(val) {
    ...
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"GroupMini\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    const groupType = val.group_type == void 0 ? void 0 : deserializeGroupMiniGroupTypeField(val.group_type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"GroupMini\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupMini\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"GroupMini\" to be defined" });
    }
