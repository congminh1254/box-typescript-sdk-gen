...
function deserializeShieldInformationBarrierSegmentMemberBaseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierSegmentMemberBaseTypeField" });
}
...
function deserializeShieldInformationBarrierSegmentMemberBase(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentMemberBase\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentMemberBase\"" });
    }
