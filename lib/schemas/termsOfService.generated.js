...
function deserializeTermsOfServiceStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TermsOfServiceStatusField" });
}
...
function deserializeTermsOfServiceEnterpriseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TermsOfServiceEnterpriseTypeField" });
}
...
function deserializeTermsOfServiceEnterpriseField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TermsOfServiceEnterpriseField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TermsOfServiceEnterpriseField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeTermsOfServiceEnterpriseTypeField(val.type);
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"TermsOfServiceEnterpriseField\"" });
    }
...
function deserializeTermsOfServiceTosTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TermsOfServiceTosTypeField" });
}
function serializeTermsOfService(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["status"]: val.status == void 0 ? val.status : serializeTermsOfServiceStatusField(val.status), ["enterprise"]: val.enterprise == void 0 ? val.enterprise : serializeTermsOfServiceEnterpriseField(val.enterprise), ["tos_type"]: val.tosType == void 0 ? val.tosType : serializeTermsOfServiceTosTypeField(val.tosType), ["text"]: val.text, ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt) });
}
function deserializeTermsOfService(val) {
    ...
    if (!(val.text == void 0) && !(0, json_js_1.sdIsString)(val.text)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text\" of type \"TermsOfService\"" });
    }
    const text = val.text == void 0 ? void 0 : val.text;
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"TermsOfService\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_1.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"TermsOfService\"" });
    }
    const modifiedAt = val.modified_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.modified_at);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"TermsOfService\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TermsOfService\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"TermsOfService\" to be defined" });
    }
