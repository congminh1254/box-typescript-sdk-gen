...
function deserializeMetadataFilterScopeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize MetadataFilterScopeField" });
}
function serializeMetadataFilter(val) {
    return { ["scope"]: val.scope == void 0 ? val.scope : serializeMetadataFilterScopeField(val.scope), ["templateKey"]: val.templateKey, ["filters"]: val.filters == void 0 ? val.filters : Object.fromEntries(Object.entries(val.filters).map(([k, v]) => [k, (0, metadataFieldFilterDateRangeOrMetadataFieldFilterFloatRangeOrArrayOfStringOrNumberOrString_generated_js_1.serializeMetadataFieldFilterDateRangeOrMetadataFieldFilterFloatRangeOrArrayOfStringOrNumberOrString)(v)])) };
}
function deserializeMetadataFilter(val) {
    ...
    if (!(val.templateKey == void 0) && !(0, json_js_1.sdIsString)(val.templateKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"MetadataFilter\"" });
    }
    const templateKey = val.templateKey == void 0 ? void 0 : val.templateKey;
    if (!(val.filters == void 0) && !(0, json_js_2.sdIsMap)(val.filters)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"filters\" of type \"MetadataFilter\"" });
    }
    const filters = val.filters == void 0 ? void 0 : (0, json_js_2.sdIsMap)(val.filters) ? Object.fromEntries(Object.entries(val.filters).map(([k, v]) => [k, (0, metadataFieldFilterDateRangeOrMetadataFieldFilterFloatRangeOrArrayOfStringOrNumberOrString_generated_js_2.deserializeMetadataFieldFilterDateRangeOrMetadataFieldFilterFloatRangeOrArrayOfStringOrNumberOrString)(v)])) : {};
