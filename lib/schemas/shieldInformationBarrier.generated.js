...
function serializeShieldInformationBarrier(val) {
    return {
        ...
        ['created_by']: val.createdBy == void 0 ? void 0 : (0, userBase_generated_js_1.serializeUserBase)(val.createdBy),
        ['updated_at']: val.updatedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.updatedAt),
        ['updated_by']: val.updatedBy == void 0 ? void 0 : (0, userBase_generated_js_1.serializeUserBase)(val.updatedBy),
        ['enabled_at']: val.enabledAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.enabledAt),
        ['enabled_by']: val.enabledBy == void 0 ? void 0 : (0, userBase_generated_js_1.serializeUserBase)(val.enabledBy),
    };
}
