...
function deserializeShieldInformationBarrierSegmentRestriction(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrierSegmentRestriction\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !(0, json_js_1.sdIsString)(val.updated_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrierSegmentRestriction\"" });
    }
    ...
    if (val.shield_information_barrier_segment == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"shield_information_barrier_segment\" of type \"ShieldInformationBarrierSegmentRestriction\" to be defined" });
    }
    ...
    if (val.restricted_segment == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"restricted_segment\" of type \"ShieldInformationBarrierSegmentRestriction\" to be defined" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentRestriction\"" });
    }
