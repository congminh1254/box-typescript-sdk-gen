...
function deserializeIntegrationMappingBoxItemSlackTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize IntegrationMappingBoxItemSlackTypeField" });
}
...
function deserializeIntegrationMappingBoxItemSlack(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingBoxItemSlack\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"IntegrationMappingBoxItemSlack\" to be defined" });
    }
    const type = deserializeIntegrationMappingBoxItemSlackTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingBoxItemSlack\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingBoxItemSlack\"" });
    }
    const id = val.id;
...
function deserializeIntegrationMappingBoxItemSlackInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingBoxItemSlackInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeIntegrationMappingBoxItemSlackTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingBoxItemSlackInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingBoxItemSlackInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
