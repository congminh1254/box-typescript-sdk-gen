...
function deserializeTemplateSignerRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TemplateSignerRoleField" });
}
function serializeTemplateSigner(val) {
    return { ["inputs"]: val.inputs == void 0 ? val.inputs : val.inputs.map(function (item) {
            return (0, templateSignerInput_generated_js_1.serializeTemplateSignerInput)(item);
        }), ["email"]: val.email, ["role"]: val.role == void 0 ? val.role : serializeTemplateSignerRoleField(val.role), ["is_in_person"]: val.isInPerson, ["order"]: val.order, ["signer_group_id"]: val.signerGroupId, ["label"]: val.label, ["public_id"]: val.publicId };
}
function deserializeTemplateSigner(val) {
    ...
    if (!(val.inputs == void 0) && !(0, json_js_4.sdIsList)(val.inputs)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"inputs\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.email == void 0) && !(0, json_js_3.sdIsString)(val.email)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.is_in_person == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_in_person)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_in_person\" of type \"TemplateSigner\"" });
    }
    const isInPerson = val.is_in_person == void 0 ? void 0 : val.is_in_person;
    if (!(val.order == void 0) && !(0, json_js_2.sdIsNumber)(val.order)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"order\" of type \"TemplateSigner\"" });
    }
    const order = val.order == void 0 ? void 0 : val.order;
    if (!(val.signer_group_id == void 0) && !(0, json_js_3.sdIsString)(val.signer_group_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"signer_group_id\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.label == void 0) && !(0, json_js_3.sdIsString)(val.label)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"label\" of type \"TemplateSigner\"" });
    }
    const label = val.label == void 0 ? void 0 : val.label;
    if (!(val.public_id == void 0) && !(0, json_js_3.sdIsString)(val.public_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"public_id\" of type \"TemplateSigner\"" });
    }
    const publicId = val.public_id == void 0 ? void 0 : val.public_id;
    return { inputs: inputs, email: email, role: role, isInPerson: isInPerson, order: order, signerGroupId: signerGroupId, label: label, publicId: publicId };
}
