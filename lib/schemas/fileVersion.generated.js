...
function serializeFileVersion(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["name"]: val.name, ["size"]: val.size, ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt), ["modified_by"]: val.modifiedBy == void 0 ? val.modifiedBy : (0, userMini_generated_js_1.serializeUserMini)(val.modifiedBy), ["trashed_at"]: val.trashedAt == void 0 ? val.trashedAt : (0, utils_js_1.serializeDateTime)(val.trashedAt), ["trashed_by"]: val.trashedBy == void 0 ? val.trashedBy : (0, userMini_generated_js_1.serializeUserMini)(val.trashedBy), ["restored_at"]: val.restoredAt == void 0 ? val.restoredAt : (0, utils_js_1.serializeDateTime)(val.restoredAt), ["restored_by"]: val.restoredBy == void 0 ? val.restoredBy : (0, userMini_generated_js_1.serializeUserMini)(val.restoredBy), ["purged_at"]: val.purgedAt == void 0 ? val.purgedAt : (0, utils_js_1.serializeDateTime)(val.purgedAt), ["uploader_display_name"]: val.uploaderDisplayName });
}
function deserializeFileVersion(val) {
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"FileVersion\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.size == void 0) && !(0, json_js_1.sdIsNumber)(val.size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"size\" of type \"FileVersion\"" });
    }
    const size = val.size == void 0 ? void 0 : val.size;
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_2.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.restored_at == void 0) && !(0, json_js_2.sdIsString)(val.restored_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"restored_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !(0, json_js_2.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"FileVersion\"" });
    }
    const purgedAt = val.purged_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.purged_at);
    if (!(val.uploader_display_name == void 0) && !(0, json_js_2.sdIsString)(val.uploader_display_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"uploader_display_name\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.sha1 == void 0) && !(0, json_js_2.sdIsString)(val.sha1)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sha1\" of type \"FileVersion\"" });
    }
    const sha1 = val.sha1 == void 0 ? void 0 : val.sha1;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"FileVersion\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"FileVersion\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"FileVersion\" to be defined" });
    }
