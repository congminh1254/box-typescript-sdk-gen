...
function deserializeLegalHoldPolicyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize LegalHoldPolicyStatusField" });
}
...
function deserializeLegalHoldPolicyAssignmentCountsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"LegalHoldPolicyAssignmentCountsField\"" });
    }
    if (!(val.user == void 0) && !(0, json_js_1.sdIsNumber)(val.user)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"user\" of type \"LegalHoldPolicyAssignmentCountsField\"" });
    }
    const user = val.user == void 0 ? void 0 : val.user;
    if (!(val.folder == void 0) && !(0, json_js_1.sdIsNumber)(val.folder)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"folder\" of type \"LegalHoldPolicyAssignmentCountsField\"" });
    }
    const folder = val.folder == void 0 ? void 0 : val.folder;
    if (!(val.file == void 0) && !(0, json_js_1.sdIsNumber)(val.file)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"file\" of type \"LegalHoldPolicyAssignmentCountsField\"" });
    }
    const file = val.file == void 0 ? void 0 : val.file;
    if (!(val.file_version == void 0) && !(0, json_js_1.sdIsNumber)(val.file_version)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"file_version\" of type \"LegalHoldPolicyAssignmentCountsField\"" });
    }
...
function deserializeLegalHoldPolicy(val) {
    ...
    if (!(val.policy_name == void 0) && !(0, json_js_2.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.deleted_at == void 0) && !(0, json_js_2.sdIsString)(val.deleted_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"deleted_at\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.filter_started_at == void 0) && !(0, json_js_2.sdIsString)(val.filter_started_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"filter_started_at\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.filter_ended_at == void 0) && !(0, json_js_2.sdIsString)(val.filter_ended_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"filter_ended_at\" of type \"LegalHoldPolicy\"" });
    }
    ...
    if (!(val.release_notes == void 0) && !(0, json_js_2.sdIsString)(val.release_notes)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"release_notes\" of type \"LegalHoldPolicy\"" });
    }
    const releaseNotes = val.release_notes == void 0 ? void 0 : val.release_notes;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"LegalHoldPolicy\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"LegalHoldPolicy\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"LegalHoldPolicy\" to be defined" });
    }
