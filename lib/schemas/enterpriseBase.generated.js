...
function deserializeEnterpriseBaseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize EnterpriseBaseTypeField" });
}
...
function deserializeEnterpriseBase(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"EnterpriseBase\"" });
    }
