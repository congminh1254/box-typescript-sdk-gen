...
function deserializeIntegrationMappingIntegrationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize IntegrationMappingIntegrationTypeField" });
}
function serializeIntegrationMapping(val) {
    ...
    if (!(0, json_js_3.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMapping\"" });
    }
    return Object.assign(Object.assign({}, base), { ["integration_type"]: val.integrationType == void 0 ? val.integrationType : serializeIntegrationMappingIntegrationTypeField(val.integrationType), ["is_manually_created"]: val.isManuallyCreated, ["options"]: val.options == void 0 ? val.options : (0, integrationMappingSlackOptions_generated_js_1.serializeIntegrationMappingSlackOptions)(val.options), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userIntegrationMappings_generated_js_1.serializeUserIntegrationMappings)(val.createdBy), ["modified_by"]: val.modifiedBy == void 0 ? val.modifiedBy : (0, userIntegrationMappings_generated_js_1.serializeUserIntegrationMappings)(val.modifiedBy), ["partner_item"]: (0, integrationMappingPartnerItemSlackUnion_generated_js_1.serializeIntegrationMappingPartnerItemSlackUnion)(val.partnerItem), ["box_item"]: (0, folderMini_generated_js_1.serializeFolderMini)(val.boxItem), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt) });
}
function deserializeIntegrationMapping(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMapping\"" });
    }
    const integrationType = val.integration_type == void 0 ? void 0 : deserializeIntegrationMappingIntegrationTypeField(val.integration_type);
    if (!(val.is_manually_created == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_manually_created)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_manually_created\" of type \"IntegrationMapping\"" });
    }
    ...
    const createdBy = val.created_by == void 0 ? void 0 : (0, userIntegrationMappings_generated_js_2.deserializeUserIntegrationMappings)(val.created_by);
    const modifiedBy = val.modified_by == void 0 ? void 0 : (0, userIntegrationMappings_generated_js_2.deserializeUserIntegrationMappings)(val.modified_by);
    if (val.partner_item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"partner_item\" of type \"IntegrationMapping\" to be defined" });
    }
    ...
    if (val.box_item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"box_item\" of type \"IntegrationMapping\" to be defined" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"IntegrationMapping\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"IntegrationMapping\"" });
    }
    const modifiedAt = val.modified_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.modified_at);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMapping\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMapping\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"IntegrationMapping\" to be defined" });
    }
    const type = (0, integrationMappingBase_generated_js_1.deserializeIntegrationMappingBaseTypeField)(val.type);
    return { integrationType: integrationType, isManuallyCreated: isManuallyCreated, options: options, createdBy: createdBy, modifiedBy: modifiedBy, partnerItem: partnerItem, boxItem: boxItem, createdAt: createdAt, modifiedAt: modifiedAt, id: id, type: type };
}
