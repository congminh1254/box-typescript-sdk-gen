...
function deserializeRoleVariableVariableTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RoleVariableVariableTypeField" });
}
...
function deserializeRoleVariableVariableValueField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RoleVariableVariableValueField" });
}
...
function deserializeRoleVariable(val) {
    ...
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"RoleVariable\" to be defined" });
    }
    const type = deserializeRoleVariableTypeField(val.type);
    if (val.variable_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_type\" of type \"RoleVariable\" to be defined" });
    }
    const variableType = deserializeRoleVariableVariableTypeField(val.variable_type);
    if (val.variable_value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_value\" of type \"RoleVariable\" to be defined" });
    }
...
function deserializeRoleVariableInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RoleVariableInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeRoleVariableTypeField(val.type);
    const variableType = val.variableType == void 0 ? void 0 : deserializeRoleVariableVariableTypeField(val.variableType);
    if (val.variable_value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_value\" of type \"RoleVariableInput\" to be defined" });
    }
    const variableValue = deserializeRoleVariableVariableValueField(val.variable_value);
    return { type: type, variableType: variableType, variableValue: variableValue };
}
