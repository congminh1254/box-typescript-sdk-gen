...
function deserializeMetadataCascadePolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize MetadataCascadePolicyTypeField" });
}
...
function deserializeMetadataCascadePolicyOwnerEnterpriseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize MetadataCascadePolicyOwnerEnterpriseTypeField" });
}
...
function deserializeMetadataCascadePolicyOwnerEnterpriseField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"MetadataCascadePolicyOwnerEnterpriseField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeMetadataCascadePolicyOwnerEnterpriseTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"MetadataCascadePolicyOwnerEnterpriseField\"" });
    }
...
function deserializeMetadataCascadePolicyParentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize MetadataCascadePolicyParentTypeField" });
}
...
function deserializeMetadataCascadePolicyParentField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"MetadataCascadePolicyParentField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeMetadataCascadePolicyParentTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"MetadataCascadePolicyParentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    return { type: type, id: id };
}
...
function deserializeMetadataCascadePolicy(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"MetadataCascadePolicy\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"MetadataCascadePolicy\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"MetadataCascadePolicy\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"MetadataCascadePolicy\" to be defined" });
    }
    ...
    if (!(val.scope == void 0) && !(0, json_js_1.sdIsString)(val.scope)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"scope\" of type \"MetadataCascadePolicy\"" });
    }
    const scope = val.scope == void 0 ? void 0 : val.scope;
    if (!(val.templateKey == void 0) && !(0, json_js_1.sdIsString)(val.templateKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"MetadataCascadePolicy\"" });
    }
...
function deserializeMetadataCascadePolicyInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"MetadataCascadePolicyInput\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"MetadataCascadePolicyInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"MetadataCascadePolicyInput\"" });
    }
    const id = val.id;
    ...
    const parent = val.parent == void 0 ? void 0 : deserializeMetadataCascadePolicyParentField(val.parent);
    if (!(val.scope == void 0) && !(0, json_js_1.sdIsString)(val.scope)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"scope\" of type \"MetadataCascadePolicyInput\"" });
    }
    const scope = val.scope == void 0 ? void 0 : val.scope;
    if (!(val.templateKey == void 0) && !(0, json_js_1.sdIsString)(val.templateKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"MetadataCascadePolicyInput\"" });
    }
    const templateKey = val.templateKey == void 0 ? void 0 : val.templateKey;
    return { id: id, type: type, ownerEnterprise: ownerEnterprise, parent: parent, scope: scope, templateKey: templateKey };
}
