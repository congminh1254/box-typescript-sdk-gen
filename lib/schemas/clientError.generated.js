...
function deserializeClientErrorContextInfoField(val) {
    ...
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({
            message: 'Expecting string for "message" of type "ClientErrorContextInfoField"',
        });
    }
...
function serializeClientError(val) {
    return {
        ['type']: val.type == void 0 ? void 0 : serializeClientErrorTypeField(val.type),
        ['status']: val.status == void 0 ? void 0 : val.status,
        ['code']: val.code == void 0 ? void 0 : serializeClientErrorCodeField(val.code),
