...
function serializeClientError(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeClientErrorTypeField(val.type), ["status"]: val.status, ["code"]: val.code == void 0 ? val.code : serializeClientErrorCodeField(val.code), ["message"]: val.message, ["context_info"]: val.contextInfo == void 0 ? val.contextInfo : Object.fromEntries(Object.entries(val.contextInfo).map(([k, v]) => [k, function (v) {
                return v;
            }(v)])), ["help_url"]: val.helpUrl, ["request_id"]: val.requestId };
}
function deserializeClientError(val) {
    ...
    if (!(val.status == void 0) && !(0, json_js_1.sdIsNumber)(val.status)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"status\" of type \"ClientError\"" });
    }
    ...
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"ClientError\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.context_info == void 0) && !(0, json_js_3.sdIsMap)(val.context_info)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"context_info\" of type \"ClientError\"" });
    }
    const contextInfo = val.context_info == void 0 ? void 0 : (0, json_js_3.sdIsMap)(val.context_info) ? Object.fromEntries(Object.entries(val.context_info).map(([k, v]) => [k, function (v) {
            return v;
        }(v)])) : {};
    if (!(val.help_url == void 0) && !(0, json_js_2.sdIsString)(val.help_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"help_url\" of type \"ClientError\"" });
    }
    const helpUrl = val.help_url == void 0 ? void 0 : val.help_url;
    if (!(val.request_id == void 0) && !(0, json_js_2.sdIsString)(val.request_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"request_id\" of type \"ClientError\"" });
    }
