...
function deserializeUsersOrderDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UsersOrderDirectionField" });
}
...
function deserializeUsersOrderField(val) {
    ...
    if (!(val.by == void 0) && !(0, json_js_2.sdIsString)(val.by)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"by\" of type \"UsersOrderField\"" });
    }
    const by = val.by == void 0 ? void 0 : val.by;
    const direction = val.direction == void 0 ? void 0 : deserializeUsersOrderDirectionField(val.direction);
    return { by: by, direction: direction };
}
function serializeUsers(val) {
    return { ["limit"]: val.limit, ["next_marker"]: val.nextMarker, ["prev_marker"]: val.prevMarker, ["total_count"]: val.totalCount, ["offset"]: val.offset, ["order"]: val.order == void 0 ? val.order : val.order.map(function (item) {
...
function deserializeUsers(val) {
    ...
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"Users\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !(0, json_js_2.sdIsString)(val.next_marker)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"next_marker\" of type \"Users\"" });
    }
    ...
    if (!(val.prev_marker == void 0) && !(0, json_js_2.sdIsString)(val.prev_marker)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prev_marker\" of type \"Users\"" });
    }
    ...
    if (!(val.total_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"Users\"" });
    }
    const totalCount = val.total_count == void 0 ? void 0 : val.total_count;
    if (!(val.offset == void 0) && !(0, json_js_1.sdIsNumber)(val.offset)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"offset\" of type \"Users\"" });
    }
    const offset = val.offset == void 0 ? void 0 : val.offset;
    if (!(val.order == void 0) && !(0, json_js_3.sdIsList)(val.order)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"order\" of type \"Users\"" });
    }
    ...
    if (!(val.entries == void 0) && !(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"Users\"" });
    }
    ...
    return { limit: limit, nextMarker: nextMarker, prevMarker: prevMarker, totalCount: totalCount, offset: offset, order: order, entries: entries };
}
