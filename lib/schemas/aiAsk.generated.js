...
function serializeAiAsk(val) {
    return { ["mode"]: serializeAiAskModeField(val.mode), ["prompt"]: val.prompt, ["items"]: val.items.map(function (item) {
        ...
        }), ["include_citations"]: val.includeCitations, ["ai_agent"]: val.aiAgent == void 0 ? val.aiAgent : (0, aiAgentAsk_generated_js_1.serializeAiAgentAsk)(val.aiAgent) };
}
function deserializeAiAsk(val) {
    ...
    if (val.mode == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"mode\" of type \"AiAsk\" to be defined" });
    }
    const mode = deserializeAiAskModeField(val.mode);
    if (val.prompt == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"prompt\" of type \"AiAsk\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.prompt)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prompt\" of type \"AiAsk\"" });
    }
    const prompt = val.prompt;
    if (val.items == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"items\" of type \"AiAsk\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.items)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"items\" of type \"AiAsk\"" });
    }
    const items = (0, json_js_3.sdIsList)(val.items) ? val.items.map(function (itm) {
    ...
    if (!(val.dialogue_history == void 0) && !(0, json_js_3.sdIsList)(val.dialogue_history)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"dialogue_history\" of type \"AiAsk\"" });
    }
    const dialogueHistory = val.dialogue_history == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.dialogue_history) ? val.dialogue_history.map(function (itm) {
        return (0, aiDialogueHistory_generated_js_2.deserializeAiDialogueHistory)(itm);
    }) : [];
    if (!(val.include_citations == void 0) && !(0, json_js_1.sdIsBoolean)(val.include_citations)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"include_citations\" of type \"AiAsk\"" });
    }
    ...
    return { mode: mode, prompt: prompt, items: items, dialogueHistory: dialogueHistory, includeCitations: includeCitations, aiAgent: aiAgent };
}
