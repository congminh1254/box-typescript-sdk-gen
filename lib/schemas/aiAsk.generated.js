...
function serializeAiAsk(val) {
    return {
        ...
        ['include_citations']: val.includeCitations == void 0 ? void 0 : val.includeCitations,
        ['ai_agent']: val.aiAgent == void 0 ? void 0 : (0, aiAgentAsk_generated_js_1.serializeAiAgentAsk)(val.aiAgent),
    };
}
