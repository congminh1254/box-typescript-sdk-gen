...
function deserializeEmailAlias(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"EmailAlias\"" });
    }
    ...
    if (!(val.email == void 0) && !(0, json_js_2.sdIsString)(val.email)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email\" of type \"EmailAlias\"" });
    }
    const email = val.email == void 0 ? void 0 : val.email;
    if (!(val.is_confirmed == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_confirmed)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_confirmed\" of type \"EmailAlias\"" });
    }
