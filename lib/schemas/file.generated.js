...
function deserializeFilePathCollectionField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FilePathCollectionField\"" });
    }
    if (val.total_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"total_count\" of type \"FilePathCollectionField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"FilePathCollectionField\"" });
    }
    const totalCount = val.total_count;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"FilePathCollectionField\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"FilePathCollectionField\"" });
    }
...
function deserializeFileSharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FileSharedLinkAccessField" });
}
...
function deserializeFileSharedLinkEffectiveAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FileSharedLinkEffectiveAccessField" });
}
...
function deserializeFileSharedLinkEffectivePermissionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FileSharedLinkEffectivePermissionField" });
}
...
function deserializeFileSharedLinkPermissionsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FileSharedLinkPermissionsField\"" });
    }
    if (val.can_download == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_download\" of type \"FileSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"FileSharedLinkPermissionsField\"" });
    }
    const canDownload = val.can_download;
    if (val.can_preview == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_preview\" of type \"FileSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"FileSharedLinkPermissionsField\"" });
    }
    const canPreview = val.can_preview;
    if (val.can_edit == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_edit\" of type \"FileSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_edit\" of type \"FileSharedLinkPermissionsField\"" });
    }
...
function serializeFileSharedLinkField(val) {
    return { ["url"]: val.url, ["download_url"]: val.downloadUrl, ["vanity_url"]: val.vanityUrl, ["vanity_name"]: val.vanityName, ["access"]: val.access == void 0 ? val.access : serializeFileSharedLinkAccessField(val.access), ["effective_access"]: serializeFileSharedLinkEffectiveAccessField(val.effectiveAccess), ["effective_permission"]: serializeFileSharedLinkEffectivePermissionField(val.effectivePermission), ["unshared_at"]: val.unsharedAt == void 0 ? val.unsharedAt : (0, utils_js_1.serializeDateTime)(val.unsharedAt), ["is_password_enabled"]: val.isPasswordEnabled, ["permissions"]: val.permissions == void 0 ? val.permissions : serializeFileSharedLinkPermissionsField(val.permissions), ["download_count"]: val.downloadCount, ["preview_count"]: val.previewCount };
}
function deserializeFileSharedLinkField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FileSharedLinkField\"" });
    }
    if (val.url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"url\" of type \"FileSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"FileSharedLinkField\"" });
    }
    const url = val.url;
    if (!(val.download_url == void 0) && !(0, json_js_3.sdIsString)(val.download_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"download_url\" of type \"FileSharedLinkField\"" });
    }
    ...
    if (!(val.vanity_url == void 0) && !(0, json_js_3.sdIsString)(val.vanity_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_url\" of type \"FileSharedLinkField\"" });
    }
    ...
    if (!(val.vanity_name == void 0) && !(0, json_js_3.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"FileSharedLinkField\"" });
    }
    const vanityName = val.vanity_name == void 0 ? void 0 : val.vanity_name;
    const access = val.access == void 0 ? void 0 : deserializeFileSharedLinkAccessField(val.access);
    if (val.effective_access == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_access\" of type \"FileSharedLinkField\" to be defined" });
    }
    ...
    if (val.effective_permission == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_permission\" of type \"FileSharedLinkField\" to be defined" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_3.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"FileSharedLinkField\"" });
    }
    ...
    if (val.is_password_enabled == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"is_password_enabled\" of type \"FileSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.is_password_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_password_enabled\" of type \"FileSharedLinkField\"" });
    }
    const isPasswordEnabled = val.is_password_enabled;
    const permissions = val.permissions == void 0 ? void 0 : deserializeFileSharedLinkPermissionsField(val.permissions);
    if (val.download_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"download_count\" of type \"FileSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.download_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"download_count\" of type \"FileSharedLinkField\"" });
    }
    const downloadCount = val.download_count;
    if (val.preview_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"preview_count\" of type \"FileSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.preview_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"preview_count\" of type \"FileSharedLinkField\"" });
    }
...
function deserializeFile(val) {
    ...
    if (!(val.description == void 0) && !(0, json_js_3.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"File\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.size == void 0) && !(0, json_js_2.sdIsNumber)(val.size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"size\" of type \"File\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_3.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"File\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_3.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"File\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_3.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"File\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !(0, json_js_3.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"File\"" });
    }
    ...
    if (!(val.content_created_at == void 0) && !(0, json_js_3.sdIsString)(val.content_created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_created_at\" of type \"File\"" });
    }
    ...
    if (!(val.content_modified_at == void 0) && !(0, json_js_3.sdIsString)(val.content_modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_modified_at\" of type \"File\"" });
    }
    ...
    if (!(val.sequence_id == void 0) && !(0, json_js_3.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"File\"" });
    }
    const sequenceId = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"File\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.sha1 == void 0) && !(0, json_js_3.sdIsString)(val.sha1)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sha1\" of type \"File\"" });
    }
    ...
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"File\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"File\"" });
    }
    const id = val.id;
    if (!(val.etag == void 0) && !(0, json_js_3.sdIsString)(val.etag)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"etag\" of type \"File\"" });
    }
    const etag = val.etag == void 0 ? void 0 : val.etag;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"File\" to be defined" });
    }
