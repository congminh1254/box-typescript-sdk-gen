...
function serializeTaskAssignment(val) {
    return {
        ...
        ['type']: val.type == void 0 ? void 0 : serializeTaskAssignmentTypeField(val.type),
        ['item']: val.item == void 0 ? void 0 : (0, fileMini_generated_js_1.serializeFileMini)(val.item),
        ['assigned_to']: val.assignedTo == void 0 ? void 0 : (0, userMini_generated_js_1.serializeUserMini)(val.assignedTo),
        ['message']: val.message == void 0 ? void 0 : val.message,
        ['completed_at']: val.completedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.completedAt),
        ['assigned_at']: val.assignedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.assignedAt),
        ['reminded_at']: val.remindedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.remindedAt),
        ['resolution_state']: val.resolutionState == void 0
            ? void 0
            : serializeTaskAssignmentResolutionStateField(val.resolutionState),
        ['assigned_by']: val.assignedBy == void 0 ? void 0 : (0, userMini_generated_js_1.serializeUserMini)(val.assignedBy),
    };
}
