...
function deserializeTaskAssignmentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TaskAssignmentTypeField" });
}
...
function deserializeTaskAssignmentResolutionStateField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TaskAssignmentResolutionStateField" });
}
function serializeTaskAssignment(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeTaskAssignmentTypeField(val.type), ["item"]: val.item == void 0 ? val.item : (0, fileMini_generated_js_1.serializeFileMini)(val.item), ["assigned_to"]: val.assignedTo == void 0 ? val.assignedTo : (0, userMini_generated_js_1.serializeUserMini)(val.assignedTo), ["message"]: val.message, ["completed_at"]: val.completedAt == void 0 ? val.completedAt : (0, utils_js_1.serializeDateTime)(val.completedAt), ["assigned_at"]: val.assignedAt == void 0 ? val.assignedAt : (0, utils_js_1.serializeDateTime)(val.assignedAt), ["reminded_at"]: val.remindedAt == void 0 ? val.remindedAt : (0, utils_js_1.serializeDateTime)(val.remindedAt), ["resolution_state"]: val.resolutionState == void 0 ? val.resolutionState : serializeTaskAssignmentResolutionStateField(val.resolutionState), ["assigned_by"]: val.assignedBy == void 0 ? val.assignedBy : (0, userMini_generated_js_1.serializeUserMini)(val.assignedBy) };
}
function deserializeTaskAssignment(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.message == void 0) && !(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"TaskAssignment\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.completed_at == void 0) && !(0, json_js_1.sdIsString)(val.completed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"completed_at\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.assigned_at == void 0) && !(0, json_js_1.sdIsString)(val.assigned_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"assigned_at\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.reminded_at == void 0) && !(0, json_js_1.sdIsString)(val.reminded_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"reminded_at\" of type \"TaskAssignment\"" });
    }
