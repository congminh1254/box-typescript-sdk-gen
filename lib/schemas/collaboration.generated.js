...
function serializeCollaborationAcceptanceRequirementsStatusStrongPasswordRequirementField(val) {
    return {
        ['enterprise_has_strong_password_required_for_external_users']: val.enterpriseHasStrongPasswordRequiredForExternalUsers == void 0
            ? void 0
            : val.enterpriseHasStrongPasswordRequiredForExternalUsers,
        ['user_has_strong_password']: val.userHasStrongPassword == void 0 ? void 0 : val.userHasStrongPassword,
    };
}
...
function serializeCollaborationAcceptanceRequirementsStatusTwoFactorAuthenticationRequirementField(val) {
    return {
        ['enterprise_has_two_factor_auth_enabled']: val.enterpriseHasTwoFactorAuthEnabled == void 0
            ? void 0
            : val.enterpriseHasTwoFactorAuthEnabled,
        ['user_has_two_factor_authentication_enabled']: val.userHasTwoFactorAuthenticationEnabled == void 0
            ? void 0
...
function serializeCollaboration(val) {
    return {
        ...
        ['item']: val.item == void 0 ? void 0 : (0, fileOrFolderOrWebLink_generated_js_1.serializeFileOrFolderOrWebLink)(val.item),
        ['app_item']: val.appItem == void 0 ? void 0 : (0, appItem_generated_js_1.serializeAppItem)(val.appItem),
        ...
        ['role']: val.role == void 0 ? void 0 : serializeCollaborationRoleField(val.role),
...
function serializeCollaborationInput(val) {
    return {
        ['id']: val.id,
        ['type']: val.type == void 0 ? void 0 : serializeCollaborationTypeField(val.type),
        ['item']: val.item == void 0 ? void 0 : (0, fileOrFolderOrWebLink_generated_js_1.serializeFileOrFolderOrWebLink)(val.item),
        ['app_item']: val.appItem == void 0 ? void 0 : (0, appItem_generated_js_1.serializeAppItem)(val.appItem),
        ['accessible_by']: val.accessibleBy == void 0
            ? void 0
