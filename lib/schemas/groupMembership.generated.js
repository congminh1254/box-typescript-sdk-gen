...
function serializeGroupMembership(val) {
    return {
        ...
        ['type']: val.type == void 0 ? void 0 : serializeGroupMembershipTypeField(val.type),
        ['user']: val.user == void 0 ? void 0 : (0, userMini_generated_js_1.serializeUserMini)(val.user),
        ['group']: val.group == void 0 ? void 0 : (0, groupMini_generated_js_1.serializeGroupMini)(val.group),
        ['role']: val.role == void 0 ? void 0 : serializeGroupMembershipRoleField(val.role),
