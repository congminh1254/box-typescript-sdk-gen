...
function deserializeGroupMembershipTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupMembershipTypeField" });
}
...
function deserializeGroupMembershipRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupMembershipRoleField" });
}
function serializeGroupMembership(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeGroupMembershipTypeField(val.type), ["user"]: val.user == void 0 ? val.user : (0, userMini_generated_js_1.serializeUserMini)(val.user), ["group"]: val.group == void 0 ? val.group : (0, groupMini_generated_js_1.serializeGroupMini)(val.group), ["role"]: val.role == void 0 ? val.role : serializeGroupMembershipRoleField(val.role), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt) };
}
function deserializeGroupMembership(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupMembership\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"GroupMembership\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_1.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"GroupMembership\"" });
    }
