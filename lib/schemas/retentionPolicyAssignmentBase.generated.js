...
function deserializeRetentionPolicyAssignmentBaseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyAssignmentBaseTypeField" });
}
...
function deserializeRetentionPolicyAssignmentBase(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyAssignmentBase\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyAssignmentBase\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyAssignmentBase\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicyAssignmentBase\" to be defined" });
    }
...
function deserializeRetentionPolicyAssignmentBaseInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyAssignmentBaseInput\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyAssignmentBaseInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyAssignmentBaseInput\"" });
    }
    const id = val.id;
    const type = val.type == void 0 ? void 0 : deserializeRetentionPolicyAssignmentBaseTypeField(val.type);
    return { id: id, type: type };
}
