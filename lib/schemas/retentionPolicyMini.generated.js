...
function deserializeRetentionPolicyMiniDispositionActionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyMiniDispositionActionField" });
}
function serializeRetentionPolicyMini(val) {
    ...
    if (!(0, json_js_2.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyMini\"" });
    }
    return Object.assign(Object.assign({}, base), { ["policy_name"]: val.policyName, ["retention_length"]: val.retentionLength, ["disposition_action"]: val.dispositionAction == void 0 ? val.dispositionAction : serializeRetentionPolicyMiniDispositionActionField(val.dispositionAction) });
}
function deserializeRetentionPolicyMini(val) {
    ...
    if (!(val.policy_name == void 0) && !(0, json_js_1.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"RetentionPolicyMini\"" });
    }
    ...
    if (!(val.retention_length == void 0) && !(0, json_js_1.sdIsString)(val.retention_length)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"RetentionPolicyMini\"" });
    }
    ...
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyMini\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyMini\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicyMini\" to be defined" });
    }
