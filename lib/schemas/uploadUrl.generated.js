...
function deserializeUploadUrl(val) {
    ...
    if (!(val.upload_url == void 0) && !(0, json_js_1.sdIsString)(val.upload_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"upload_url\" of type \"UploadUrl\"" });
    }
    ...
    if (!(val.upload_token == void 0) && !(0, json_js_1.sdIsString)(val.upload_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"upload_token\" of type \"UploadUrl\"" });
    }
