...
function deserializeFileConflict(val) {
    ...
    if (!(val.sequence_id == void 0) && !(0, json_js_1.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"FileConflict\"" });
    }
    const sequenceId = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"FileConflict\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.sha1 == void 0) && !(0, json_js_1.sdIsString)(val.sha1)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sha1\" of type \"FileConflict\"" });
    }
    ...
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"FileConflict\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"FileConflict\"" });
    }
    const id = val.id;
    if (!(val.etag == void 0) && !(0, json_js_1.sdIsString)(val.etag)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"etag\" of type \"FileConflict\"" });
    }
    const etag = val.etag == void 0 ? void 0 : val.etag;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"FileConflict\" to be defined" });
    }
