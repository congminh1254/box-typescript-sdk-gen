...
function deserializeTrashFolderRestoredTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TrashFolderRestoredTypeField" });
}
...
function deserializeTrashFolderRestoredPathCollectionField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TrashFolderRestoredPathCollectionField\"" });
    }
    if (val.total_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"total_count\" of type \"TrashFolderRestoredPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"TrashFolderRestoredPathCollectionField\"" });
    }
    const totalCount = val.total_count;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"TrashFolderRestoredPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"TrashFolderRestoredPathCollectionField\"" });
    }
...
function deserializeTrashFolderRestored(val) {
    ...
    if (!(val.sequence_id == void 0) && !(0, json_js_2.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"TrashFolderRestored\"" });
    }
    const sequenceId = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"TrashFolderRestored\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"TrashFolderRestored\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.size == void 0) && !(0, json_js_1.sdIsNumber)(val.size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"size\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_2.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"TrashFolderRestored\"" });
    }
    const trashedAt = val.trashed_at == void 0 ? void 0 : val.trashed_at;
    if (!(val.purged_at == void 0) && !(0, json_js_2.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.content_created_at == void 0) && !(0, json_js_2.sdIsString)(val.content_created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_created_at\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.content_modified_at == void 0) && !(0, json_js_2.sdIsString)(val.content_modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_modified_at\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.shared_link == void 0) && !(0, json_js_2.sdIsString)(val.shared_link)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"shared_link\" of type \"TrashFolderRestored\"" });
    }
    ...
    if (!(val.folder_upload_email == void 0) && !(0, json_js_2.sdIsString)(val.folder_upload_email)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"folder_upload_email\" of type \"TrashFolderRestored\"" });
    }
