...
function deserializeEventAdditionalDetailsField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"EventAdditionalDetailsField\"" });
    }
    return {};
}
function serializeEvent(val) {
    return { ["type"]: val.type, ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["recorded_at"]: val.recordedAt == void 0 ? val.recordedAt : (0, utils_js_1.serializeDateTime)(val.recordedAt), ["event_id"]: val.eventId, ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy), ["event_type"]: val.eventType == void 0 ? val.eventType : serializeEventEventTypeField(val.eventType), ["session_id"]: val.sessionId, ["source"]: val.source == void 0 ? val.source : (0, appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_1.serializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser)(val.source), ["additional_details"]: val.additionalDetails == void 0 ? val.additionalDetails : serializeEventAdditionalDetailsField(val.additionalDetails) };
}
function deserializeEvent(val) {
    ...
    if (!(val.type == void 0) && !(0, json_js_1.sdIsString)(val.type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"type\" of type \"Event\"" });
    }
    const type = val.type == void 0 ? void 0 : val.type;
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Event\"" });
    }
    ...
    if (!(val.recorded_at == void 0) && !(0, json_js_1.sdIsString)(val.recorded_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"recorded_at\" of type \"Event\"" });
    }
    ...
    if (!(val.event_id == void 0) && !(0, json_js_1.sdIsString)(val.event_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"event_id\" of type \"Event\"" });
    }
    ...
    if (!(val.session_id == void 0) && !(0, json_js_1.sdIsString)(val.session_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"session_id\" of type \"Event\"" });
    }
    const sessionId = val.session_id == void 0 ? void 0 : val.session_id;
    const source = val.source == void 0 ? void 0 : (0, appItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser_generated_js_2.deserializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser)(val.source);
