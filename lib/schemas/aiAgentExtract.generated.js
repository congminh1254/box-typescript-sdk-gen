...
function deserializeAiAgentExtract(val) {
    ...
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AiAgentExtract\" to be defined" });
    }
...
function serializeAiAgentExtractInput(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeAiAgentExtractTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : (0, aiAgentLongTextTool_generated_js_1.serializeAiAgentLongTextTool)(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : (0, aiAgentBasicTextTool_generated_js_1.serializeAiAgentBasicTextTool)(val.basicText) };
}
function deserializeAiAgentExtractInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentExtractInput\"" });
    }
