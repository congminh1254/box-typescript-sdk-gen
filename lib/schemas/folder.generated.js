...
function deserializeFolderPathCollectionField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FolderPathCollectionField\"" });
    }
    if (val.total_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"total_count\" of type \"FolderPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"FolderPathCollectionField\"" });
    }
    const totalCount = val.total_count;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"FolderPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"FolderPathCollectionField\"" });
    }
    const entries = (0, json_js_4.sdIsList)(val.entries) ? val.entries.map(function (itm) {
...
function deserializeFolderSharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FolderSharedLinkAccessField" });
}
...
function deserializeFolderSharedLinkEffectiveAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FolderSharedLinkEffectiveAccessField" });
}
...
function deserializeFolderSharedLinkEffectivePermissionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FolderSharedLinkEffectivePermissionField" });
}
...
function deserializeFolderSharedLinkPermissionsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FolderSharedLinkPermissionsField\"" });
    }
    if (val.can_download == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_download\" of type \"FolderSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"FolderSharedLinkPermissionsField\"" });
    }
    const canDownload = val.can_download;
    if (val.can_preview == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_preview\" of type \"FolderSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"FolderSharedLinkPermissionsField\"" });
    }
    const canPreview = val.can_preview;
    if (val.can_edit == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_edit\" of type \"FolderSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_edit\" of type \"FolderSharedLinkPermissionsField\"" });
    }
...
function deserializeFolderSharedLinkField(val) {
    ...
    if (!(val.vanity_url == void 0) && !(0, json_js_3.sdIsString)(val.vanity_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_url\" of type \"FolderSharedLinkField\"" });
    }
    ...
    if (!(val.vanity_name == void 0) && !(0, json_js_3.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"FolderSharedLinkField\"" });
    }
    const vanityName = val.vanity_name == void 0 ? void 0 : val.vanity_name;
    const access = val.access == void 0 ? void 0 : deserializeFolderSharedLinkAccessField(val.access);
    if (val.effective_access == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_access\" of type \"FolderSharedLinkField\" to be defined" });
    }
    ...
    if (val.effective_permission == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_permission\" of type \"FolderSharedLinkField\" to be defined" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_3.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"FolderSharedLinkField\"" });
    }
    ...
    if (val.is_password_enabled == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"is_password_enabled\" of type \"FolderSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.is_password_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_password_enabled\" of type \"FolderSharedLinkField\"" });
    }
    const isPasswordEnabled = val.is_password_enabled;
    const permissions = val.permissions == void 0 ? void 0 : deserializeFolderSharedLinkPermissionsField(val.permissions);
    if (val.download_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"download_count\" of type \"FolderSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.download_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"download_count\" of type \"FolderSharedLinkField\"" });
    }
    const downloadCount = val.download_count;
    if (val.preview_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"preview_count\" of type \"FolderSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.preview_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"preview_count\" of type \"FolderSharedLinkField\"" });
    }
...
function deserializeFolderFolderUploadEmailAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FolderFolderUploadEmailAccessField" });
}
...
function deserializeFolderFolderUploadEmailField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FolderFolderUploadEmailField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeFolderFolderUploadEmailAccessField(val.access);
    if (!(val.email == void 0) && !(0, json_js_3.sdIsString)(val.email)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email\" of type \"FolderFolderUploadEmailField\"" });
    }
...
function deserializeFolder(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_3.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Folder\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_3.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"Folder\"" });
    }
    ...
    if (!(val.description == void 0) && !(0, json_js_3.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"Folder\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.size == void 0) && !(0, json_js_2.sdIsNumber)(val.size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"size\" of type \"Folder\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_3.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"Folder\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !(0, json_js_3.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"Folder\"" });
    }
    ...
    if (!(val.content_created_at == void 0) && !(0, json_js_3.sdIsString)(val.content_created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_created_at\" of type \"Folder\"" });
    }
    ...
    if (!(val.content_modified_at == void 0) && !(0, json_js_3.sdIsString)(val.content_modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_modified_at\" of type \"Folder\"" });
    }
    ...
    const itemCollection = val.item_collection == void 0 ? void 0 : (0, items_generated_js_2.deserializeItems)(val.item_collection);
    if (!(val.sequence_id == void 0) && !(0, json_js_3.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"Folder\"" });
    }
    const sequenceId = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"Folder\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"Folder\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"Folder\"" });
    }
    const id = val.id;
    if (!(val.etag == void 0) && !(0, json_js_3.sdIsString)(val.etag)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"etag\" of type \"Folder\"" });
    }
    const etag = val.etag == void 0 ? void 0 : val.etag;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"Folder\" to be defined" });
    }
