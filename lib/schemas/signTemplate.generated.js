...
function serializeSignTemplateReadySignLinkField(val) {
    return {
        ...
        ['is_notification_disabled']: val.isNotificationDisabled == void 0
            ? void 0
...
function serializeSignTemplateCustomBrandingField(val) {
    return {
        ...
        ['branding_color']: val.brandingColor == void 0 ? void 0 : val.brandingColor,
        ['email_footer_text']: val.emailFooterText == void 0 ? void 0 : val.emailFooterText,
    };
}
...
function serializeSignTemplate(val) {
    return {
        ['type']: val.type == void 0 ? void 0 : serializeSignTemplateTypeField(val.type),
        ...
        ['are_fields_locked']: val.areFieldsLocked == void 0 ? void 0 : val.areFieldsLocked,
        ['are_options_locked']: val.areOptionsLocked == void 0 ? void 0 : val.areOptionsLocked,
        ['are_recipients_locked']: val.areRecipientsLocked == void 0 ? void 0 : val.areRecipientsLocked,
        ['are_email_settings_locked']: val.areEmailSettingsLocked == void 0
            ? void 0
            : val.areEmailSettingsLocked,
        ['are_files_locked']: val.areFilesLocked == void 0 ? void 0 : val.areFilesLocked,
        ['signers']: val.signers == void 0
            ? void 0
            : val.signers.map(function (item) {
