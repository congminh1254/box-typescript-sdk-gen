...
function deserializeCommentFull(val) {
    ...
    if (!(val.tagged_message == void 0) && !(0, json_js_2.sdIsString)(val.tagged_message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"tagged_message\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.is_reply_comment == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_reply_comment)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_reply_comment\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CommentFull\"" });
    }
