...
function deserializeWebhookMiniTargetTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebhookMiniTargetTypeField" });
}
...
function deserializeWebhookMiniTargetField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WebhookMiniTargetField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WebhookMiniTargetField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeWebhookMiniTargetTypeField(val.type);
...
function deserializeWebhookMini(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WebhookMini\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
