...
function deserializeGroupMembershipsOrderDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupMembershipsOrderDirectionField" });
}
...
function deserializeGroupMembershipsOrderField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"GroupMembershipsOrderField\"" });
    }
    if (!(val.by == void 0) && !(0, json_js_2.sdIsString)(val.by)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"by\" of type \"GroupMembershipsOrderField\"" });
    }
    const by = val.by == void 0 ? void 0 : val.by;
    const direction = val.direction == void 0 ? void 0 : deserializeGroupMembershipsOrderDirectionField(val.direction);
...
function deserializeGroupMemberships(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"GroupMemberships\"" });
    }
    if (!(val.total_count == void 0) && !(0, json_js_1.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"GroupMemberships\"" });
    }
    const totalCount = val.total_count == void 0 ? void 0 : val.total_count;
    if (!(val.limit == void 0) && !(0, json_js_1.sdIsNumber)(val.limit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"limit\" of type \"GroupMemberships\"" });
    }
    const limit = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.offset == void 0) && !(0, json_js_1.sdIsNumber)(val.offset)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"offset\" of type \"GroupMemberships\"" });
    }
    const offset = val.offset == void 0 ? void 0 : val.offset;
    if (!(val.order == void 0) && !(0, json_js_3.sdIsList)(val.order)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"order\" of type \"GroupMemberships\"" });
    }
    ...
    if (!(val.entries == void 0) && !(0, json_js_3.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"GroupMemberships\"" });
    }
