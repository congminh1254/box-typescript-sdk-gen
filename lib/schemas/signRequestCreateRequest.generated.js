...
function deserializeSignRequestCreateRequestSignatureColorField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SignRequestCreateRequestSignatureColorField" });
}
function serializeSignRequestCreateRequest(val) {
    ...
    if (!(0, json_js_5.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SignRequestCreateRequest\"" });
    }
    return Object.assign(Object.assign({}, base), { ["source_files"]: val.sourceFiles == void 0 ? val.sourceFiles : val.sourceFiles.map(function (item) {
            return (0, fileBase_generated_js_1.serializeFileBase)(item);
        }), ["signature_color"]: val.signatureColor == void 0 ? val.signatureColor : serializeSignRequestCreateRequestSignatureColorField(val.signatureColor), ["signers"]: val.signers.map(function (item) {
            return (0, signRequestCreateSigner_generated_js_1.serializeSignRequestCreateSigner)(item);
        }), ["parent_folder"]: val.parentFolder == void 0 ? val.parentFolder : (0, folderMini_generated_js_1.serializeFolderMini)(val.parentFolder) });
}
function deserializeSignRequestCreateRequest(val) {
    ...
    if (!(val.source_files == void 0) && !(0, json_js_4.sdIsList)(val.source_files)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"source_files\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (val.signers == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"signers\" of type \"SignRequestCreateRequest\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.signers)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignRequestCreateRequest\"" });
    }
    const signers = (0, json_js_4.sdIsList)(val.signers) ? val.signers.map(function (itm) {
    ...
    if (!(val.is_document_preparation_needed == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_document_preparation_needed)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_document_preparation_needed\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.redirect_url == void 0) && !(0, json_js_3.sdIsString)(val.redirect_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"redirect_url\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.declined_redirect_url == void 0) && !(0, json_js_3.sdIsString)(val.declined_redirect_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"declined_redirect_url\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.are_text_signatures_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_text_signatures_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_text_signatures_enabled\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.email_subject == void 0) && !(0, json_js_3.sdIsString)(val.email_subject)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email_subject\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.email_message == void 0) && !(0, json_js_3.sdIsString)(val.email_message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email_message\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.are_reminders_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_reminders_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_reminders_enabled\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"SignRequestCreateRequest\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.prefill_tags == void 0) && !(0, json_js_4.sdIsList)(val.prefill_tags)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"prefill_tags\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.days_valid == void 0) && !(0, json_js_2.sdIsNumber)(val.days_valid)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"days_valid\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.external_id == void 0) && !(0, json_js_3.sdIsString)(val.external_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"external_id\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.template_id == void 0) && !(0, json_js_3.sdIsString)(val.template_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"template_id\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.external_system_name == void 0) && !(0, json_js_3.sdIsString)(val.external_system_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"external_system_name\" of type \"SignRequestCreateRequest\"" });
    }
