...
function deserializeTaskCompletionRuleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TaskCompletionRuleField" });
}
function serializeTask(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeTaskTypeField(val.type), ["item"]: val.item == void 0 ? val.item : (0, fileMini_generated_js_1.serializeFileMini)(val.item), ["due_at"]: val.dueAt == void 0 ? val.dueAt : (0, utils_js_1.serializeDateTime)(val.dueAt), ["action"]: val.action == void 0 ? val.action : serializeTaskActionField(val.action), ["message"]: val.message, ["task_assignment_collection"]: val.taskAssignmentCollection == void 0 ? val.taskAssignmentCollection : (0, taskAssignments_generated_js_1.serializeTaskAssignments)(val.taskAssignmentCollection), ["is_completed"]: val.isCompleted, ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["completion_rule"]: val.completionRule == void 0 ? val.completionRule : serializeTaskCompletionRuleField(val.completionRule) };
}
function deserializeTask(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"Task\"" });
    }
    ...
    if (!(val.due_at == void 0) && !(0, json_js_2.sdIsString)(val.due_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"due_at\" of type \"Task\"" });
    }
    ...
    if (!(val.message == void 0) && !(0, json_js_2.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"Task\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    const taskAssignmentCollection = val.task_assignment_collection == void 0 ? void 0 : (0, taskAssignments_generated_js_2.deserializeTaskAssignments)(val.task_assignment_collection);
    if (!(val.is_completed == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_completed)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_completed\" of type \"Task\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Task\"" });
    }
