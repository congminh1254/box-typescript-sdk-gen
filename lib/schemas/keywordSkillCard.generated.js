...
function deserializeKeywordSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize KeywordSkillCardTypeField" });
}
...
function deserializeKeywordSkillCardSkillCardTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize KeywordSkillCardSkillCardTypeField" });
}
...
function deserializeKeywordSkillCardSkillCardTitleField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardSkillCardTitleField\"" });
    }
    if (!(val.code == void 0) && !(0, json_js_1.sdIsString)(val.code)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"code\" of type \"KeywordSkillCardSkillCardTitleField\"" });
    }
    const code = val.code == void 0 ? void 0 : val.code;
    if (val.message == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"message\" of type \"KeywordSkillCardSkillCardTitleField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"KeywordSkillCardSkillCardTitleField\"" });
    }
...
function deserializeKeywordSkillCardSkillTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize KeywordSkillCardSkillTypeField" });
}
...
function deserializeKeywordSkillCardSkillField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardSkillField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"KeywordSkillCardSkillField\" to be defined" });
    }
    const type = deserializeKeywordSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"KeywordSkillCardSkillField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"KeywordSkillCardSkillField\"" });
    }
    const id = val.id;
...
function deserializeKeywordSkillCardSkillFieldInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardSkillFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeKeywordSkillCardSkillTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"KeywordSkillCardSkillFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"KeywordSkillCardSkillFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeKeywordSkillCardInvocationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize KeywordSkillCardInvocationTypeField" });
}
...
function deserializeKeywordSkillCardInvocationField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardInvocationField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"KeywordSkillCardInvocationField\" to be defined" });
    }
    const type = deserializeKeywordSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"KeywordSkillCardInvocationField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"KeywordSkillCardInvocationField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeKeywordSkillCardInvocationFieldInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardInvocationFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeKeywordSkillCardInvocationTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"KeywordSkillCardInvocationFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"KeywordSkillCardInvocationFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeKeywordSkillCardEntriesField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardEntriesField\"" });
    }
    if (!(val.text == void 0) && !(0, json_js_1.sdIsString)(val.text)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text\" of type \"KeywordSkillCardEntriesField\"" });
    }
...
function deserializeKeywordSkillCard(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCard\"" });
    }
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"KeywordSkillCard\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"KeywordSkillCard\" to be defined" });
    }
    const type = deserializeKeywordSkillCardTypeField(val.type);
    if (val.skill_card_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill_card_type\" of type \"KeywordSkillCard\" to be defined" });
    }
    ...
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"KeywordSkillCard\" to be defined" });
    }
    const skill = deserializeKeywordSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"KeywordSkillCard\" to be defined" });
    }
    const invocation = deserializeKeywordSkillCardInvocationField(val.invocation);
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"KeywordSkillCard\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"KeywordSkillCard\"" });
    }
    const entries = (0, json_js_2.sdIsList)(val.entries) ? val.entries.map(function (itm) {
...
function deserializeKeywordSkillCardInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardInput\"" });
    }
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"KeywordSkillCardInput\"" });
    }
    const createdAt = val.created_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.created_at);
    const type = val.type == void 0 ? void 0 : deserializeKeywordSkillCardTypeField(val.type);
    const skillCardType = val.skillCardType == void 0 ? void 0 : deserializeKeywordSkillCardSkillCardTypeField(val.skillCardType);
    const skillCardTitle = val.skill_card_title == void 0 ? void 0 : deserializeKeywordSkillCardSkillCardTitleField(val.skill_card_title);
    if (val.skill == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"skill\" of type \"KeywordSkillCardInput\" to be defined" });
    }
    const skill = deserializeKeywordSkillCardSkillField(val.skill);
    if (val.invocation == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"invocation\" of type \"KeywordSkillCardInput\" to be defined" });
    }
    const invocation = deserializeKeywordSkillCardInvocationField(val.invocation);
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"KeywordSkillCardInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"KeywordSkillCardInput\"" });
    }
    const entries = (0, json_js_2.sdIsList)(val.entries) ? val.entries.map(function (itm) {
        return deserializeKeywordSkillCardEntriesField(itm);
    }) : [];
