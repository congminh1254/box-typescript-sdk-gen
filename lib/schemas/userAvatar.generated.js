...
function deserializeUserAvatarPicUrlsField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UserAvatarPicUrlsField\"" });
    }
    if (!(val.small == void 0) && !(0, json_js_1.sdIsString)(val.small)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"small\" of type \"UserAvatarPicUrlsField\"" });
    }
    const small = val.small == void 0 ? void 0 : val.small;
    if (!(val.large == void 0) && !(0, json_js_1.sdIsString)(val.large)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"large\" of type \"UserAvatarPicUrlsField\"" });
    }
    const large = val.large == void 0 ? void 0 : val.large;
    if (!(val.preview == void 0) && !(0, json_js_1.sdIsString)(val.preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"preview\" of type \"UserAvatarPicUrlsField\"" });
    }
