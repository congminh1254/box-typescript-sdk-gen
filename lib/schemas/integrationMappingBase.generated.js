...
function deserializeIntegrationMappingBaseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize IntegrationMappingBaseTypeField" });
}
...
function deserializeIntegrationMappingBase(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingBase\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingBase\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingBase\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"IntegrationMappingBase\" to be defined" });
    }
...
function deserializeIntegrationMappingBaseInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"IntegrationMappingBaseInput\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"IntegrationMappingBaseInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"IntegrationMappingBaseInput\"" });
    }
    const id = val.id;
    const type = val.type == void 0 ? void 0 : deserializeIntegrationMappingBaseTypeField(val.type);
    return { id: id, type: type };
}
