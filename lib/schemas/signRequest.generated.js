...
function deserializeSignRequestStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SignRequestStatusField" });
}
function serializeSignRequestSignFilesField(val) {
    return { ["files"]: val.files == void 0 ? val.files : val.files.map(function (item) {
...
function deserializeSignRequestSignFilesField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"SignRequestSignFilesField\"" });
    }
    if (!(val.files == void 0) && !(0, json_js_4.sdIsList)(val.files)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"files\" of type \"SignRequestSignFilesField\"" });
    }
    const files = val.files == void 0 ? void 0 : (0, json_js_4.sdIsList)(val.files) ? val.files.map(function (itm) {
        return (0, fileMini_generated_js_2.deserializeFileMini)(itm);
    }) : [];
    if (!(val.is_ready_for_download == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_ready_for_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_ready_for_download\" of type \"SignRequestSignFilesField\"" });
    }
...
function serializeSignRequest(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["type"]: val.type == void 0 ? val.type : serializeSignRequestTypeField(val.type), ["source_files"]: val.sourceFiles == void 0 ? val.sourceFiles : val.sourceFiles.map(function (item) {
            return (0, fileBase_generated_js_1.serializeFileBase)(item);
        }), ["signers"]: val.signers == void 0 ? val.signers : val.signers.map(function (item) {
            return (0, signRequestSigner_generated_js_1.serializeSignRequestSigner)(item);
        }), ["signature_color"]: val.signatureColor, ["id"]: val.id, ["prepare_url"]: val.prepareUrl, ["signing_log"]: val.signingLog == void 0 ? val.signingLog : (0, fileMini_generated_js_1.serializeFileMini)(val.signingLog), ["status"]: val.status == void 0 ? val.status : serializeSignRequestStatusField(val.status), ["sign_files"]: val.signFiles == void 0 ? val.signFiles : serializeSignRequestSignFilesField(val.signFiles), ["auto_expire_at"]: val.autoExpireAt == void 0 ? val.autoExpireAt : (0, utils_js_1.serializeDateTime)(val.autoExpireAt), ["parent_folder"]: val.parentFolder == void 0 ? val.parentFolder : (0, folderMini_generated_js_1.serializeFolderMini)(val.parentFolder) });
}
function deserializeSignRequest(val) {
    ...
    if (!(val.source_files == void 0) && !(0, json_js_4.sdIsList)(val.source_files)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"source_files\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.signers == void 0) && !(0, json_js_4.sdIsList)(val.signers)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.signature_color == void 0) && !(0, json_js_3.sdIsString)(val.signature_color)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"signature_color\" of type \"SignRequest\"" });
    }
    const signatureColor = val.signature_color == void 0 ? void 0 : val.signature_color;
    if (!(val.id == void 0) && !(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"SignRequest\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.prepare_url == void 0) && !(0, json_js_3.sdIsString)(val.prepare_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prepare_url\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.auto_expire_at == void 0) && !(0, json_js_3.sdIsString)(val.auto_expire_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"auto_expire_at\" of type \"SignRequest\"" });
    }
    const autoExpireAt = val.auto_expire_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.auto_expire_at);
    const parentFolder = val.parent_folder == void 0 ? void 0 : (0, folderMini_generated_js_2.deserializeFolderMini)(val.parent_folder);
    if (!(val.is_document_preparation_needed == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_document_preparation_needed)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_document_preparation_needed\" of type \"SignRequest\"" });
    }
    const isDocumentPreparationNeeded = val.is_document_preparation_needed == void 0 ? void 0 : val.is_document_preparation_needed;
    if (!(val.redirect_url == void 0) && !(0, json_js_3.sdIsString)(val.redirect_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"redirect_url\" of type \"SignRequest\"" });
    }
    const redirectUrl = val.redirect_url == void 0 ? void 0 : val.redirect_url;
    if (!(val.declined_redirect_url == void 0) && !(0, json_js_3.sdIsString)(val.declined_redirect_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"declined_redirect_url\" of type \"SignRequest\"" });
    }
    const declinedRedirectUrl = val.declined_redirect_url == void 0 ? void 0 : val.declined_redirect_url;
    if (!(val.are_text_signatures_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_text_signatures_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_text_signatures_enabled\" of type \"SignRequest\"" });
    }
    const areTextSignaturesEnabled = val.are_text_signatures_enabled == void 0 ? void 0 : val.are_text_signatures_enabled;
    if (!(val.email_subject == void 0) && !(0, json_js_3.sdIsString)(val.email_subject)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email_subject\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.email_message == void 0) && !(0, json_js_3.sdIsString)(val.email_message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"email_message\" of type \"SignRequest\"" });
    }
    const emailMessage = val.email_message == void 0 ? void 0 : val.email_message;
    if (!(val.are_reminders_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_reminders_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_reminders_enabled\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"SignRequest\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.prefill_tags == void 0) && !(0, json_js_4.sdIsList)(val.prefill_tags)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"prefill_tags\" of type \"SignRequest\"" });
    }
    const prefillTags = val.prefill_tags == void 0 ? void 0 : (0, json_js_4.sdIsList)(val.prefill_tags) ? val.prefill_tags.map(function (itm) {
    ...
    if (!(val.days_valid == void 0) && !(0, json_js_2.sdIsNumber)(val.days_valid)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"days_valid\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.external_id == void 0) && !(0, json_js_3.sdIsString)(val.external_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"external_id\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.template_id == void 0) && !(0, json_js_3.sdIsString)(val.template_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"template_id\" of type \"SignRequest\"" });
    }
    const templateId = val.template_id == void 0 ? void 0 : val.template_id;
    if (!(val.external_system_name == void 0) && !(0, json_js_3.sdIsString)(val.external_system_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"external_system_name\" of type \"SignRequest\"" });
    }
