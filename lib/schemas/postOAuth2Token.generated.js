...
function deserializePostOAuth2TokenGrantTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize PostOAuth2TokenGrantTypeField" });
}
...
function deserializePostOAuth2TokenSubjectTokenTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize PostOAuth2TokenSubjectTokenTypeField" });
}
...
function deserializePostOAuth2TokenActorTokenTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize PostOAuth2TokenActorTokenTypeField" });
}
...
function deserializePostOAuth2TokenBoxSubjectTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize PostOAuth2TokenBoxSubjectTypeField" });
}
...
function deserializePostOAuth2Token(val) {
    ...
    if (val.grant_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"grant_type\" of type \"PostOAuth2Token\" to be defined" });
    }
    ...
    if (!(val.client_id == void 0) && !(0, json_js_1.sdIsString)(val.client_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_id\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.client_secret == void 0) && !(0, json_js_1.sdIsString)(val.client_secret)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"client_secret\" of type \"PostOAuth2Token\"" });
    }
    const clientSecret = val.client_secret == void 0 ? void 0 : val.client_secret;
    if (!(val.code == void 0) && !(0, json_js_1.sdIsString)(val.code)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"code\" of type \"PostOAuth2Token\"" });
    }
    const code = val.code == void 0 ? void 0 : val.code;
    if (!(val.refresh_token == void 0) && !(0, json_js_1.sdIsString)(val.refresh_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"refresh_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.assertion == void 0) && !(0, json_js_1.sdIsString)(val.assertion)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"assertion\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.subject_token == void 0) && !(0, json_js_1.sdIsString)(val.subject_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"subject_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.actor_token == void 0) && !(0, json_js_1.sdIsString)(val.actor_token)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"actor_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.scope == void 0) && !(0, json_js_1.sdIsString)(val.scope)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"scope\" of type \"PostOAuth2Token\"" });
    }
    const scope = val.scope == void 0 ? void 0 : val.scope;
    if (!(val.resource == void 0) && !(0, json_js_1.sdIsString)(val.resource)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"resource\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.box_subject_id == void 0) && !(0, json_js_1.sdIsString)(val.box_subject_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"box_subject_id\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.box_shared_link == void 0) && !(0, json_js_1.sdIsString)(val.box_shared_link)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"box_shared_link\" of type \"PostOAuth2Token\"" });
    }
