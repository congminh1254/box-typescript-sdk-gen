...
function deserializeWebLinkPathCollectionField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WebLinkPathCollectionField\"" });
    }
    if (val.total_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"total_count\" of type \"WebLinkPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.total_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"total_count\" of type \"WebLinkPathCollectionField\"" });
    }
    const totalCount = val.total_count;
    if (val.entries == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"entries\" of type \"WebLinkPathCollectionField\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"WebLinkPathCollectionField\"" });
    }
...
function deserializeWebLinkSharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebLinkSharedLinkAccessField" });
}
...
function deserializeWebLinkSharedLinkEffectiveAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebLinkSharedLinkEffectiveAccessField" });
}
...
function deserializeWebLinkSharedLinkEffectivePermissionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebLinkSharedLinkEffectivePermissionField" });
}
...
function deserializeWebLinkSharedLinkPermissionsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WebLinkSharedLinkPermissionsField\"" });
    }
    if (val.can_download == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_download\" of type \"WebLinkSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"WebLinkSharedLinkPermissionsField\"" });
    }
    const canDownload = val.can_download;
    if (val.can_preview == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_preview\" of type \"WebLinkSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"WebLinkSharedLinkPermissionsField\"" });
    }
    const canPreview = val.can_preview;
    if (val.can_edit == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"can_edit\" of type \"WebLinkSharedLinkPermissionsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_edit\" of type \"WebLinkSharedLinkPermissionsField\"" });
    }
...
function deserializeWebLinkSharedLinkField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WebLinkSharedLinkField\"" });
    }
    if (val.url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"url\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"WebLinkSharedLinkField\"" });
    }
    const url = val.url;
    if (!(val.download_url == void 0) && !(0, json_js_3.sdIsString)(val.download_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"download_url\" of type \"WebLinkSharedLinkField\"" });
    }
    ...
    if (!(val.vanity_url == void 0) && !(0, json_js_3.sdIsString)(val.vanity_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_url\" of type \"WebLinkSharedLinkField\"" });
    }
    ...
    if (!(val.vanity_name == void 0) && !(0, json_js_3.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"WebLinkSharedLinkField\"" });
    }
    const vanityName = val.vanity_name == void 0 ? void 0 : val.vanity_name;
    const access = val.access == void 0 ? void 0 : deserializeWebLinkSharedLinkAccessField(val.access);
    if (val.effective_access == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_access\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    ...
    if (val.effective_permission == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"effective_permission\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_3.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"WebLinkSharedLinkField\"" });
    }
    ...
    if (val.is_password_enabled == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"is_password_enabled\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.is_password_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_password_enabled\" of type \"WebLinkSharedLinkField\"" });
    }
    const isPasswordEnabled = val.is_password_enabled;
    const permissions = val.permissions == void 0 ? void 0 : deserializeWebLinkSharedLinkPermissionsField(val.permissions);
    if (val.download_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"download_count\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.download_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"download_count\" of type \"WebLinkSharedLinkField\"" });
    }
    const downloadCount = val.download_count;
    if (val.preview_count == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"preview_count\" of type \"WebLinkSharedLinkField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.preview_count)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"preview_count\" of type \"WebLinkSharedLinkField\"" });
    }
...
function deserializeWebLinkItemStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebLinkItemStatusField" });
}
...
function deserializeWebLink(val) {
    ...
    if (!(val.description == void 0) && !(0, json_js_3.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"WebLink\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_3.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WebLink\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_3.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"WebLink\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_3.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"WebLink\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !(0, json_js_3.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"WebLink\"" });
    }
    ...
    if (!(val.url == void 0) && !(0, json_js_3.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"WebLink\"" });
    }
    const url = val.url == void 0 ? void 0 : val.url;
    if (!(val.sequence_id == void 0) && !(0, json_js_3.sdIsString)(val.sequence_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"WebLink\"" });
    }
    const sequenceId = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !(0, json_js_3.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"WebLink\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"WebLink\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WebLink\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"WebLink\" to be defined" });
    }
    ...
    if (!(val.etag == void 0) && !(0, json_js_3.sdIsString)(val.etag)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"etag\" of type \"WebLink\"" });
    }
