...
function serializeShieldInformationBarrierSegmentMemberMini(val) {
    ...
    if (!(0, json_js_2.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentMemberMini\"" });
    }
    return Object.assign(Object.assign({}, base), { ["user"]: val.user == void 0 ? val.user : (0, userBase_generated_js_1.serializeUserBase)(val.user) });
}
function deserializeShieldInformationBarrierSegmentMemberMini(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentMemberMini\"" });
    }
