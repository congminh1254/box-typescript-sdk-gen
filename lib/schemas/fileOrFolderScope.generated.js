...
function deserializeFileOrFolderScopeScopeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FileOrFolderScopeScopeField" });
}
function serializeFileOrFolderScope(val) {
    return { ["scope"]: val.scope == void 0 ? val.scope : serializeFileOrFolderScopeScopeField(val.scope), ["object"]: val.object == void 0 ? val.object : (0, fileMiniOrFolderMini_generated_js_1.serializeFileMiniOrFolderMini)(val.object) };
}
function deserializeFileOrFolderScope(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FileOrFolderScope\"" });
    }
    const scope = val.scope == void 0 ? void 0 : deserializeFileOrFolderScopeScopeField(val.scope);
