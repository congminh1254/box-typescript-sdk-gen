...
function serializeDevicePinner(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeDevicePinnerTypeField(val.type), ["owned_by"]: val.ownedBy == void 0 ? val.ownedBy : (0, userMini_generated_js_1.serializeUserMini)(val.ownedBy), ["product_name"]: val.productName };
}
function deserializeDevicePinner(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"DevicePinner\"" });
    }
    ...
    if (!(val.product_name == void 0) && !(0, json_js_1.sdIsString)(val.product_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"product_name\" of type \"DevicePinner\"" });
    }
