...
function serializeWorkflowFull(val) {
    ...
    return Object.assign(Object.assign({}, base), { ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : (0, utils_js_1.serializeDateTime)(val.modifiedAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userBase_generated_js_1.serializeUserBase)(val.createdBy), ["modified_by"]: val.modifiedBy == void 0 ? val.modifiedBy : (0, userBase_generated_js_1.serializeUserBase)(val.modifiedBy) });
}
function deserializeWorkflowFull(val) {
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.flows == void 0) && !(0, json_js_3.sdIsList)(val.flows)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"flows\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowFull\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"WorkflowFull\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.is_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_enabled\" of type \"WorkflowFull\"" });
    }
