...
function serializeAiAgentBasicGenTool(val) {
    ...
    if (!(0, json_js_3.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentBasicGenTool\"" });
    }
...
function deserializeAiAgentBasicGenTool(val) {
    ...
    if (!(val.content_template == void 0) && !(0, json_js_2.sdIsString)(val.content_template)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"content_template\" of type \"AiAgentBasicGenTool\"" });
    }
    const contentTemplate = val.content_template == void 0 ? void 0 : val.content_template;
    const embeddings = val.embeddings == void 0 ? void 0 : (0, aiAgentLongTextToolTextGen_generated_js_1.deserializeAiAgentLongTextToolTextGenEmbeddingsField)(val.embeddings);
    if (!(val.system_message == void 0) && !(0, json_js_2.sdIsString)(val.system_message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"system_message\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.prompt_template == void 0) && !(0, json_js_2.sdIsString)(val.prompt_template)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prompt_template\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.model == void 0) && !(0, json_js_2.sdIsString)(val.model)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"model\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.num_tokens_for_completion == void 0) && !(0, json_js_1.sdIsNumber)(val.num_tokens_for_completion)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"num_tokens_for_completion\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    return { contentTemplate: contentTemplate, embeddings: embeddings, systemMessage: systemMessage, promptTemplate: promptTemplate, model: model, numTokensForCompletion: numTokensForCompletion, llmEndpointParams: llmEndpointParams };
}
