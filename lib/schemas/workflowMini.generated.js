...
function deserializeWorkflowMini(val) {
    ...
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowMini\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowMini\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"WorkflowMini\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.is_enabled == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_enabled)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_enabled\" of type \"WorkflowMini\"" });
    }
