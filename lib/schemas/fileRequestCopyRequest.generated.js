...
function deserializeFileRequestCopyRequestFolderTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize FileRequestCopyRequestFolderTypeField" });
}
...
function deserializeFileRequestCopyRequestFolderField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FileRequestCopyRequestFolderField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeFileRequestCopyRequestFolderTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"FileRequestCopyRequestFolderField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"FileRequestCopyRequestFolderField\"" });
    }
    const id = val.id;
...
function serializeFileRequestCopyRequest(val) {
    ...
    if (!(0, json_js_3.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"FileRequestCopyRequest\"" });
    }
...
function deserializeFileRequestCopyRequest(val) {
    ...
    if (val.folder == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"folder\" of type \"FileRequestCopyRequest\" to be defined" });
    }
    const folder = deserializeFileRequestCopyRequestFolderField(val.folder);
    if (!(val.title == void 0) && !(0, json_js_2.sdIsString)(val.title)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"title\" of type \"FileRequestCopyRequest\"" });
    }
    const title = val.title == void 0 ? void 0 : val.title;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"FileRequestCopyRequest\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    const status = val.status == void 0 ? void 0 : (0, fileRequestUpdateRequest_generated_js_1.deserializeFileRequestUpdateRequestStatusField)(val.status);
    if (!(val.is_email_required == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_email_required)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_email_required\" of type \"FileRequestCopyRequest\"" });
    }
    ...
    if (!(val.is_description_required == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_description_required)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_description_required\" of type \"FileRequestCopyRequest\"" });
    }
    ...
    if (!(val.expires_at == void 0) && !(0, json_js_2.sdIsString)(val.expires_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"FileRequestCopyRequest\"" });
    }
