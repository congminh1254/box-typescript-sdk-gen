...
function serializeRealtimeServers(val) {
    return { ["chunk_size"]: val.chunkSize, ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item) {
...
function deserializeRealtimeServers(val) {
    ...
    if (!(val.chunk_size == void 0) && !(0, json_js_1.sdIsNumber)(val.chunk_size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"chunk_size\" of type \"RealtimeServers\"" });
    }
    const chunkSize = val.chunk_size == void 0 ? void 0 : val.chunk_size;
    if (!(val.entries == void 0) && !(0, json_js_2.sdIsList)(val.entries)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"entries\" of type \"RealtimeServers\"" });
    }
