...
function serializeAiAgentBasicTextTool(val) {
    ...
    if (!(0, json_js_3.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AiAgentBasicTextTool\"" });
    }
...
function deserializeAiAgentBasicTextTool(val) {
    ...
    if (!(val.system_message == void 0) && !(0, json_js_2.sdIsString)(val.system_message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"system_message\" of type \"AiAgentBasicTextTool\"" });
    }
    ...
    if (!(val.prompt_template == void 0) && !(0, json_js_2.sdIsString)(val.prompt_template)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prompt_template\" of type \"AiAgentBasicTextTool\"" });
    }
    ...
    if (!(val.model == void 0) && !(0, json_js_2.sdIsString)(val.model)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"model\" of type \"AiAgentBasicTextTool\"" });
    }
    ...
    if (!(val.num_tokens_for_completion == void 0) && !(0, json_js_1.sdIsNumber)(val.num_tokens_for_completion)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"num_tokens_for_completion\" of type \"AiAgentBasicTextTool\"" });
    }
