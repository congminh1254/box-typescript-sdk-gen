...
function deserializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser\"" });
    }
    if (val.type == "app_item") {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser" });
}
