...
function serializeSignRequestSignerSignerDecisionField(val) {
    return {
        ...
        ['finalized_at']: val.finalizedAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.finalizedAt),
        ['additional_info']: val.additionalInfo == void 0 ? void 0 : val.additionalInfo,
    };
}
...
function serializeSignRequestSigner(val) {
    ...
    return Object.assign(Object.assign({}, base), {
        ['has_viewed_document']: val.hasViewedDocument == void 0 ? void 0 : val.hasViewedDocument,
        ...
        ['iframeable_embed_url']: val.iframeableEmbedUrl == void 0 ? void 0 : val.iframeableEmbedUrl,
    });
}
