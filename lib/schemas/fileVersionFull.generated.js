...
function deserializeFileVersionFull(val) {
    ...
    if (!(val.version_number == void 0) && !(0, json_js_2.sdIsString)(val.version_number)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"version_number\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"FileVersionFull\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.size == void 0) && !(0, json_js_1.sdIsNumber)(val.size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"size\" of type \"FileVersionFull\"" });
    }
    const size = val.size == void 0 ? void 0 : val.size;
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !(0, json_js_2.sdIsString)(val.trashed_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.restored_at == void 0) && !(0, json_js_2.sdIsString)(val.restored_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"restored_at\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !(0, json_js_2.sdIsString)(val.purged_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.uploader_display_name == void 0) && !(0, json_js_2.sdIsString)(val.uploader_display_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"uploader_display_name\" of type \"FileVersionFull\"" });
    }
    ...
    if (!(val.sha1 == void 0) && !(0, json_js_2.sdIsString)(val.sha1)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"sha1\" of type \"FileVersionFull\"" });
    }
    const sha1 = val.sha1 == void 0 ? void 0 : val.sha1;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"FileVersionFull\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"FileVersionFull\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"FileVersionFull\" to be defined" });
    }
