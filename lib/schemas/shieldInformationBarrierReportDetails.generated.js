...
function deserializeShieldInformationBarrierReportDetailsDetailsField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReportDetailsDetailsField\"" });
    }
    if (!(val.folder_id == void 0) && !(0, json_js_1.sdIsString)(val.folder_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"ShieldInformationBarrierReportDetailsDetailsField\"" });
    }
...
function deserializeShieldInformationBarrierReportDetails(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReportDetails\"" });
    }
