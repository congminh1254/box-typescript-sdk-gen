...
function deserializeTemplateSignerInputTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TemplateSignerInputTypeField" });
}
...
function deserializeTemplateSignerInputContentTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize TemplateSignerInputContentTypeField" });
}
...
function deserializeTemplateSignerInputCoordinatesField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TemplateSignerInputCoordinatesField\"" });
    }
    if (!(val.x == void 0) && !(0, json_js_2.sdIsNumber)(val.x)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"x\" of type \"TemplateSignerInputCoordinatesField\"" });
    }
    const x = val.x == void 0 ? void 0 : val.x;
    if (!(val.y == void 0) && !(0, json_js_2.sdIsNumber)(val.y)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"y\" of type \"TemplateSignerInputCoordinatesField\"" });
    }
...
function deserializeTemplateSignerInputDimensionsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TemplateSignerInputDimensionsField\"" });
    }
    if (!(val.width == void 0) && !(0, json_js_2.sdIsNumber)(val.width)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"width\" of type \"TemplateSignerInputDimensionsField\"" });
    }
    const width = val.width == void 0 ? void 0 : val.width;
    if (!(val.height == void 0) && !(0, json_js_2.sdIsNumber)(val.height)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"height\" of type \"TemplateSignerInputDimensionsField\"" });
    }
...
function serializeTemplateSignerInput(val) {
    ...
    if (!(0, json_js_5.sdIsMap)(base)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TemplateSignerInput\"" });
    }
    return Object.assign(Object.assign({}, base), { ["type"]: val.type == void 0 ? val.type : serializeTemplateSignerInputTypeField(val.type), ["content_type"]: val.contentType == void 0 ? val.contentType : serializeTemplateSignerInputContentTypeField(val.contentType), ["is_required"]: val.isRequired, ["page_index"]: val.pageIndex, ["document_id"]: val.documentId, ["dropdown_choices"]: val.dropdownChoices == void 0 ? val.dropdownChoices : val.dropdownChoices.map(function (item) {
            return item;
        }), ["group_id"]: val.groupId, ["coordinates"]: val.coordinates == void 0 ? val.coordinates : serializeTemplateSignerInputCoordinatesField(val.coordinates), ["dimensions"]: val.dimensions == void 0 ? val.dimensions : serializeTemplateSignerInputDimensionsField(val.dimensions), ["label"]: val.label, ["read_only"]: val.readOnly });
}
function deserializeTemplateSignerInput(val) {
    ...
    if (!(val.is_required == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_required)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_required\" of type \"TemplateSignerInput\"" });
    }
    const isRequired = val.is_required == void 0 ? void 0 : val.is_required;
    if (val.page_index == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"page_index\" of type \"TemplateSignerInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsNumber)(val.page_index)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"page_index\" of type \"TemplateSignerInput\"" });
    }
    const pageIndex = val.page_index;
    if (!(val.document_id == void 0) && !(0, json_js_3.sdIsString)(val.document_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"document_id\" of type \"TemplateSignerInput\"" });
    }
    ...
    if (!(val.dropdown_choices == void 0) && !(0, json_js_4.sdIsList)(val.dropdown_choices)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"dropdown_choices\" of type \"TemplateSignerInput\"" });
    }
    const dropdownChoices = val.dropdown_choices == void 0 ? void 0 : (0, json_js_4.sdIsList)(val.dropdown_choices) ? val.dropdown_choices.map(function (itm) {
        if (!(0, json_js_3.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"TemplateSignerInput\"" });
        }
        return itm;
    }) : [];
    if (!(val.group_id == void 0) && !(0, json_js_3.sdIsString)(val.group_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"group_id\" of type \"TemplateSignerInput\"" });
    }
    ...
    if (!(val.label == void 0) && !(0, json_js_3.sdIsString)(val.label)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"label\" of type \"TemplateSignerInput\"" });
    }
    const label = val.label == void 0 ? void 0 : val.label;
    if (!(val.read_only == void 0) && !(0, json_js_1.sdIsBoolean)(val.read_only)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"read_only\" of type \"TemplateSignerInput\"" });
    }
    ...
    if (!(val.document_tag_id == void 0) && !(0, json_js_3.sdIsString)(val.document_tag_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"document_tag_id\" of type \"TemplateSignerInput\"" });
    }
    ...
    if (!(val.text_value == void 0) && !(0, json_js_3.sdIsString)(val.text_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text_value\" of type \"TemplateSignerInput\"" });
    }
    ...
    if (!(val.checkbox_value == void 0) && !(0, json_js_1.sdIsBoolean)(val.checkbox_value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"checkbox_value\" of type \"TemplateSignerInput\"" });
    }
