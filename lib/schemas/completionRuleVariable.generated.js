...
function deserializeCompletionRuleVariableTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CompletionRuleVariableTypeField" });
}
...
function deserializeCompletionRuleVariableVariableTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CompletionRuleVariableVariableTypeField" });
}
...
function deserializeCompletionRuleVariableVariableValueField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CompletionRuleVariableVariableValueField" });
}
...
function deserializeCompletionRuleVariable(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CompletionRuleVariable\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CompletionRuleVariable\" to be defined" });
    }
    const type = deserializeCompletionRuleVariableTypeField(val.type);
    if (val.variable_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_type\" of type \"CompletionRuleVariable\" to be defined" });
    }
    const variableType = deserializeCompletionRuleVariableVariableTypeField(val.variable_type);
    if (val.variable_value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_value\" of type \"CompletionRuleVariable\" to be defined" });
    }
...
function deserializeCompletionRuleVariableInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CompletionRuleVariableInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCompletionRuleVariableTypeField(val.type);
    const variableType = val.variableType == void 0 ? void 0 : deserializeCompletionRuleVariableVariableTypeField(val.variableType);
    if (val.variable_value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"variable_value\" of type \"CompletionRuleVariableInput\" to be defined" });
    }
    const variableValue = deserializeCompletionRuleVariableVariableValueField(val.variable_value);
    return { type: type, variableType: variableType, variableValue: variableValue };
}
