...
function deserializeRetentionPolicyBaseTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize RetentionPolicyBaseTypeField" });
}
...
function deserializeRetentionPolicyBase(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyBase\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyBase\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyBase\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicyBase\" to be defined" });
    }
...
function deserializeRetentionPolicyBaseInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RetentionPolicyBaseInput\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyBaseInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyBaseInput\"" });
    }
    const id = val.id;
    const type = val.type == void 0 ? void 0 : deserializeRetentionPolicyBaseTypeField(val.type);
    return { id: id, type: type };
}
