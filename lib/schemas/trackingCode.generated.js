...
function deserializeTrackingCode(val) {
    ...
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"TrackingCode\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.value == void 0) && !(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"TrackingCode\"" });
    }
