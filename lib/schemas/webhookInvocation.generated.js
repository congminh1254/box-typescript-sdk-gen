...
function deserializeWebhookInvocationTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebhookInvocationTypeField" });
}
...
function deserializeWebhookInvocationTriggerField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize WebhookInvocationTriggerField" });
}
function serializeWebhookInvocation(val) {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeWebhookInvocationTypeField(val.type), ["webhook"]: val.webhook == void 0 ? val.webhook : (0, webhook_generated_js_1.serializeWebhook)(val.webhook), ["created_by"]: val.createdBy == void 0 ? val.createdBy : (0, userMini_generated_js_1.serializeUserMini)(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : (0, utils_js_1.serializeDateTime)(val.createdAt), ["trigger"]: val.trigger == void 0 ? val.trigger : serializeWebhookInvocationTriggerField(val.trigger), ["source"]: val.source == void 0 ? val.source : (0, fileOrFolder_generated_js_1.serializeFileOrFolder)(val.source) };
}
function deserializeWebhookInvocation(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"WebhookInvocation\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"WebhookInvocation\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_1.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WebhookInvocation\"" });
    }
