...
function deserializeMetadataFieldFilterFloatRange(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"MetadataFieldFilterFloatRange\"" });
    }
    if (!(val.lt == void 0) && !(0, json_js_1.sdIsNumber)(val.lt)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"lt\" of type \"MetadataFieldFilterFloatRange\"" });
    }
    const lt = val.lt == void 0 ? void 0 : val.lt;
    if (!(val.gt == void 0) && !(0, json_js_1.sdIsNumber)(val.gt)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"gt\" of type \"MetadataFieldFilterFloatRange\"" });
    }
