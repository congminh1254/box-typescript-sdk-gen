...
function deserializeGroupFullInvitabilityLevelField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupFullInvitabilityLevelField" });
}
...
function deserializeGroupFullMemberViewabilityLevelField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GroupFullMemberViewabilityLevelField" });
}
...
function deserializeGroupFullPermissionsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"GroupFullPermissionsField\"" });
    }
    if (!(val.can_invite_as_collaborator == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_invite_as_collaborator)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_invite_as_collaborator\" of type \"GroupFullPermissionsField\"" });
    }
    const canInviteAsCollaborator = val.can_invite_as_collaborator == void 0 ? void 0 : val.can_invite_as_collaborator;
...
function deserializeGroupFull(val) {
    ...
    if (!(val.provenance == void 0) && !(0, json_js_2.sdIsString)(val.provenance)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"provenance\" of type \"GroupFull\"" });
    }
    const provenance = val.provenance == void 0 ? void 0 : val.provenance;
    if (!(val.external_sync_identifier == void 0) && !(0, json_js_2.sdIsString)(val.external_sync_identifier)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"external_sync_identifier\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.created_at == void 0) && !(0, json_js_2.sdIsString)(val.created_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"created_at\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.modified_at == void 0) && !(0, json_js_2.sdIsString)(val.modified_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"GroupFull\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    const groupType = val.group_type == void 0 ? void 0 : (0, groupMini_generated_js_1.deserializeGroupMiniGroupTypeField)(val.group_type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"GroupFull\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupFull\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"GroupFull\" to be defined" });
    }
