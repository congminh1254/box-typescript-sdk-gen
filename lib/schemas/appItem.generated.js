...
function deserializeAppItem(val) {
    ...
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"AppItem\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"AppItem\"" });
    }
    const id = val.id;
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"AppItem\" to be defined" });
    }
    const type = deserializeAppItemTypeField(val.type);
    if (val.application_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"application_type\" of type \"AppItem\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.application_type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"application_type\" of type \"AppItem\"" });
    }
    const applicationType = val.application_type;
    return { id: id, type: type, applicationType: applicationType };
}
...
function deserializeAppItemInput(val) {
    ...
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"AppItemInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"AppItemInput\"" });
    }
    const id = val.id;
    const type = val.type == void 0 ? void 0 : deserializeAppItemTypeField(val.type);
    if (val.application_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"application_type\" of type \"AppItemInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.application_type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"application_type\" of type \"AppItemInput\"" });
    }
    const applicationType = val.application_type;
    return { id: id, type: type, applicationType: applicationType };
}
