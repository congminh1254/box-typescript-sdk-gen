...
function serializeAiExtract(val) {
    return { ["prompt"]: val.prompt, ["items"]: val.items.map(function (item) {
        ...
        }), ["ai_agent"]: val.aiAgent == void 0 ? val.aiAgent : (0, aiAgentExtract_generated_js_1.serializeAiAgentExtract)(val.aiAgent) };
}
function deserializeAiExtract(val) {
    ...
    if (val.prompt == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"prompt\" of type \"AiExtract\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.prompt)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"prompt\" of type \"AiExtract\"" });
    }
    const prompt = val.prompt;
    if (val.items == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"items\" of type \"AiExtract\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.items)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"items\" of type \"AiExtract\"" });
    }
