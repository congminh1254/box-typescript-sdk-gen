...
exports.Hash = exports.DateTime = exports.Date = exports.ByteStream = exports.Buffer = void 0;
...
function generateByteStreamFromBuffer(buffer) {
    return isBrowser()
        ...
        : eval('require')('stream').Readable.from(buffer_1.Buffer.from(buffer));
}
function readableStreamToNodeReadable(stream) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (done) {
                        ...
                        this.push(buffer_1.Buffer.from(value)); // Push the chunk
                    }
                }
                catch (error) {
...
function decodeBase64ByteStream(data) {
    return isBrowser()
        ...
        : eval('require')('stream').Readable.from(buffer_1.Buffer.from(data, 'base64'));
}
function stringToByteStream(data) {
    return isBrowser()
        ...
        : eval('require')('stream').Readable.from(buffer_1.Buffer.from(data, 'ascii'));
}
