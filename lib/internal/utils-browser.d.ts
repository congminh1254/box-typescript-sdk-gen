...
export declare function isBrowser(): false | globalThis.Crypto;
...
export declare function generateByteStreamFromBuffer(buffer: Buffer | ArrayBuffer): Promise<ReadableStream>;
export declare function generateByteStream(size: number): Promise<ReadableStream<Uint8Array>>;
