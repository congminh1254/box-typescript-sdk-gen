...
test("testLegalHoldPolicyAssignments", function testLegalHoldPolicyAssignments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const legalHoldPolicyAssignment = yield exports.client.legalHoldPolicyAssignments.createLegalHoldPolicyAssignment({ policyId: legalHoldPolicyId, assignTo: { type: "file", id: fileId } });
        if (!((0, utils_js_2.toString)(legalHoldPolicyAssignment.legalHoldPolicy.type) == "legal_hold_policy")) {
        ...
        const legalPolicyAssignments = yield exports.client.legalHoldPolicyAssignments.getLegalHoldPolicyAssignments({ policyId: legalHoldPolicyId });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.legalHoldPolicyAssignments.deleteLegalHoldPolicyAssignmentById(legalHoldPolicyAssignmentId); })).rejects.toThrow();
