...
test("testUploadFileAndFileVersion", function testUploadFileAndFileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const uploadedFilesVersion = yield exports.client.uploads.uploadFileVersion(uploadedFile.id, { attributes: { name: newFileVersionName }, file: newFileContentStream });
...
test("testRequestCancellation", function testRequestCancellation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.uploads.uploadFile({ attributes: { name: fileName, parent: { id: "0" } }, file: fileByteStream }, { queryParams: {}, headers: new uploads_generated_js_1.UploadFileHeaders({}), cancellationToken: cancellationToken }); })).rejects.toThrow();
    });
});
