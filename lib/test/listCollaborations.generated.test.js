...
test("testListCollaborations", function testListCollaborations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const group = yield client.groups.createGroup({ name: (0, utils_js_1.getUuid)() });
        const groupCollaboration = yield client.userCollaborations.createCollaboration({ item: { type: "folder", id: folder.id }, accessibleBy: { type: "group", id: group.id }, role: "editor" });
        const fileCollaboration = yield client.userCollaborations.createCollaboration({ item: { type: "file", id: file.id }, accessibleBy: { type: "user", id: (0, utils_js_2.getEnvVar)("USER_ID") }, role: "editor" });
        ...
        const pendingCollaborations = yield client.listCollaborations.getCollaborations({ status: "pending" });
