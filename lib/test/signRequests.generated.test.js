...
test("testCreateGetCancelAndListSignRequest", function testCreateGetCancelAndListSignRequest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createdSignRequest = yield exports.client.signRequests.createSignRequest({ signers: [{ email: signerEmail, suppressNotifications: true, declinedRedirectUrl: "https://www.box.com", embedUrlExternalUserId: "123", isInPerson: false, loginRequired: false, password: "password", role: "signer" }], areRemindersEnabled: true, areTextSignaturesEnabled: true, daysValid: 30, declinedRedirectUrl: "https://www.box.com", emailMessage: "Please sign this document", emailSubject: "Sign this document", externalId: "123", externalSystemName: "BoxSignIntegration", isDocumentPreparationNeeded: false, name: "Sign Request", parentFolder: new folderMini_generated_js_1.FolderMini({ id: destinationFolder.id }), redirectUrl: "https://www.box.com", prefillTags: [{ dateValue: (0, utils_js_2.dateFromString)("2035-01-01"), documentTagId: "0" }], sourceFiles: [new fileBase_generated_js_1.FileBase({ id: fileToSign.id })] });
        ...
        if (!(createdSignRequest.signers[1].declinedRedirectUrl == "https://www.box.com")) {
            throw new Error("Assertion failed");
        }
        ...
        if (!((0, utils_js_3.dateToString)(createdSignRequest.prefillTags[0].dateValue) == "2035-01-01")) {
            throw new Error("Assertion failed");
        }
        ...
        yield exports.client.folders.deleteFolderById(destinationFolder.id, { queryParams: { recursive: true } });
...
test("testCreateSignRequestWithSignerGroupId", function testCreateSignRequestWithSignerGroupId() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileToSign = yield (0, commons_generated_js_1.uploadNewFile)();
        const destinationFolder = yield (0, commons_generated_js_2.createNewFolder)();
        const createdSignRequest = yield exports.client.signRequests.createSignRequest({ signers: [{ email: signer1Email, signerGroupId: "user" }, { email: signer2Email, signerGroupId: "user" }], parentFolder: new folderMini_generated_js_1.FolderMini({ id: destinationFolder.id }), sourceFiles: [new fileBase_generated_js_1.FileBase({ id: fileToSign.id })] });
        ...
        if (!(createdSignRequest.signers[1].signerGroupId == createdSignRequest.signers[2].signerGroupId)) {
            throw new Error("Assertion failed");
        }
        yield exports.client.folders.deleteFolderById(destinationFolder.id, { queryParams: { recursive: true } });
        yield exports.client.files.deleteFileById(fileToSign.id);
