...
test("testMetadataCascadePolicies", function testMetadataCascadePolicies() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exports.client.metadataTemplates.createMetadataTemplate({ scope: "enterprise", displayName: templateKey, templateKey: templateKey, fields: [{ type: "string", key: "testName", displayName: "testName" }] });
        const folder = yield (0, commons_generated_js_2.createNewFolder)();
        const enterpriseId = (0, utils_js_2.getEnvVar)("ENTERPRISE_ID");
        const cascadePolicy = yield exports.client.metadataCascadePolicies.createMetadataCascadePolicy({ folderId: folder.id, scope: "enterprise", templateKey: templateKey });
        ...
        if (!((0, utils_js_3.toString)(cascadePolicy.scope) == "".concat("enterprise_", enterpriseId))) {
            throw new Error("Assertion failed");
        }
        ...
        const policies = yield exports.client.metadataCascadePolicies.getMetadataCascadePolicies({ folderId: folder.id });
        if (!(policies.entries.length == 1)) {
            throw new Error("Assertion failed");
        }
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.metadataCascadePolicies.applyMetadataCascadePolicy(cascadePolicyId, { conflictResolution: "overwrite" }); })).rejects.toThrow();
        yield exports.client.folderMetadata.createFolderMetadataById(folder.id, "enterprise", templateKey, { ["testName"]: "xyz" });
        yield exports.client.metadataCascadePolicies.applyMetadataCascadePolicy(cascadePolicyId, { conflictResolution: "overwrite" });
        yield exports.client.metadataCascadePolicies.deleteMetadataCascadePolicyById(cascadePolicyId);
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.metadataCascadePolicies.getMetadataCascadePolicyById(cascadePolicyId); })).rejects.toThrow();
