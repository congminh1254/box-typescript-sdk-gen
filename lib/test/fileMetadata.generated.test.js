...
test("testGlobalFileMetadata", function testGlobalFileMetadata() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newValue = "bar";
        yield exports.client.fileMetadata.updateFileMetadataById(file.id, "global", "properties", [{ op: "replace", path: "/abc", value: newValue }]);
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.fileMetadata.getFileMetadataById(file.id, "global", "properties"); })).rejects.toThrow();
