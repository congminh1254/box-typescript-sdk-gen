...
test("testTrashedFolders", function testTrashedFolders() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.folders.getFolderById(folder.id); })).rejects.toThrow();
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.trashedFolders.getTrashedFolderById(folder.id); })).rejects.toThrow();
    });
});
