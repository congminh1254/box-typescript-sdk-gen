...
function getOrCreateSecondClassification(classificationTemplateInput) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentNumberOfClassifications == 1) {
            const classificationTemplateWithNewClassification = yield exports.client.classifications.addClassification([new classifications_generated_js_1.AddClassificationRequestBody({ data: { key: (0, utils_js_1.getUuid)(), staticConfig: { classification: { colorId: 4, classificationDefinition: "Other description" } } } })]);
...
test("testFolderClassifications", function testFolderClassifications() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.folderClassifications.getClassificationOnFolder(folder.id); })).rejects.toThrow();
        const createdFolderClassification = yield exports.client.folderClassifications.addClassificationToFolder(folder.id, { requestBody: { boxSecurityClassificationKey: classification.key } });
        ...
        const updatedFolderClassification = yield exports.client.folderClassifications.updateClassificationOnFolder(folder.id, [new folderClassifications_generated_js_1.UpdateClassificationOnFolderRequestBody({ value: secondClassification.key })]);
