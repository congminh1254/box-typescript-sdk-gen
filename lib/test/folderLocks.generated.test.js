...
test("testFolderLocks", function testFolderLocks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const folderLocks = yield exports.client.folderLocks.getFolderLocks({ folderId: folder.id });
        if (!(folderLocks.entries.length == 0)) {
            throw new Error("Assertion failed");
        }
        const folderLock = yield exports.client.folderLocks.createFolderLock({ folder: { id: folder.id, type: "folder" }, lockedOperations: { move: true, delete: true } });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.folderLocks.deleteFolderLockById(folderLock.id); })).rejects.toThrow();
        const newFolderLocks = yield exports.client.folderLocks.getFolderLocks({ folderId: folder.id });
