...
test("testCollections", function testCollections() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exports.client.folders.updateFolderById(folder.id, { requestBody: { collections: [{ id: favouriteCollection.id }] } });
        ...
        yield exports.client.folders.updateFolderById(folder.id, { requestBody: { collections: [] } });
