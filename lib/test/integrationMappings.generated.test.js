...
test("testIntegrationMappings", function testIntegrationMappings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield userClient.integrationMappings.createSlackIntegrationMapping({ partnerItem: new integrationMappingPartnerItemSlack_generated_js_1.IntegrationMappingPartnerItemSlack({ id: partnerItemId, slackOrgId: slackOrgId }), boxItem: new integrationMappingBoxItemSlack_generated_js_1.IntegrationMappingBoxItemSlack({ id: folder.id }) }); })).rejects.toThrow();
