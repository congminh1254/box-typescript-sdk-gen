...
test("testComments", function testComments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parentId = "0";
        const uploadedFiles = yield exports.client.uploads.uploadFile({ attributes: { name: fileName, parent: { id: parentId } }, file: fileByteStream });
        ...
        const newComment = yield exports.client.comments.createComment({ message: message, item: { id: fileId, type: "file" } });
        ...
        const newReplyComment = yield exports.client.comments.createComment({ message: message, item: { id: newComment.id, type: "comment" } });
        ...
        const newMessage = "Hi!";
        yield exports.client.comments.updateCommentById(newReplyComment.id, { requestBody: { message: newMessage } });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.comments.getCommentById(newComment.id); })).rejects.toThrow();
