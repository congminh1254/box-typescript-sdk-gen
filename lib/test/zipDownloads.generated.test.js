...
test("testZipDownload", function testZipDownload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const zipStream = yield exports.client.zipDownloads.downloadZip({ items: [{ id: file1.id, type: "file" }, { id: file2.id, type: "file" }, { id: folder1.id, type: "folder" }], downloadFileName: "zip" });
        if (!((0, utils_js_1.bufferEquals)(yield (0, utils_js_2.readByteStream)(zipStream), (0, utils_js_3.generateByteBuffer)(10)) == false)) {
...
test("testManualZipDownloadAndCheckStatus", function testManualZipDownloadAndCheckStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const file2 = yield (0, commons_generated_js_2.uploadNewFile)();
        const folder1 = yield (0, commons_generated_js_3.createNewFolder)();
        const zipDownload = yield exports.client.zipDownloads.createZipDownload({ items: [{ id: file1.id, type: "file" }, { id: file2.id, type: "file" }, { id: folder1.id, type: "folder" }], downloadFileName: "zip" });
