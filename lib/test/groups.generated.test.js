...
test("test_create_get_delete_group", function test_create_get_delete_group() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const group = yield exports.client.groups.createGroup({ name: groupName, description: groupDescription });
        if (!(group.name == groupName)) {
            throw new Error("Assertion failed");
        }
        const groupById = yield exports.client.groups.getGroupById(group.id, { queryParams: { fields: ["id", "name", "description", "group_type"] } });
        ...
        const updatedGroup = yield exports.client.groups.updateGroupById(group.id, { requestBody: { name: updatedGroupName } });
        if (!(updatedGroup.name == updatedGroupName)) {
            throw new Error("Assertion failed");
        }
        yield exports.client.groups.deleteGroupById(group.id);
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.groups.getGroupById(group.id); })).rejects.toThrow();
    });
});
