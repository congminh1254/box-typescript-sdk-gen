...
test("testCollaborationAllowlistEntries", function testCollaborationAllowlistEntries() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newEntry = yield exports.client.collaborationAllowlistEntries.createCollaborationWhitelistEntry({ direction: "inbound", domain: domain });
        ...
        if (!((0, utils_js_2.toString)(entry.direction) == (0, utils_js_2.toString)(newEntry.direction))) {
            throw new Error("Assertion failed");
        }
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.collaborationAllowlistEntries.getCollaborationWhitelistEntryById(entry.id); })).rejects.toThrow();
    });
});
