...
test("testCreateListGetPromoteFileVersion", function testCreateListGetPromoteFileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = yield exports.client.uploads.uploadFile({ attributes: { name: oldName, parent: { id: "0" } }, file: (0, utils_js_2.generateByteStream)(10) });
        ...
        const newFiles = yield exports.client.uploads.uploadFileVersion(file.id, { attributes: { name: newName }, file: (0, utils_js_2.generateByteStream)(20) });
        ...
        yield exports.client.fileVersions.promoteFileVersion(file.id, { requestBody: { id: fileVersions.entries[0].id, type: "file_version" } });
...
test("testRemoveAndRestoreFileVersion", function testRemoveAndRestoreFileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = yield exports.client.uploads.uploadFile({ attributes: { name: oldName, parent: { id: "0" } }, file: (0, utils_js_2.generateByteStream)(10) });
        const file = files.entries[0];
        yield exports.client.uploads.uploadFileVersion(file.id, { attributes: { name: newName }, file: (0, utils_js_2.generateByteStream)(20) });
        const fileVersions = yield exports.client.fileVersions.getFileVersions(file.id);
        if (!(fileVersions.totalCount == 1)) {
            throw new Error("Assertion failed");
        }
        const fileVersion = yield exports.client.fileVersions.getFileVersionById(file.id, fileVersions.entries[0].id, { queryParams: { fields: ["trashed_at", "trashed_by", "restored_at", "restored_by"] } });
        ...
        yield exports.client.fileVersions.deleteFileVersionById(file.id, fileVersion.id);
        const deletedFileVersion = yield exports.client.fileVersions.getFileVersionById(file.id, fileVersions.entries[0].id, { queryParams: { fields: ["trashed_at", "trashed_by", "restored_at", "restored_by"] } });
        ...
        yield exports.client.fileVersions.updateFileVersionById(file.id, fileVersion.id, { requestBody: { trashedAt: (0, utils_js_3.createNull)() } });
        const restoredFileVersion = yield exports.client.fileVersions.getFileVersionById(file.id, fileVersions.entries[0].id, { queryParams: { fields: ["trashed_at", "trashed_by", "restored_at", "restored_by"] } });
