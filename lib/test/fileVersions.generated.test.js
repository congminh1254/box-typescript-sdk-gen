...
test('testCreateListGetRestoreDeleteFileVersion', function testCreateListGetRestoreDeleteFileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileRestored = yield exports.client.files.getFileById(file.id);
        ...
        const fileVersionsRestored = yield exports.client.fileVersions.getFileVersions(file.id);
        yield exports.client.fileVersions.deleteFileVersionById(file.id, fileVersionsRestored.entries[0].id);
        yield exports.client.fileVersions.getFileVersions(file.id);
