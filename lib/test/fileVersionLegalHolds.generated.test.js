...
test("testGetFileVersionLegalHolds", function testGetFileVersionLegalHolds() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileVersionLegalHolds = yield exports.client.fileVersionLegalHolds.getFileVersionLegalHolds({ policyId: policyId });
...
test("testGetFileVersionLegalHoldById", function testGetFileVersionLegalHoldById() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.fileVersionLegalHolds.getFileVersionLegalHoldById(fileVersionLegalHoldId); })).rejects.toThrow();
    });
});
