...
test("test_get_folder_full_info_with_extra_fields", function test_get_folder_full_info_with_extra_fields() {
    return __awaiter(this, void 0, void 0, function* () {
        const rootFolder = yield exports.client.folders.getFolderById("0", { queryParams: { fields: ["has_collaborations", "tags"] } });
        if (!(rootFolder.id == "0")) {
            throw new Error("Assertion failed");
        }
...
test("test_create_and_delete_folder", function test_create_and_delete_folder() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.folders.getFolderById(newFolder.id); })).rejects.toThrow();
    });
});
test("test_update_folder", function test_update_folder() {
    return __awaiter(this, void 0, void 0, function* () {
        const folderToUpdateName = (0, utils_js_1.getUuid)();
        const folderToUpdate = yield exports.client.folders.createFolder({ name: folderToUpdateName, parent: { id: "0" } });
        const updatedName = (0, utils_js_1.getUuid)();
        const updatedFolder = yield exports.client.folders.updateFolderById(folderToUpdate.id, { requestBody: { name: updatedName, description: "Updated description" } });
...
test("test_copy_move_folder_and_list_folder_items", function test_copy_move_folder_and_list_folder_items() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const folderOrigin = yield exports.client.folders.createFolder({ name: folderOriginName, parent: { id: "0" } });
        const copiedFolderName = (0, utils_js_1.getUuid)();
        const copiedFolder = yield exports.client.folders.copyFolder(folderOrigin.id, { parent: { id: "0" }, name: copiedFolderName });
        if (!(copiedFolder.parent.id == "0")) {
            throw new Error("Assertion failed");
        }
        const movedFolderName = (0, utils_js_1.getUuid)();
        const movedFolder = yield exports.client.folders.updateFolderById(copiedFolder.id, { requestBody: { parent: { id: folderOrigin.id }, name: movedFolderName } });
