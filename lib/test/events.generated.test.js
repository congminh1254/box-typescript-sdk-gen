...
test("testEventUpload", function testEventUpload() {
    return __awaiter(this, void 0, void 0, function* () {
        const events = yield exports.client.events.getEvents({ streamType: "admin_logs", eventType: ["UPLOAD"] });
        if (!(events.entries.length > 0)) {
            throw new Error("Assertion failed");
        }
        const firstEvent = events.entries[0];
        ...
        if (!((0, utils_js_2.toString)(source.itemType) == "file" || (0, utils_js_2.toString)(source.itemType) == "folder")) {
            throw new Error("Assertion failed");
        }
        if (!!(source.itemId == "")) {
            throw new Error("Assertion failed");
...
test("testEventDeleteUser", function testEventDeleteUser() {
    return __awaiter(this, void 0, void 0, function* () {
        const events = yield exports.client.events.getEvents({ streamType: "admin_logs", eventType: ["DELETE_USER"] });
        if (!(events.entries.length > 0)) {
            throw new Error("Assertion failed");
        }
        const firstEvent = events.entries[0];
...
test("testEventSourceFileOrFolder", function testEventSourceFileOrFolder() {
    return __awaiter(this, void 0, void 0, function* () {
        const events = yield exports.client.events.getEvents({ streamType: "changes" });
        if (!(events.entries.length > 0)) {
            throw new Error("Assertion failed");
        }
        const firstEvent = events.entries[0];
        const source = firstEvent.source;
        if (!((0, utils_js_2.toString)(source.type) == "file" || (0, utils_js_2.toString)(source.type) == "folder")) {
            throw new Error("Assertion failed");
        }
        if (!!(source.id == "")) {
            throw new Error("Assertion failed");
...
test("testGetEventsWithDateFilters", function testGetEventsWithDateFilters() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const servers = yield exports.client.events.getEvents({ streamType: "admin_logs", limit: 1, createdAfter: createdAfterDate, createdBefore: createdBeforeDate });
