...
test('testEvents', function testEvents() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!((0, utils_js_2.toString)(event.createdBy.type) == 'user')) {
            throw new Error('Assertion failed');
        }
        if (!!((0, utils_js_2.toString)(event.eventType) == '')) {
            throw new Error('Assertion failed');
        }
    });
});
test('testEventUpload', function testEventUpload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const event = events.entries[0];
        if (!((0, utils_js_2.toString)(event.eventType) == 'UPLOAD')) {
            throw new Error('Assertion failed');
        }
...
test('testEventDeleteUser', function testEventDeleteUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const event = events.entries[0];
        if (!((0, utils_js_2.toString)(event.eventType) == 'DELETE_USER')) {
            throw new Error('Assertion failed');
        }
        const source = event.source;
