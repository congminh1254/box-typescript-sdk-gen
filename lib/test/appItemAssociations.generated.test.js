...
test("testListFileAppItemAssocations", function testListFileAppItemAssocations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const file = yield client.files.getFileById(fileId, { queryParams: { fields: ["is_associated_with_app_item"] } });
...
test("testListFolderAppItemAssocations", function testListFolderAppItemAssocations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const folder = yield client.folders.getFolderById(folderId, { queryParams: { fields: ["is_associated_with_app_item"] } });
