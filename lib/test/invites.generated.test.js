...
test("testInvites", function testInvites() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const currentUser = yield client.users.getUserMe({ fields: ["enterprise"] });
        const email = (0, utils_js_1.getEnvVar)("BOX_EXTERNAL_USER_EMAIL");
        const invitation = yield client.invites.createInvite({ enterprise: { id: currentUser.enterprise.id }, actionableBy: { login: email } });
