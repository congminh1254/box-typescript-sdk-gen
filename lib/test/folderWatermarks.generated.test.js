...
test("testCreateGetDeleteFolderWatermark", function testCreateGetDeleteFolderWatermark() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const folder = yield exports.client.folders.createFolder({ name: folderName, parent: { id: "0" } });
        const createdWatermark = yield exports.client.folderWatermarks.updateFolderWatermark(folder.id, { watermark: new folderWatermarks_generated_js_1.UpdateFolderWatermarkRequestBodyWatermarkField({ imprint: "default" }) });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.folderWatermarks.getFolderWatermark(folder.id); })).rejects.toThrow();
