...
test("test_change_download_url_with_interceptor", function test_change_download_url_with_interceptor() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function afterRequest(response) {
            return { url: response.url, status: response.status, data: response.data, content: response.content, headers: Object.assign(Object.assign({}, response.headers), { ["location"]: "fake_location" }) };
        }
        const clientWithInterceptor = exports.client.withInterceptors([{ beforeRequest: emptyBeforeRequest, afterRequest: afterRequest }]);
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield clientWithInterceptor.downloads.downloadFile(uploadedFile.id); })).rejects.toThrow();
        yield exports.client.files.deleteFileById(uploadedFile.id);
    });
});
