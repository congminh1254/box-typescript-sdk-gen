...
function reducerById(accInput, chunk) {
    return __awaiter(this, void 0, void 0, function* () {
        const acc = new TestPartAccumulator({ lastIndex: accInput.lastIndex, parts: accInput.parts, fileSize: accInput.fileSize, uploadPartUrl: accInput.uploadPartUrl, uploadSessionId: accInput.uploadSessionId, fileHash: accInput.fileHash });
        ...
        const uploadedPart = yield exports.client.chunkedUploads.uploadFilePart(acc.uploadSessionId, (0, utils_js_1.generateByteStreamFromBuffer)(chunkBuffer), { digest: digest, contentRange: contentRange });
...
function reducerByUrl(accInput, chunk) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const bytesEnd = lastIndex + chunkSize;
        const contentRange = "".concat("bytes ", (0, utils_js_10.toString)(bytesStart), "-", (0, utils_js_10.toString)(bytesEnd), "/", (0, utils_js_10.toString)(acc.fileSize));
        const uploadedPart = yield exports.client.chunkedUploads.uploadFilePartByUrl(acc.uploadPartUrl, (0, utils_js_1.generateByteStreamFromBuffer)(chunkBuffer), { digest: digest, contentRange: contentRange });
        const part = uploadedPart.part;
        const partSha1 = (0, utils_js_2.hexToBase64)(part.sha1);
        if (!(partSha1 == sha1)) {
            throw new Error("Assertion failed");
...
test("testChunkedManualProcessById", function testChunkedManualProcessById() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const uploadSession = yield exports.client.chunkedUploads.createFileUploadSession({ fileName: fileName, fileSize: fileSize, folderId: parentFolderId });
        ...
        const results = yield (0, utils_js_5.reduceIterator)(chunksIterator, reducerById, new TestPartAccumulator({ lastIndex: -1, parts: [], fileSize: fileSize, uploadSessionId: uploadSessionId, fileHash: fileHash }));
...
test("testChunkedManualProcessByUrl", function testChunkedManualProcessByUrl() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileHash = new utils_js_6.Hash({ algorithm: "sha1" });
        const chunksIterator = (0, utils_js_3.iterateChunks)(fileByteStream, partSize, fileSize);
        const results = yield (0, utils_js_5.reduceIterator)(chunksIterator, reducerByUrl, new TestPartAccumulator({ lastIndex: -1, parts: [], fileSize: fileSize, uploadPartUrl: uploadPartUrl, fileHash: fileHash }));
        const parts = results.parts;
        ...
        const sha1 = yield fileHash.digestHash("base64");
        const digest = "".concat("sha=", sha1);
        const committedSession = yield exports.client.chunkedUploads.createFileUploadSessionCommitByUrl(commitUrl, { parts: parts }, { digest: digest });
        if (!(committedSession.entries[0].name == fileName)) {
            throw new Error("Assertion failed");
        }
