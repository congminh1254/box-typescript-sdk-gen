...
test('testGetFileThumbnail', function testGetFileThumbnail() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!!((0, utils_js_4.bufferEquals)(yield (0, utils_js_3.readByteStream)(yield exports.client.files.getFileThumbnailById(thumbnailFile.id, 'png')), yield (0, utils_js_3.readByteStream)(thumbnailContentStream)) == true)) {
