...
function uploadFile(fileName, fileStream) {
    return __awaiter(this, void 0, void 0, function* () {
        const uploadedFiles = yield exports.client.uploads.uploadFile({ attributes: { name: fileName, parent: { id: "0" } }, file: fileStream });
...
test("testGetFileFullExtraFields", function testGetFileFullExtraFields() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const file = yield exports.client.files.getFileById(uploadedFile.id, { queryParams: { fields: ["is_externally_owned", "has_collaborations"] } });
...
test("testCreateGetAndDeleteFile", function testCreateGetAndDeleteFile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.files.getFileById(uploadedFile.id, { queryParams: { fields: ["name"] }, headers: new files_generated_js_1.GetFileByIdHeaders({ extraHeaders: { ["if-none-match"]: file.etag } }) }); })).rejects.toThrow();
...
test("testUpdateFile", function testUpdateFile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updatedFile = yield exports.client.files.updateFileById(fileToUpdate.id, { requestBody: { name: updatedName, description: "Updated description" } });
...
test("testFileLock", function testFileLock() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileWithLock = yield exports.client.files.updateFileById(file.id, { requestBody: { lock: { access: "lock" } }, queryParams: { fields: ["lock"] } });
        if (!!(fileWithLock.lock == void 0)) {
            throw new Error("Assertion failed");
        }
        const fileWithoutLock = yield exports.client.files.updateFileById(file.id, { requestBody: { lock: (0, utils_js_5.createNull)() }, queryParams: { fields: ["lock"] } });
...
test("testCopyFile", function testCopyFile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const copiedFile = yield exports.client.files.copyFile(fileOrigin.id, { parent: { id: "0" }, name: copiedFileName });
