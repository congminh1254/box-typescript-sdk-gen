...
test("testMetadataTemplates", function testMetadataTemplates() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const template = yield exports.client.metadataTemplates.createMetadataTemplate({ scope: "enterprise", displayName: templateKey, templateKey: templateKey, fields: [{ type: "string", key: "testName", displayName: "testName" }] });
        ...
        const updatedTemplate = yield exports.client.metadataTemplates.updateMetadataTemplate("enterprise", templateKey, [{ op: "addField", fieldKey: "newfieldname", data: { ["type"]: "string", ["displayName"]: "newFieldName" } }]);
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.metadataTemplates.deleteMetadataTemplate("enterprise", template.templateKey); })).rejects.toThrow();
    });
});
test("testGetMetadataTemplateByInstance", function testGetMetadataTemplateByInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const metadataTemplates = yield exports.client.metadataTemplates.getMetadataTemplatesByInstanceId({ metadataInstanceId: createdMetadataInstance.id });
