...
test("testShieldInformationBarrierSegmentMembers", function testShieldInformationBarrierSegmentMembers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const segment = yield client.shieldInformationBarrierSegments.createShieldInformationBarrierSegment({ shieldInformationBarrier: { id: barrierId, type: "shield_information_barrier" }, name: segmentName });
        if (!(segment.name == segmentName)) {
            throw new Error("Assertion failed");
        }
        const segmentMember = yield client.shieldInformationBarrierSegmentMembers.createShieldInformationBarrierSegmentMember({ shieldInformationBarrierSegment: { id: segment.id, type: "shield_information_barrier_segment" }, user: new userBase_generated_js_1.UserBase({ id: (0, utils_js_1.getEnvVar)("USER_ID") }) });
        ...
        const segmentMembers = yield client.shieldInformationBarrierSegmentMembers.getShieldInformationBarrierSegmentMembers({ shieldInformationBarrierSegmentId: segment.id });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.shieldInformationBarrierSegmentMembers.getShieldInformationBarrierSegmentMemberById(segmentMember.id); })).rejects.toThrow();
