...
function getOrCreateTermsOfServices() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield client.termsOfServices.createTermsOfService({ status: "disabled", tosType: "managed", text: "Test TOS" });
    });
}
function getOrCreateClassification(classificationTemplateInput) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentNumberOfClassifications == 0) {
            const classificationTemplateWithNewClassification = yield client.classifications.addClassification([new classifications_generated_js_1.AddClassificationRequestBody({ data: { key: (0, utils_js_3.getUuid)(), staticConfig: { classification: { colorId: 3, classificationDefinition: "Some description" } } } })]);
...
function getOrCreateClassificationTemplate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return yield client.classifications.createClassificationTemplate({ fields: [new classifications_generated_js_2.CreateClassificationTemplateRequestBodyFieldsField({ options: [] })] });
        }
        finally {
        }
    });
...
function getOrCreateShieldInformationBarrier(clientInput, enterpriseId) {
    return __awaiter(this, void 0, void 0, function* () {
        const client = new client_generated_js_1.BoxClient({ auth: clientInput.auth, networkSession: clientInput.networkSession });
        ...
        if (numberOfBarriers == 0) {
            return yield client.shieldInformationBarriers.createShieldInformationBarrier({ enterprise: { id: enterpriseId } });
        }
