...
function getAccessToken() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ccgConfig = new ccgAuth_generated_js_2.CcgConfig({ clientId: (0, utils_js_2.getEnvVar)("CLIENT_ID"), clientSecret: (0, utils_js_2.getEnvVar)("CLIENT_SECRET"), enterpriseId: enterpriseId, userId: userId });
...
test("test_jwt_auth", function test_jwt_auth() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newUser = yield enterpriseClient.users.getUserMe({ fields: ["enterprise"] });
...
test("test_jwt_auth_downscope", function test_jwt_auth_downscope() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const uploadedFiles = yield parentClient.uploads.uploadFile({ attributes: { name: (0, utils_js_3.getUuid)(), parent: { id: "0" } }, file: (0, utils_js_4.generateByteStream)(1024 * 1024) });
        ...
        const downscopedClient = new client_generated_js_1.BoxClient({ auth: new developerTokenAuth_generated_js_1.BoxDeveloperTokenAuth({ token: downscopedToken.accessToken }) });
        yield downscopedClient.files.updateFileById(file.id, { requestBody: { name: (0, utils_js_3.getUuid)() } });
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield downscopedClient.files.deleteFileById(file.id); })).rejects.toThrow();
...
test("test_oauth_auth_authorizeUrl", function test_oauth_auth_authorizeUrl() {
    const config = new oauth_generated_js_2.OAuthConfig({ clientId: "OAUTH_CLIENT_ID", clientSecret: "OAUTH_CLIENT_SECRET" });
...
test("test_ccg_auth_downscope", function test_ccg_auth_downscope() {
    return __awaiter(this, void 0, void 0, function* () {
        const ccgConfig = new ccgAuth_generated_js_2.CcgConfig({ clientId: (0, utils_js_2.getEnvVar)("CLIENT_ID"), clientSecret: (0, utils_js_2.getEnvVar)("CLIENT_SECRET"), userId: (0, utils_js_2.getEnvVar)("USER_ID") });
        const auth = new ccgAuth_generated_js_1.BoxCcgAuth({ config: ccgConfig });
        const parentClient = new client_generated_js_1.BoxClient({ auth: auth });
        const folder = yield parentClient.folders.createFolder({ name: (0, utils_js_3.getUuid)(), parent: { id: "0" } });
        ...
        const downscopedClient = new client_generated_js_1.BoxClient({ auth: new developerTokenAuth_generated_js_1.BoxDeveloperTokenAuth({ token: downscopedToken.accessToken }) });
        yield downscopedClient.folders.updateFolderById(folder.id, { requestBody: { name: (0, utils_js_3.getUuid)() } });
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield downscopedClient.folders.deleteFolderById(folder.id); })).rejects.toThrow();
...
test("test_developer_token_auth_revoke", function test_developer_token_auth_revoke() {
    return __awaiter(this, void 0, void 0, function* () {
        const developerTokenConfig = { clientId: (0, utils_js_2.getEnvVar)("CLIENT_ID"), clientSecret: (0, utils_js_2.getEnvVar)("CLIENT_SECRET") };
        const token = yield getAccessToken();
        const auth = new developerTokenAuth_generated_js_1.BoxDeveloperTokenAuth({ token: token.accessToken, config: developerTokenConfig });
        const tokenFromStorageBeforeRevoke = yield auth.retrieveToken();
        if (!!(tokenFromStorageBeforeRevoke == void 0)) {
            throw new Error("Assertion failed");
        }
        yield auth.revokeToken();
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield auth.retrieveToken(); })).rejects.toThrow();
    });
});
...
test("test_developer_token_auth", function test_developer_token_auth() {
    return __awaiter(this, void 0, void 0, function* () {
        const userId = (0, utils_js_2.getEnvVar)("USER_ID");
        const token = yield getAccessToken();
        const devAuth = new developerTokenAuth_generated_js_1.BoxDeveloperTokenAuth({ token: token.accessToken });
...
test("test_oauth_auth_revoke", function test_oauth_auth_revoke() {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield getAccessToken();
        const tokenStorage = new tokenStorage_generated_js_1.InMemoryTokenStorage({ token: token });
        const config = new oauth_generated_js_2.OAuthConfig({ clientId: (0, utils_js_2.getEnvVar)("CLIENT_ID"), clientSecret: (0, utils_js_2.getEnvVar)("CLIENT_SECRET"), tokenStorage: tokenStorage });
        const auth = new oauth_generated_js_1.BoxOAuth({ config: config });
        const client = new client_generated_js_1.BoxClient({ auth: auth });
        yield client.users.getUserMe();
        yield auth.revokeToken();
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.users.getUserMe(); })).rejects.toThrow();
    });
});
