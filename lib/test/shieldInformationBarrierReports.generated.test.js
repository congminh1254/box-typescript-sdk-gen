...
test("testShieldInformationBarrierReports", function testShieldInformationBarrierReports() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const existingReports = yield client.shieldInformationBarrierReports.getShieldInformationBarrierReports({ shieldInformationBarrierId: barrierId });
        if (existingReports.entries.length > 0) {
            return void 0;
        }
        const createdReport = yield client.shieldInformationBarrierReports.createShieldInformationBarrierReport({ shieldInformationBarrier: { id: barrierId, type: "shield_information_barrier" } });
        ...
        const retrievedReports = yield client.shieldInformationBarrierReports.getShieldInformationBarrierReports({ shieldInformationBarrierId: barrierId });
