...
test("testCreateUpdateGetDeleteTaskAssignment", function testCreateUpdateGetDeleteTaskAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const task = yield exports.client.tasks.createTask({ item: { type: "file", id: file.id }, message: "test message", dueAt: date, action: "review", completionRule: "all_assignees" });
        ...
        const taskAssignment = yield exports.client.taskAssignments.createTaskAssignment({ task: new taskAssignments_generated_js_1.CreateTaskAssignmentRequestBodyTaskField({ type: "task", id: task.id }), assignTo: { id: currentUser.id } });
        ...
        const updatedTaskAssignment = yield exports.client.taskAssignments.updateTaskAssignmentById(taskAssignment.id, { requestBody: { message: "updated message", resolutionState: "approved" } });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.taskAssignments.deleteTaskAssignmentById(taskAssignment.id); })).rejects.toThrow();
