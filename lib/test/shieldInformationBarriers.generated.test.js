...
test("testShieldInformationBarriers", function testShieldInformationBarriers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.shieldInformationBarriers.updateShieldInformationBarrierStatus({ id: barrierId, status: "disabled" }); })).rejects.toThrow();
    });
});
