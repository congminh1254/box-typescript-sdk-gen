...
test("testShieldInformationBarrierSegmentRestrictions", function testShieldInformationBarrierSegmentRestrictions() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const segment = yield client.shieldInformationBarrierSegments.createShieldInformationBarrierSegment({ shieldInformationBarrier: { id: barrierId, type: "shield_information_barrier" }, name: (0, utils_js_2.getUuid)(), description: "barrier segment description" });
        const segmentId = segment.id;
        const segmentToRestrict = yield client.shieldInformationBarrierSegments.createShieldInformationBarrierSegment({ shieldInformationBarrier: { id: barrierId, type: "shield_information_barrier" }, name: (0, utils_js_2.getUuid)(), description: "barrier segment description" });
        const segmentToRestrictId = segmentToRestrict.id;
        const segmentRestriction = yield client.shieldInformationBarrierSegmentRestrictions.createShieldInformationBarrierSegmentRestriction({ restrictedSegment: { id: segmentToRestrictId, type: "shield_information_barrier_segment" }, shieldInformationBarrierSegment: { id: segmentId, type: "shield_information_barrier_segment" }, type: "shield_information_barrier_segment_restriction" });
        const segmentRestrictionId = segmentRestriction.id;
        if (!(segmentRestriction.shieldInformationBarrierSegment.id == segmentId)) {
            throw new Error("Assertion failed");
        }
        const segmentRestrictions = yield client.shieldInformationBarrierSegmentRestrictions.getShieldInformationBarrierSegmentRestrictions({ shieldInformationBarrierSegmentId: segmentId });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.shieldInformationBarrierSegmentRestrictions.getShieldInformationBarrierSegmentRestrictionById(segmentRestrictionId); })).rejects.toThrow();
