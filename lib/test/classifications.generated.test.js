...
test("testClassifications", function testClassifications() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const classificationTemplateWithUpdatedClassification = yield exports.client.classifications.updateClassification([new classifications_generated_js_1.UpdateClassificationRequestBody({ enumOptionKey: classification.key, data: { key: updatedClassificationName, staticConfig: { classification: { colorId: 2, classificationDefinition: updatedClassificationDescription } } } })]);
