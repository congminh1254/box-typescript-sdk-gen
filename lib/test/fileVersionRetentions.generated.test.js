...
test("testCreateUpdateGetDeleteRetentionPolicy", function testCreateUpdateGetDeleteRetentionPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const retentionPolicy = yield exports.client.retentionPolicies.createRetentionPolicy({ policyName: (0, utils_js_2.getUuid)(), policyType: "finite", dispositionAction: "remove_retention", retentionLength: "1", description: description, canOwnerExtendRetention: false, retentionType: "modifiable" });
        ...
        const retentionPolicyAssignment = yield exports.client.retentionPolicyAssignments.createRetentionPolicyAssignment({ policyId: retentionPolicy.id, assignTo: { id: folder.id, type: "folder" } });
        ...
        if (!((0, utils_js_3.toString)(retentionPolicyAssignment.assignedTo.type) == (0, utils_js_3.toString)(folder.type))) {
            throw new Error("Assertion failed");
        }
        const files = yield exports.client.uploads.uploadFile({ attributes: { name: (0, utils_js_2.getUuid)(), parent: { id: folder.id } }, file: (0, utils_js_1.generateByteStream)(10) });
        const file = files.entries[0];
        const newFiles = yield exports.client.uploads.uploadFileVersion(file.id, { attributes: { name: file.name }, file: (0, utils_js_1.generateByteStream)(20) });
        ...
        if (fileVersionRetentionsCount == 0) {
            ...
            yield exports.client.folders.deleteFolderById(folder.id, { queryParams: { recursive: true } });
            return void 0;
        }
