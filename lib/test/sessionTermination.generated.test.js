...
test("testSessionTerminationUser", function testSessionTerminationUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield exports.client.sessionTermination.terminateUsersSessions({ userIds: [(0, utils_js_2.getEnvVar)("USER_ID")], userLogins: [user.login] });
...
test("testSessionTerminationGroup", function testSessionTerminationGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const group = yield exports.client.groups.createGroup({ name: groupName });
        const result = yield exports.client.sessionTermination.terminateGroupsSessions({ groupIds: [group.id] });
        if (!(result.message == "Request is successful, please check the admin events for the status of the job")) {
            throw new Error("Assertion failed");
        }
