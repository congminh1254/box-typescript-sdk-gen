...
test("test_createGetDeleteWeblink", function test_createGetDeleteWeblink() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const weblink = yield exports.client.webLinks.createWebLink({ url: url, parent: { id: parent.id }, name: name, description: description });
        if (!(weblink.url == url)) {
        ...
        const updatedWeblink = yield exports.client.webLinks.updateWebLinkById(weblink.id, { requestBody: { name: updatedName, sharedLink: { access: "open", password: password } } });
