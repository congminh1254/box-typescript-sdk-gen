...
test("test_skills_cards_CRUD", function test_skills_cards_CRUD() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const skillCardsMetadata = yield exports.client.skills.createBoxSkillCardsOnFile(file.id, { cards: [{ type: "skill_card", skillCardType: "keyword", skillCardTitle: { code: "license-plates", message: titleMessage }, skill: { id: skillId, type: "service" }, invocation: { id: invocationId, type: "skill_invocation" }, entries: [{ text: "DN86 BOX" }] }] });
        ...
        const updatedSkillCardsMetadata = yield exports.client.skills.updateBoxSkillCardsOnFile(file.id, [{ op: "replace", path: "/cards/0", value: new keywordSkillCard_generated_js_3.KeywordSkillCard({ type: "skill_card", skillCardType: "keyword", skillCardTitle: { code: "license-plates", message: updatedTitleMessage }, skill: new keywordSkillCard_generated_js_1.KeywordSkillCardSkillField({ id: skillId, type: "service" }), invocation: new keywordSkillCard_generated_js_2.KeywordSkillCardInvocationField({ id: invocationId, type: "skill_invocation" }), entries: [{ text: "DN86 BOX" }] }) }]);
