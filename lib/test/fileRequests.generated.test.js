...
test("testGetCopyUpdateDeleteFileRequest", function testGetCopyUpdateDeleteFileRequest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const copiedFileRequest = yield client.fileRequests.createFileRequestCopy(fileRequestId, { folder: { id: fileRequest.folder.id, type: "folder" } });
        ...
        const updatedFileRequest = yield client.fileRequests.updateFileRequestById(copiedFileRequest.id, { title: "updated title", description: "updated description" });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.fileRequests.getFileRequestById(updatedFileRequest.id); })).rejects.toThrow();
    });
});
