...
function getOrCreateStoragePolicyAssignment(clientInput, policyId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const storagePolicyAssignments = yield client.storagePolicyAssignments.getStoragePolicyAssignments({ resolvedForType: "user", resolvedForId: userId });
        ...
        const storagePolicyAssignment = yield client.storagePolicyAssignments.createStoragePolicyAssignment({ storagePolicy: new storagePolicyAssignments_generated_js_1.CreateStoragePolicyAssignmentRequestBodyStoragePolicyField({ id: policyId }), assignedTo: { id: userId, type: "user" } });
...
test("testGetStoragePolicyAssignments", function testGetStoragePolicyAssignments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newUser = yield client.users.createUser({ name: userName, isPlatformAccessOnly: true });
        ...
        if (!((0, utils_js_3.toString)(storagePolicyAssignment.type) == "storage_policy_assignment")) {
        ...
        const updatedStoragePolicyAssignment = yield client.storagePolicyAssignments.updateStoragePolicyAssignmentById(storagePolicyAssignment.id, { storagePolicy: new storagePolicyAssignments_generated_js_2.UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField({ id: storagePolicy2.id }) });
