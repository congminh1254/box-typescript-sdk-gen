...
test("test_create_update_get_delete_user", function test_create_update_get_delete_user() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updatedUser = yield exports.client.users.updateUserById(user.id, { requestBody: { name: updatedUserName } });
...
test("test_user_notification_email", function test_user_notification_email() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const userLogin = "".concat((0, utils_js_1.getUuid)(), "@gmail.com");
        const user = yield exports.client.users.createUser({ name: userName, login: userLogin, isPlatformAccessOnly: true });
        const updatedWithNotificationEmail = yield exports.client.users.updateUserById(user.id, { requestBody: { notificationEmail: { email: userLogin } } });
        if (!!(updatedWithNotificationEmail.notificationEmail == void 0)) {
            throw new Error("Assertion failed");
        }
        const updatedWithoutNotificationEmail = yield exports.client.users.updateUserById(user.id, { requestBody: { notificationEmail: (0, utils_js_2.createNull)() } });
