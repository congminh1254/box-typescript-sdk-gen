...
test("testCreateUpdateGetDeleteTask", function testCreateUpdateGetDeleteTask() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const task = yield exports.client.tasks.createTask({ item: { type: "file", id: file.id }, message: "test message", dueAt: dateTime, action: "review", completionRule: "all_assignees" });
        ...
        const updatedTask = yield exports.client.tasks.updateTaskById(task.id, { requestBody: { message: "updated message" } });
