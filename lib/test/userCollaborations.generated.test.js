...
test("testUserCollaborations", function testUserCollaborations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const user = yield exports.client.users.createUser({ name: userName, login: userLogin, isPlatformAccessOnly: true });
        const folder = yield (0, commons_generated_js_2.createNewFolder)();
        const collaboration = yield exports.client.userCollaborations.createCollaboration({ item: { type: "folder", id: folder.id }, accessibleBy: { type: "user", id: user.id }, role: "editor" });
        ...
        const updatedCollaboration = yield exports.client.userCollaborations.updateCollaborationById(collaborationId, { role: "viewer" });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.userCollaborations.getCollaborationById(collaborationId); })).rejects.toThrow();
...
test("testConvertingUserCollaborationToOwnership", function testConvertingUserCollaborationToOwnership() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ownerCollaboration = yield exports.client.userCollaborations.updateCollaborationById(collaboration.id, { role: "owner" });
...
test("testExternalUserCollaborations", function testExternalUserCollaborations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const folder = yield (0, commons_generated_js_2.createNewFolder)();
        const collaboration = yield exports.client.userCollaborations.createCollaboration({ item: { type: "folder", id: folder.id }, accessibleBy: { type: "user", login: userLogin }, role: "editor" });
        if (!((0, utils_js_2.toString)(collaboration.role) == "editor")) {
            throw new Error("Assertion failed");
        }
        const collaborationId = collaboration.id;
