...
test("testCollaborationAllowlistExemptTargets", function testCollaborationAllowlistExemptTargets() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const user = yield exports.client.users.createUser({ name: (0, utils_js_1.getUuid)(), login: "".concat((0, utils_js_1.getUuid)(), "@boxdemo.com"), isPlatformAccessOnly: true });
        const newExemptTarget = yield exports.client.collaborationAllowlistExemptTargets.createCollaborationWhitelistExemptTarget({ user: { id: user.id } });
        if (!((0, utils_js_2.toString)(newExemptTarget.type) == "collaboration_whitelist_exempt_target")) {
            throw new Error("Assertion failed");
        }
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.collaborationAllowlistExemptTargets.getCollaborationWhitelistExemptTargetById(exemptTarget.id); })).rejects.toThrow();
