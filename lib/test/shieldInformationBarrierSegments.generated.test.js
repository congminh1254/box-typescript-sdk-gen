...
test("testShieldInformationBarrierSegments", function testShieldInformationBarrierSegments() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const segment = yield client.shieldInformationBarrierSegments.createShieldInformationBarrierSegment({ shieldInformationBarrier: { id: barrierId, type: "shield_information_barrier" }, name: segmentName, description: segmentDescription });
        if (!(segment.name == segmentName)) {
            throw new Error("Assertion failed");
        }
        const segments = yield client.shieldInformationBarrierSegments.getShieldInformationBarrierSegments({ shieldInformationBarrierId: barrierId });
        ...
        if (!((0, utils_js_3.toString)(segmentFromApi.type) == "shield_information_barrier_segment")) {
            throw new Error("Assertion failed");
        }
        ...
        const updatedSegment = yield client.shieldInformationBarrierSegments.updateShieldInformationBarrierSegmentById(segmentId, { requestBody: { description: updatedSegmentDescription } });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield client.shieldInformationBarrierSegments.getShieldInformationBarrierSegmentById(segmentId); })).rejects.toThrow();
    });
});
