...
test("testCreateGetDeleteFileWatermark", function testCreateGetDeleteFileWatermark() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const uploadedFiles = yield exports.client.uploads.uploadFile({ attributes: { name: fileName, parent: { id: "0" } }, file: (0, utils_js_2.generateByteStream)(10) });
        const file = uploadedFiles.entries[0];
        const createdWatermark = yield exports.client.fileWatermarks.updateFileWatermark(file.id, { watermark: new fileWatermarks_generated_js_1.UpdateFileWatermarkRequestBodyWatermarkField({ imprint: "default" }) });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.fileWatermarks.getFileWatermark(file.id); })).rejects.toThrow();
