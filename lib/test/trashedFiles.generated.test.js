...
test("testTrashedFiles", function testTrashedFiles() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = yield exports.client.uploads.uploadFile({ attributes: { name: fileName, parent: { id: "0" } }, file: fileByteStream });
        ...
        yield expect(() => __awaiter(this, void 0, void 0, function* () { yield exports.client.trashedFiles.getTrashedFileById(file.id); })).rejects.toThrow();
    });
});
