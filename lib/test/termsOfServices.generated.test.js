...
test("testGetTermsOfServices", function testGetTermsOfServices() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const updatedTos1 = yield exports.client.termsOfServices.updateTermsOfServiceById(tos.id, { status: "disabled", text: "TOS" });
        ...
        const updatedTos2 = yield exports.client.termsOfServices.updateTermsOfServiceById(tos.id, { status: "disabled", text: "Updated TOS" });
