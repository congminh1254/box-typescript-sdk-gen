...
test('testAskAIMultipleItems', function testAskAIMultipleItems() {
    return __awaiter(this, void 0, void 0, function* () {
        const fileToAsk1 = yield uploadNewFile();
        const fileToAsk2 = yield uploadNewFile();
        const response = yield client.ai.createAiAsk({
        ...
        yield client.files.deleteFileById(fileToAsk1.id);
        yield client.files.deleteFileById(fileToAsk2.id);
    });
});
test('testAITextGenWithDialogueHistory', function testAITextGenWithDialogueHistory() {
    return __awaiter(this, void 0, void 0, function* () {
        const fileToAsk = yield uploadNewFile();
        const response = yield client.ai.createAiTextGen({
...
test('testGettingAIAskAgentConfig', function testGettingAIAskAgentConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        const aiAskConfig = yield client.ai.getAiAgentDefaultConfig({
            mode: 'ask',
            language: 'en-US',
        });
...
test('testGettingAITextGenAgentConfig', function testGettingAITextGenAgentConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        const aiTextGenConfig = yield client.ai.getAiAgentDefaultConfig({
            mode: 'text_gen',
            language: 'en-US',
        });
...
test('testAIExtract', function testAIExtract() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield client.ai.createAiExtract({
...
test('testAIExtractStructuredWithFields', function testAIExtractStructuredWithFields() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const file = uploadedFiles.entries[0];
        yield delayInSeconds(5);
        const response = yield client.ai.createAiExtractStructured({
            fields: [
                {
                    key: 'firstName',
