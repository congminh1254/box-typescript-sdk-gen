...
test("testAskAISingleItem", function testAskAISingleItem() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield exports.client.ai.createAiAsk({ mode: "single_item_qa", prompt: "which direction sun rises", items: [new aiItemBase_generated_js_1.AiItemBase({ id: fileToAsk.id, type: "file", content: "Sun rises in the East" })] });
...
test("testAskAIMultipleItems", function testAskAIMultipleItems() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield exports.client.ai.createAiAsk({ mode: "multiple_item_qa", prompt: "Which direction sun rises?", items: [new aiItemBase_generated_js_1.AiItemBase({ id: fileToAsk1.id, type: "file", content: "Earth goes around the sun" }), new aiItemBase_generated_js_1.AiItemBase({ id: fileToAsk2.id, type: "file", content: "Sun rises in the East in the morning" })] });
        if (!response.answer.includes("East")) {
            throw new Error("Assertion failed");
        }
        if (!(response.completionReason == "done")) {
...
test("testAITextGenWithDialogueHistory", function testAITextGenWithDialogueHistory() {
    return __awaiter(this, void 0, void 0, function* () {
        const fileToAsk = yield (0, commons_generated_js_2.uploadNewFile)();
        const response = yield exports.client.ai.createAiTextGen({ prompt: "Parapharse the document.s", items: [new aiTextGen_generated_js_1.AiTextGenItemsField({ id: fileToAsk.id, type: "file", content: "The Earth goes around the sun. Sun rises in the East in the morning." })], dialogueHistory: [{ prompt: "What does the earth go around?", answer: "The sun", createdAt: (0, utils_js_4.dateTimeFromString)("2021-01-01T00:00:00Z") }, { prompt: "On Earth, where does the sun rise?", answer: "East", createdAt: (0, utils_js_4.dateTimeFromString)("2021-01-01T00:00:00Z") }] });
...
test("testGettingAIAskAgentConfig", function testGettingAIAskAgentConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        const aiAskConfig = yield exports.client.ai.getAiAgentDefaultConfig({ mode: "ask", language: "en-US" });
...
test("testGettingAITextGenAgentConfig", function testGettingAITextGenAgentConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        const aiTextGenConfig = yield exports.client.ai.getAiAgentDefaultConfig({ mode: "text_gen", language: "en-US" });
...
test("testAIExtract", function testAIExtract() {
    return __awaiter(this, void 0, void 0, function* () {
        const uploadedFiles = yield exports.client.uploads.uploadFile({ attributes: { name: "".concat((0, utils_js_1.getUuid)(), ".txt"), parent: { id: "0" } }, file: (0, utils_js_2.stringToByteStream)("My name is John Doe. I live in San Francisco. I was born in 1990. I work at Box.") });
        const file = uploadedFiles.entries[0];
        yield (0, utils_js_3.delayInSeconds)(5);
        const response = yield exports.client.ai.createAiExtract({ prompt: "firstName, lastName, location, yearOfBirth, company", items: [new aiItemBase_generated_js_1.AiItemBase({ id: file.id })] });
...
test("testAIExtractStructuredWithFields", function testAIExtractStructuredWithFields() {
    return __awaiter(this, void 0, void 0, function* () {
        const uploadedFiles = yield exports.client.uploads.uploadFile({ attributes: { name: "".concat((0, utils_js_1.getUuid)(), ".txt"), parent: { id: "0" } }, file: (0, utils_js_2.stringToByteStream)("My name is John Doe. I was born in 4th July 1990. I am 34 years old. My hobby is guitar.") });
        const file = uploadedFiles.entries[0];
        yield (0, utils_js_3.delayInSeconds)(5);
        const response = yield exports.client.ai.createAiExtractStructured({ fields: [{ key: "firstName", displayName: "First name", description: "Person first name", prompt: "What is the your first name?", type: "string" }, { key: "lastName", displayName: "Last name", description: "Person last name", prompt: "What is the your last name?", type: "string" }, { key: "dateOfBirth", displayName: "Birth date", description: "Person date of birth", prompt: "What is the date of your birth?", type: "date" }, { key: "age", displayName: "Age", description: "Person age", prompt: "How old are you?", type: "float" }, { key: "hobby", displayName: "Hobby", description: "Person hobby", prompt: "What is your hobby?", type: "multiSelect", options: [{ key: "guitar" }, { key: "books" }] }], items: [new aiItemBase_generated_js_1.AiItemBase({ id: file.id })] });
        if (!((0, utils_js_6.toString)((0, utils_js_5.getValueFromObjectRawData)(response, "firstName")) == "John")) {
            throw new Error("Assertion failed");
        }
        if (!((0, utils_js_6.toString)((0, utils_js_5.getValueFromObjectRawData)(response, "lastName")) == "Doe")) {
            throw new Error("Assertion failed");
        }
        ...
        if (!((0, utils_js_6.toString)((0, utils_js_5.getValueFromObjectRawData)(response, "hobby")) == ["guitar"].map(utils_js_6.toString).join(","))) {
            throw new Error("Assertion failed");
        }
        yield exports.client.files.deleteFileById(file.id);
    });
...
test("testAIExtractStructuredWithMetadataTemplate", function testAIExtractStructuredWithMetadataTemplate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const template = yield exports.client.metadataTemplates.createMetadataTemplate({ scope: "enterprise", displayName: templateKey, templateKey: templateKey, fields: [{ key: "firstName", displayName: "First name", description: "Person first name", type: "string" }, { key: "lastName", displayName: "Last name", description: "Person last name", type: "string" }, { key: "dateOfBirth", displayName: "Birth date", description: "Person date of birth", type: "date" }, { key: "age", displayName: "Age", description: "Person age", type: "float" }, { key: "hobby", displayName: "Hobby", description: "Person hobby", type: "multiSelect", options: [{ key: "guitar" }, { key: "books" }] }] });
        const response = yield exports.client.ai.createAiExtractStructured({ metadataTemplate: { templateKey: templateKey, scope: "enterprise" }, items: [new aiItemBase_generated_js_1.AiItemBase({ id: file.id })] });
        if (!((0, utils_js_6.toString)((0, utils_js_5.getValueFromObjectRawData)(response, "firstName")) == "John")) {
            throw new Error("Assertion failed");
        }
        if (!((0, utils_js_6.toString)((0, utils_js_5.getValueFromObjectRawData)(response, "lastName")) == "Doe")) {
