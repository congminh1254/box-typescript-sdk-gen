...
test("testCreateUpdateGetDeleteLegalHoldPolicy", function testCreateUpdateGetDeleteLegalHoldPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const legalHoldPolicy = yield exports.client.legalHoldPolicies.createLegalHoldPolicy({ policyName: legalHoldPolicyName, description: legalHoldDescription, isOngoing: true });
        ...
        const updatedLegalHoldPolicy = yield exports.client.legalHoldPolicies.updateLegalHoldPolicyById(legalHoldPolicyId, { requestBody: { policyName: updatedLegalHoldPolicyName } });
...
test("testCreateNotOngoingLegalHoldPolicy", function testCreateNotOngoingLegalHoldPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const legalHoldPolicy = yield exports.client.legalHoldPolicies.createLegalHoldPolicy({ policyName: legalHoldPolicyName, description: legalHoldDescription, isOngoing: false, filterStartedAt: filterStartedAt, filterEndedAt: filterEndedAt });
        if (!(legalHoldPolicy.policyName == legalHoldPolicyName)) {
            throw new Error("Assertion failed");
        }
        if (!(legalHoldPolicy.description == legalHoldDescription)) {
        ...
        if (!((0, utils_js_3.dateTimeToString)(legalHoldPolicy.filterStartedAt) == (0, utils_js_3.dateTimeToString)(filterStartedAt))) {
            throw new Error("Assertion failed");
        }
        if (!((0, utils_js_3.dateTimeToString)(legalHoldPolicy.filterEndedAt) == (0, utils_js_3.dateTimeToString)(filterEndedAt))) {
            throw new Error("Assertion failed");
        }
