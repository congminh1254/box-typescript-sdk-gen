...
const uploadSession_generated_1 = require("../schemas/uploadSession.generated");
const uploadedPart_generated_1 = require("../schemas/uploadedPart.generated");
const uploadParts_generated_1 = require("../schemas/uploadParts.generated");
const files_generated_1 = require("../schemas/files.generated");
const uploadPart_generated_1 = require("../schemas/uploadPart.generated");
const uploadPart_generated_2 = require("../schemas/uploadPart.generated");
const network_generated_1 = require("../networking/network.generated");
const utils_1 = require("../internal/utils");
const utils_2 = require("../internal/utils");
const fetch_1 = require("../networking/fetch");
...
class ChunkedUploadsManager {
    constructor(fields) {
        this.networkSession = new network_generated_1.NetworkSession({});
        if (fields.auth) {
    ...
    createFileUploadSession(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_1.fetch)({
            ...
            return Object.assign(Object.assign({}, (0, uploadSession_generated_1.deserializeUploadSession)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    uploadFilePartByUrl(url_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (url, requestBody, headersInput, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, uploadedPart_generated_1.deserializeUploadedPart)(response.data)), { rawData: response.data });
        });
    }
    /**
       * Uploads a chunk of a file for an upload session.
    ...
    getFileUploadSessionPartsByUrl(url_1) {
        return __awaiter(this, arguments, void 0, function* (url, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, uploadParts_generated_1.deserializeUploadParts)(response.data)), { rawData: response.data });
        });
    }
    /**
       * Return a list of the chunks uploaded to the upload session so far.
    ...
    createFileUploadSessionCommitByUrl(url_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (url, requestBody, headersInput, optionalsInput = {}) {
            ...
            return Object.assign(Object.assign({}, (0, files_generated_1.deserializeFiles)(response.data)), { rawData: response.data });
        });
    }
    /**
       * Close an upload session and create a file from the uploaded chunks.
...
function serializeCreateFileUploadSessionCommitByUrlRequestBody(val) {
    return {
        'parts': val.parts.map(function (item) {
            return (0, uploadPart_generated_1.serializeUploadPart)(item);
        }),
    };
}
function deserializeCreateFileUploadSessionCommitByUrlRequestBody(val) {
    ...
    const parts = (0, json_3.sdIsList)(val.parts)
        ? val.parts.map(function (itm) {
            return (0, uploadPart_generated_2.deserializeUploadPart)(itm);
        })
        : [];
    return {
        parts: parts,
