...
class ChunkedUploadsManager {
    ...
    createFileUploadSession(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateFileUploadSessionOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions"), method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFileUploadSessionForExistingFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new CreateFileUploadSessionForExistingFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/upload_sessions"), method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionForExistingFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, uploadSession_generated_js_1.deserializeUploadSession)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFileUploadSessionByUrl(url_1) {
        return __awaiter(this, arguments, void 0, function* (url, optionalsInput = {}) {
            const optionals = new GetFileUploadSessionByUrlOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: url, method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, uploadSession_generated_js_1.deserializeUploadSession)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFileUploadSessionById(uploadSessionId_1) {
        return __awaiter(this, arguments, void 0, function* (uploadSessionId, optionalsInput = {}) {
            const optionals = new GetFileUploadSessionByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", (0, utils_js_2.toString)(uploadSessionId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, uploadSession_generated_js_1.deserializeUploadSession)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    uploadFilePartByUrl(url_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (url, requestBody, headersInput, optionalsInput = {}) {
            const headers = new UploadFilePartByUrlHeaders({ digest: headersInput.digest, contentRange: headersInput.contentRange, extraHeaders: headersInput.extraHeaders });
            const optionals = new UploadFilePartByUrlOptionals({ cancellationToken: optionalsInput.cancellationToken });
            const cancellationToken = optionals.cancellationToken;
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: url, method: "PUT", headers: headersMap, fileStream: requestBody, contentType: "application/octet-stream", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    uploadFilePart(uploadSessionId_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (uploadSessionId, requestBody, headersInput, optionalsInput = {}) {
            const headers = new UploadFilePartHeaders({ digest: headersInput.digest, contentRange: headersInput.contentRange, extraHeaders: headersInput.extraHeaders });
            const optionals = new UploadFilePartOptionals({ cancellationToken: optionalsInput.cancellationToken });
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({ ["digest"]: (0, utils_js_2.toString)(headers.digest), ["content-range"]: (0, utils_js_2.toString)(headers.contentRange) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", (0, utils_js_2.toString)(uploadSessionId)), method: "PUT", headers: headersMap, fileStream: requestBody, contentType: "application/octet-stream", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, uploadedPart_generated_js_1.deserializeUploadedPart)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFileUploadSessionByUrl(url_1) {
        return __awaiter(this, arguments, void 0, function* (url, optionalsInput = {}) {
            const optionals = new DeleteFileUploadSessionByUrlOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: url, method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    deleteFileUploadSessionById(uploadSessionId_1) {
        return __awaiter(this, arguments, void 0, function* (uploadSessionId, optionalsInput = {}) {
            const optionals = new DeleteFileUploadSessionByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", (0, utils_js_2.toString)(uploadSessionId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    getFileUploadSessionPartsByUrl(url_1) {
        return __awaiter(this, arguments, void 0, function* (url, optionalsInput = {}) {
            const optionals = new GetFileUploadSessionPartsByUrlOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: url, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getFileUploadSessionParts(uploadSessionId_1) {
        return __awaiter(this, arguments, void 0, function* (uploadSessionId, optionalsInput = {}) {
            const optionals = new GetFileUploadSessionPartsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["offset"]: (0, utils_js_2.toString)(queryParams.offset), ["limit"]: (0, utils_js_2.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", (0, utils_js_2.toString)(uploadSessionId), "/parts"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, uploadParts_generated_js_1.deserializeUploadParts)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createFileUploadSessionCommitByUrl(url_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (url, requestBody, headersInput, optionalsInput = {}) {
            const headers = new CreateFileUploadSessionCommitByUrlHeaders({ digest: headersInput.digest, ifMatch: headersInput.ifMatch, ifNoneMatch: headersInput.ifNoneMatch, extraHeaders: headersInput.extraHeaders });
            const optionals = new CreateFileUploadSessionCommitByUrlOptionals({ cancellationToken: optionalsInput.cancellationToken });
            const cancellationToken = optionals.cancellationToken;
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: url, method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionCommitRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFileUploadSessionCommit(uploadSessionId_1, requestBody_1, headersInput_1) {
        return __awaiter(this, arguments, void 0, function* (uploadSessionId, requestBody, headersInput, optionalsInput = {}) {
            const headers = new CreateFileUploadSessionCommitHeaders({ digest: headersInput.digest, ifMatch: headersInput.ifMatch, ifNoneMatch: headersInput.ifNoneMatch, extraHeaders: headersInput.extraHeaders });
            const optionals = new CreateFileUploadSessionCommitOptionals({ cancellationToken: optionalsInput.cancellationToken });
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({ ["digest"]: (0, utils_js_2.toString)(headers.digest), ["if-match"]: (0, utils_js_2.toString)(headers.ifMatch), ["if-none-match"]: (0, utils_js_2.toString)(headers.ifNoneMatch) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", (0, utils_js_2.toString)(uploadSessionId), "/commit"), method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionCommitRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            if ((0, utils_js_2.toString)(response.status) == "202") {
                return void 0;
            }
            return Object.assign(Object.assign({}, (0, files_generated_js_1.deserializeFiles)(response.data)), { rawData: response.data });
    ...
    reducer(acc, chunk) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uploadedPart = yield this.uploadFilePartByUrl(acc.uploadPartUrl, (0, utils_js_3.generateByteStreamFromBuffer)(chunkBuffer), { digest: digest, contentRange: contentRange });
            ...
            return { lastIndex: bytesEnd, parts: parts.concat([part]), fileSize: acc.fileSize, uploadPartUrl: acc.uploadPartUrl, fileHash: acc.fileHash };
        });
    }
    /**
    ...
    uploadBigFile(file, fileName, fileSize, parentFolderId, cancellationToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const uploadSession = yield this.createFileUploadSession({ fileName: fileName, fileSize: fileSize, folderId: parentFolderId }, { headers: new CreateFileUploadSessionHeaders({}), cancellationToken: cancellationToken });
            ...
            const results = yield (0, utils_js_7.reduceIterator)(chunksIterator, this.reducer.bind(this), { lastIndex: -1, parts: [], fileSize: fileSize, uploadPartUrl: uploadPartUrl, fileHash: fileHash });
            const parts = results.parts;
            const processedSessionParts = yield this.getFileUploadSessionPartsByUrl(listPartsUrl, { queryParams: {}, headers: new GetFileUploadSessionPartsByUrlHeaders({}), cancellationToken: cancellationToken });
            if (!(processedSessionParts.totalCount == totalParts)) {
                throw new Error("Assertion failed");
            }
            const sha1 = yield fileHash.digestHash("base64");
            const digest = "".concat("sha=", sha1);
            const committedSession = yield this.createFileUploadSessionCommitByUrl(commitUrl, { parts: parts }, { digest: digest }, { cancellationToken: cancellationToken });
...
function deserializeCreateFileUploadSessionRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionRequestBody\"" });
    }
    if (val.folder_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"folder_id\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.folder_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
    const folderId = val.folder_id;
    if (val.file_size == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"file_size\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsNumber)(val.file_size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"file_size\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
    const fileSize = val.file_size;
    if (val.file_name == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"file_name\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.file_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"file_name\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
...
function deserializeCreateFileUploadSessionForExistingFileRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
    if (val.file_size == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"file_size\" of type \"CreateFileUploadSessionForExistingFileRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsNumber)(val.file_size)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"file_size\" of type \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
    const fileSize = val.file_size;
    if (!(val.file_name == void 0) && !(0, json_js_2.sdIsString)(val.file_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"file_name\" of type \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
...
function deserializeCreateFileUploadSessionCommitByUrlRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionCommitByUrlRequestBody\"" });
    }
    if (val.parts == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parts\" of type \"CreateFileUploadSessionCommitByUrlRequestBody\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.parts)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"parts\" of type \"CreateFileUploadSessionCommitByUrlRequestBody\"" });
    }
    const parts = (0, json_js_3.sdIsList)(val.parts) ? val.parts.map(function (itm) {
...
function deserializeCreateFileUploadSessionCommitRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionCommitRequestBody\"" });
    }
    if (val.parts == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parts\" of type \"CreateFileUploadSessionCommitRequestBody\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.parts)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"parts\" of type \"CreateFileUploadSessionCommitRequestBody\"" });
    }
    const parts = (0, json_js_3.sdIsList)(val.parts) ? val.parts.map(function (itm) {
        return (0, uploadPart_generated_js_2.deserializeUploadPart)(itm);
    }) : [];
