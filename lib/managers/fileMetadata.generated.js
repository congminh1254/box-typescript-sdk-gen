...
class FileMetadataManager {
    ...
    getFileMetadata(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new GetFileMetadataOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getFileMetadataById(fileId_1, scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, scope, templateKey, optionalsInput = {}) {
            const optionals = new GetFileMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFileMetadataById(fileId_1, scope_1, templateKey_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, scope, templateKey, requestBody, optionalsInput = {}) {
            const optionals = new CreateFileMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "POST", headers: headersMap, data: serializeCreateFileMetadataByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataFull_generated_js_1.deserializeMetadataFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateFileMetadataById(fileId_1, scope_1, templateKey_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, scope, templateKey, requestBody, optionalsInput = {}) {
            const optionals = new UpdateFileMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateFileMetadataByIdRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataFull_generated_js_1.deserializeMetadataFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFileMetadataById(fileId_1, scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, scope, templateKey, optionalsInput = {}) {
            const optionals = new DeleteFileMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeGetFileMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFileMetadataByIdScope" });
}
...
function deserializeCreateFileMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateFileMetadataByIdScope" });
}
function serializeCreateFileMetadataByIdRequestBody(val) {
    return Object.fromEntries(Object.entries(val).map(([k, v]) => [k, function (v) {
            return v;
        }(v)]));
}
function deserializeCreateFileMetadataByIdRequestBody(val) {
    return (0, json_js_2.sdIsMap)(val) ? Object.fromEntries(Object.entries(val).map(([k, v]) => [k, function (v) {
            return v;
        }(v)])) : {};
}
...
function deserializeUpdateFileMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileMetadataByIdScope" });
}
...
function deserializeUpdateFileMetadataByIdRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileMetadataByIdRequestBodyOpField" });
}
...
function deserializeUpdateFileMetadataByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileMetadataByIdRequestBody\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateFileMetadataByIdRequestBodyOpField(val.op);
    if (!(val.path == void 0) && !(0, json_js_1.sdIsString)(val.path)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"path\" of type \"UpdateFileMetadataByIdRequestBody\"" });
    }
    const path = val.path == void 0 ? void 0 : val.path;
    if (!(val.value == void 0) && !(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateFileMetadataByIdRequestBody\"" });
    }
    const value = val.value == void 0 ? void 0 : val.value;
    if (!(val.from == void 0) && !(0, json_js_1.sdIsString)(val.from)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"from\" of type \"UpdateFileMetadataByIdRequestBody\"" });
    }
    const from = val.from == void 0 ? void 0 : val.from;
    return { op: op, path: path, value: value, from: from };
}
...
function deserializeDeleteFileMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize DeleteFileMetadataByIdScope" });
}
