...
class SessionTerminationManager {
    ...
    terminateGroupsSessions(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new TerminateGroupsSessionsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/groups/terminate_sessions"), method: "POST", headers: headersMap, data: serializeTerminateGroupsSessionsRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, sessionTerminationMessage_generated_js_1.deserializeSessionTerminationMessage)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeTerminateUsersSessionsRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TerminateUsersSessionsRequestBody\"" });
    }
    if (val.user_ids == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"user_ids\" of type \"TerminateUsersSessionsRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.user_ids)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"user_ids\" of type \"TerminateUsersSessionsRequestBody\"" });
    }
    const userIds = (0, json_js_2.sdIsList)(val.user_ids) ? val.user_ids.map(function (itm) {
        if (!(0, json_js_1.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"TerminateUsersSessionsRequestBody\"" });
        }
        return itm;
    }) : [];
    if (val.user_logins == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"user_logins\" of type \"TerminateUsersSessionsRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.user_logins)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"user_logins\" of type \"TerminateUsersSessionsRequestBody\"" });
    }
    const userLogins = (0, json_js_2.sdIsList)(val.user_logins) ? val.user_logins.map(function (itm) {
        if (!(0, json_js_1.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"TerminateUsersSessionsRequestBody\"" });
        }
        return itm;
...
function deserializeTerminateGroupsSessionsRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"TerminateGroupsSessionsRequestBody\"" });
    }
    if (val.group_ids == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"group_ids\" of type \"TerminateGroupsSessionsRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.group_ids)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"group_ids\" of type \"TerminateGroupsSessionsRequestBody\"" });
    }
    const groupIds = (0, json_js_2.sdIsList)(val.group_ids) ? val.group_ids.map(function (itm) {
        if (!(0, json_js_1.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"TerminateGroupsSessionsRequestBody\"" });
        }
        return itm;
    }) : [];
