...
class SessionTerminationManager {
    ...
    terminateUsersSessions(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/users/terminate_sessions'), {
                method: 'POST',
                headers: headersMap,
            ...
            return (0, sessionTerminationMessage_generated_js_1.deserializeSessionTerminationMessage)(response.data);
        });
    }
    terminateGroupsSessions(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/groups/terminate_sessions'), {
                method: 'POST',
                headers: headersMap,
