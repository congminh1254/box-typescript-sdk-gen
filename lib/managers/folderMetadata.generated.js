...
class FolderMetadataManager {
    ...
    getFolderMetadata(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new GetFolderMetadataOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getFolderMetadataById(folderId_1, scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, scope, templateKey, optionalsInput = {}) {
            const optionals = new GetFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFolderMetadataById(folderId_1, scope_1, templateKey_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, scope, templateKey, requestBody, optionalsInput = {}) {
            const optionals = new CreateFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "POST", headers: headersMap, data: serializeCreateFolderMetadataByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataFull_generated_js_1.deserializeMetadataFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateFolderMetadataById(folderId_1, scope_1, templateKey_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, scope, templateKey, requestBody, optionalsInput = {}) {
            const optionals = new UpdateFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateFolderMetadataByIdRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataFull_generated_js_1.deserializeMetadataFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFolderMetadataById(folderId_1, scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, scope, templateKey, optionalsInput = {}) {
            const optionals = new DeleteFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeGetFolderMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFolderMetadataByIdScope" });
}
...
function deserializeCreateFolderMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateFolderMetadataByIdScope" });
}
...
function deserializeUpdateFolderMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFolderMetadataByIdScope" });
}
...
function deserializeUpdateFolderMetadataByIdRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFolderMetadataByIdRequestBodyOpField" });
}
...
function deserializeUpdateFolderMetadataByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateFolderMetadataByIdRequestBodyOpField(val.op);
    if (!(val.path == void 0) && !(0, json_js_1.sdIsString)(val.path)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"path\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const path = val.path == void 0 ? void 0 : val.path;
    if (!(val.value == void 0) && !(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const value = val.value == void 0 ? void 0 : val.value;
    if (!(val.from == void 0) && !(0, json_js_1.sdIsString)(val.from)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"from\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
...
function deserializeDeleteFolderMetadataByIdScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize DeleteFolderMetadataByIdScope" });
}
