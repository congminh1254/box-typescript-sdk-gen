...
class TaskAssignmentsManager {
    ...
    getTaskAssignments(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/tasks/', (0, utils_js_2.toString)(taskId), '/assignments'), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return (0, taskAssignments_generated_js_1.deserializeTaskAssignments)(response.data);
        });
    }
    createTaskAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/task_assignments'), {
                method: 'POST',
                headers: headersMap,
            ...
            return (0, taskAssignment_generated_js_1.deserializeTaskAssignment)(response.data);
        });
    }
    getTaskAssignmentById(taskAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (taskAssignmentId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/task_assignments/', (0, utils_js_2.toString)(taskAssignmentId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
