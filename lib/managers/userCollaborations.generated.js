...
class UserCollaborationsManager {
    ...
    getCollaborationById(collaborationId_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/collaborations/', (0, utils_js_4.toString)(collaborationId)), {
                method: 'GET',
            ...
            return (0, collaboration_generated_js_1.deserializeCollaboration)(response.data);
        });
    }
