...
class UserCollaborationsManager {
    ...
    getCollaborationById(collaborationId_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationId, optionalsInput = {}) {
            const optionals = new GetCollaborationByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaborations/", (0, utils_js_4.toString)(collaborationId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateCollaborationById(collaborationId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateCollaborationByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaborations/", (0, utils_js_4.toString)(collaborationId)), method: "PUT", headers: headersMap, data: serializeUpdateCollaborationByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    deleteCollaborationById(collaborationId_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationId, optionalsInput = {}) {
            const optionals = new DeleteCollaborationByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaborations/", (0, utils_js_4.toString)(collaborationId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    createCollaboration(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateCollaborationOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined, ["notify"]: (0, utils_js_4.toString)(queryParams.notify) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaborations"), method: "POST", params: queryParamsMap, headers: headersMap, data: serializeCreateCollaborationRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, collaboration_generated_js_1.deserializeCollaboration)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeUpdateCollaborationByIdRequestBodyRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateCollaborationByIdRequestBodyRoleField" });
}
...
function deserializeUpdateCollaborationByIdRequestBodyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateCollaborationByIdRequestBodyStatusField" });
}
function serializeUpdateCollaborationByIdRequestBody(val) {
    return { ["role"]: serializeUpdateCollaborationByIdRequestBodyRoleField(val.role), ["status"]: val.status == void 0 ? val.status : serializeUpdateCollaborationByIdRequestBodyStatusField(val.status), ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : (0, utils_js_1.serializeDateTime)(val.expiresAt), ["can_view_path"]: val.canViewPath };
}
function deserializeUpdateCollaborationByIdRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateCollaborationByIdRequestBody\"" });
    }
    if (val.role == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"role\" of type \"UpdateCollaborationByIdRequestBody\" to be defined" });
    }
    const role = deserializeUpdateCollaborationByIdRequestBodyRoleField(val.role);
    const status = val.status == void 0 ? void 0 : deserializeUpdateCollaborationByIdRequestBodyStatusField(val.status);
    if (!(val.expires_at == void 0) && !(0, json_js_2.sdIsString)(val.expires_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"UpdateCollaborationByIdRequestBody\"" });
    }
    ...
    if (!(val.can_view_path == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_view_path)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_view_path\" of type \"UpdateCollaborationByIdRequestBody\"" });
    }
...
function deserializeCreateCollaborationRequestBodyItemTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateCollaborationRequestBodyItemTypeField" });
}
...
function deserializeCreateCollaborationRequestBodyItemField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateCollaborationRequestBodyItemField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCreateCollaborationRequestBodyItemTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateCollaborationRequestBodyItemField\"" });
    }
...
function deserializeCreateCollaborationRequestBodyAccessibleByTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateCollaborationRequestBodyAccessibleByTypeField" });
}
...
function deserializeCreateCollaborationRequestBodyAccessibleByField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateCollaborationRequestBodyAccessibleByField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateCollaborationRequestBodyAccessibleByField\" to be defined" });
    }
    const type = deserializeCreateCollaborationRequestBodyAccessibleByTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateCollaborationRequestBodyAccessibleByField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.login == void 0) && !(0, json_js_2.sdIsString)(val.login)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"login\" of type \"CreateCollaborationRequestBodyAccessibleByField\"" });
    }
...
function deserializeCreateCollaborationRequestBodyRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateCollaborationRequestBodyRoleField" });
}
function serializeCreateCollaborationRequestBody(val) {
    return { ["item"]: serializeCreateCollaborationRequestBodyItemField(val.item), ["accessible_by"]: serializeCreateCollaborationRequestBodyAccessibleByField(val.accessibleBy), ["role"]: serializeCreateCollaborationRequestBodyRoleField(val.role), ["is_access_only"]: val.isAccessOnly, ["can_view_path"]: val.canViewPath, ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : (0, utils_js_1.serializeDateTime)(val.expiresAt) };
}
function deserializeCreateCollaborationRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateCollaborationRequestBody\"" });
    }
    if (val.item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"item\" of type \"CreateCollaborationRequestBody\" to be defined" });
    }
    const item = deserializeCreateCollaborationRequestBodyItemField(val.item);
    if (val.accessible_by == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"accessible_by\" of type \"CreateCollaborationRequestBody\" to be defined" });
    }
    const accessibleBy = deserializeCreateCollaborationRequestBodyAccessibleByField(val.accessible_by);
    if (val.role == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"role\" of type \"CreateCollaborationRequestBody\" to be defined" });
    }
    ...
    if (!(val.is_access_only == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_access_only)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_access_only\" of type \"CreateCollaborationRequestBody\"" });
    }
    const isAccessOnly = val.is_access_only == void 0 ? void 0 : val.is_access_only;
    if (!(val.can_view_path == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_view_path)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_view_path\" of type \"CreateCollaborationRequestBody\"" });
    }
    const canViewPath = val.can_view_path == void 0 ? void 0 : val.can_view_path;
    if (!(val.expires_at == void 0) && !(0, json_js_2.sdIsString)(val.expires_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"CreateCollaborationRequestBody\"" });
    }
    const expiresAt = val.expires_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.expires_at);
    return { item: item, accessibleBy: accessibleBy, role: role, isAccessOnly: isAccessOnly, canViewPath: canViewPath, expiresAt: expiresAt };
}
