...
class WebLinksManager {
    ...
    createWebLink(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateWebLinkOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/web_links"), method: "POST", headers: headersMap, data: serializeCreateWebLinkRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getWebLinkById(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            const optionals = new GetWebLinkByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/web_links/", (0, utils_js_4.toString)(webLinkId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, webLink_generated_js_1.deserializeWebLink)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateWebLinkById(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            const optionals = new UpdateWebLinkByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/web_links/", (0, utils_js_4.toString)(webLinkId)), method: "PUT", headers: headersMap, data: serializeUpdateWebLinkByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, webLink_generated_js_1.deserializeWebLink)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteWebLinkById(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            const optionals = new DeleteWebLinkByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/web_links/", (0, utils_js_4.toString)(webLinkId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateWebLinkRequestBodyParentField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateWebLinkRequestBodyParentField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateWebLinkRequestBodyParentField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateWebLinkRequestBodyParentField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCreateWebLinkRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateWebLinkRequestBody\"" });
    }
    if (val.url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"url\" of type \"CreateWebLinkRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"CreateWebLinkRequestBody\"" });
    }
    const url = val.url;
    if (val.parent == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parent\" of type \"CreateWebLinkRequestBody\" to be defined" });
    }
    const parent = deserializeCreateWebLinkRequestBodyParentField(val.parent);
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CreateWebLinkRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_1.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateWebLinkRequestBody\"" });
    }
...
function deserializeUpdateWebLinkByIdRequestBodyParentField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateWebLinkByIdRequestBodyParentField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateWebLinkByIdRequestBodyParentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.user_id == void 0) && !(0, json_js_1.sdIsString)(val.user_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"user_id\" of type \"UpdateWebLinkByIdRequestBodyParentField\"" });
    }
...
function deserializeUpdateWebLinkByIdRequestBodySharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateWebLinkByIdRequestBodySharedLinkAccessField" });
}
function serializeUpdateWebLinkByIdRequestBodySharedLinkField(val) {
    return { ["access"]: val.access == void 0 ? val.access : serializeUpdateWebLinkByIdRequestBodySharedLinkAccessField(val.access), ["password"]: val.password, ["vanity_name"]: val.vanityName, ["unshared_at"]: val.unsharedAt == void 0 ? val.unsharedAt : (0, utils_js_1.serializeDateTime)(val.unsharedAt) };
}
function deserializeUpdateWebLinkByIdRequestBodySharedLinkField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateWebLinkByIdRequestBodySharedLinkField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateWebLinkByIdRequestBodySharedLinkAccessField(val.access);
    if (!(val.password == void 0) && !(0, json_js_1.sdIsString)(val.password)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"password\" of type \"UpdateWebLinkByIdRequestBodySharedLinkField\"" });
    }
    const password = val.password == void 0 ? void 0 : val.password;
    if (!(val.vanity_name == void 0) && !(0, json_js_1.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"UpdateWebLinkByIdRequestBodySharedLinkField\"" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_1.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"UpdateWebLinkByIdRequestBodySharedLinkField\"" });
    }
...
function deserializeUpdateWebLinkByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateWebLinkByIdRequestBody\"" });
    }
    if (!(val.url == void 0) && !(0, json_js_1.sdIsString)(val.url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"url\" of type \"UpdateWebLinkByIdRequestBody\"" });
    }
    const url = val.url == void 0 ? void 0 : val.url;
    const parent = val.parent == void 0 ? void 0 : deserializeUpdateWebLinkByIdRequestBodyParentField(val.parent);
    if (!(val.name == void 0) && !(0, json_js_1.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"UpdateWebLinkByIdRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_1.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateWebLinkByIdRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeUpdateWebLinkByIdRequestBodySharedLinkField(val.shared_link);
