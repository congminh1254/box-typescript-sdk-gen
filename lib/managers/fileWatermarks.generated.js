...
class FileWatermarksManager {
    ...
    getFileWatermark(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new GetFileWatermarkOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/watermark"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateFileWatermark(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateFileWatermarkOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/watermark"), method: "PUT", headers: headersMap, data: serializeUpdateFileWatermarkRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, watermark_generated_js_1.deserializeWatermark)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFileWatermark(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new DeleteFileWatermarkOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/watermark"), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeUpdateFileWatermarkRequestBodyWatermarkImprintField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileWatermarkRequestBodyWatermarkImprintField" });
}
...
function deserializeUpdateFileWatermarkRequestBodyWatermarkField(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileWatermarkRequestBodyWatermarkField\"" });
    }
    if (val.imprint == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"imprint\" of type \"UpdateFileWatermarkRequestBodyWatermarkField\" to be defined" });
    }
...
function deserializeUpdateFileWatermarkRequestBodyWatermarkFieldInput(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileWatermarkRequestBodyWatermarkFieldInput\"" });
    }
    const imprint = val.imprint == void 0 ? void 0 : deserializeUpdateFileWatermarkRequestBodyWatermarkImprintField(val.imprint);
    return { imprint: imprint };
}
...
function deserializeUpdateFileWatermarkRequestBody(val) {
    if (!(0, json_js_1.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileWatermarkRequestBody\"" });
    }
    if (val.watermark == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"watermark\" of type \"UpdateFileWatermarkRequestBody\" to be defined" });
    }
