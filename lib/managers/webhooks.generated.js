...
class WebhooksManager {
    ...
    getWebhooks() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetWebhooksHeaders({}), cancellationToken) {
            const headers = new GetWebhooksHeaders({ extraHeaders: headersInput.extraHeaders });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/webhooks"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createWebhook(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateWebhookOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/webhooks"), method: "POST", headers: headersMap, data: serializeCreateWebhookRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getWebhookById(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, optionalsInput = {}) {
            const optionals = new GetWebhookByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/webhooks/", (0, utils_js_2.toString)(webhookId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, webhook_generated_js_1.deserializeWebhook)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateWebhookById(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, optionalsInput = {}) {
            const optionals = new UpdateWebhookByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/webhooks/", (0, utils_js_2.toString)(webhookId)), method: "PUT", headers: headersMap, data: serializeUpdateWebhookByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, webhook_generated_js_1.deserializeWebhook)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteWebhookById(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, optionalsInput = {}) {
            const optionals = new DeleteWebhookByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/webhooks/", (0, utils_js_2.toString)(webhookId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    static validateMessage(body_1, headers_1, primaryKey_1) {
        return __awaiter(this, arguments, void 0, function* (body, headers, primaryKey, optionalsInput = {}) {
            const optionals = new ValidateMessageOptionals({ secondaryKey: optionalsInput.secondaryKey, maxAge: optionalsInput.maxAge });
            ...
            if (currentEpoch - maxAge > (0, utils_js_6.dateTimeToEpochSeconds)(deliveryTimestamp) || (0, utils_js_6.dateTimeToEpochSeconds)(deliveryTimestamp) > currentEpoch) {
                return false;
            }
            if (primaryKey && (yield (0, utils_js_3.computeWebhookSignature)(body, headers, primaryKey)) == headers["box-signature-primary"]) {
                return true;
            }
            if (secondaryKey && (yield (0, utils_js_3.computeWebhookSignature)(body, headers, secondaryKey)) == headers["box-signature-secondary"]) {
                return true;
            }
            return false;
        });
...
function deserializeCreateWebhookRequestBodyTargetTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateWebhookRequestBodyTargetTypeField" });
}
...
function deserializeCreateWebhookRequestBodyTargetField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateWebhookRequestBodyTargetField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateWebhookRequestBodyTargetField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeCreateWebhookRequestBodyTargetTypeField(val.type);
...
function deserializeCreateWebhookRequestBodyTriggersField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateWebhookRequestBodyTriggersField" });
}
function serializeCreateWebhookRequestBody(val) {
    return { ["target"]: serializeCreateWebhookRequestBodyTargetField(val.target), ["address"]: val.address, ["triggers"]: val.triggers.map(function (item) {
            return serializeCreateWebhookRequestBodyTriggersField(item);
        }) };
}
function deserializeCreateWebhookRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateWebhookRequestBody\"" });
    }
    if (val.target == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"target\" of type \"CreateWebhookRequestBody\" to be defined" });
    }
    const target = deserializeCreateWebhookRequestBodyTargetField(val.target);
    if (val.address == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"address\" of type \"CreateWebhookRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.address)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"address\" of type \"CreateWebhookRequestBody\"" });
    }
    const address = val.address;
    if (val.triggers == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"triggers\" of type \"CreateWebhookRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.triggers)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"triggers\" of type \"CreateWebhookRequestBody\"" });
    }
    const triggers = (0, json_js_2.sdIsList)(val.triggers) ? val.triggers.map(function (itm) {
...
function deserializeUpdateWebhookByIdRequestBodyTargetTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateWebhookByIdRequestBodyTargetTypeField" });
}
...
function deserializeUpdateWebhookByIdRequestBodyTargetField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateWebhookByIdRequestBodyTargetField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateWebhookByIdRequestBodyTargetField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeUpdateWebhookByIdRequestBodyTargetTypeField(val.type);
    return { id: id, type: type };
}
...
function deserializeUpdateWebhookByIdRequestBodyTriggersField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateWebhookByIdRequestBodyTriggersField" });
}
function serializeUpdateWebhookByIdRequestBody(val) {
    return { ["target"]: val.target == void 0 ? val.target : serializeUpdateWebhookByIdRequestBodyTargetField(val.target), ["address"]: val.address, ["triggers"]: val.triggers == void 0 ? val.triggers : val.triggers.map(function (item) {
            return serializeUpdateWebhookByIdRequestBodyTriggersField(item);
        }) };
}
function deserializeUpdateWebhookByIdRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateWebhookByIdRequestBody\"" });
    }
    const target = val.target == void 0 ? void 0 : deserializeUpdateWebhookByIdRequestBodyTargetField(val.target);
    if (!(val.address == void 0) && !(0, json_js_1.sdIsString)(val.address)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"address\" of type \"UpdateWebhookByIdRequestBody\"" });
    }
    const address = val.address == void 0 ? void 0 : val.address;
    if (!(val.triggers == void 0) && !(0, json_js_2.sdIsList)(val.triggers)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"triggers\" of type \"UpdateWebhookByIdRequestBody\"" });
    }
    const triggers = val.triggers == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.triggers) ? val.triggers.map(function (itm) {
