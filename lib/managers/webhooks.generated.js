...
class WebhooksManager {
    ...
    getWebhooks() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetWebhooksHeaders({}), cancellationToken) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/webhooks'), {
                method: 'GET',
            ...
            return (0, webhooks_generated_js_1.deserializeWebhooks)(response.data);
        });
    }
    createWebhook(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, webhook_generated_js_1.deserializeWebhook)(response.data);
        });
    }
    getWebhookById(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/webhooks/', (0, utils_js_2.toString)(webhookId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
