...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPolicyAssignments(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            const optionals = new GetRetentionPolicyAssignmentsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["type"]: (0, utils_js_2.toString)(queryParams.type), ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined, ["marker"]: (0, utils_js_2.toString)(queryParams.marker), ["limit"]: (0, utils_js_2.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policies/", (0, utils_js_2.toString)(retentionPolicyId), "/assignments"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createRetentionPolicyAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateRetentionPolicyAssignmentOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policy_assignments"), method: "POST", headers: headersMap, data: serializeCreateRetentionPolicyAssignmentRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getRetentionPolicyAssignmentById(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            const optionals = new GetRetentionPolicyAssignmentByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policy_assignments/", (0, utils_js_2.toString)(retentionPolicyAssignmentId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, retentionPolicyAssignment_generated_js_1.deserializeRetentionPolicyAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteRetentionPolicyAssignmentById(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            const optionals = new DeleteRetentionPolicyAssignmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policy_assignments/", (0, utils_js_2.toString)(retentionPolicyAssignmentId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    getFilesUnderRetentionPolicyAssignment(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            const optionals = new GetFilesUnderRetentionPolicyAssignmentOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
...
function deserializeGetRetentionPolicyAssignmentsQueryParamsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetRetentionPolicyAssignmentsQueryParamsTypeField" });
}
...
function deserializeCreateRetentionPolicyAssignmentRequestBodyAssignToTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateRetentionPolicyAssignmentRequestBodyAssignToTypeField" });
}
...
function deserializeCreateRetentionPolicyAssignmentRequestBodyAssignToField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateRetentionPolicyAssignmentRequestBodyAssignToField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateRetentionPolicyAssignmentRequestBodyAssignToField\" to be defined" });
    }
    ...
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateRetentionPolicyAssignmentRequestBodyAssignToField\"" });
    }
...
function deserializeCreateRetentionPolicyAssignmentRequestBodyFilterFieldsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateRetentionPolicyAssignmentRequestBodyFilterFieldsField\"" });
    }
    if (!(val.field == void 0) && !(0, json_js_1.sdIsString)(val.field)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"field\" of type \"CreateRetentionPolicyAssignmentRequestBodyFilterFieldsField\"" });
    }
    const field = val.field == void 0 ? void 0 : val.field;
    if (!(val.value == void 0) && !(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"CreateRetentionPolicyAssignmentRequestBodyFilterFieldsField\"" });
    }
    const value = val.value == void 0 ? void 0 : val.value;
    return { field: field, value: value };
}
function serializeCreateRetentionPolicyAssignmentRequestBody(val) {
    return { ["policy_id"]: val.policyId, ["assign_to"]: serializeCreateRetentionPolicyAssignmentRequestBodyAssignToField(val.assignTo), ["filter_fields"]: val.filterFields == void 0 ? val.filterFields : val.filterFields.map(function (item) {
...
function deserializeCreateRetentionPolicyAssignmentRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateRetentionPolicyAssignmentRequestBody\"" });
    }
    if (val.policy_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"policy_id\" of type \"CreateRetentionPolicyAssignmentRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.policy_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_id\" of type \"CreateRetentionPolicyAssignmentRequestBody\"" });
    }
    const policyId = val.policy_id;
    if (val.assign_to == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"assign_to\" of type \"CreateRetentionPolicyAssignmentRequestBody\" to be defined" });
    }
    ...
    if (!(val.filter_fields == void 0) && !(0, json_js_2.sdIsList)(val.filter_fields)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"filter_fields\" of type \"CreateRetentionPolicyAssignmentRequestBody\"" });
    }
    const filterFields = val.filter_fields == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.filter_fields) ? val.filter_fields.map(function (itm) {
    ...
    if (!(val.start_date_field == void 0) && !(0, json_js_1.sdIsString)(val.start_date_field)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"start_date_field\" of type \"CreateRetentionPolicyAssignmentRequestBody\"" });
    }
