...
class RetentionPolicyAssignmentsManager {
    ...
    getRetentionPolicyAssignments(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policies/', (0, utils_js_2.toString)(retentionPolicyId), '/assignments'), {
                method: 'GET',
            ...
            return (0, retentionPolicyAssignments_generated_js_1.deserializeRetentionPolicyAssignments)(response.data);
        });
    }
    createRetentionPolicyAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policy_assignments'), {
                method: 'POST',
                headers: headersMap,
            ...
            return (0, retentionPolicyAssignment_generated_js_1.deserializeRetentionPolicyAssignment)(response.data);
        });
    }
    getRetentionPolicyAssignmentById(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policy_assignments/', (0, utils_js_2.toString)(retentionPolicyAssignmentId)), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
    ...
    getFilesUnderRetentionPolicyAssignment(retentionPolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyAssignmentId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policy_assignments/', (0, utils_js_2.toString)(retentionPolicyAssignmentId), '/files_under_retention'), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return (0, filesUnderRetention_generated_js_1.deserializeFilesUnderRetention)(response.data);
        });
    }
}
