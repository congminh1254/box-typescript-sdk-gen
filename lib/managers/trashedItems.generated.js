...
class TrashedItemsManager {
    ...
    getTrashedItems() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetTrashedItemsHeaders({}), cancellationToken) {
            const headers = new GetTrashedItemsHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined, ["limit"]: (0, utils_js_2.toString)(queryParams.limit), ["offset"]: (0, utils_js_2.toString)(queryParams.offset), ["usemarker"]: (0, utils_js_2.toString)(queryParams.usemarker), ["marker"]: (0, utils_js_2.toString)(queryParams.marker), ["direction"]: (0, utils_js_2.toString)(queryParams.direction), ["sort"]: (0, utils_js_2.toString)(queryParams.sort) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/trash/items"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
...
function deserializeGetTrashedItemsQueryParamsDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetTrashedItemsQueryParamsDirectionField" });
}
...
function deserializeGetTrashedItemsQueryParamsSortField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetTrashedItemsQueryParamsSortField" });
}
