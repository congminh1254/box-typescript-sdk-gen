...
class TermsOfServiceUserStatusesManager {
    ...
    getTermsOfServiceUserStatuses(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetTermsOfServiceUserStatusesOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
    ...
    createTermsOfServiceStatusForUser(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateTermsOfServiceStatusForUserOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_service_user_statuses"), method: "POST", headers: headersMap, data: serializeCreateTermsOfServiceStatusForUserRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateTermsOfServiceStatusForUserById(termsOfServiceUserStatusId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceUserStatusId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateTermsOfServiceStatusForUserByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_service_user_statuses/", (0, utils_js_2.toString)(termsOfServiceUserStatusId)), method: "PUT", headers: headersMap, data: serializeUpdateTermsOfServiceStatusForUserByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, termsOfServiceUserStatus_generated_js_1.deserializeTermsOfServiceUserStatus)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyTosTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTermsOfServiceStatusForUserRequestBodyTosTypeField" });
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyTosField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceStatusForUserRequestBodyTosField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateTermsOfServiceStatusForUserRequestBodyTosField\" to be defined" });
    }
    const type = deserializeCreateTermsOfServiceStatusForUserRequestBodyTosTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyTosField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyTosField\"" });
    }
    const id = val.id;
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyTosFieldInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceStatusForUserRequestBodyTosFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCreateTermsOfServiceStatusForUserRequestBodyTosTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyTosFieldInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyTosFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyUserTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTermsOfServiceStatusForUserRequestBodyUserTypeField" });
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyUserField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceStatusForUserRequestBodyUserField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateTermsOfServiceStatusForUserRequestBodyUserField\" to be defined" });
    }
    const type = deserializeCreateTermsOfServiceStatusForUserRequestBodyUserTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyUserField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyUserField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBodyUserFieldInput(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceStatusForUserRequestBodyUserFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCreateTermsOfServiceStatusForUserRequestBodyUserTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyUserFieldInput\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateTermsOfServiceStatusForUserRequestBodyUserFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeCreateTermsOfServiceStatusForUserRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceStatusForUserRequestBody\"" });
    }
    if (val.tos == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"tos\" of type \"CreateTermsOfServiceStatusForUserRequestBody\" to be defined" });
    }
    const tos = deserializeCreateTermsOfServiceStatusForUserRequestBodyTosField(val.tos);
    if (val.user == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"user\" of type \"CreateTermsOfServiceStatusForUserRequestBody\" to be defined" });
    }
    const user = deserializeCreateTermsOfServiceStatusForUserRequestBodyUserField(val.user);
    if (val.is_accepted == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"is_accepted\" of type \"CreateTermsOfServiceStatusForUserRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.is_accepted)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_accepted\" of type \"CreateTermsOfServiceStatusForUserRequestBody\"" });
    }
...
function deserializeUpdateTermsOfServiceStatusForUserByIdRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateTermsOfServiceStatusForUserByIdRequestBody\"" });
    }
    if (val.is_accepted == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"is_accepted\" of type \"UpdateTermsOfServiceStatusForUserByIdRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.is_accepted)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_accepted\" of type \"UpdateTermsOfServiceStatusForUserByIdRequestBody\"" });
    }
    const isAccepted = val.is_accepted;
