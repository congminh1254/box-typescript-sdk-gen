...
class TermsOfServiceUserStatusesManager {
    ...
    getTermsOfServiceUserStatuses(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/terms_of_service_user_statuses'), {
                method: 'GET',
            ...
            return (0, termsOfServiceUserStatuses_generated_js_1.deserializeTermsOfServiceUserStatuses)(response.data);
        });
    }
    createTermsOfServiceStatusForUser(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, termsOfServiceUserStatus_generated_js_1.deserializeTermsOfServiceUserStatus)(response.data);
        });
    }
    updateTermsOfServiceStatusForUserById(termsOfServiceUserStatusId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceUserStatusId, requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/terms_of_service_user_statuses/', (0, utils_js_2.toString)(termsOfServiceUserStatusId)), {
                method: 'PUT',
                headers: headersMap,
