...
class InvitesManager {
    ...
    createInvite(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateInviteOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/invites"), method: "POST", params: queryParamsMap, headers: headersMap, data: serializeCreateInviteRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getInviteById(inviteId_1) {
        return __awaiter(this, arguments, void 0, function* (inviteId, optionalsInput = {}) {
            const optionals = new GetInviteByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/invites/", (0, utils_js_2.toString)(inviteId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, invite_generated_js_1.deserializeInvite)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeCreateInviteRequestBodyEnterpriseField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateInviteRequestBodyEnterpriseField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateInviteRequestBodyEnterpriseField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateInviteRequestBodyEnterpriseField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCreateInviteRequestBodyActionableByField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateInviteRequestBodyActionableByField\"" });
    }
    if (!(val.login == void 0) && !(0, json_js_1.sdIsString)(val.login)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"login\" of type \"CreateInviteRequestBodyActionableByField\"" });
    }
...
function deserializeCreateInviteRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateInviteRequestBody\"" });
    }
    if (val.enterprise == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"enterprise\" of type \"CreateInviteRequestBody\" to be defined" });
    }
    const enterprise = deserializeCreateInviteRequestBodyEnterpriseField(val.enterprise);
    if (val.actionable_by == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"actionable_by\" of type \"CreateInviteRequestBody\" to be defined" });
    }
