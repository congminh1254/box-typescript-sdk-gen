...
class InvitesManager {
    ...
    createInvite(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/invites'), {
                method: 'POST',
            ...
            return (0, invite_generated_js_1.deserializeInvite)(response.data);
        });
    }
    getInviteById(inviteId_1) {
        return __awaiter(this, arguments, void 0, function* (inviteId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/invites/', (0, utils_js_2.toString)(inviteId)), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
