...
class TermsOfServicesManager {
    ...
    getTermsOfService() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetTermsOfServiceHeaders({}), cancellationToken) {
            const headers = new GetTermsOfServiceHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["tos_type"]: (0, utils_js_2.toString)(queryParams.tosType) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_services"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createTermsOfService(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateTermsOfServiceOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_services"), method: "POST", headers: headersMap, data: serializeCreateTermsOfServiceRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getTermsOfServiceById(termsOfServiceId_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceId, optionalsInput = {}) {
            const optionals = new GetTermsOfServiceByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_services/", (0, utils_js_2.toString)(termsOfServiceId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, termsOfService_generated_js_1.deserializeTermsOfService)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateTermsOfServiceById(termsOfServiceId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (termsOfServiceId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateTermsOfServiceByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/terms_of_services/", (0, utils_js_2.toString)(termsOfServiceId)), method: "PUT", headers: headersMap, data: serializeUpdateTermsOfServiceByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, termsOfService_generated_js_1.deserializeTermsOfService)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeGetTermsOfServiceQueryParamsTosTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetTermsOfServiceQueryParamsTosTypeField" });
}
...
function deserializeCreateTermsOfServiceRequestBodyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTermsOfServiceRequestBodyStatusField" });
}
...
function deserializeCreateTermsOfServiceRequestBodyTosTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTermsOfServiceRequestBodyTosTypeField" });
}
...
function deserializeCreateTermsOfServiceRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTermsOfServiceRequestBody\"" });
    }
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"CreateTermsOfServiceRequestBody\" to be defined" });
    }
    const status = deserializeCreateTermsOfServiceRequestBodyStatusField(val.status);
    const tosType = val.tos_type == void 0 ? void 0 : deserializeCreateTermsOfServiceRequestBodyTosTypeField(val.tos_type);
    if (val.text == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"text\" of type \"CreateTermsOfServiceRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.text)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text\" of type \"CreateTermsOfServiceRequestBody\"" });
    }
    const text = val.text;
...
function deserializeUpdateTermsOfServiceByIdRequestBodyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateTermsOfServiceByIdRequestBodyStatusField" });
}
...
function deserializeUpdateTermsOfServiceByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateTermsOfServiceByIdRequestBody\"" });
    }
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"UpdateTermsOfServiceByIdRequestBody\" to be defined" });
    }
    const status = deserializeUpdateTermsOfServiceByIdRequestBodyStatusField(val.status);
    if (val.text == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"text\" of type \"UpdateTermsOfServiceByIdRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.text)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"text\" of type \"UpdateTermsOfServiceByIdRequestBody\"" });
    }
    const text = val.text;
