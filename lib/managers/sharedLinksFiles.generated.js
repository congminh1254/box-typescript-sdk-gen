...
class SharedLinksFilesManager {
    ...
    findFileForSharedLink() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput, optionalsInput = {}) {
            const headers = new FindFileForSharedLinkHeaders({ ifNoneMatch: headersInput.ifNoneMatch, boxapi: headersInput.boxapi, extraHeaders: headersInput.extraHeaders });
            const optionals = new FindFileForSharedLinkOptionals({ cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shared_items"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getSharedLinkForFile(fileId_1, queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, queryParams, optionalsInput = {}) {
            const optionals = new GetSharedLinkForFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "#get_shared_link"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    addShareLinkToFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody = {}, queryParams, optionalsInput = {}) {
            const optionals = new AddShareLinkToFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: (0, utils_js_4.toString)(queryParams.fields) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "#add_shared_link"), method: "PUT", params: queryParamsMap, headers: headersMap, data: serializeAddShareLinkToFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateSharedLinkOnFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody = {}, queryParams, optionalsInput = {}) {
            const optionals = new UpdateSharedLinkOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: (0, utils_js_4.toString)(queryParams.fields) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "#update_shared_link"), method: "PUT", params: queryParamsMap, headers: headersMap, data: serializeUpdateSharedLinkOnFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    removeSharedLinkFromFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody = {}, queryParams, optionalsInput = {}) {
            const optionals = new RemoveSharedLinkFromFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: (0, utils_js_4.toString)(queryParams.fields) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "#remove_shared_link"), method: "PUT", params: queryParamsMap, headers: headersMap, data: serializeRemoveSharedLinkFromFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeAddShareLinkToFileRequestBodySharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AddShareLinkToFileRequestBodySharedLinkAccessField" });
}
...
function deserializeAddShareLinkToFileRequestBodySharedLinkPermissionsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddShareLinkToFileRequestBodySharedLinkPermissionsField\"" });
    }
    if (!(val.can_download == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"AddShareLinkToFileRequestBodySharedLinkPermissionsField\"" });
    }
    ...
    if (!(val.can_preview == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"AddShareLinkToFileRequestBodySharedLinkPermissionsField\"" });
    }
    ...
    if (!(val.can_edit == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_edit\" of type \"AddShareLinkToFileRequestBodySharedLinkPermissionsField\"" });
    }
...
function deserializeAddShareLinkToFileRequestBodySharedLinkField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddShareLinkToFileRequestBodySharedLinkField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeAddShareLinkToFileRequestBodySharedLinkAccessField(val.access);
    if (!(val.password == void 0) && !(0, json_js_2.sdIsString)(val.password)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"password\" of type \"AddShareLinkToFileRequestBodySharedLinkField\"" });
    }
    const password = val.password == void 0 ? void 0 : val.password;
    if (!(val.vanity_name == void 0) && !(0, json_js_2.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"AddShareLinkToFileRequestBodySharedLinkField\"" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_2.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"AddShareLinkToFileRequestBodySharedLinkField\"" });
    }
    const unsharedAt = val.unshared_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.unshared_at);
    const permissions = val.permissions == void 0 ? void 0 : deserializeAddShareLinkToFileRequestBodySharedLinkPermissionsField(val.permissions);
...
function deserializeAddShareLinkToFileRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddShareLinkToFileRequestBody\"" });
    }
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeAddShareLinkToFileRequestBodySharedLinkField(val.shared_link);
...
function deserializeUpdateSharedLinkOnFileRequestBodySharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateSharedLinkOnFileRequestBodySharedLinkAccessField" });
}
...
function deserializeUpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField\"" });
    }
    if (!(val.can_download == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField\"" });
    }
    const canDownload = val.can_download == void 0 ? void 0 : val.can_download;
    if (!(val.can_preview == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_preview)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField\"" });
    }
    const canPreview = val.can_preview == void 0 ? void 0 : val.can_preview;
    if (!(val.can_edit == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_edit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_edit\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField\"" });
    }
    const canEdit = val.can_edit == void 0 ? void 0 : val.can_edit;
    return { canDownload: canDownload, canPreview: canPreview, canEdit: canEdit };
}
...
function deserializeUpdateSharedLinkOnFileRequestBodySharedLinkField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateSharedLinkOnFileRequestBodySharedLinkField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateSharedLinkOnFileRequestBodySharedLinkAccessField(val.access);
    if (!(val.password == void 0) && !(0, json_js_2.sdIsString)(val.password)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"password\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkField\"" });
    }
    const password = val.password == void 0 ? void 0 : val.password;
    if (!(val.vanity_name == void 0) && !(0, json_js_2.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkField\"" });
    }
    const vanityName = val.vanity_name == void 0 ? void 0 : val.vanity_name;
    if (!(val.unshared_at == void 0) && !(0, json_js_2.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"UpdateSharedLinkOnFileRequestBodySharedLinkField\"" });
    }
    const unsharedAt = val.unshared_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.unshared_at);
    const permissions = val.permissions == void 0 ? void 0 : deserializeUpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField(val.permissions);
    return { access: access, password: password, vanityName: vanityName, unsharedAt: unsharedAt, permissions: permissions };
}
...
function deserializeUpdateSharedLinkOnFileRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateSharedLinkOnFileRequestBody\"" });
    }
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeUpdateSharedLinkOnFileRequestBodySharedLinkField(val.shared_link);
    return { sharedLink: sharedLink };
}
...
function deserializeRemoveSharedLinkFromFileRequestBodySharedLinkField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RemoveSharedLinkFromFileRequestBodySharedLinkField\"" });
    }
    return {};
}
...
function deserializeRemoveSharedLinkFromFileRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"RemoveSharedLinkFromFileRequestBody\"" });
    }
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeRemoveSharedLinkFromFileRequestBodySharedLinkField(val.shared_link);
    return { sharedLink: sharedLink };
}
