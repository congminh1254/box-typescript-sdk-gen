...
class TrashedWebLinksManager {
    ...
    restoreWeblinkFromTrash(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_js_2.toString)(webLinkId)), {
                method: 'POST',
            ...
            return (0, trashWebLinkRestored_generated_js_1.deserializeTrashWebLinkRestored)(response.data);
        });
    }
    getTrashedWebLinkById(webLinkId_1) {
        return __awaiter(this, arguments, void 0, function* (webLinkId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/web_links/', (0, utils_js_2.toString)(webLinkId), '/trash'), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return (0, trashWebLink_generated_js_1.deserializeTrashWebLink)(response.data);
        });
    }
