...
class CollaborationAllowlistEntriesManager {
    ...
    getCollaborationWhitelistEntries() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetCollaborationWhitelistEntriesHeaders({}), cancellationToken) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/collaboration_whitelist_entries'), {
                method: 'GET',
            ...
            return (0, collaborationAllowlistEntries_generated_js_1.deserializeCollaborationAllowlistEntries)(response.data);
        });
    }
    createCollaborationWhitelistEntry(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, collaborationAllowlistEntry_generated_js_1.deserializeCollaborationAllowlistEntry)(response.data);
        });
    }
    getCollaborationWhitelistEntryById(collaborationWhitelistEntryId_1) {
        return __awaiter(this, arguments, void 0, function* (collaborationWhitelistEntryId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/collaboration_whitelist_entries/', (0, utils_js_2.toString)(collaborationWhitelistEntryId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
