...
class FileClassificationsManager {
    ...
    getClassificationOnFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new GetClassificationOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    addClassificationToFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new AddClassificationToFileOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "POST", headers: headersMap, data: serializeAddClassificationToFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classification_generated_js_1.deserializeClassification)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateClassificationOnFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateClassificationOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateClassificationOnFileRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classification_generated_js_1.deserializeClassification)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteClassificationFromFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new DeleteClassificationFromFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeAddClassificationToFileRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationToFileRequestBody\"" });
    }
    if (!(val.Box__Security__Classification__Key == void 0) && !(0, json_js_1.sdIsString)(val.Box__Security__Classification__Key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"Box__Security__Classification__Key\" of type \"AddClassificationToFileRequestBody\"" });
    }
    const boxSecurityClassificationKey = val.Box__Security__Classification__Key == void 0 ? void 0 : val.Box__Security__Classification__Key;
...
function deserializeUpdateClassificationOnFileRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationOnFileRequestBodyOpField" });
}
...
function deserializeUpdateClassificationOnFileRequestBodyPathField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationOnFileRequestBodyPathField" });
}
...
function deserializeUpdateClassificationOnFileRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationOnFileRequestBody\"" });
    }
    if (val.op == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"op\" of type \"UpdateClassificationOnFileRequestBody\" to be defined" });
    }
    const op = deserializeUpdateClassificationOnFileRequestBodyOpField(val.op);
    if (val.path == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"path\" of type \"UpdateClassificationOnFileRequestBody\" to be defined" });
    }
    const path = deserializeUpdateClassificationOnFileRequestBodyPathField(val.path);
    if (val.value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"value\" of type \"UpdateClassificationOnFileRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateClassificationOnFileRequestBody\"" });
    }
...
function deserializeUpdateClassificationOnFileRequestBodyInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationOnFileRequestBodyInput\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateClassificationOnFileRequestBodyOpField(val.op);
    const path = val.path == void 0 ? void 0 : deserializeUpdateClassificationOnFileRequestBodyPathField(val.path);
    if (val.value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"value\" of type \"UpdateClassificationOnFileRequestBodyInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateClassificationOnFileRequestBodyInput\"" });
    }
    const value = val.value;
    return { op: op, path: path, value: value };
}
