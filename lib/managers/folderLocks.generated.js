...
class FolderLocksManager {
    ...
    getFolderLocks(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folder_locks'), {
                method: 'GET',
            ...
            return (0, folderLocks_generated_js_1.deserializeFolderLocks)(response.data);
        });
    }
    createFolderLock(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, folderLock_generated_js_1.deserializeFolderLock)(response.data);
        });
    }
    deleteFolderLockById(folderLockId_1) {
        return __awaiter(this, arguments, void 0, function* (folderLockId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/folder_locks/', (0, utils_js_2.toString)(folderLockId)), {
                method: 'DELETE',
                headers: headersMap,
