...
class FolderLocksManager {
    ...
    getFolderLocks(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetFolderLocksOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folder_locks"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFolderLock(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateFolderLockOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folder_locks"), method: "POST", headers: headersMap, data: serializeCreateFolderLockRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    deleteFolderLockById(folderLockId_1) {
        return __awaiter(this, arguments, void 0, function* (folderLockId, optionalsInput = {}) {
            const optionals = new DeleteFolderLockByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folder_locks/", (0, utils_js_2.toString)(folderLockId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateFolderLockRequestBodyLockedOperationsField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderLockRequestBodyLockedOperationsField\"" });
    }
    if (val.move == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"move\" of type \"CreateFolderLockRequestBodyLockedOperationsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.move)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"move\" of type \"CreateFolderLockRequestBodyLockedOperationsField\"" });
    }
    const move = val.move;
    if (val.delete == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"delete\" of type \"CreateFolderLockRequestBodyLockedOperationsField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsBoolean)(val.delete)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"delete\" of type \"CreateFolderLockRequestBodyLockedOperationsField\"" });
    }
...
function deserializeCreateFolderLockRequestBodyFolderField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderLockRequestBodyFolderField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateFolderLockRequestBodyFolderField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"type\" of type \"CreateFolderLockRequestBodyFolderField\"" });
    }
    const type = val.type;
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateFolderLockRequestBodyFolderField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateFolderLockRequestBodyFolderField\"" });
    }
    const id = val.id;
...
function deserializeCreateFolderLockRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderLockRequestBody\"" });
    }
    const lockedOperations = val.locked_operations == void 0 ? void 0 : deserializeCreateFolderLockRequestBodyLockedOperationsField(val.locked_operations);
    if (val.folder == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"folder\" of type \"CreateFolderLockRequestBody\" to be defined" });
    }
