...
class CommentsManager {
    ...
    getFileComments(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_2.toString)(fileId), '/comments'), {
                method: 'GET',
            ...
            return (0, comments_generated_js_1.deserializeComments)(response.data);
        });
    }
    getCommentById(commentId_1) {
        return __awaiter(this, arguments, void 0, function* (commentId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/comments/', (0, utils_js_2.toString)(commentId)), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
            ...
            return (0, commentFull_generated_js_1.deserializeCommentFull)(response.data);
        });
    }
    ...
    createComment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/comments'), {
                method: 'POST',
                params: queryParamsMap,
                headers: headersMap,
