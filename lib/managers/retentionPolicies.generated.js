...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetRetentionPoliciesHeaders({}), cancellationToken) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policies'), {
                method: 'GET',
            ...
            return (0, retentionPolicies_generated_js_1.deserializeRetentionPolicies)(response.data);
        });
    }
    createRetentionPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, retentionPolicy_generated_js_1.deserializeRetentionPolicy)(response.data);
        });
    }
    getRetentionPolicyById(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/retention_policies/', (0, utils_js_2.toString)(retentionPolicyId)), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
                responseFormat: 'json',
