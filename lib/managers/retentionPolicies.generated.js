...
class RetentionPoliciesManager {
    ...
    getRetentionPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetRetentionPoliciesHeaders({}), cancellationToken) {
            const headers = new GetRetentionPoliciesHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["policy_name"]: (0, utils_js_2.toString)(queryParams.policyName), ["policy_type"]: (0, utils_js_2.toString)(queryParams.policyType), ["created_by_user_id"]: (0, utils_js_2.toString)(queryParams.createdByUserId), ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined, ["limit"]: (0, utils_js_2.toString)(queryParams.limit), ["marker"]: (0, utils_js_2.toString)(queryParams.marker) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policies"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createRetentionPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateRetentionPolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policies"), method: "POST", headers: headersMap, data: serializeCreateRetentionPolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getRetentionPolicyById(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            const optionals = new GetRetentionPolicyByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
    ...
    updateRetentionPolicyById(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            const optionals = new UpdateRetentionPolicyByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
    ...
    deleteRetentionPolicyById(retentionPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (retentionPolicyId, optionalsInput = {}) {
            const optionals = new DeleteRetentionPolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/retention_policies/", (0, utils_js_2.toString)(retentionPolicyId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeGetRetentionPoliciesQueryParamsPolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetRetentionPoliciesQueryParamsPolicyTypeField" });
}
...
function deserializeCreateRetentionPolicyRequestBodyPolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateRetentionPolicyRequestBodyPolicyTypeField" });
}
...
function deserializeCreateRetentionPolicyRequestBodyDispositionActionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateRetentionPolicyRequestBodyDispositionActionField" });
}
...
function deserializeCreateRetentionPolicyRequestBodyRetentionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateRetentionPolicyRequestBodyRetentionTypeField" });
}
function serializeCreateRetentionPolicyRequestBody(val) {
    return { ["policy_name"]: val.policyName, ["description"]: val.description, ["policy_type"]: serializeCreateRetentionPolicyRequestBodyPolicyTypeField(val.policyType), ["disposition_action"]: serializeCreateRetentionPolicyRequestBodyDispositionActionField(val.dispositionAction), ["retention_length"]: val.retentionLength, ["retention_type"]: val.retentionType == void 0 ? val.retentionType : serializeCreateRetentionPolicyRequestBodyRetentionTypeField(val.retentionType), ["can_owner_extend_retention"]: val.canOwnerExtendRetention, ["are_owners_notified"]: val.areOwnersNotified, ["custom_notification_recipients"]: val.customNotificationRecipients == void 0 ? val.customNotificationRecipients : val.customNotificationRecipients.map(function (item) {
            return (0, userMini_generated_js_1.serializeUserMini)(item);
        }) };
}
function deserializeCreateRetentionPolicyRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateRetentionPolicyRequestBody\"" });
    }
    if (val.policy_name == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"policy_name\" of type \"CreateRetentionPolicyRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const policyName = val.policy_name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (val.policy_type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"policy_type\" of type \"CreateRetentionPolicyRequestBody\" to be defined" });
    }
    ...
    if (val.disposition_action == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"disposition_action\" of type \"CreateRetentionPolicyRequestBody\" to be defined" });
    }
    ...
    if (!(val.retention_length == void 0) && !(0, json_js_2.sdIsString)(val.retention_length)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const retentionLength = val.retention_length == void 0 ? void 0 : val.retention_length;
    const retentionType = val.retention_type == void 0 ? void 0 : deserializeCreateRetentionPolicyRequestBodyRetentionTypeField(val.retention_type);
    if (!(val.can_owner_extend_retention == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_owner_extend_retention)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_owner_extend_retention\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const canOwnerExtendRetention = val.can_owner_extend_retention == void 0 ? void 0 : val.can_owner_extend_retention;
    if (!(val.are_owners_notified == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_owners_notified)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_owners_notified\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const areOwnersNotified = val.are_owners_notified == void 0 ? void 0 : val.are_owners_notified;
    if (!(val.custom_notification_recipients == void 0) && !(0, json_js_3.sdIsList)(val.custom_notification_recipients)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"custom_notification_recipients\" of type \"CreateRetentionPolicyRequestBody\"" });
    }
    const customNotificationRecipients = val.custom_notification_recipients == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.custom_notification_recipients) ? val.custom_notification_recipients.map(function (itm) {
...
function serializeUpdateRetentionPolicyByIdRequestBody(val) {
    return { ["policy_name"]: val.policyName, ["description"]: val.description, ["disposition_action"]: val.dispositionAction, ["retention_type"]: val.retentionType, ["retention_length"]: val.retentionLength, ["status"]: val.status, ["can_owner_extend_retention"]: val.canOwnerExtendRetention, ["are_owners_notified"]: val.areOwnersNotified, ["custom_notification_recipients"]: val.customNotificationRecipients == void 0 ? val.customNotificationRecipients : val.customNotificationRecipients.map(function (item) {
            return (0, userBase_generated_js_1.serializeUserBase)(item);
        }) };
}
function deserializeUpdateRetentionPolicyByIdRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    if (!(val.policy_name == void 0) && !(0, json_js_2.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const policyName = val.policy_name == void 0 ? void 0 : val.policy_name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.disposition_action == void 0) && !(0, json_js_2.sdIsString)(val.disposition_action)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"disposition_action\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    ...
    if (!(val.retention_type == void 0) && !(0, json_js_2.sdIsString)(val.retention_type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"retention_type\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const retentionType = val.retention_type == void 0 ? void 0 : val.retention_type;
    if (!(val.retention_length == void 0) && !(0, json_js_2.sdIsString)(val.retention_length)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const retentionLength = val.retention_length == void 0 ? void 0 : val.retention_length;
    if (!(val.status == void 0) && !(0, json_js_2.sdIsString)(val.status)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"status\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const status = val.status == void 0 ? void 0 : val.status;
    if (!(val.can_owner_extend_retention == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_owner_extend_retention)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_owner_extend_retention\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const canOwnerExtendRetention = val.can_owner_extend_retention == void 0 ? void 0 : val.can_owner_extend_retention;
    if (!(val.are_owners_notified == void 0) && !(0, json_js_1.sdIsBoolean)(val.are_owners_notified)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"are_owners_notified\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const areOwnersNotified = val.are_owners_notified == void 0 ? void 0 : val.are_owners_notified;
    if (!(val.custom_notification_recipients == void 0) && !(0, json_js_3.sdIsList)(val.custom_notification_recipients)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"custom_notification_recipients\" of type \"UpdateRetentionPolicyByIdRequestBody\"" });
    }
    const customNotificationRecipients = val.custom_notification_recipients == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.custom_notification_recipients) ? val.custom_notification_recipients.map(function (itm) {
