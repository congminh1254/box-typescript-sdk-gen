...
class MetadataCascadePoliciesManager {
    ...
    getMetadataCascadePolicies(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetMetadataCascadePoliciesOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createMetadataCascadePolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateMetadataCascadePolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies"), method: "POST", headers: headersMap, data: serializeCreateMetadataCascadePolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getMetadataCascadePolicyById(metadataCascadePolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (metadataCascadePolicyId, optionalsInput = {}) {
            const optionals = new GetMetadataCascadePolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", (0, utils_js_2.toString)(metadataCascadePolicyId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataCascadePolicy_generated_js_1.deserializeMetadataCascadePolicy)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteMetadataCascadePolicyById(metadataCascadePolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (metadataCascadePolicyId, optionalsInput = {}) {
            const optionals = new DeleteMetadataCascadePolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", (0, utils_js_2.toString)(metadataCascadePolicyId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    applyMetadataCascadePolicy(metadataCascadePolicyId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (metadataCascadePolicyId, requestBody, optionalsInput = {}) {
            const optionals = new ApplyMetadataCascadePolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", (0, utils_js_2.toString)(metadataCascadePolicyId), "/apply"), method: "POST", headers: headersMap, data: serializeApplyMetadataCascadePolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateMetadataCascadePolicyRequestBodyScopeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateMetadataCascadePolicyRequestBodyScopeField" });
}
...
function deserializeCreateMetadataCascadePolicyRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateMetadataCascadePolicyRequestBody\"" });
    }
    if (val.folder_id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"folder_id\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.folder_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"CreateMetadataCascadePolicyRequestBody\"" });
    }
    const folderId = val.folder_id;
    if (val.scope == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"scope\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    const scope = deserializeCreateMetadataCascadePolicyRequestBodyScopeField(val.scope);
    if (val.templateKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"templateKey\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.templateKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"CreateMetadataCascadePolicyRequestBody\"" });
    }
...
function deserializeApplyMetadataCascadePolicyRequestBodyConflictResolutionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize ApplyMetadataCascadePolicyRequestBodyConflictResolutionField" });
}
...
function deserializeApplyMetadataCascadePolicyRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"ApplyMetadataCascadePolicyRequestBody\"" });
    }
    if (val.conflict_resolution == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"conflict_resolution\" of type \"ApplyMetadataCascadePolicyRequestBody\" to be defined" });
    }
