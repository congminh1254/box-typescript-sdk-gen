...
class StoragePolicyAssignmentsManager {
    ...
    getStoragePolicyAssignments(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetStoragePolicyAssignmentsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/storage_policy_assignments"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createStoragePolicyAssignment(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateStoragePolicyAssignmentOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/storage_policy_assignments"), method: "POST", headers: headersMap, data: serializeCreateStoragePolicyAssignmentRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getStoragePolicyAssignmentById(storagePolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (storagePolicyAssignmentId, optionalsInput = {}) {
            const optionals = new GetStoragePolicyAssignmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/storage_policy_assignments/", (0, utils_js_2.toString)(storagePolicyAssignmentId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, storagePolicyAssignment_generated_js_1.deserializeStoragePolicyAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateStoragePolicyAssignmentById(storagePolicyAssignmentId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (storagePolicyAssignmentId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateStoragePolicyAssignmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/storage_policy_assignments/", (0, utils_js_2.toString)(storagePolicyAssignmentId)), method: "PUT", headers: headersMap, data: serializeUpdateStoragePolicyAssignmentByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, storagePolicyAssignment_generated_js_1.deserializeStoragePolicyAssignment)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteStoragePolicyAssignmentById(storagePolicyAssignmentId_1) {
        return __awaiter(this, arguments, void 0, function* (storagePolicyAssignmentId, optionalsInput = {}) {
            const optionals = new DeleteStoragePolicyAssignmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/storage_policy_assignments/", (0, utils_js_2.toString)(storagePolicyAssignmentId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeGetStoragePolicyAssignmentsQueryParamsResolvedForTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetStoragePolicyAssignmentsQueryParamsResolvedForTypeField" });
}
...
function deserializeCreateStoragePolicyAssignmentRequestBodyStoragePolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateStoragePolicyAssignmentRequestBodyStoragePolicyTypeField" });
}
...
function deserializeCreateStoragePolicyAssignmentRequestBodyStoragePolicyField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyField\" to be defined" });
    }
    const type = deserializeCreateStoragePolicyAssignmentRequestBodyStoragePolicyTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyField\"" });
    }
    const id = val.id;
...
function deserializeCreateStoragePolicyAssignmentRequestBodyStoragePolicyFieldInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCreateStoragePolicyAssignmentRequestBodyStoragePolicyTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyStoragePolicyFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeCreateStoragePolicyAssignmentRequestBodyAssignedToTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateStoragePolicyAssignmentRequestBodyAssignedToTypeField" });
}
...
function deserializeCreateStoragePolicyAssignmentRequestBodyAssignedToField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateStoragePolicyAssignmentRequestBodyAssignedToField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateStoragePolicyAssignmentRequestBodyAssignedToField\" to be defined" });
    }
    const type = deserializeCreateStoragePolicyAssignmentRequestBodyAssignedToTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyAssignedToField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateStoragePolicyAssignmentRequestBodyAssignedToField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeCreateStoragePolicyAssignmentRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateStoragePolicyAssignmentRequestBody\"" });
    }
    if (val.storage_policy == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"storage_policy\" of type \"CreateStoragePolicyAssignmentRequestBody\" to be defined" });
    }
    ...
    if (val.assigned_to == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"assigned_to\" of type \"CreateStoragePolicyAssignmentRequestBody\" to be defined" });
    }
...
function deserializeUpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyTypeField" });
}
...
function deserializeUpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField\" to be defined" });
    }
    const type = deserializeUpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyField\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeUpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyFieldInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeUpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyTypeField(val.type);
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyFieldInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateStoragePolicyAssignmentByIdRequestBodyStoragePolicyFieldInput\"" });
    }
    const id = val.id;
    return { type: type, id: id };
}
...
function deserializeUpdateStoragePolicyAssignmentByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateStoragePolicyAssignmentByIdRequestBody\"" });
    }
    if (val.storage_policy == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"storage_policy\" of type \"UpdateStoragePolicyAssignmentByIdRequestBody\" to be defined" });
    }
