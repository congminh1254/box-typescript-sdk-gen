...
class TasksManager {
    ...
    getFileTasks(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_4.toString)(fileId), '/tasks'), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return (0, tasks_generated_js_1.deserializeTasks)(response.data);
        });
    }
    createTask(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/tasks'), {
                method: 'POST',
                headers: headersMap,
            ...
            return (0, task_generated_js_1.deserializeTask)(response.data);
        });
    }
    getTaskById(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/tasks/', (0, utils_js_4.toString)(taskId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
...
function serializeCreateTaskRequestBody(val) {
    return {
        ...
        ['due_at']: val.dueAt == void 0 ? void 0 : (0, utils_js_1.serializeDateTime)(val.dueAt),
