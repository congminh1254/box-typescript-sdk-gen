...
class TasksManager {
    ...
    createTask(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateTaskOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/tasks"), method: "POST", headers: headersMap, data: serializeCreateTaskRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getTaskById(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            const optionals = new GetTaskByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/tasks/", (0, utils_js_4.toString)(taskId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, task_generated_js_1.deserializeTask)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateTaskById(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            const optionals = new UpdateTaskByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/tasks/", (0, utils_js_4.toString)(taskId)), method: "PUT", headers: headersMap, data: serializeUpdateTaskByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, task_generated_js_1.deserializeTask)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteTaskById(taskId_1) {
        return __awaiter(this, arguments, void 0, function* (taskId, optionalsInput = {}) {
            const optionals = new DeleteTaskByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/tasks/", (0, utils_js_4.toString)(taskId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateTaskRequestBodyItemTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTaskRequestBodyItemTypeField" });
}
...
function deserializeCreateTaskRequestBodyItemField(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTaskRequestBodyItemField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateTaskRequestBodyItemField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    const type = val.type == void 0 ? void 0 : deserializeCreateTaskRequestBodyItemTypeField(val.type);
...
function deserializeCreateTaskRequestBodyActionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTaskRequestBodyActionField" });
}
...
function deserializeCreateTaskRequestBodyCompletionRuleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateTaskRequestBodyCompletionRuleField" });
}
function serializeCreateTaskRequestBody(val) {
    return { ["item"]: serializeCreateTaskRequestBodyItemField(val.item), ["action"]: val.action == void 0 ? val.action : serializeCreateTaskRequestBodyActionField(val.action), ["message"]: val.message, ["due_at"]: val.dueAt == void 0 ? val.dueAt : (0, utils_js_1.serializeDateTime)(val.dueAt), ["completion_rule"]: val.completionRule == void 0 ? val.completionRule : serializeCreateTaskRequestBodyCompletionRuleField(val.completionRule) };
}
function deserializeCreateTaskRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateTaskRequestBody\"" });
    }
    if (val.item == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"item\" of type \"CreateTaskRequestBody\" to be defined" });
    }
    const item = deserializeCreateTaskRequestBodyItemField(val.item);
    const action = val.action == void 0 ? void 0 : deserializeCreateTaskRequestBodyActionField(val.action);
    if (!(val.message == void 0) && !(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"CreateTaskRequestBody\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.due_at == void 0) && !(0, json_js_1.sdIsString)(val.due_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"due_at\" of type \"CreateTaskRequestBody\"" });
    }
    const dueAt = val.due_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.due_at);
    const completionRule = val.completion_rule == void 0 ? void 0 : deserializeCreateTaskRequestBodyCompletionRuleField(val.completion_rule);
...
function deserializeUpdateTaskByIdRequestBodyActionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateTaskByIdRequestBodyActionField" });
}
...
function deserializeUpdateTaskByIdRequestBodyCompletionRuleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateTaskByIdRequestBodyCompletionRuleField" });
}
function serializeUpdateTaskByIdRequestBody(val) {
    return { ["action"]: val.action == void 0 ? val.action : serializeUpdateTaskByIdRequestBodyActionField(val.action), ["message"]: val.message, ["due_at"]: val.dueAt == void 0 ? val.dueAt : (0, utils_js_1.serializeDateTime)(val.dueAt), ["completion_rule"]: val.completionRule == void 0 ? val.completionRule : serializeUpdateTaskByIdRequestBodyCompletionRuleField(val.completionRule) };
}
function deserializeUpdateTaskByIdRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateTaskByIdRequestBody\"" });
    }
    const action = val.action == void 0 ? void 0 : deserializeUpdateTaskByIdRequestBodyActionField(val.action);
    if (!(val.message == void 0) && !(0, json_js_1.sdIsString)(val.message)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"message\" of type \"UpdateTaskByIdRequestBody\"" });
    }
    const message = val.message == void 0 ? void 0 : val.message;
    if (!(val.due_at == void 0) && !(0, json_js_1.sdIsString)(val.due_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"due_at\" of type \"UpdateTaskByIdRequestBody\"" });
    }
    const dueAt = val.due_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.due_at);
    const completionRule = val.completion_rule == void 0 ? void 0 : deserializeUpdateTaskByIdRequestBodyCompletionRuleField(val.completion_rule);
