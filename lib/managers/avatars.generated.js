...
class AvatarsManager {
    ...
    getUserAvatar(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/users/', (0, utils_js_2.toString)(userId), '/avatar'), {
                method: 'GET',
                headers: headersMap,
    ...
    createUserAvatar(userId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (userId, requestBody, optionalsInput = {}) {
            ...
            return (0, userAvatar_generated_js_1.deserializeUserAvatar)(response.data);
        });
    }
