...
class FolderClassificationsManager {
    ...
    getClassificationOnFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new GetClassificationOnFolderOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    addClassificationToFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new AddClassificationToFolderOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "POST", headers: headersMap, data: serializeAddClassificationToFolderRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classification_generated_js_1.deserializeClassification)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateClassificationOnFolder(folderId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateClassificationOnFolderOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateClassificationOnFolderRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classification_generated_js_1.deserializeClassification)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteClassificationFromFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new DeleteClassificationFromFolderOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_2.toString)(folderId), "/metadata/enterprise/securityClassification-6VMVochwUWo"), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeAddClassificationToFolderRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationToFolderRequestBody\"" });
    }
    if (!(val.Box__Security__Classification__Key == void 0) && !(0, json_js_1.sdIsString)(val.Box__Security__Classification__Key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"Box__Security__Classification__Key\" of type \"AddClassificationToFolderRequestBody\"" });
    }
...
function deserializeUpdateClassificationOnFolderRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationOnFolderRequestBodyOpField" });
}
...
function deserializeUpdateClassificationOnFolderRequestBodyPathField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationOnFolderRequestBodyPathField" });
}
...
function deserializeUpdateClassificationOnFolderRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationOnFolderRequestBody\"" });
    }
    if (val.op == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"op\" of type \"UpdateClassificationOnFolderRequestBody\" to be defined" });
    }
    const op = deserializeUpdateClassificationOnFolderRequestBodyOpField(val.op);
    if (val.path == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"path\" of type \"UpdateClassificationOnFolderRequestBody\" to be defined" });
    }
    const path = deserializeUpdateClassificationOnFolderRequestBodyPathField(val.path);
    if (val.value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"value\" of type \"UpdateClassificationOnFolderRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateClassificationOnFolderRequestBody\"" });
    }
...
function deserializeUpdateClassificationOnFolderRequestBodyInput(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationOnFolderRequestBodyInput\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateClassificationOnFolderRequestBodyOpField(val.op);
    const path = val.path == void 0 ? void 0 : deserializeUpdateClassificationOnFolderRequestBodyPathField(val.path);
    if (val.value == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"value\" of type \"UpdateClassificationOnFolderRequestBodyInput\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateClassificationOnFolderRequestBodyInput\"" });
    }
    const value = val.value;
    return { op: op, path: path, value: value };
}
