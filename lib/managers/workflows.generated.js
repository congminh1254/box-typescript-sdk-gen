...
class WorkflowsManager {
    ...
    getWorkflows(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetWorkflowsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/workflows"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    startWorkflow(workflowId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (workflowId, requestBody, optionalsInput = {}) {
            const optionals = new StartWorkflowOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/workflows/", (0, utils_js_2.toString)(workflowId), "/start"), method: "POST", headers: headersMap, data: serializeStartWorkflowRequestBody(requestBody), contentType: "application/json", responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeStartWorkflowRequestBodyTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StartWorkflowRequestBodyTypeField" });
}
...
function deserializeStartWorkflowRequestBodyFlowField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StartWorkflowRequestBodyFlowField\"" });
    }
    if (!(val.type == void 0) && !(0, json_js_1.sdIsString)(val.type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"type\" of type \"StartWorkflowRequestBodyFlowField\"" });
    }
    const type = val.type == void 0 ? void 0 : val.type;
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StartWorkflowRequestBodyFlowField\"" });
    }
...
function deserializeStartWorkflowRequestBodyFilesTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StartWorkflowRequestBodyFilesTypeField" });
}
...
function deserializeStartWorkflowRequestBodyFilesField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StartWorkflowRequestBodyFilesField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeStartWorkflowRequestBodyFilesTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StartWorkflowRequestBodyFilesField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    return { type: type, id: id };
}
...
function deserializeStartWorkflowRequestBodyFolderTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize StartWorkflowRequestBodyFolderTypeField" });
}
...
function deserializeStartWorkflowRequestBodyFolderField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StartWorkflowRequestBodyFolderField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeStartWorkflowRequestBodyFolderTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"StartWorkflowRequestBodyFolderField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    return { type: type, id: id };
}
function serializeStartWorkflowRequestBody(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeStartWorkflowRequestBodyTypeField(val.type), ["flow"]: serializeStartWorkflowRequestBodyFlowField(val.flow), ["files"]: val.files.map(function (item) {
            return serializeStartWorkflowRequestBodyFilesField(item);
        }), ["folder"]: serializeStartWorkflowRequestBodyFolderField(val.folder), ["outcomes"]: val.outcomes == void 0 ? val.outcomes : val.outcomes.map(function (item) {
            return (0, outcome_generated_js_1.serializeOutcome)(item);
        }) };
}
function deserializeStartWorkflowRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"StartWorkflowRequestBody\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeStartWorkflowRequestBodyTypeField(val.type);
    if (val.flow == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"flow\" of type \"StartWorkflowRequestBody\" to be defined" });
    }
    const flow = deserializeStartWorkflowRequestBodyFlowField(val.flow);
    if (val.files == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"files\" of type \"StartWorkflowRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsList)(val.files)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"files\" of type \"StartWorkflowRequestBody\"" });
    }
    const files = (0, json_js_2.sdIsList)(val.files) ? val.files.map(function (itm) {
        return deserializeStartWorkflowRequestBodyFilesField(itm);
    }) : [];
    if (val.folder == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"folder\" of type \"StartWorkflowRequestBody\" to be defined" });
    }
    ...
    if (!(val.outcomes == void 0) && !(0, json_js_2.sdIsList)(val.outcomes)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"outcomes\" of type \"StartWorkflowRequestBody\"" });
    }
    const outcomes = val.outcomes == void 0 ? void 0 : (0, json_js_2.sdIsList)(val.outcomes) ? val.outcomes.map(function (itm) {
