...
class ClassificationsManager {
    ...
    getClassificationTemplate() {
        return __awaiter(this, arguments, void 0, function* (headersInput = new GetClassificationTemplateHeaders({}), cancellationToken) {
            const headers = new GetClassificationTemplateHeaders({ extraHeaders: headersInput.extraHeaders });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    addClassification(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new AddClassificationOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema#add"), method: "PUT", headers: headersMap, data: requestBody.map(serializeAddClassificationRequestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classificationTemplate_generated_js_1.deserializeClassificationTemplate)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateClassification(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new UpdateClassificationOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/enterprise/securityClassification-6VMVochwUWo/schema#update"), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateClassificationRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classificationTemplate_generated_js_1.deserializeClassificationTemplate)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createClassificationTemplate(requestBodyInput_1) {
        return __awaiter(this, arguments, void 0, function* (requestBodyInput, optionalsInput = {}) {
            const requestBody = new CreateClassificationTemplateRequestBody({ scope: requestBodyInput.scope, templateKey: requestBodyInput.templateKey, displayName: requestBodyInput.displayName, hidden: requestBodyInput.hidden, copyInstanceOnItemCopy: requestBodyInput.copyInstanceOnItemCopy, fields: requestBodyInput.fields });
            const optionals = new CreateClassificationTemplateOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/schema#classifications"), method: "POST", headers: headersMap, data: serializeCreateClassificationTemplateRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, classificationTemplate_generated_js_1.deserializeClassificationTemplate)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeAddClassificationRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AddClassificationRequestBodyOpField" });
}
...
function deserializeAddClassificationRequestBodyFieldKeyField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize AddClassificationRequestBodyFieldKeyField" });
}
...
function deserializeAddClassificationRequestBodyDataStaticConfigClassificationField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
    if (!(val.classificationDefinition == void 0) && !(0, json_js_3.sdIsString)(val.classificationDefinition)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"classificationDefinition\" of type \"AddClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
    const classificationDefinition = val.classificationDefinition == void 0 ? void 0 : val.classificationDefinition;
    if (!(val.colorID == void 0) && !(0, json_js_2.sdIsNumber)(val.colorID)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"colorID\" of type \"AddClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
...
function deserializeAddClassificationRequestBodyDataStaticConfigField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationRequestBodyDataStaticConfigField\"" });
    }
    const classification = val.classification == void 0 ? void 0 : deserializeAddClassificationRequestBodyDataStaticConfigClassificationField(val.classification);
...
function deserializeAddClassificationRequestBodyDataField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationRequestBodyDataField\"" });
    }
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"AddClassificationRequestBodyDataField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"key\" of type \"AddClassificationRequestBodyDataField\"" });
    }
    const key = val.key;
    const staticConfig = val.staticConfig == void 0 ? void 0 : deserializeAddClassificationRequestBodyDataStaticConfigField(val.staticConfig);
...
function deserializeAddClassificationRequestBody(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationRequestBody\"" });
    }
    if (val.op == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"op\" of type \"AddClassificationRequestBody\" to be defined" });
    }
    const op = deserializeAddClassificationRequestBodyOpField(val.op);
    if (val.fieldKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"fieldKey\" of type \"AddClassificationRequestBody\" to be defined" });
    }
    const fieldKey = deserializeAddClassificationRequestBodyFieldKeyField(val.fieldKey);
    if (val.data == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"data\" of type \"AddClassificationRequestBody\" to be defined" });
    }
    const data = deserializeAddClassificationRequestBodyDataField(val.data);
    return { op: op, fieldKey: fieldKey, data: data };
}
...
function deserializeAddClassificationRequestBodyInput(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"AddClassificationRequestBodyInput\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeAddClassificationRequestBodyOpField(val.op);
    const fieldKey = val.fieldKey == void 0 ? void 0 : deserializeAddClassificationRequestBodyFieldKeyField(val.fieldKey);
    if (val.data == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"data\" of type \"AddClassificationRequestBodyInput\" to be defined" });
    }
    const data = deserializeAddClassificationRequestBodyDataField(val.data);
    return { op: op, fieldKey: fieldKey, data: data };
}
...
function deserializeUpdateClassificationRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationRequestBodyOpField" });
}
...
function deserializeUpdateClassificationRequestBodyFieldKeyField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateClassificationRequestBodyFieldKeyField" });
}
...
function deserializeUpdateClassificationRequestBodyDataStaticConfigClassificationField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
    if (!(val.classificationDefinition == void 0) && !(0, json_js_3.sdIsString)(val.classificationDefinition)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"classificationDefinition\" of type \"UpdateClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
    const classificationDefinition = val.classificationDefinition == void 0 ? void 0 : val.classificationDefinition;
    if (!(val.colorID == void 0) && !(0, json_js_2.sdIsNumber)(val.colorID)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"colorID\" of type \"UpdateClassificationRequestBodyDataStaticConfigClassificationField\"" });
    }
    const colorId = val.colorID == void 0 ? void 0 : val.colorID;
    return { classificationDefinition: classificationDefinition, colorId: colorId };
}
...
function deserializeUpdateClassificationRequestBodyDataStaticConfigField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationRequestBodyDataStaticConfigField\"" });
    }
    const classification = val.classification == void 0 ? void 0 : deserializeUpdateClassificationRequestBodyDataStaticConfigClassificationField(val.classification);
    return { classification: classification };
}
...
function deserializeUpdateClassificationRequestBodyDataField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationRequestBodyDataField\"" });
    }
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"UpdateClassificationRequestBodyDataField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"key\" of type \"UpdateClassificationRequestBodyDataField\"" });
    }
    const key = val.key;
    const staticConfig = val.staticConfig == void 0 ? void 0 : deserializeUpdateClassificationRequestBodyDataStaticConfigField(val.staticConfig);
    return { key: key, staticConfig: staticConfig };
}
...
function deserializeUpdateClassificationRequestBody(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationRequestBody\"" });
    }
    if (val.op == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"op\" of type \"UpdateClassificationRequestBody\" to be defined" });
    }
    const op = deserializeUpdateClassificationRequestBodyOpField(val.op);
    if (val.fieldKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"fieldKey\" of type \"UpdateClassificationRequestBody\" to be defined" });
    }
    const fieldKey = deserializeUpdateClassificationRequestBodyFieldKeyField(val.fieldKey);
    if (val.enumOptionKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"enumOptionKey\" of type \"UpdateClassificationRequestBody\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.enumOptionKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"enumOptionKey\" of type \"UpdateClassificationRequestBody\"" });
    }
    const enumOptionKey = val.enumOptionKey;
    if (val.data == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"data\" of type \"UpdateClassificationRequestBody\" to be defined" });
    }
    const data = deserializeUpdateClassificationRequestBodyDataField(val.data);
    return { op: op, fieldKey: fieldKey, enumOptionKey: enumOptionKey, data: data };
}
...
function deserializeUpdateClassificationRequestBodyInput(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateClassificationRequestBodyInput\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateClassificationRequestBodyOpField(val.op);
    const fieldKey = val.fieldKey == void 0 ? void 0 : deserializeUpdateClassificationRequestBodyFieldKeyField(val.fieldKey);
    if (val.enumOptionKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"enumOptionKey\" of type \"UpdateClassificationRequestBodyInput\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.enumOptionKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"enumOptionKey\" of type \"UpdateClassificationRequestBodyInput\"" });
    }
    const enumOptionKey = val.enumOptionKey;
    if (val.data == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"data\" of type \"UpdateClassificationRequestBodyInput\" to be defined" });
    }
    const data = deserializeUpdateClassificationRequestBodyDataField(val.data);
    return { op: op, fieldKey: fieldKey, enumOptionKey: enumOptionKey, data: data };
}
...
function deserializeCreateClassificationTemplateRequestBodyScopeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyScopeField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyTemplateKeyField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyTemplateKeyField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyDisplayNameField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyDisplayNameField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyFieldsTypeField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsKeyField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyFieldsKeyField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsDisplayNameField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateClassificationTemplateRequestBodyFieldsDisplayNameField" });
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField\"" });
    }
    if (!(val.classificationDefinition == void 0) && !(0, json_js_3.sdIsString)(val.classificationDefinition)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"classificationDefinition\" of type \"CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField\"" });
    }
    const classificationDefinition = val.classificationDefinition == void 0 ? void 0 : val.classificationDefinition;
    if (!(val.colorID == void 0) && !(0, json_js_2.sdIsNumber)(val.colorID)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"colorID\" of type \"CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField\"" });
    }
    const colorId = val.colorID == void 0 ? void 0 : val.colorID;
    return { classificationDefinition: classificationDefinition, colorId: colorId };
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField\"" });
    }
    const classification = val.classification == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigClassificationField(val.classification);
    return { classification: classification };
}
...
function deserializeCreateClassificationTemplateRequestBodyFieldsOptionsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyFieldsOptionsField\"" });
    }
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"CreateClassificationTemplateRequestBodyFieldsOptionsField\" to be defined" });
    }
    if (!(0, json_js_3.sdIsString)(val.key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"key\" of type \"CreateClassificationTemplateRequestBodyFieldsOptionsField\"" });
    }
    const key = val.key;
    const staticConfig = val.staticConfig == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyFieldsOptionsStaticConfigField(val.staticConfig);
    return { key: key, staticConfig: staticConfig };
}
function serializeCreateClassificationTemplateRequestBodyFieldsField(val) {
    return { ["type"]: serializeCreateClassificationTemplateRequestBodyFieldsTypeField(val.type), ["key"]: serializeCreateClassificationTemplateRequestBodyFieldsKeyField(val.key), ["displayName"]: serializeCreateClassificationTemplateRequestBodyFieldsDisplayNameField(val.displayName), ["hidden"]: val.hidden, ["options"]: val.options.map(function (item) {
...
function deserializeCreateClassificationTemplateRequestBodyFieldsField(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyFieldsField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateClassificationTemplateRequestBodyFieldsField\" to be defined" });
    }
    const type = deserializeCreateClassificationTemplateRequestBodyFieldsTypeField(val.type);
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"CreateClassificationTemplateRequestBodyFieldsField\" to be defined" });
    }
    const key = deserializeCreateClassificationTemplateRequestBodyFieldsKeyField(val.key);
    if (val.displayName == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"displayName\" of type \"CreateClassificationTemplateRequestBodyFieldsField\" to be defined" });
    }
    ...
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateClassificationTemplateRequestBodyFieldsField\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (val.options == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"options\" of type \"CreateClassificationTemplateRequestBodyFieldsField\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.options)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"options\" of type \"CreateClassificationTemplateRequestBodyFieldsField\"" });
    }
    const options = (0, json_js_4.sdIsList)(val.options) ? val.options.map(function (itm) {
...
function serializeCreateClassificationTemplateRequestBodyFieldsFieldInput(val) {
    return { ["type"]: val.type == void 0 ? val.type : serializeCreateClassificationTemplateRequestBodyFieldsTypeField(val.type), ["key"]: val.key == void 0 ? val.key : serializeCreateClassificationTemplateRequestBodyFieldsKeyField(val.key), ["displayName"]: val.displayName == void 0 ? val.displayName : serializeCreateClassificationTemplateRequestBodyFieldsDisplayNameField(val.displayName), ["hidden"]: val.hidden, ["options"]: val.options.map(function (item) {
            return serializeCreateClassificationTemplateRequestBodyFieldsOptionsField(item);
        }) };
}
function deserializeCreateClassificationTemplateRequestBodyFieldsFieldInput(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyFieldsFieldInput\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyFieldsTypeField(val.type);
    const key = val.key == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyFieldsKeyField(val.key);
    const displayName = val.displayName == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyFieldsDisplayNameField(val.displayName);
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateClassificationTemplateRequestBodyFieldsFieldInput\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (val.options == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"options\" of type \"CreateClassificationTemplateRequestBodyFieldsFieldInput\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.options)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"options\" of type \"CreateClassificationTemplateRequestBodyFieldsFieldInput\"" });
    }
    const options = (0, json_js_4.sdIsList)(val.options) ? val.options.map(function (itm) {
        return deserializeCreateClassificationTemplateRequestBodyFieldsOptionsField(itm);
    }) : [];
...
function deserializeCreateClassificationTemplateRequestBody(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBody\"" });
    }
    if (val.scope == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"scope\" of type \"CreateClassificationTemplateRequestBody\" to be defined" });
    }
    const scope = deserializeCreateClassificationTemplateRequestBodyScopeField(val.scope);
    if (val.templateKey == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"templateKey\" of type \"CreateClassificationTemplateRequestBody\" to be defined" });
    }
    const templateKey = deserializeCreateClassificationTemplateRequestBodyTemplateKeyField(val.templateKey);
    if (val.displayName == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"displayName\" of type \"CreateClassificationTemplateRequestBody\" to be defined" });
    }
    const displayName = deserializeCreateClassificationTemplateRequestBodyDisplayNameField(val.displayName);
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateClassificationTemplateRequestBody\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (!(val.copyInstanceOnItemCopy == void 0) && !(0, json_js_1.sdIsBoolean)(val.copyInstanceOnItemCopy)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"copyInstanceOnItemCopy\" of type \"CreateClassificationTemplateRequestBody\"" });
    }
    const copyInstanceOnItemCopy = val.copyInstanceOnItemCopy == void 0 ? void 0 : val.copyInstanceOnItemCopy;
    if (val.fields == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"fields\" of type \"CreateClassificationTemplateRequestBody\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.fields)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"fields\" of type \"CreateClassificationTemplateRequestBody\"" });
    }
    const fields = (0, json_js_4.sdIsList)(val.fields) ? val.fields.map(function (itm) {
...
function deserializeCreateClassificationTemplateRequestBodyInput(val) {
    if (!(0, json_js_5.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateClassificationTemplateRequestBodyInput\"" });
    }
    const scope = val.scope == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyScopeField(val.scope);
    const templateKey = val.templateKey == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyTemplateKeyField(val.templateKey);
    const displayName = val.displayName == void 0 ? void 0 : deserializeCreateClassificationTemplateRequestBodyDisplayNameField(val.displayName);
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateClassificationTemplateRequestBodyInput\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (!(val.copyInstanceOnItemCopy == void 0) && !(0, json_js_1.sdIsBoolean)(val.copyInstanceOnItemCopy)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"copyInstanceOnItemCopy\" of type \"CreateClassificationTemplateRequestBodyInput\"" });
    }
    const copyInstanceOnItemCopy = val.copyInstanceOnItemCopy == void 0 ? void 0 : val.copyInstanceOnItemCopy;
    if (val.fields == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"fields\" of type \"CreateClassificationTemplateRequestBodyInput\" to be defined" });
    }
    if (!(0, json_js_4.sdIsList)(val.fields)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"fields\" of type \"CreateClassificationTemplateRequestBodyInput\"" });
    }
    const fields = (0, json_js_4.sdIsList)(val.fields) ? val.fields.map(function (itm) {
        return deserializeCreateClassificationTemplateRequestBodyFieldsField(itm);
    }) : [];
