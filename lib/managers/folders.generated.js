...
class FoldersManager {
    ...
    getFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new GetFolderByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined, ["sort"]: (0, utils_js_4.toString)(queryParams.sort), ["direction"]: (0, utils_js_4.toString)(queryParams.direction), ["offset"]: (0, utils_js_4.toString)(queryParams.offset), ["limit"]: (0, utils_js_4.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({ ["if-none-match"]: (0, utils_js_4.toString)(headers.ifNoneMatch), ["boxapi"]: (0, utils_js_4.toString)(headers.boxapi) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_4.toString)(folderId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new UpdateFolderByIdOptionals({ requestBody: optionalsInput.requestBody, queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_4.toString)(folderId)), method: "PUT", params: queryParamsMap, headers: headersMap, data: serializeUpdateFolderByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, folderFull_generated_js_1.deserializeFolderFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFolderById(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new DeleteFolderByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["recursive"]: (0, utils_js_4.toString)(queryParams.recursive) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({ ["if-match"]: (0, utils_js_4.toString)(headers.ifMatch) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_4.toString)(folderId)), method: "DELETE", params: queryParamsMap, headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    getFolderItems(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, optionalsInput = {}) {
            const optionals = new GetFolderItemsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined, ["usemarker"]: (0, utils_js_4.toString)(queryParams.usemarker), ["marker"]: (0, utils_js_4.toString)(queryParams.marker), ["offset"]: (0, utils_js_4.toString)(queryParams.offset), ["limit"]: (0, utils_js_4.toString)(queryParams.limit), ["sort"]: (0, utils_js_4.toString)(queryParams.sort), ["direction"]: (0, utils_js_4.toString)(queryParams.direction) });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_4.toString)(folderId), "/items"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createFolder(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateFolderOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined });
    ...
    copyFolder(folderId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, requestBody, optionalsInput = {}) {
            const optionals = new CopyFolderOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", (0, utils_js_4.toString)(folderId), "/copy"), method: "POST", params: queryParamsMap, headers: headersMap, data: serializeCopyFolderRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, folderFull_generated_js_1.deserializeFolderFull)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeGetFolderByIdQueryParamsSortField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFolderByIdQueryParamsSortField" });
}
...
function deserializeGetFolderByIdQueryParamsDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFolderByIdQueryParamsDirectionField" });
}
...
function deserializeUpdateFolderByIdRequestBodySyncStateField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFolderByIdRequestBodySyncStateField" });
}
...
function deserializeUpdateFolderByIdRequestBodyParentField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderByIdRequestBodyParentField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateFolderByIdRequestBodyParentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.user_id == void 0) && !(0, json_js_2.sdIsString)(val.user_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"user_id\" of type \"UpdateFolderByIdRequestBodyParentField\"" });
    }
...
function deserializeUpdateFolderByIdRequestBodySharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFolderByIdRequestBodySharedLinkAccessField" });
}
...
function deserializeUpdateFolderByIdRequestBodySharedLinkPermissionsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderByIdRequestBodySharedLinkPermissionsField\"" });
    }
    if (!(val.can_download == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"UpdateFolderByIdRequestBodySharedLinkPermissionsField\"" });
    }
...
function serializeUpdateFolderByIdRequestBodySharedLinkField(val) {
    return { ["access"]: val.access == void 0 ? val.access : serializeUpdateFolderByIdRequestBodySharedLinkAccessField(val.access), ["password"]: val.password, ["vanity_name"]: val.vanityName, ["unshared_at"]: val.unsharedAt == void 0 ? val.unsharedAt : (0, utils_js_1.serializeDateTime)(val.unsharedAt), ["permissions"]: val.permissions == void 0 ? val.permissions : serializeUpdateFolderByIdRequestBodySharedLinkPermissionsField(val.permissions) };
}
function deserializeUpdateFolderByIdRequestBodySharedLinkField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderByIdRequestBodySharedLinkField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodySharedLinkAccessField(val.access);
    if (!(val.password == void 0) && !(0, json_js_2.sdIsString)(val.password)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"password\" of type \"UpdateFolderByIdRequestBodySharedLinkField\"" });
    }
    const password = val.password == void 0 ? void 0 : val.password;
    if (!(val.vanity_name == void 0) && !(0, json_js_2.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"UpdateFolderByIdRequestBodySharedLinkField\"" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_2.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"UpdateFolderByIdRequestBodySharedLinkField\"" });
    }
    const unsharedAt = val.unshared_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.unshared_at);
    const permissions = val.permissions == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodySharedLinkPermissionsField(val.permissions);
...
function deserializeUpdateFolderByIdRequestBodyFolderUploadEmailAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFolderByIdRequestBodyFolderUploadEmailAccessField" });
}
...
function deserializeUpdateFolderByIdRequestBodyFolderUploadEmailField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderByIdRequestBodyFolderUploadEmailField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodyFolderUploadEmailAccessField(val.access);
...
function deserializeUpdateFolderByIdRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFolderByIdRequestBody\"" });
    }
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    const syncState = val.sync_state == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodySyncStateField(val.sync_state);
    if (!(val.can_non_owners_invite == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_non_owners_invite)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_non_owners_invite\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const canNonOwnersInvite = val.can_non_owners_invite == void 0 ? void 0 : val.can_non_owners_invite;
    const parent = val.parent == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodyParentField(val.parent);
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodySharedLinkField(val.shared_link);
    const folderUploadEmail = val.folder_upload_email == void 0 ? void 0 : deserializeUpdateFolderByIdRequestBodyFolderUploadEmailField(val.folder_upload_email);
    if (!(val.tags == void 0) && !(0, json_js_3.sdIsList)(val.tags)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"tags\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const tags = val.tags == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.tags) ? val.tags.map(function (itm) {
        if (!(0, json_js_2.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"UpdateFolderByIdRequestBody\"" });
        }
        return itm;
    }) : [];
    if (!(val.is_collaboration_restricted_to_enterprise == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_collaboration_restricted_to_enterprise)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_collaboration_restricted_to_enterprise\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const isCollaborationRestrictedToEnterprise = val.is_collaboration_restricted_to_enterprise == void 0 ? void 0 : val.is_collaboration_restricted_to_enterprise;
    if (!(val.collections == void 0) && !(0, json_js_3.sdIsList)(val.collections)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"collections\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const collections = val.collections == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.collections) ? val.collections.map(function (itm) {
        return deserializeUpdateFolderByIdRequestBodyCollectionsField(itm);
    }) : [];
    if (!(val.can_non_owners_view_collaborators == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_non_owners_view_collaborators)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_non_owners_view_collaborators\" of type \"UpdateFolderByIdRequestBody\"" });
    }
    const canNonOwnersViewCollaborators = val.can_non_owners_view_collaborators == void 0 ? void 0 : val.can_non_owners_view_collaborators;
...
function deserializeGetFolderItemsQueryParamsSortField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFolderItemsQueryParamsSortField" });
}
...
function deserializeGetFolderItemsQueryParamsDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFolderItemsQueryParamsDirectionField" });
}
...
function deserializeCreateFolderRequestBodyParentField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderRequestBodyParentField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateFolderRequestBodyParentField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateFolderRequestBodyParentField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCreateFolderRequestBodyFolderUploadEmailAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateFolderRequestBodyFolderUploadEmailAccessField" });
}
...
function deserializeCreateFolderRequestBodyFolderUploadEmailField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderRequestBodyFolderUploadEmailField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeCreateFolderRequestBodyFolderUploadEmailAccessField(val.access);
    return { access: access };
}
...
function deserializeCreateFolderRequestBodySyncStateField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateFolderRequestBodySyncStateField" });
}
...
function deserializeCreateFolderRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateFolderRequestBody\"" });
    }
    if (val.name == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"name\" of type \"CreateFolderRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CreateFolderRequestBody\"" });
    }
    const name = val.name;
    if (val.parent == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parent\" of type \"CreateFolderRequestBody\" to be defined" });
    }
    const parent = deserializeCreateFolderRequestBodyParentField(val.parent);
    const folderUploadEmail = val.folder_upload_email == void 0 ? void 0 : deserializeCreateFolderRequestBodyFolderUploadEmailField(val.folder_upload_email);
    const syncState = val.sync_state == void 0 ? void 0 : deserializeCreateFolderRequestBodySyncStateField(val.sync_state);
...
function deserializeCopyFolderRequestBodyParentField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CopyFolderRequestBodyParentField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CopyFolderRequestBodyParentField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CopyFolderRequestBodyParentField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCopyFolderRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CopyFolderRequestBody\"" });
    }
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CopyFolderRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (val.parent == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parent\" of type \"CopyFolderRequestBody\" to be defined" });
    }
