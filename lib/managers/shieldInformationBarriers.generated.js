...
class ShieldInformationBarriersManager {
    ...
    getShieldInformationBarrierById(shieldInformationBarrierId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierId, optionalsInput = {}) {
            const optionals = new GetShieldInformationBarrierByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barriers/", (0, utils_js_2.toString)(shieldInformationBarrierId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateShieldInformationBarrierStatus(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new UpdateShieldInformationBarrierStatusOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
    ...
    getShieldInformationBarriers() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetShieldInformationBarriersHeaders({}), cancellationToken) {
            const headers = new GetShieldInformationBarriersHeaders({ extraHeaders: headersInput.extraHeaders });
    ...
    createShieldInformationBarrier(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateShieldInformationBarrierOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barriers"), method: "POST", headers: headersMap, data: serializeCreateShieldInformationBarrierRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, shieldInformationBarrier_generated_js_1.deserializeShieldInformationBarrier)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeUpdateShieldInformationBarrierStatusRequestBodyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateShieldInformationBarrierStatusRequestBodyStatusField" });
}
...
function deserializeUpdateShieldInformationBarrierStatusRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateShieldInformationBarrierStatusRequestBody\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"UpdateShieldInformationBarrierStatusRequestBody\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateShieldInformationBarrierStatusRequestBody\"" });
    }
    const id = val.id;
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"UpdateShieldInformationBarrierStatusRequestBody\" to be defined" });
    }
...
function deserializeCreateShieldInformationBarrierRequestBody(val) {
    if (!(0, json_js_2.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateShieldInformationBarrierRequestBody\"" });
    }
    if (val.enterprise == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"enterprise\" of type \"CreateShieldInformationBarrierRequestBody\" to be defined" });
    }
