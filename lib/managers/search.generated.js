...
class SearchManager {
    ...
    searchByMetadataQuery(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new SearchByMetadataQueryOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_queries/execute_read"), method: "POST", headers: headersMap, data: (0, metadataQuery_generated_js_1.serializeMetadataQuery)(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    searchForContent() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new SearchForContentHeaders({}), cancellationToken) {
            const headers = new SearchForContentHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["query"]: (0, utils_js_2.toString)(queryParams.query), ["scope"]: (0, utils_js_2.toString)(queryParams.scope), ["file_extensions"]: queryParams.fileExtensions ? queryParams.fileExtensions.map(utils_js_2.toString).join(",") : undefined, ["created_at_range"]: queryParams.createdAtRange ? queryParams.createdAtRange.map(utils_js_2.toString).join(",") : undefined, ["updated_at_range"]: queryParams.updatedAtRange ? queryParams.updatedAtRange.map(utils_js_2.toString).join(",") : undefined, ["size_range"]: queryParams.sizeRange ? queryParams.sizeRange.map(utils_js_2.toString).join(",") : undefined, ["owner_user_ids"]: queryParams.ownerUserIds ? queryParams.ownerUserIds.map(utils_js_2.toString).join(",") : undefined, ["recent_updater_user_ids"]: queryParams.recentUpdaterUserIds ? queryParams.recentUpdaterUserIds.map(utils_js_2.toString).join(",") : undefined, ["ancestor_folder_ids"]: queryParams.ancestorFolderIds ? queryParams.ancestorFolderIds.map(utils_js_2.toString).join(",") : undefined, ["content_types"]: queryParams.contentTypes ? queryParams.contentTypes.map(utils_js_2.toString).join(",") : undefined, ["type"]: (0, utils_js_2.toString)(queryParams.type), ["trash_content"]: (0, utils_js_2.toString)(queryParams.trashContent), ["mdfilters"]: queryParams.mdfilters ? (0, json_js_1.sdToJson)(queryParams.mdfilters.map(metadataFilter_generated_js_1.serializeMetadataFilter)) : undefined, ["sort"]: (0, utils_js_2.toString)(queryParams.sort), ["direction"]: (0, utils_js_2.toString)(queryParams.direction), ["limit"]: (0, utils_js_2.toString)(queryParams.limit), ["include_recent_shared_links"]: (0, utils_js_2.toString)(queryParams.includeRecentSharedLinks), ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined, ["offset"]: (0, utils_js_2.toString)(queryParams.offset), ["deleted_user_ids"]: queryParams.deletedUserIds ? queryParams.deletedUserIds.map(utils_js_2.toString).join(",") : undefined, ["deleted_at_range"]: queryParams.deletedAtRange ? queryParams.deletedAtRange.map(utils_js_2.toString).join(",") : undefined });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/search"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
...
function deserializeSearchForContentQueryParamsScopeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsScopeField" });
}
...
function deserializeSearchForContentQueryParamsContentTypesField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsContentTypesField" });
}
...
function deserializeSearchForContentQueryParamsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsTypeField" });
}
...
function deserializeSearchForContentQueryParamsTrashContentField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsTrashContentField" });
}
...
function deserializeSearchForContentQueryParamsSortField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsSortField" });
}
...
function deserializeSearchForContentQueryParamsDirectionField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsDirectionField" });
}
