...
exports.FilesManager = exports.GetFileThumbnailByIdHeaders = exports.CopyFileHeaders = exports.DeleteFileByIdHeaders = exports.UpdateFileByIdHeaders = exports.GetFileByIdHeaders = exports.GetFileThumbnailByIdOptionals = exports.CopyFileOptionals = exports.DeleteFileByIdOptionals = exports.UpdateFileByIdOptionals = exports.GetFileByIdOptionals = void 0;
...
class FilesManager {
    ...
    getFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_4.toString)(fileId)), {
                method: 'GET',
            ...
            return (0, fileFull_generated_js_1.deserializeFileFull)(response.data);
        });
    }
    ...
    copyFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_4.toString)(fileId), '/copy'), {
                method: 'POST',
                params: queryParamsMap,
                headers: headersMap,
    ...
    getFileThumbnailById(fileId_1, extension_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, extension, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_4.toString)(fileId), '/thumbnail.', (0, utils_js_4.toString)(extension)), {
                method: 'GET',
                params: queryParamsMap,
                headers: headersMap,
