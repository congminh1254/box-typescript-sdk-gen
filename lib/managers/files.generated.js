...
class FilesManager {
    ...
    getFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new GetFileByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({ ["if-none-match"]: (0, utils_js_4.toString)(headers.ifNoneMatch), ["boxapi"]: (0, utils_js_4.toString)(headers.boxapi), ["x-rep-hints"]: (0, utils_js_4.toString)(headers.xRepHints) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new UpdateFileByIdOptionals({ requestBody: optionalsInput.requestBody, queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId)), method: "PUT", params: queryParamsMap, headers: headersMap, data: serializeUpdateFileByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteFileById(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new DeleteFileByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({ ["if-match"]: (0, utils_js_4.toString)(headers.ifMatch) }, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    copyFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new CopyFileOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "/copy"), method: "POST", params: queryParamsMap, headers: headersMap, data: serializeCopyFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, fileFull_generated_js_1.deserializeFileFull)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getFileThumbnailUrl(fileId_1, extension_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, extension, optionalsInput = {}) {
            const optionals = new GetFileThumbnailUrlOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["min_height"]: (0, utils_js_4.toString)(queryParams.minHeight), ["min_width"]: (0, utils_js_4.toString)(queryParams.minWidth), ["max_height"]: (0, utils_js_4.toString)(queryParams.maxHeight), ["max_width"]: (0, utils_js_4.toString)(queryParams.maxWidth) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const cancellationController = (0, utils_js_6.createCancellationController)();
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "/thumbnail.", (0, utils_js_4.toString)(extension)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken == void 0 ? cancellationController.signal : cancellationToken, followRedirects: false }));
    ...
    getFileThumbnailById(fileId_1, extension_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, extension, optionalsInput = {}) {
            const optionals = new GetFileThumbnailByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["min_height"]: (0, utils_js_4.toString)(queryParams.minHeight), ["min_width"]: (0, utils_js_4.toString)(queryParams.minWidth), ["max_height"]: (0, utils_js_4.toString)(queryParams.maxHeight), ["max_width"]: (0, utils_js_4.toString)(queryParams.maxWidth) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_4.toString)(fileId), "/thumbnail.", (0, utils_js_4.toString)(extension)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "binary", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
...
function deserializeUpdateFileByIdRequestBodyParentField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodyParentField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateFileByIdRequestBodyParentField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.user_id == void 0) && !(0, json_js_2.sdIsString)(val.user_id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"user_id\" of type \"UpdateFileByIdRequestBodyParentField\"" });
    }
...
function deserializeUpdateFileByIdRequestBodySharedLinkAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileByIdRequestBodySharedLinkAccessField" });
}
...
function deserializeUpdateFileByIdRequestBodySharedLinkPermissionsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodySharedLinkPermissionsField\"" });
    }
    if (!(val.can_download == void 0) && !(0, json_js_1.sdIsBoolean)(val.can_download)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"UpdateFileByIdRequestBodySharedLinkPermissionsField\"" });
    }
...
function deserializeUpdateFileByIdRequestBodySharedLinkField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodySharedLinkField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodySharedLinkAccessField(val.access);
    if (!(val.password == void 0) && !(0, json_js_2.sdIsString)(val.password)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"password\" of type \"UpdateFileByIdRequestBodySharedLinkField\"" });
    }
    const password = val.password == void 0 ? void 0 : val.password;
    if (!(val.vanity_name == void 0) && !(0, json_js_2.sdIsString)(val.vanity_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"vanity_name\" of type \"UpdateFileByIdRequestBodySharedLinkField\"" });
    }
    ...
    if (!(val.unshared_at == void 0) && !(0, json_js_2.sdIsString)(val.unshared_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unshared_at\" of type \"UpdateFileByIdRequestBodySharedLinkField\"" });
    }
    const unsharedAt = val.unshared_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.unshared_at);
    const permissions = val.permissions == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodySharedLinkPermissionsField(val.permissions);
...
function deserializeUpdateFileByIdRequestBodyLockAccessField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileByIdRequestBodyLockAccessField" });
}
function serializeUpdateFileByIdRequestBodyLockField(val) {
    return { ["access"]: val.access == void 0 ? val.access : serializeUpdateFileByIdRequestBodyLockAccessField(val.access), ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : (0, utils_js_1.serializeDateTime)(val.expiresAt), ["is_download_prevented"]: val.isDownloadPrevented };
}
function deserializeUpdateFileByIdRequestBodyLockField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodyLockField\"" });
    }
    const access = val.access == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodyLockAccessField(val.access);
    if (!(val.expires_at == void 0) && !(0, json_js_2.sdIsString)(val.expires_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"UpdateFileByIdRequestBodyLockField\"" });
    }
    ...
    if (!(val.is_download_prevented == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_download_prevented)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_download_prevented\" of type \"UpdateFileByIdRequestBodyLockField\"" });
    }
...
function deserializeUpdateFileByIdRequestBodyPermissionsCanDownloadField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateFileByIdRequestBodyPermissionsCanDownloadField" });
}
...
function deserializeUpdateFileByIdRequestBodyPermissionsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodyPermissionsField\"" });
    }
    const canDownload = val.can_download == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodyPermissionsCanDownloadField(val.can_download);
    return { canDownload: canDownload };
}
...
function deserializeUpdateFileByIdRequestBodyCollectionsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBodyCollectionsField\"" });
    }
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateFileByIdRequestBodyCollectionsField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    if (!(val.type == void 0) && !(0, json_js_2.sdIsString)(val.type)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"type\" of type \"UpdateFileByIdRequestBodyCollectionsField\"" });
    }
    const type = val.type == void 0 ? void 0 : val.type;
    return { id: id, type: type };
}
function serializeUpdateFileByIdRequestBody(val) {
    return { ["name"]: val.name, ["description"]: val.description, ["parent"]: val.parent == void 0 ? val.parent : serializeUpdateFileByIdRequestBodyParentField(val.parent), ["shared_link"]: val.sharedLink == void 0 ? val.sharedLink : serializeUpdateFileByIdRequestBodySharedLinkField(val.sharedLink), ["lock"]: val.lock == void 0 ? val.lock : serializeUpdateFileByIdRequestBodyLockField(val.lock), ["disposition_at"]: val.dispositionAt == void 0 ? val.dispositionAt : (0, utils_js_1.serializeDateTime)(val.dispositionAt), ["permissions"]: val.permissions == void 0 ? val.permissions : serializeUpdateFileByIdRequestBodyPermissionsField(val.permissions), ["collections"]: val.collections == void 0 ? val.collections : val.collections.map(function (item) {
            return serializeUpdateFileByIdRequestBodyCollectionsField(item);
        }), ["tags"]: val.tags == void 0 ? val.tags : val.tags.map(function (item) {
            return item;
        }) };
}
function deserializeUpdateFileByIdRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateFileByIdRequestBody\"" });
    }
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"UpdateFileByIdRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateFileByIdRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    const parent = val.parent == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodyParentField(val.parent);
    const sharedLink = val.shared_link == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodySharedLinkField(val.shared_link);
    const lock = val.lock == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodyLockField(val.lock);
    if (!(val.disposition_at == void 0) && !(0, json_js_2.sdIsString)(val.disposition_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"disposition_at\" of type \"UpdateFileByIdRequestBody\"" });
    }
    const dispositionAt = val.disposition_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.disposition_at);
    const permissions = val.permissions == void 0 ? void 0 : deserializeUpdateFileByIdRequestBodyPermissionsField(val.permissions);
    if (!(val.collections == void 0) && !(0, json_js_3.sdIsList)(val.collections)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"collections\" of type \"UpdateFileByIdRequestBody\"" });
    }
    ...
    if (!(val.tags == void 0) && !(0, json_js_3.sdIsList)(val.tags)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"tags\" of type \"UpdateFileByIdRequestBody\"" });
    }
    const tags = val.tags == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.tags) ? val.tags.map(function (itm) {
        if (!(0, json_js_2.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"UpdateFileByIdRequestBody\"" });
        }
        return itm;
    }) : [];
...
function deserializeCopyFileRequestBodyParentField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CopyFileRequestBodyParentField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CopyFileRequestBodyParentField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CopyFileRequestBodyParentField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCopyFileRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CopyFileRequestBody\"" });
    }
    if (!(val.name == void 0) && !(0, json_js_2.sdIsString)(val.name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"name\" of type \"CopyFileRequestBody\"" });
    }
    const name = val.name == void 0 ? void 0 : val.name;
    if (!(val.version == void 0) && !(0, json_js_2.sdIsString)(val.version)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"version\" of type \"CopyFileRequestBody\"" });
    }
    const version = val.version == void 0 ? void 0 : val.version;
    if (val.parent == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"parent\" of type \"CopyFileRequestBody\" to be defined" });
    }
...
function deserializeGetFileThumbnailUrlExtension(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFileThumbnailUrlExtension" });
}
...
function deserializeGetFileThumbnailByIdExtension(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetFileThumbnailByIdExtension" });
}
