...
class MembershipsManager {
    ...
    getUserMemberships(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, optionalsInput = {}) {
            const optionals = new GetUserMembershipsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            ...
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/users/", (0, utils_js_2.toString)(userId), "/memberships"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getGroupMemberships(groupId_1) {
        return __awaiter(this, arguments, void 0, function* (groupId, optionalsInput = {}) {
            const optionals = new GetGroupMembershipsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["limit"]: (0, utils_js_2.toString)(queryParams.limit), ["offset"]: (0, utils_js_2.toString)(queryParams.offset) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/groups/", (0, utils_js_2.toString)(groupId), "/memberships"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, groupMemberships_generated_js_1.deserializeGroupMemberships)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createGroupMembership(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateGroupMembershipOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/group_memberships"), method: "POST", params: queryParamsMap, headers: headersMap, data: serializeCreateGroupMembershipRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getGroupMembershipById(groupMembershipId_1) {
        return __awaiter(this, arguments, void 0, function* (groupMembershipId, optionalsInput = {}) {
            const optionals = new GetGroupMembershipByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const queryParams = optionals.queryParams;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_2.toString).join(",") : undefined });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/group_memberships/", (0, utils_js_2.toString)(groupMembershipId)), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, groupMembership_generated_js_1.deserializeGroupMembership)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateGroupMembershipById(groupMembershipId_1) {
        return __awaiter(this, arguments, void 0, function* (groupMembershipId, optionalsInput = {}) {
            const optionals = new UpdateGroupMembershipByIdOptionals({ requestBody: optionalsInput.requestBody, queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
    ...
    deleteGroupMembershipById(groupMembershipId_1) {
        return __awaiter(this, arguments, void 0, function* (groupMembershipId, optionalsInput = {}) {
            const optionals = new DeleteGroupMembershipByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/group_memberships/", (0, utils_js_2.toString)(groupMembershipId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateGroupMembershipRequestBodyUserField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateGroupMembershipRequestBodyUserField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateGroupMembershipRequestBodyUserField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateGroupMembershipRequestBodyUserField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCreateGroupMembershipRequestBodyGroupField(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateGroupMembershipRequestBodyGroupField\"" });
    }
    if (val.id == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"id\" of type \"CreateGroupMembershipRequestBodyGroupField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateGroupMembershipRequestBodyGroupField\"" });
    }
    const id = val.id;
    return { id: id };
}
...
function deserializeCreateGroupMembershipRequestBodyRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateGroupMembershipRequestBodyRoleField" });
}
...
function deserializeCreateGroupMembershipRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateGroupMembershipRequestBody\"" });
    }
    if (val.user == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"user\" of type \"CreateGroupMembershipRequestBody\" to be defined" });
    }
    const user = deserializeCreateGroupMembershipRequestBodyUserField(val.user);
    if (val.group == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"group\" of type \"CreateGroupMembershipRequestBody\" to be defined" });
    }
    const group = deserializeCreateGroupMembershipRequestBodyGroupField(val.group);
    const role = val.role == void 0 ? void 0 : deserializeCreateGroupMembershipRequestBodyRoleField(val.role);
    if (!(val.configurable_permissions == void 0) && !(0, json_js_3.sdIsMap)(val.configurable_permissions)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"configurable_permissions\" of type \"CreateGroupMembershipRequestBody\"" });
    }
    const configurablePermissions = val.configurable_permissions == void 0 ? void 0 : (0, json_js_3.sdIsMap)(val.configurable_permissions) ? Object.fromEntries(Object.entries(val.configurable_permissions).map(([k, v]) => [k, function (v) {
            if (!(0, json_js_1.sdIsBoolean)(v)) {
                throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"CreateGroupMembershipRequestBody\"" });
            }
            return v;
        }(v)])) : {};
...
function deserializeUpdateGroupMembershipByIdRequestBodyRoleField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateGroupMembershipByIdRequestBodyRoleField" });
}
...
function deserializeUpdateGroupMembershipByIdRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateGroupMembershipByIdRequestBody\"" });
    }
    const role = val.role == void 0 ? void 0 : deserializeUpdateGroupMembershipByIdRequestBodyRoleField(val.role);
    if (!(val.configurable_permissions == void 0) && !(0, json_js_3.sdIsMap)(val.configurable_permissions)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"configurable_permissions\" of type \"UpdateGroupMembershipByIdRequestBody\"" });
    }
    const configurablePermissions = val.configurable_permissions == void 0 ? void 0 : (0, json_js_3.sdIsMap)(val.configurable_permissions) ? Object.fromEntries(Object.entries(val.configurable_permissions).map(([k, v]) => [k, function (v) {
            if (!(0, json_js_1.sdIsBoolean)(v)) {
                throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"UpdateGroupMembershipByIdRequestBody\"" });
            }
            return v;
        }(v)])) : {};
