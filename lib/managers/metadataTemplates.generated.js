...
class MetadataTemplatesManager {
    ...
    getMetadataTemplatesByInstanceId(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            const optionals = new GetMetadataTemplatesByInstanceIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["metadata_instance_id"]: (0, utils_js_2.toString)(queryParams.metadataInstanceId), ["marker"]: (0, utils_js_2.toString)(queryParams.marker), ["limit"]: (0, utils_js_2.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getMetadataTemplate(scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (scope, templateKey, optionalsInput = {}) {
            const optionals = new GetMetadataTemplateOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey), "/schema"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    updateMetadataTemplate(scope_1, templateKey_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (scope, templateKey, requestBody, optionalsInput = {}) {
            const optionals = new UpdateMetadataTemplateOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey), "/schema"), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateMetadataTemplateRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataTemplate_generated_js_1.deserializeMetadataTemplate)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteMetadataTemplate(scope_1, templateKey_1) {
        return __awaiter(this, arguments, void 0, function* (scope, templateKey, optionalsInput = {}) {
            const optionals = new DeleteMetadataTemplateOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/", (0, utils_js_2.toString)(scope), "/", (0, utils_js_2.toString)(templateKey), "/schema"), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    getMetadataTemplateById(templateId_1) {
        return __awaiter(this, arguments, void 0, function* (templateId, optionalsInput = {}) {
            const optionals = new GetMetadataTemplateByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/", (0, utils_js_2.toString)(templateId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataTemplate_generated_js_1.deserializeMetadataTemplate)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getGlobalMetadataTemplates() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetGlobalMetadataTemplatesHeaders({}), cancellationToken) {
            const headers = new GetGlobalMetadataTemplatesHeaders({ extraHeaders: headersInput.extraHeaders });
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/global"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataTemplates_generated_js_1.deserializeMetadataTemplates)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    getEnterpriseMetadataTemplates() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetEnterpriseMetadataTemplatesHeaders({}), cancellationToken) {
            const headers = new GetEnterpriseMetadataTemplatesHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_1.prepareParams)({ ["marker"]: (0, utils_js_2.toString)(queryParams.marker), ["limit"]: (0, utils_js_2.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/enterprise"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataTemplates_generated_js_1.deserializeMetadataTemplates)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    createMetadataTemplate(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateMetadataTemplateOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_templates/schema"), method: "POST", headers: headersMap, data: serializeCreateMetadataTemplateRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, metadataTemplate_generated_js_1.deserializeMetadataTemplate)(response.data)), { rawData: response.data });
        });
    }
}
...
function deserializeGetMetadataTemplateScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetMetadataTemplateScope" });
}
...
function deserializeUpdateMetadataTemplateScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateMetadataTemplateScope" });
}
...
function deserializeUpdateMetadataTemplateRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateMetadataTemplateRequestBodyOpField" });
}
function serializeUpdateMetadataTemplateRequestBody(val) {
    return { ["op"]: serializeUpdateMetadataTemplateRequestBodyOpField(val.op), ["data"]: val.data == void 0 ? val.data : Object.fromEntries(Object.entries(val.data).map(([k, v]) => [k, function (v) {
                return v;
            }(v)])), ["fieldKey"]: val.fieldKey, ["fieldKeys"]: val.fieldKeys == void 0 ? val.fieldKeys : val.fieldKeys.map(function (item) {
            return item;
        }), ["enumOptionKey"]: val.enumOptionKey, ["enumOptionKeys"]: val.enumOptionKeys == void 0 ? val.enumOptionKeys : val.enumOptionKeys.map(function (item) {
            return item;
        }), ["multiSelectOptionKey"]: val.multiSelectOptionKey, ["multiSelectOptionKeys"]: val.multiSelectOptionKeys == void 0 ? val.multiSelectOptionKeys : val.multiSelectOptionKeys.map(function (item) {
            return item;
        }) };
}
function deserializeUpdateMetadataTemplateRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateMetadataTemplateRequestBody\"" });
    }
    if (val.op == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"op\" of type \"UpdateMetadataTemplateRequestBody\" to be defined" });
    }
    const op = deserializeUpdateMetadataTemplateRequestBodyOpField(val.op);
    if (!(val.data == void 0) && !(0, json_js_4.sdIsMap)(val.data)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting object for \"data\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const data = val.data == void 0 ? void 0 : (0, json_js_4.sdIsMap)(val.data) ? Object.fromEntries(Object.entries(val.data).map(([k, v]) => [k, function (v) {
            return v;
        }(v)])) : {};
    if (!(val.fieldKey == void 0) && !(0, json_js_2.sdIsString)(val.fieldKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"fieldKey\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const fieldKey = val.fieldKey == void 0 ? void 0 : val.fieldKey;
    if (!(val.fieldKeys == void 0) && !(0, json_js_3.sdIsList)(val.fieldKeys)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"fieldKeys\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const fieldKeys = val.fieldKeys == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.fieldKeys) ? val.fieldKeys.map(function (itm) {
        if (!(0, json_js_2.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"UpdateMetadataTemplateRequestBody\"" });
        }
        return itm;
    }) : [];
    if (!(val.enumOptionKey == void 0) && !(0, json_js_2.sdIsString)(val.enumOptionKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"enumOptionKey\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    ...
    if (!(val.enumOptionKeys == void 0) && !(0, json_js_3.sdIsList)(val.enumOptionKeys)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"enumOptionKeys\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const enumOptionKeys = val.enumOptionKeys == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.enumOptionKeys) ? val.enumOptionKeys.map(function (itm) {
        if (!(0, json_js_2.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"UpdateMetadataTemplateRequestBody\"" });
        }
        return itm;
    }) : [];
    if (!(val.multiSelectOptionKey == void 0) && !(0, json_js_2.sdIsString)(val.multiSelectOptionKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"multiSelectOptionKey\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const multiSelectOptionKey = val.multiSelectOptionKey == void 0 ? void 0 : val.multiSelectOptionKey;
    if (!(val.multiSelectOptionKeys == void 0) && !(0, json_js_3.sdIsList)(val.multiSelectOptionKeys)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"multiSelectOptionKeys\" of type \"UpdateMetadataTemplateRequestBody\"" });
    }
    const multiSelectOptionKeys = val.multiSelectOptionKeys == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.multiSelectOptionKeys) ? val.multiSelectOptionKeys.map(function (itm) {
        if (!(0, json_js_2.sdIsString)(itm)) {
            throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"UpdateMetadataTemplateRequestBody\"" });
        }
        return itm;
    }) : [];
    return { op: op, data: data, fieldKey: fieldKey, fieldKeys: fieldKeys, enumOptionKey: enumOptionKey, enumOptionKeys: enumOptionKeys, multiSelectOptionKey: multiSelectOptionKey, multiSelectOptionKeys: multiSelectOptionKeys };
}
...
function deserializeDeleteMetadataTemplateScope(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize DeleteMetadataTemplateScope" });
}
...
function deserializeCreateMetadataTemplateRequestBodyFieldsTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize CreateMetadataTemplateRequestBodyFieldsTypeField" });
}
...
function deserializeCreateMetadataTemplateRequestBodyFieldsOptionsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateMetadataTemplateRequestBodyFieldsOptionsField\"" });
    }
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"CreateMetadataTemplateRequestBodyFieldsOptionsField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"key\" of type \"CreateMetadataTemplateRequestBodyFieldsOptionsField\"" });
    }
    const key = val.key;
    return { key: key };
}
function serializeCreateMetadataTemplateRequestBodyFieldsField(val) {
    return { ["type"]: serializeCreateMetadataTemplateRequestBodyFieldsTypeField(val.type), ["key"]: val.key, ["displayName"]: val.displayName, ["description"]: val.description, ["hidden"]: val.hidden, ["options"]: val.options == void 0 ? val.options : val.options.map(function (item) {
...
function deserializeCreateMetadataTemplateRequestBodyFieldsField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    if (val.type == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"type\" of type \"CreateMetadataTemplateRequestBodyFieldsField\" to be defined" });
    }
    const type = deserializeCreateMetadataTemplateRequestBodyFieldsTypeField(val.type);
    if (val.key == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"key\" of type \"CreateMetadataTemplateRequestBodyFieldsField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.key)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"key\" of type \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    const key = val.key;
    if (val.displayName == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"displayName\" of type \"CreateMetadataTemplateRequestBodyFieldsField\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.displayName)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"displayName\" of type \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    const displayName = val.displayName;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (!(val.options == void 0) && !(0, json_js_3.sdIsList)(val.options)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"options\" of type \"CreateMetadataTemplateRequestBodyFieldsField\"" });
    }
    const options = val.options == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.options) ? val.options.map(function (itm) {
...
function serializeCreateMetadataTemplateRequestBody(val) {
    return { ["scope"]: val.scope, ["templateKey"]: val.templateKey, ["displayName"]: val.displayName, ["hidden"]: val.hidden, ["fields"]: val.fields == void 0 ? val.fields : val.fields.map(function (item) {
...
function deserializeCreateMetadataTemplateRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateMetadataTemplateRequestBody\"" });
    }
    if (val.scope == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"scope\" of type \"CreateMetadataTemplateRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.scope)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"scope\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
    const scope = val.scope;
    if (!(val.templateKey == void 0) && !(0, json_js_2.sdIsString)(val.templateKey)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
    const templateKey = val.templateKey == void 0 ? void 0 : val.templateKey;
    if (val.displayName == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"displayName\" of type \"CreateMetadataTemplateRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.displayName)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"displayName\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
    const displayName = val.displayName;
    if (!(val.hidden == void 0) && !(0, json_js_1.sdIsBoolean)(val.hidden)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"hidden\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
    const hidden = val.hidden == void 0 ? void 0 : val.hidden;
    if (!(val.fields == void 0) && !(0, json_js_3.sdIsList)(val.fields)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"fields\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
    const fields = val.fields == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.fields) ? val.fields.map(function (itm) {
    ...
    if (!(val.copyInstanceOnItemCopy == void 0) && !(0, json_js_1.sdIsBoolean)(val.copyInstanceOnItemCopy)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"copyInstanceOnItemCopy\" of type \"CreateMetadataTemplateRequestBody\"" });
    }
