...
class ShieldInformationBarrierSegmentRestrictionsManager {
    ...
    getShieldInformationBarrierSegmentRestrictionById(shieldInformationBarrierSegmentRestrictionId_1) {
        return __awaiter(this, arguments, void 0, function* (shieldInformationBarrierSegmentRestrictionId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_segment_restrictions/', (0, utils_js_2.toString)(shieldInformationBarrierSegmentRestrictionId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return (0, shieldInformationBarrierSegmentRestriction_generated_js_1.deserializeShieldInformationBarrierSegmentRestriction)(response.data);
        });
    }
    ...
    getShieldInformationBarrierSegmentRestrictions(queryParams_1) {
        return __awaiter(this, arguments, void 0, function* (queryParams, optionalsInput = {}) {
            ...
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/shield_information_barrier_segment_restrictions'), {
                method: 'GET',
            ...
            return (0, shieldInformationBarrierSegmentRestrictions_generated_js_1.deserializeShieldInformationBarrierSegmentRestrictions)(response.data);
        });
    }
