...
class EventsManager {
    ...
    getEvents() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetEventsHeaders({}), cancellationToken) {
            const headers = new GetEventsHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_2.prepareParams)({ ["stream_type"]: (0, utils_js_3.toString)(queryParams.streamType), ["stream_position"]: (0, utils_js_3.toString)(queryParams.streamPosition), ["limit"]: (0, utils_js_3.toString)(queryParams.limit), ["event_type"]: queryParams.eventType ? queryParams.eventType.map(utils_js_3.toString).join(",") : undefined, ["created_after"]: queryParams.createdAfter ? (0, utils_js_1.serializeDateTime)(queryParams.createdAfter) : undefined, ["created_before"]: queryParams.createdBefore ? (0, utils_js_1.serializeDateTime)(queryParams.createdBefore) : undefined });
            const headersMap = (0, utils_js_2.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/events"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
...
function deserializeGetEventsQueryParamsStreamTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetEventsQueryParamsStreamTypeField" });
}
...
function deserializeGetEventsQueryParamsEventTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize GetEventsQueryParamsEventTypeField" });
}
