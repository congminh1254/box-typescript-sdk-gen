...
class LegalHoldPoliciesManager {
    ...
    getLegalHoldPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetLegalHoldPoliciesHeaders({}), cancellationToken) {
            const headers = new GetLegalHoldPoliciesHeaders({ extraHeaders: headersInput.extraHeaders });
            const queryParamsMap = (0, utils_js_3.prepareParams)({ ["policy_name"]: (0, utils_js_4.toString)(queryParams.policyName), ["fields"]: queryParams.fields ? queryParams.fields.map(utils_js_4.toString).join(",") : undefined, ["marker"]: (0, utils_js_4.toString)(queryParams.marker), ["limit"]: (0, utils_js_4.toString)(queryParams.limit) });
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies"), method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createLegalHoldPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            const optionals = new CreateLegalHoldPolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies"), method: "POST", headers: headersMap, data: serializeCreateLegalHoldPolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    getLegalHoldPolicyById(legalHoldPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyId, optionalsInput = {}) {
            const optionals = new GetLegalHoldPolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", (0, utils_js_4.toString)(legalHoldPolicyId)), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, legalHoldPolicy_generated_js_1.deserializeLegalHoldPolicy)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateLegalHoldPolicyById(legalHoldPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyId, optionalsInput = {}) {
            const optionals = new UpdateLegalHoldPolicyByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const requestBody = optionals.requestBody;
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", (0, utils_js_4.toString)(legalHoldPolicyId)), method: "PUT", headers: headersMap, data: serializeUpdateLegalHoldPolicyByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, legalHoldPolicy_generated_js_1.deserializeLegalHoldPolicy)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteLegalHoldPolicyById(legalHoldPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyId, optionalsInput = {}) {
            const optionals = new DeleteLegalHoldPolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", (0, utils_js_4.toString)(legalHoldPolicyId)), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function serializeCreateLegalHoldPolicyRequestBody(val) {
    return { ["policy_name"]: val.policyName, ["description"]: val.description, ["filter_started_at"]: val.filterStartedAt == void 0 ? val.filterStartedAt : (0, utils_js_1.serializeDateTime)(val.filterStartedAt), ["filter_ended_at"]: val.filterEndedAt == void 0 ? val.filterEndedAt : (0, utils_js_1.serializeDateTime)(val.filterEndedAt), ["is_ongoing"]: val.isOngoing };
}
function deserializeCreateLegalHoldPolicyRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateLegalHoldPolicyRequestBody\"" });
    }
    if (val.policy_name == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"policy_name\" of type \"CreateLegalHoldPolicyRequestBody\" to be defined" });
    }
    if (!(0, json_js_2.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const policyName = val.policy_name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.filter_started_at == void 0) && !(0, json_js_2.sdIsString)(val.filter_started_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"filter_started_at\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const filterStartedAt = val.filter_started_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.filter_started_at);
    if (!(val.filter_ended_at == void 0) && !(0, json_js_2.sdIsString)(val.filter_ended_at)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"filter_ended_at\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const filterEndedAt = val.filter_ended_at == void 0 ? void 0 : (0, utils_js_2.deserializeDateTime)(val.filter_ended_at);
    if (!(val.is_ongoing == void 0) && !(0, json_js_1.sdIsBoolean)(val.is_ongoing)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting boolean for \"is_ongoing\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
...
function deserializeUpdateLegalHoldPolicyByIdRequestBody(val) {
    if (!(0, json_js_3.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    if (!(val.policy_name == void 0) && !(0, json_js_2.sdIsString)(val.policy_name)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    const policyName = val.policy_name == void 0 ? void 0 : val.policy_name;
    if (!(val.description == void 0) && !(0, json_js_2.sdIsString)(val.description)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    const description = val.description == void 0 ? void 0 : val.description;
    if (!(val.release_notes == void 0) && !(0, json_js_2.sdIsString)(val.release_notes)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"release_notes\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
