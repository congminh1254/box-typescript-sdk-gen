...
class LegalHoldPoliciesManager {
    ...
    getLegalHoldPolicies() {
        return __awaiter(this, arguments, void 0, function* (queryParams = {}, headersInput = new GetLegalHoldPoliciesHeaders({}), cancellationToken) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/legal_hold_policies'), {
                method: 'GET',
            ...
            return (0, legalHoldPolicies_generated_js_1.deserializeLegalHoldPolicies)(response.data);
        });
    }
    createLegalHoldPolicy(requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (requestBody, optionalsInput = {}) {
            ...
            return (0, legalHoldPolicy_generated_js_1.deserializeLegalHoldPolicy)(response.data);
        });
    }
    getLegalHoldPolicyById(legalHoldPolicyId_1) {
        return __awaiter(this, arguments, void 0, function* (legalHoldPolicyId, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_3.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/legal_hold_policies/', (0, utils_js_4.toString)(legalHoldPolicyId)), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
