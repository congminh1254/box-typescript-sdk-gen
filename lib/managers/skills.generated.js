...
class SkillsManager {
    ...
    getBoxSkillCardsOnFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new GetBoxSkillCardsOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/global/boxSkillsCards"), method: "GET", headers: headersMap, responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
    ...
    createBoxSkillCardsOnFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new CreateBoxSkillCardsOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/global/boxSkillsCards"), method: "POST", headers: headersMap, data: serializeCreateBoxSkillCardsOnFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, skillCardsMetadata_generated_js_1.deserializeSkillCardsMetadata)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    updateBoxSkillCardsOnFile(fileId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateBoxSkillCardsOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/global/boxSkillsCards"), method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateBoxSkillCardsOnFileRequestBody), contentType: "application/json-patch+json", responseFormat: "json", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return Object.assign(Object.assign({}, (0, skillCardsMetadata_generated_js_1.deserializeSkillCardsMetadata)(response.data)), { rawData: response.data });
        });
    }
    /**
    ...
    deleteBoxSkillCardsFromFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            const optionals = new DeleteBoxSkillCardsFromFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", (0, utils_js_2.toString)(fileId), "/metadata/global/boxSkillsCards"), method: "DELETE", headers: headersMap, responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
    /**
    ...
    updateAllSkillCardsOnFile(skillId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (skillId, requestBody, optionalsInput = {}) {
            const optionals = new UpdateAllSkillCardsOnFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
            const headers = optionals.headers;
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = yield this.networkSession.networkClient.fetch(new fetchOptions_generated_js_1.FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/skill_invocations/", (0, utils_js_2.toString)(skillId)), method: "PUT", headers: headersMap, data: serializeUpdateAllSkillCardsOnFileRequestBody(requestBody), contentType: "application/json", responseFormat: "no_content", auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
            return void 0;
        });
    }
}
...
function deserializeCreateBoxSkillCardsOnFileRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"CreateBoxSkillCardsOnFileRequestBody\"" });
    }
    if (val.cards == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"cards\" of type \"CreateBoxSkillCardsOnFileRequestBody\" to be defined" });
    }
    if (!(0, json_js_3.sdIsList)(val.cards)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"cards\" of type \"CreateBoxSkillCardsOnFileRequestBody\"" });
    }
    const cards = (0, json_js_3.sdIsList)(val.cards) ? val.cards.map(function (itm) {
...
function deserializeUpdateBoxSkillCardsOnFileRequestBodyOpField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateBoxSkillCardsOnFileRequestBodyOpField" });
}
function serializeUpdateBoxSkillCardsOnFileRequestBody(val) {
    return { ["op"]: val.op == void 0 ? val.op : serializeUpdateBoxSkillCardsOnFileRequestBodyOpField(val.op), ["path"]: val.path, ["value"]: val.value == void 0 ? val.value : (0, keywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard_generated_js_1.serializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard)(val.value) };
}
function deserializeUpdateBoxSkillCardsOnFileRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateBoxSkillCardsOnFileRequestBody\"" });
    }
    const op = val.op == void 0 ? void 0 : deserializeUpdateBoxSkillCardsOnFileRequestBodyOpField(val.op);
    if (!(val.path == void 0) && !(0, json_js_2.sdIsString)(val.path)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"path\" of type \"UpdateBoxSkillCardsOnFileRequestBody\"" });
    }
    const path = val.path == void 0 ? void 0 : val.path;
    const value = val.value == void 0 ? void 0 : (0, keywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard_generated_js_2.deserializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard)(val.value);
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyStatusField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateAllSkillCardsOnFileRequestBodyStatusField" });
}
function serializeUpdateAllSkillCardsOnFileRequestBodyMetadataField(val) {
    return { ["cards"]: val.cards == void 0 ? val.cards : val.cards.map(function (item) {
            return (0, keywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard_generated_js_1.serializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard)(item);
        }) };
}
function deserializeUpdateAllSkillCardsOnFileRequestBodyMetadataField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateAllSkillCardsOnFileRequestBodyMetadataField\"" });
    }
    if (!(val.cards == void 0) && !(0, json_js_3.sdIsList)(val.cards)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting array for \"cards\" of type \"UpdateAllSkillCardsOnFileRequestBodyMetadataField\"" });
    }
    const cards = val.cards == void 0 ? void 0 : (0, json_js_3.sdIsList)(val.cards) ? val.cards.map(function (itm) {
        return (0, keywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard_generated_js_2.deserializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard)(itm);
    }) : [];
    return { cards: cards };
}
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyFileTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateAllSkillCardsOnFileRequestBodyFileTypeField" });
}
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyFileField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateAllSkillCardsOnFileRequestBodyFileField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeUpdateAllSkillCardsOnFileRequestBodyFileTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateAllSkillCardsOnFileRequestBodyFileField\"" });
    }
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyFileVersionTypeField(val) {
    ...
    throw new errors_js_1.BoxSdkError({ message: "Can't deserialize UpdateAllSkillCardsOnFileRequestBodyFileVersionTypeField" });
}
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyFileVersionField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateAllSkillCardsOnFileRequestBodyFileVersionField\"" });
    }
    const type = val.type == void 0 ? void 0 : deserializeUpdateAllSkillCardsOnFileRequestBodyFileVersionTypeField(val.type);
    if (!(val.id == void 0) && !(0, json_js_2.sdIsString)(val.id)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateAllSkillCardsOnFileRequestBodyFileVersionField\"" });
    }
    const id = val.id == void 0 ? void 0 : val.id;
    return { type: type, id: id };
}
...
function deserializeUpdateAllSkillCardsOnFileRequestBodyUsageField(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateAllSkillCardsOnFileRequestBodyUsageField\"" });
    }
    if (!(val.unit == void 0) && !(0, json_js_2.sdIsString)(val.unit)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"unit\" of type \"UpdateAllSkillCardsOnFileRequestBodyUsageField\"" });
    }
    const unit = val.unit == void 0 ? void 0 : val.unit;
    if (!(val.value == void 0) && !(0, json_js_1.sdIsNumber)(val.value)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting number for \"value\" of type \"UpdateAllSkillCardsOnFileRequestBodyUsageField\"" });
    }
...
function deserializeUpdateAllSkillCardsOnFileRequestBody(val) {
    if (!(0, json_js_4.sdIsMap)(val)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting a map for \"UpdateAllSkillCardsOnFileRequestBody\"" });
    }
    if (val.status == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"status\" of type \"UpdateAllSkillCardsOnFileRequestBody\" to be defined" });
    }
    const status = deserializeUpdateAllSkillCardsOnFileRequestBodyStatusField(val.status);
    if (val.metadata == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"metadata\" of type \"UpdateAllSkillCardsOnFileRequestBody\" to be defined" });
    }
    const metadata = deserializeUpdateAllSkillCardsOnFileRequestBodyMetadataField(val.metadata);
    if (val.file == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"file\" of type \"UpdateAllSkillCardsOnFileRequestBody\" to be defined" });
    }
    const file = deserializeUpdateAllSkillCardsOnFileRequestBodyFileField(val.file);
    const fileVersion = val.file_version == void 0 ? void 0 : deserializeUpdateAllSkillCardsOnFileRequestBodyFileVersionField(val.file_version);
    const usage = val.usage == void 0 ? void 0 : deserializeUpdateAllSkillCardsOnFileRequestBodyUsageField(val.usage);
