...
class SkillsManager {
    ...
    getBoxSkillCardsOnFile(fileId_1) {
        return __awaiter(this, arguments, void 0, function* (fileId, optionalsInput = {}) {
            ...
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/files/', (0, utils_js_2.toString)(fileId), '/metadata/global/boxSkillsCards'), {
                method: 'GET',
                headers: headersMap,
                responseFormat: 'json',
                auth: this.auth,
            ...
            return (0, skillCardsMetadata_generated_js_1.deserializeSkillCardsMetadata)(response.data);
        });
    }
    ...
    updateAllSkillCardsOnFile(skillId_1, requestBody_1) {
        return __awaiter(this, arguments, void 0, function* (skillId, requestBody, optionalsInput = {}) {
            ...
            const cancellationToken = optionals.cancellationToken;
            const headersMap = (0, utils_js_1.prepareParams)(Object.assign({}, headers.extraHeaders));
            const response = (yield (0, fetch_js_1.fetch)(''.concat(this.networkSession.baseUrls.baseUrl, '/2.0/skill_invocations/', (0, utils_js_2.toString)(skillId)), {
                method: 'PUT',
                headers: headersMap,
