...
function deserializeBaseUrls(val) {
    ...
    if (val.base_url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"base_url\" of type \"BaseUrls\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.base_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"base_url\" of type \"BaseUrls\"" });
    }
    const baseUrl = val.base_url;
    if (val.upload_url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"upload_url\" of type \"BaseUrls\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.upload_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"upload_url\" of type \"BaseUrls\"" });
    }
    const uploadUrl = val.upload_url;
    if (val.oauth2_url == void 0) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting \"oauth2_url\" of type \"BaseUrls\" to be defined" });
    }
    if (!(0, json_js_1.sdIsString)(val.oauth2_url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"oauth2_url\" of type \"BaseUrls\"" });
    }
...
function deserializeBaseUrlsInput(val) {
    ...
    if (!(val.baseUrl == void 0) && !(0, json_js_1.sdIsString)(val.baseUrl)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"baseUrl\" of type \"BaseUrlsInput\"" });
    }
    const baseUrl = val.baseUrl == void 0 ? void 0 : val.baseUrl;
    if (!(val.uploadUrl == void 0) && !(0, json_js_1.sdIsString)(val.uploadUrl)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"uploadUrl\" of type \"BaseUrlsInput\"" });
    }
    const uploadUrl = val.uploadUrl == void 0 ? void 0 : val.uploadUrl;
    if (!(val.oauth2Url == void 0) && !(0, json_js_1.sdIsString)(val.oauth2Url)) {
        throw new errors_js_1.BoxSdkError({ message: "Expecting string for \"oauth2Url\" of type \"BaseUrlsInput\"" });
    }
    const oauth2Url = val.oauth2Url == void 0 ? void 0 : val.oauth2Url;
    return { baseUrl: baseUrl, uploadUrl: uploadUrl, oauth2Url: oauth2Url };
}
