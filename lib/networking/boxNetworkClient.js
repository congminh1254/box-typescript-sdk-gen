...
function createRequestInit(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({ method, headers: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, contentHeaders), headers), (options.auth && {
            ...
            })), { 'User-Agent': exports.userAgentHeader, 'X-Box-UA': exports.xBoxUaHeader }), (_a = options.networkSession) === null || _a === void 0 ? void 0 : _a.additionalHeaders), body: body, signal: options.cancellationToken, agent: (_b = options.networkSession) === null || _b === void 0 ? void 0 : _b.agent }, (fileStream && (0, utils_1.isBrowser)() && { duplex: 'half' }));
    });
}
