...
function fetch(resource, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fetchOptions = ((_b = (_a = options.networkSession) === null || _a === void 0 ? void 0 : _a.interceptors) === null || _b === void 0 ? void 0 : _b.length)
            ...
            : options;
        const fileStreamBuffer = fetchOptions.fileStream ? yield (0, utils_1.readByteStream)(fetchOptions.fileStream) : void 0;
        const requestInit = yield createRequestInit(Object.assign(Object.assign({}, fetchOptions), { fileStream: fileStreamBuffer ? (0, utils_1.generateByteStreamFromBuffer)(fileStreamBuffer) : void 0 }));
        ...
        if (fetchResponse.status >= 400 || acceptedWithRetryAfter) {
            ...
            if (reauthenticationNeeded && fetchOptions.auth) {
                ...
                return fetch(resource, Object.assign(Object.assign({}, fetchOptions), { numRetries: numRetries + 1, fileStream: fileStreamBuffer ? (0, utils_1.generateByteStreamFromBuffer)(fileStreamBuffer) : void 0 }));
            }
