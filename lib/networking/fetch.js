...
function createRequestInit(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({ method, headers: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (contentType && { 'Content-Type': contentType })), headers), (options.auth && {
...
function fetch(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield (0, node_fetch_1.default)(''.concat(fetchOptions.url, Object.keys(params).length === 0 || fetchOptions.url.endsWith('?')
            ? ''
            : '?', new URLSearchParams(params).toString()), Object.assign(Object.assign({}, requestInit), { redirect: 'manual' }));
