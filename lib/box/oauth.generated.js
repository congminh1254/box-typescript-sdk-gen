...
class BoxOAuth {
    ...
    getAuthorizeUrl(options = {}) {
        const paramsMap = (0, utils_js_1.prepareParams)({ ["client_id"]: !(options.clientId == void 0) ? options.clientId : this.config.clientId, ["response_type"]: !(options.responseType == void 0) ? options.responseType : "code", ["redirect_uri"]: options.redirectUri, ["state"]: options.state, ["scope"]: options.scope });
    ...
    getTokensAuthorizationCodeGrant(authorizationCode, networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = yield authManager.requestAccessToken({ grantType: "authorization_code", clientId: this.config.clientId, clientSecret: this.config.clientSecret, code: authorizationCode });
    ...
    retrieveToken(networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (token == void 0) {
                throw new errors_js_1.BoxSdkError({ message: "Access and refresh tokens not available. Authenticate before making any API call first." });
            }
            return token;
        });
    }
    ...
    refreshToken(networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokenUsedForRefresh = !(oldToken == void 0) ? oldToken.refreshToken : void 0;
            const authManager = new authorization_generated_js_1.AuthorizationManager({ networkSession: !(networkSession == void 0) ? networkSession : new network_generated_js_1.NetworkSession({}) });
            const token = yield authManager.requestAccessToken({ grantType: "refresh_token", clientId: this.config.clientId, clientSecret: this.config.clientSecret, refreshToken: tokenUsedForRefresh });
            yield this.tokenStorage.store(token);
            return token;
        });
    }
    ...
    revokeToken(networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authManager = new authorization_generated_js_1.AuthorizationManager({ networkSession: !(networkSession == void 0) ? networkSession : new network_generated_js_1.NetworkSession({}) });
            yield authManager.revokeAccessToken({ clientId: this.config.clientId, clientSecret: this.config.clientSecret, token: token.accessToken });
            return void 0;
        });
    }
    /**
    ...
    downscopeToken(scopes, resource, sharedLink, networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authManager = new authorization_generated_js_1.AuthorizationManager({ networkSession: !(networkSession == void 0) ? networkSession : new network_generated_js_1.NetworkSession({}) });
            const downscopedToken = yield authManager.requestAccessToken({ grantType: "urn:ietf:params:oauth:grant-type:token-exchange", subjectToken: token.accessToken, subjectTokenType: "urn:ietf:params:oauth:token-type:access_token", scope: scopes.join(" "), resource: resource, boxSharedLink: sharedLink });
