...
class BoxDeveloperTokenAuth {
    constructor(fields) {
        ...
        this.tokenStorage = new tokenStorage_generated_js_1.InMemoryTokenStorage({ token: { accessToken: this.token } });
    }
    /**
    ...
    refreshToken(networkSession) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new errors_js_1.BoxSdkError({ message: "Developer token has expired. Please provide a new one." });
        });
    }
    /**
