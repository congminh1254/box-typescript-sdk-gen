...
export class CreateCollaborationWhitelistExemptTargetOptionals {
    readonly headers: CreateCollaborationWhitelistExemptTargetHeaders = new CreateCollaborationWhitelistExemptTargetHeaders({});
...
export class GetCollaborationWhitelistExemptTargetByIdOptionals {
    readonly headers: GetCollaborationWhitelistExemptTargetByIdHeaders = new GetCollaborationWhitelistExemptTargetByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteCollaborationWhitelistExemptTargetByIdOptionals {
    readonly headers: DeleteCollaborationWhitelistExemptTargetByIdHeaders = new DeleteCollaborationWhitelistExemptTargetByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CollaborationAllowlistExemptTargetsManager {
     ...
     */
    async getCollaborationWhitelistExemptTargets(queryParams: GetCollaborationWhitelistExemptTargetsQueryParams = {} satisfies GetCollaborationWhitelistExemptTargetsQueryParams, headersInput: GetCollaborationWhitelistExemptTargetsHeadersInput = new GetCollaborationWhitelistExemptTargetsHeaders({}), cancellationToken?: CancellationToken): Promise<CollaborationAllowlistExemptTargets> {
        const headers: GetCollaborationWhitelistExemptTargetsHeaders = new GetCollaborationWhitelistExemptTargetsHeaders({ extraHeaders: headersInput.extraHeaders });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaboration_whitelist_exempt_targets") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createCollaborationWhitelistExemptTarget(requestBody: CreateCollaborationWhitelistExemptTargetRequestBody, optionalsInput: CreateCollaborationWhitelistExemptTargetOptionalsInput = {}): Promise<CollaborationAllowlistExemptTarget> {
        const optionals: CreateCollaborationWhitelistExemptTargetOptionals = new CreateCollaborationWhitelistExemptTargetOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaboration_whitelist_exempt_targets") as string, method: "POST", headers: headersMap, data: serializeCreateCollaborationWhitelistExemptTargetRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<CollaborationAllowlistExemptTarget>}
     */
    async getCollaborationWhitelistExemptTargetById(collaborationWhitelistExemptTargetId: string, optionalsInput: GetCollaborationWhitelistExemptTargetByIdOptionalsInput = {}): Promise<CollaborationAllowlistExemptTarget> {
        const optionals: GetCollaborationWhitelistExemptTargetByIdOptionals = new GetCollaborationWhitelistExemptTargetByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     */
    async deleteCollaborationWhitelistExemptTargetById(collaborationWhitelistExemptTargetId: string, optionalsInput: DeleteCollaborationWhitelistExemptTargetByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteCollaborationWhitelistExemptTargetByIdOptionals = new DeleteCollaborationWhitelistExemptTargetByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
...
export function serializeCreateCollaborationWhitelistExemptTargetRequestBodyUserField(val: CreateCollaborationWhitelistExemptTargetRequestBodyUserField): SerializedData {
    return { ["id"]: val.id };
}
export function deserializeCreateCollaborationWhitelistExemptTargetRequestBodyUserField(val: SerializedData): CreateCollaborationWhitelistExemptTargetRequestBodyUserField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateCollaborationWhitelistExemptTargetRequestBodyUserField\"" });
    }
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"CreateCollaborationWhitelistExemptTargetRequestBodyUserField\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"CreateCollaborationWhitelistExemptTargetRequestBodyUserField\"" });
    }
    const id: string = val.id;
    return { id: id } satisfies CreateCollaborationWhitelistExemptTargetRequestBodyUserField;
}
export function serializeCreateCollaborationWhitelistExemptTargetRequestBody(val: CreateCollaborationWhitelistExemptTargetRequestBody): SerializedData {
    return { ["user"]: serializeCreateCollaborationWhitelistExemptTargetRequestBodyUserField(val.user) };
}
export function deserializeCreateCollaborationWhitelistExemptTargetRequestBody(val: SerializedData): CreateCollaborationWhitelistExemptTargetRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateCollaborationWhitelistExemptTargetRequestBody\"" });
    }
    if (val.user == void 0) {
        throw new BoxSdkError({ message: "Expecting \"user\" of type \"CreateCollaborationWhitelistExemptTargetRequestBody\" to be defined" });
    }
    const user: CreateCollaborationWhitelistExemptTargetRequestBodyUserField = deserializeCreateCollaborationWhitelistExemptTargetRequestBodyUserField(val.user);
    return { user: user } satisfies CreateCollaborationWhitelistExemptTargetRequestBody;
}
