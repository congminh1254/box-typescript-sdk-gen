...
export class AuthorizationManager {
     ...
     */
    async authorizeUser(queryParams: AuthorizeUserQueryParams, optionalsInput: AuthorizeUserOptionalsInput = {}): Promise<undefined> {
        const optionals: AuthorizeUserOptionals = new AuthorizeUserOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["response_type"]: toString(queryParams.responseType) as string, ["client_id"]: toString(queryParams.clientId) as string, ["redirect_uri"]: toString(queryParams.redirectUri) as string, ["state"]: toString(queryParams.state) as string, ["scope"]: toString(queryParams.scope) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.oauth2Url, "/authorize") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     */
    async requestAccessToken(requestBody: PostOAuth2Token, optionalsInput: RequestAccessTokenOptionalsInput = {}): Promise<AccessToken> {
        const optionals: RequestAccessTokenOptionals = new RequestAccessTokenOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/oauth2/token") as string, method: "POST", headers: headersMap, data: serializePostOAuth2Token(requestBody), contentType: "application/x-www-form-urlencoded", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<AccessToken>}
     */
    async refreshAccessToken(requestBodyInput: PostOAuth2TokenRefreshAccessTokenInput, optionalsInput: RefreshAccessTokenOptionalsInput = {}): Promise<AccessToken> {
        const requestBody: PostOAuth2TokenRefreshAccessToken = new PostOAuth2TokenRefreshAccessToken({ grantType: requestBodyInput.grantType, clientId: requestBodyInput.clientId, clientSecret: requestBodyInput.clientSecret, refreshToken: requestBodyInput.refreshToken });
        const optionals: RefreshAccessTokenOptionals = new RefreshAccessTokenOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/oauth2/token#refresh") as string, method: "POST", headers: headersMap, data: serializePostOAuth2TokenRefreshAccessToken(requestBody), contentType: "application/x-www-form-urlencoded", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeAccessToken(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<undefined>}
     */
    async revokeAccessToken(requestBody: PostOAuth2Revoke, optionalsInput: RevokeAccessTokenOptionalsInput = {}): Promise<undefined> {
        const optionals: RevokeAccessTokenOptionals = new RevokeAccessTokenOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/oauth2/revoke") as string, method: "POST", headers: headersMap, data: serializePostOAuth2Revoke(requestBody), contentType: "application/x-www-form-urlencoded", responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeAuthorizeUserQueryParamsResponseTypeField(val: AuthorizeUserQueryParamsResponseTypeField): SerializedData {
    return val;
}
export function deserializeAuthorizeUserQueryParamsResponseTypeField(val: SerializedData): AuthorizeUserQueryParamsResponseTypeField {
    if (val == "code") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize AuthorizeUserQueryParamsResponseTypeField" });
}
