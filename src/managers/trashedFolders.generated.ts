...
export class RestoreFolderFromTrashOptionals {
    readonly requestBody: RestoreFolderFromTrashRequestBody = {} satisfies RestoreFolderFromTrashRequestBody;
    readonly queryParams: RestoreFolderFromTrashQueryParams = {} satisfies RestoreFolderFromTrashQueryParams;
    readonly headers: RestoreFolderFromTrashHeaders = new RestoreFolderFromTrashHeaders({});
...
export class GetTrashedFolderByIdOptionals {
    readonly queryParams: GetTrashedFolderByIdQueryParams = {} satisfies GetTrashedFolderByIdQueryParams;
    readonly headers: GetTrashedFolderByIdHeaders = new GetTrashedFolderByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteTrashedFolderByIdOptionals {
    readonly headers: DeleteTrashedFolderByIdHeaders = new DeleteTrashedFolderByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class TrashedFoldersManager {
     ...
     */
    async restoreFolderFromTrash(folderId: string, optionalsInput: RestoreFolderFromTrashOptionalsInput = {}): Promise<TrashFolderRestored> {
        const optionals: RestoreFolderFromTrashOptionals = new RestoreFolderFromTrashOptionals({ requestBody: optionalsInput.requestBody, queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     */
    async getTrashedFolderById(folderId: string, optionalsInput: GetTrashedFolderByIdOptionalsInput = {}): Promise<TrashFolder> {
        const optionals: GetTrashedFolderByIdOptionals = new GetTrashedFolderByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/trash") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async deleteTrashedFolderById(folderId: string, optionalsInput: DeleteTrashedFolderByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteTrashedFolderByIdOptionals = new DeleteTrashedFolderByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/trash") as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeRestoreFolderFromTrashRequestBodyParentField(val: RestoreFolderFromTrashRequestBodyParentField): SerializedData {
    return { ["id"]: val.id };
}
export function deserializeRestoreFolderFromTrashRequestBodyParentField(val: SerializedData): RestoreFolderFromTrashRequestBodyParentField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RestoreFolderFromTrashRequestBodyParentField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"RestoreFolderFromTrashRequestBodyParentField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    return { id: id } satisfies RestoreFolderFromTrashRequestBodyParentField;
}
export function serializeRestoreFolderFromTrashRequestBody(val: RestoreFolderFromTrashRequestBody): SerializedData {
    return { ["name"]: val.name, ["parent"]: val.parent == void 0 ? val.parent : serializeRestoreFolderFromTrashRequestBodyParentField(val.parent) };
}
export function deserializeRestoreFolderFromTrashRequestBody(val: SerializedData): RestoreFolderFromTrashRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RestoreFolderFromTrashRequestBody\"" });
    }
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"RestoreFolderFromTrashRequestBody\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    const parent: undefined | RestoreFolderFromTrashRequestBodyParentField = val.parent == void 0 ? void 0 : deserializeRestoreFolderFromTrashRequestBodyParentField(val.parent);
    return { name: name, parent: parent } satisfies RestoreFolderFromTrashRequestBody;
}
