...
export class CreateCollaborationWhitelistEntryOptionals {
    readonly headers: CreateCollaborationWhitelistEntryHeaders = new CreateCollaborationWhitelistEntryHeaders({});
...
export class GetCollaborationWhitelistEntryByIdOptionals {
    readonly headers: GetCollaborationWhitelistEntryByIdHeaders = new GetCollaborationWhitelistEntryByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteCollaborationWhitelistEntryByIdOptionals {
    readonly headers: DeleteCollaborationWhitelistEntryByIdHeaders = new DeleteCollaborationWhitelistEntryByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CollaborationAllowlistEntriesManager {
     ...
     */
    async getCollaborationWhitelistEntries(queryParams: GetCollaborationWhitelistEntriesQueryParams = {} satisfies GetCollaborationWhitelistEntriesQueryParams, headersInput: GetCollaborationWhitelistEntriesHeadersInput = new GetCollaborationWhitelistEntriesHeaders({}), cancellationToken?: CancellationToken): Promise<CollaborationAllowlistEntries> {
        const headers: GetCollaborationWhitelistEntriesHeaders = new GetCollaborationWhitelistEntriesHeaders({ extraHeaders: headersInput.extraHeaders });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaboration_whitelist_entries") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createCollaborationWhitelistEntry(requestBody: CreateCollaborationWhitelistEntryRequestBody, optionalsInput: CreateCollaborationWhitelistEntryOptionalsInput = {}): Promise<CollaborationAllowlistEntry> {
        const optionals: CreateCollaborationWhitelistEntryOptionals = new CreateCollaborationWhitelistEntryOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     * @returns {Promise<CollaborationAllowlistEntry>}
     */
    async getCollaborationWhitelistEntryById(collaborationWhitelistEntryId: string, optionalsInput: GetCollaborationWhitelistEntryByIdOptionalsInput = {}): Promise<CollaborationAllowlistEntry> {
        const optionals: GetCollaborationWhitelistEntryByIdOptionals = new GetCollaborationWhitelistEntryByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaboration_whitelist_entries/", toString(collaborationWhitelistEntryId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeCollaborationAllowlistEntry(response.data!),
            rawData: response.data!
        };
     ...
     */
    async deleteCollaborationWhitelistEntryById(collaborationWhitelistEntryId: string, optionalsInput: DeleteCollaborationWhitelistEntryByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteCollaborationWhitelistEntryByIdOptionals = new DeleteCollaborationWhitelistEntryByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaboration_whitelist_entries/", toString(collaborationWhitelistEntryId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeCreateCollaborationWhitelistEntryRequestBodyDirectionField(val: CreateCollaborationWhitelistEntryRequestBodyDirectionField): SerializedData {
    return val;
}
export function deserializeCreateCollaborationWhitelistEntryRequestBodyDirectionField(val: SerializedData): CreateCollaborationWhitelistEntryRequestBodyDirectionField {
    if (val == "inbound") {
        return val;
    }
    if (val == "outbound") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize CreateCollaborationWhitelistEntryRequestBodyDirectionField" });
}
export function serializeCreateCollaborationWhitelistEntryRequestBody(val: CreateCollaborationWhitelistEntryRequestBody): SerializedData {
    return { ["domain"]: val.domain, ["direction"]: serializeCreateCollaborationWhitelistEntryRequestBodyDirectionField(val.direction) };
}
export function deserializeCreateCollaborationWhitelistEntryRequestBody(val: SerializedData): CreateCollaborationWhitelistEntryRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateCollaborationWhitelistEntryRequestBody\"" });
    }
    if (val.domain == void 0) {
        throw new BoxSdkError({ message: "Expecting \"domain\" of type \"CreateCollaborationWhitelistEntryRequestBody\" to be defined" });
    }
    if (!sdIsString(val.domain)) {
        throw new BoxSdkError({ message: "Expecting string for \"domain\" of type \"CreateCollaborationWhitelistEntryRequestBody\"" });
    }
    const domain: string = val.domain;
    if (val.direction == void 0) {
        throw new BoxSdkError({ message: "Expecting \"direction\" of type \"CreateCollaborationWhitelistEntryRequestBody\" to be defined" });
    }
    const direction: CreateCollaborationWhitelistEntryRequestBodyDirectionField = deserializeCreateCollaborationWhitelistEntryRequestBodyDirectionField(val.direction);
    return { domain: domain, direction: direction } satisfies CreateCollaborationWhitelistEntryRequestBody;
}
