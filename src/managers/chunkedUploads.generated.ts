...
export class CreateFileUploadSessionOptionals {
    readonly headers: CreateFileUploadSessionHeaders = new CreateFileUploadSessionHeaders({});
...
export class CreateFileUploadSessionForExistingFileOptionals {
    readonly headers: CreateFileUploadSessionForExistingFileHeaders = new CreateFileUploadSessionForExistingFileHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetFileUploadSessionByUrlOptionals {
    readonly headers: GetFileUploadSessionByUrlHeaders = new GetFileUploadSessionByUrlHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetFileUploadSessionByIdOptionals {
    readonly headers: GetFileUploadSessionByIdHeaders = new GetFileUploadSessionByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteFileUploadSessionByUrlOptionals {
    readonly headers: DeleteFileUploadSessionByUrlHeaders = new DeleteFileUploadSessionByUrlHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteFileUploadSessionByIdOptionals {
    readonly headers: DeleteFileUploadSessionByIdHeaders = new DeleteFileUploadSessionByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetFileUploadSessionPartsByUrlOptionals {
    readonly queryParams: GetFileUploadSessionPartsByUrlQueryParams = {} satisfies GetFileUploadSessionPartsByUrlQueryParams;
    readonly headers: GetFileUploadSessionPartsByUrlHeaders = new GetFileUploadSessionPartsByUrlHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetFileUploadSessionPartsOptionals {
    readonly queryParams: GetFileUploadSessionPartsQueryParams = {} satisfies GetFileUploadSessionPartsQueryParams;
    readonly headers: GetFileUploadSessionPartsHeaders = new GetFileUploadSessionPartsHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ChunkedUploadsManager {
     ...
     */
    async createFileUploadSession(requestBody: CreateFileUploadSessionRequestBody, optionalsInput: CreateFileUploadSessionOptionalsInput = {}): Promise<UploadSession> {
        const optionals: CreateFileUploadSessionOptionals = new CreateFileUploadSessionOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions") as string, method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<UploadSession>}
     */
    async createFileUploadSessionForExistingFile(fileId: string, requestBody: CreateFileUploadSessionForExistingFileRequestBody, optionalsInput: CreateFileUploadSessionForExistingFileOptionalsInput = {}): Promise<UploadSession> {
        const optionals: CreateFileUploadSessionForExistingFileOptionals = new CreateFileUploadSessionForExistingFileOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/", toString(fileId) as string, "/upload_sessions") as string, method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionForExistingFileRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeUploadSession(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<UploadSession>}
     */
    async getFileUploadSessionByUrl(url: string, optionalsInput: GetFileUploadSessionByUrlOptionalsInput = {}): Promise<UploadSession> {
        const optionals: GetFileUploadSessionByUrlOptionals = new GetFileUploadSessionByUrlOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: url, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeUploadSession(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<UploadSession>}
     */
    async getFileUploadSessionById(uploadSessionId: string, optionalsInput: GetFileUploadSessionByIdOptionalsInput = {}): Promise<UploadSession> {
        const optionals: GetFileUploadSessionByIdOptionals = new GetFileUploadSessionByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", toString(uploadSessionId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeUploadSession(response.data!),
            rawData: response.data!
        };
     ...
     */
    async uploadFilePartByUrl(url: string, requestBody: ByteStream, headersInput: UploadFilePartByUrlHeadersInput, optionalsInput: UploadFilePartByUrlOptionalsInput = {}): Promise<UploadedPart> {
        const headers: UploadFilePartByUrlHeaders = new UploadFilePartByUrlHeaders({ digest: headersInput.digest, contentRange: headersInput.contentRange, extraHeaders: headersInput.extraHeaders });
        const optionals: UploadFilePartByUrlOptionals = new UploadFilePartByUrlOptionals({ cancellationToken: optionalsInput.cancellationToken });
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["digest"]: toString(headers.digest) as string, ["content-range"]: toString(headers.contentRange) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: url, method: "PUT", headers: headersMap, fileStream: requestBody, contentType: "application/octet-stream", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<UploadedPart>}
     */
    async uploadFilePart(uploadSessionId: string, requestBody: ByteStream, headersInput: UploadFilePartHeadersInput, optionalsInput: UploadFilePartOptionalsInput = {}): Promise<UploadedPart> {
        const headers: UploadFilePartHeaders = new UploadFilePartHeaders({ digest: headersInput.digest, contentRange: headersInput.contentRange, extraHeaders: headersInput.extraHeaders });
        const optionals: UploadFilePartOptionals = new UploadFilePartOptionals({ cancellationToken: optionalsInput.cancellationToken });
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["digest"]: toString(headers.digest) as string, ["content-range"]: toString(headers.contentRange) as string }, ...headers.extraHeaders });
     ...
     */
    async deleteFileUploadSessionByUrl(url: string, optionalsInput: DeleteFileUploadSessionByUrlOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteFileUploadSessionByUrlOptionals = new DeleteFileUploadSessionByUrlOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: url, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     * Abort an upload session and discard all data uploaded.
     ...
     * @returns {Promise<undefined>}
     */
    async deleteFileUploadSessionById(uploadSessionId: string, optionalsInput: DeleteFileUploadSessionByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteFileUploadSessionByIdOptionals = new DeleteFileUploadSessionByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", toString(uploadSessionId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     */
    async getFileUploadSessionPartsByUrl(url: string, optionalsInput: GetFileUploadSessionPartsByUrlOptionalsInput = {}): Promise<UploadParts> {
        const optionals: GetFileUploadSessionPartsByUrlOptionals = new GetFileUploadSessionPartsByUrlOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["offset"]: toString(queryParams.offset) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: url, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<UploadParts>}
     */
    async getFileUploadSessionParts(uploadSessionId: string, optionalsInput: GetFileUploadSessionPartsOptionalsInput = {}): Promise<UploadParts> {
        const optionals: GetFileUploadSessionPartsOptionals = new GetFileUploadSessionPartsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.uploadUrl, "/2.0/files/upload_sessions/", toString(uploadSessionId) as string, "/parts") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeUploadParts(response.data!),
            rawData: response.data!
        };
     ...
     */
    async createFileUploadSessionCommitByUrl(url: string, requestBody: CreateFileUploadSessionCommitByUrlRequestBody, headersInput: CreateFileUploadSessionCommitByUrlHeadersInput, optionalsInput: CreateFileUploadSessionCommitByUrlOptionalsInput = {}): Promise<undefined | Files> {
        const headers: CreateFileUploadSessionCommitByUrlHeaders = new CreateFileUploadSessionCommitByUrlHeaders({ digest: headersInput.digest, ifMatch: headersInput.ifMatch, ifNoneMatch: headersInput.ifNoneMatch, extraHeaders: headersInput.extraHeaders });
        const optionals: CreateFileUploadSessionCommitByUrlOptionals = new CreateFileUploadSessionCommitByUrlOptionals({ cancellationToken: optionalsInput.cancellationToken });
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["digest"]: toString(headers.digest) as string, ["if-match"]: toString(headers.ifMatch) as string, ["if-none-match"]: toString(headers.ifNoneMatch) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: url, method: "POST", headers: headersMap, data: serializeCreateFileUploadSessionCommitRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
     ...
     * @returns {Promise<undefined | Files>}
     */
    async createFileUploadSessionCommit(uploadSessionId: string, requestBody: CreateFileUploadSessionCommitRequestBody, headersInput: CreateFileUploadSessionCommitHeadersInput, optionalsInput: CreateFileUploadSessionCommitOptionalsInput = {}): Promise<undefined | Files> {
        const headers: CreateFileUploadSessionCommitHeaders = new CreateFileUploadSessionCommitHeaders({ digest: headersInput.digest, ifMatch: headersInput.ifMatch, ifNoneMatch: headersInput.ifNoneMatch, extraHeaders: headersInput.extraHeaders });
        const optionals: CreateFileUploadSessionCommitOptionals = new CreateFileUploadSessionCommitOptionals({ cancellationToken: optionalsInput.cancellationToken });
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["digest"]: toString(headers.digest) as string, ["if-match"]: toString(headers.ifMatch) as string, ["if-none-match"]: toString(headers.ifNoneMatch) as string }, ...headers.extraHeaders });
     ...
     */
    private async reducer(acc: PartAccumulator, chunk: ByteStream): Promise<PartAccumulator> {
        ...
        const contentRange: string = "".concat("bytes ", (toString(bytesStart) as string)!, "-", (toString(bytesEnd) as string)!, "/", (toString(acc.fileSize) as string)!) as string;
        const uploadedPart: UploadedPart = await this.uploadFilePartByUrl(acc.uploadPartUrl, generateByteStreamFromBuffer(chunkBuffer), { digest: digest, contentRange: contentRange } satisfies UploadFilePartByUrlHeadersInput);
        ...
        return { lastIndex: bytesEnd, parts: parts.concat([part]), fileSize: acc.fileSize, uploadPartUrl: acc.uploadPartUrl, fileHash: acc.fileHash } satisfies PartAccumulator;
    }
    /**
     ...
     */
    async uploadBigFile(file: ByteStream, fileName: string, fileSize: number, parentFolderId: string, cancellationToken?: CancellationToken): Promise<FileFull> {
        const uploadSession: UploadSession = await this.createFileUploadSession({ fileName: fileName, fileSize: fileSize, folderId: parentFolderId } satisfies CreateFileUploadSessionRequestBody, { headers: new CreateFileUploadSessionHeaders({}), cancellationToken: cancellationToken } satisfies CreateFileUploadSessionOptionalsInput);
        ...
        const results: PartAccumulator = await reduceIterator(chunksIterator, this.reducer.bind(this), { lastIndex: -1, parts: [], fileSize: fileSize, uploadPartUrl: uploadPartUrl, fileHash: fileHash } satisfies PartAccumulator);
        const parts: readonly UploadPart[] = results.parts;
        const processedSessionParts: UploadParts = await this.getFileUploadSessionPartsByUrl(listPartsUrl, { queryParams: {} satisfies GetFileUploadSessionPartsByUrlQueryParams, headers: new GetFileUploadSessionPartsByUrlHeaders({}), cancellationToken: cancellationToken } satisfies GetFileUploadSessionPartsByUrlOptionalsInput);
        if (!(processedSessionParts.totalCount! == totalParts)) {
            throw new Error("Assertion failed");
        }
        const sha1: string = await fileHash.digestHash("base64");
        const digest: string = "".concat("sha=", sha1) as string;
        const committedSession: undefined | Files = await this.createFileUploadSessionCommitByUrl(commitUrl, { parts: parts } satisfies CreateFileUploadSessionCommitByUrlRequestBody, { digest: digest } satisfies CreateFileUploadSessionCommitByUrlHeadersInput, { cancellationToken: cancellationToken } satisfies CreateFileUploadSessionCommitByUrlOptionalsInput);
...
export function serializeCreateFileUploadSessionRequestBody(val: CreateFileUploadSessionRequestBody): SerializedData {
    return { ["folder_id"]: val.folderId, ["file_size"]: val.fileSize, ["file_name"]: val.fileName };
}
export function deserializeCreateFileUploadSessionRequestBody(val: SerializedData): CreateFileUploadSessionRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionRequestBody\"" });
    }
    if (val.folder_id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"folder_id\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!sdIsString(val.folder_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
    const folderId: string = val.folder_id;
    if (val.file_size == void 0) {
        throw new BoxSdkError({ message: "Expecting \"file_size\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!sdIsNumber(val.file_size)) {
        throw new BoxSdkError({ message: "Expecting number for \"file_size\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
    const fileSize: number = val.file_size;
    if (val.file_name == void 0) {
        throw new BoxSdkError({ message: "Expecting \"file_name\" of type \"CreateFileUploadSessionRequestBody\" to be defined" });
    }
    if (!sdIsString(val.file_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"file_name\" of type \"CreateFileUploadSessionRequestBody\"" });
    }
    const fileName: string = val.file_name;
    return { folderId: folderId, fileSize: fileSize, fileName: fileName } satisfies CreateFileUploadSessionRequestBody;
}
export function serializeCreateFileUploadSessionForExistingFileRequestBody(val: CreateFileUploadSessionForExistingFileRequestBody): SerializedData {
    return { ["file_size"]: val.fileSize, ["file_name"]: val.fileName };
}
export function deserializeCreateFileUploadSessionForExistingFileRequestBody(val: SerializedData): CreateFileUploadSessionForExistingFileRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
    if (val.file_size == void 0) {
        throw new BoxSdkError({ message: "Expecting \"file_size\" of type \"CreateFileUploadSessionForExistingFileRequestBody\" to be defined" });
    }
    if (!sdIsNumber(val.file_size)) {
        throw new BoxSdkError({ message: "Expecting number for \"file_size\" of type \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
    const fileSize: number = val.file_size;
    if (!(val.file_name == void 0) && !sdIsString(val.file_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"file_name\" of type \"CreateFileUploadSessionForExistingFileRequestBody\"" });
    }
    const fileName: undefined | string = val.file_name == void 0 ? void 0 : val.file_name;
    return { fileSize: fileSize, fileName: fileName } satisfies CreateFileUploadSessionForExistingFileRequestBody;
}
export function serializeCreateFileUploadSessionCommitByUrlRequestBody(val: CreateFileUploadSessionCommitByUrlRequestBody): SerializedData {
    return { ["parts"]: val.parts.map(function (item: UploadPart): SerializedData {
            return serializeUploadPart(item);
        }) as readonly any[] };
}
export function deserializeCreateFileUploadSessionCommitByUrlRequestBody(val: SerializedData): CreateFileUploadSessionCommitByUrlRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionCommitByUrlRequestBody\"" });
    }
    if (val.parts == void 0) {
        throw new BoxSdkError({ message: "Expecting \"parts\" of type \"CreateFileUploadSessionCommitByUrlRequestBody\" to be defined" });
    }
    if (!sdIsList(val.parts)) {
        throw new BoxSdkError({ message: "Expecting array for \"parts\" of type \"CreateFileUploadSessionCommitByUrlRequestBody\"" });
    }
    const parts: readonly UploadPart[] = sdIsList(val.parts) ? val.parts.map(function (itm: SerializedData): UploadPart {
        return deserializeUploadPart(itm);
    }) as readonly any[] : [];
    return { parts: parts } satisfies CreateFileUploadSessionCommitByUrlRequestBody;
}
export function serializeCreateFileUploadSessionCommitRequestBody(val: CreateFileUploadSessionCommitRequestBody): SerializedData {
    return { ["parts"]: val.parts.map(function (item: UploadPart): SerializedData {
            return serializeUploadPart(item);
        }) as readonly any[] };
}
export function deserializeCreateFileUploadSessionCommitRequestBody(val: SerializedData): CreateFileUploadSessionCommitRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateFileUploadSessionCommitRequestBody\"" });
    }
    if (val.parts == void 0) {
        throw new BoxSdkError({ message: "Expecting \"parts\" of type \"CreateFileUploadSessionCommitRequestBody\" to be defined" });
    }
    if (!sdIsList(val.parts)) {
        throw new BoxSdkError({ message: "Expecting array for \"parts\" of type \"CreateFileUploadSessionCommitRequestBody\"" });
    }
    const parts: readonly UploadPart[] = sdIsList(val.parts) ? val.parts.map(function (itm: SerializedData): UploadPart {
        return deserializeUploadPart(itm);
    }) as readonly any[] : [];
