...
export class CreateSlackIntegrationMappingOptionals {
    readonly headers: CreateSlackIntegrationMappingHeaders = new CreateSlackIntegrationMappingHeaders({});
...
export class UpdateSlackIntegrationMappingByIdOptionals {
    readonly requestBody: UpdateSlackIntegrationMappingByIdRequestBody = {} satisfies UpdateSlackIntegrationMappingByIdRequestBody;
    readonly headers: UpdateSlackIntegrationMappingByIdHeaders = new UpdateSlackIntegrationMappingByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteSlackIntegrationMappingByIdOptionals {
    readonly headers: DeleteSlackIntegrationMappingByIdHeaders = new DeleteSlackIntegrationMappingByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateTeamsIntegrationMappingOptionals {
    readonly headers: CreateTeamsIntegrationMappingHeaders = new CreateTeamsIntegrationMappingHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class UpdateTeamsIntegrationMappingByIdOptionals {
    readonly requestBody: UpdateTeamsIntegrationMappingByIdRequestBody = {} satisfies UpdateTeamsIntegrationMappingByIdRequestBody;
    readonly headers: UpdateTeamsIntegrationMappingByIdHeaders = new UpdateTeamsIntegrationMappingByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteTeamsIntegrationMappingByIdOptionals {
    readonly headers: DeleteTeamsIntegrationMappingByIdHeaders = new DeleteTeamsIntegrationMappingByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class IntegrationMappingsManager {
     ...
     */
    async getSlackIntegrationMapping(queryParams: GetSlackIntegrationMappingQueryParams = {} satisfies GetSlackIntegrationMappingQueryParams, headersInput: GetSlackIntegrationMappingHeadersInput = new GetSlackIntegrationMappingHeaders({}), cancellationToken?: CancellationToken): Promise<IntegrationMappings> {
        const headers: GetSlackIntegrationMappingHeaders = new GetSlackIntegrationMappingHeaders({ extraHeaders: headersInput.extraHeaders });
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string, ["partner_item_type"]: toString(queryParams.partnerItemType) as string, ["partner_item_id"]: toString(queryParams.partnerItemId) as string, ["box_item_id"]: toString(queryParams.boxItemId) as string, ["box_item_type"]: toString(queryParams.boxItemType) as string, ["is_manually_created"]: toString(queryParams.isManuallyCreated) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/integration_mappings/slack") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createSlackIntegrationMapping(requestBody: IntegrationMappingSlackCreateRequest, optionalsInput: CreateSlackIntegrationMappingOptionalsInput = {}): Promise<IntegrationMapping> {
        const optionals: CreateSlackIntegrationMappingOptionals = new CreateSlackIntegrationMappingOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/integration_mappings/slack") as string, method: "POST", headers: headersMap, data: serializeIntegrationMappingSlackCreateRequest(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<IntegrationMapping>}
     */
    async updateSlackIntegrationMappingById(integrationMappingId: string, optionalsInput: UpdateSlackIntegrationMappingByIdOptionalsInput = {}): Promise<IntegrationMapping> {
        const optionals: UpdateSlackIntegrationMappingByIdOptionals = new UpdateSlackIntegrationMappingByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     */
    async deleteSlackIntegrationMappingById(integrationMappingId: string, optionalsInput: DeleteSlackIntegrationMappingByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteSlackIntegrationMappingByIdOptionals = new DeleteSlackIntegrationMappingByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     */
    async getTeamsIntegrationMapping(queryParams: GetTeamsIntegrationMappingQueryParams = {} satisfies GetTeamsIntegrationMappingQueryParams, headersInput: GetTeamsIntegrationMappingHeadersInput = new GetTeamsIntegrationMappingHeaders({}), cancellationToken?: CancellationToken): Promise<IntegrationMappingsTeams> {
        const headers: GetTeamsIntegrationMappingHeaders = new GetTeamsIntegrationMappingHeaders({ extraHeaders: headersInput.extraHeaders });
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["partner_item_type"]: toString(queryParams.partnerItemType) as string, ["partner_item_id"]: toString(queryParams.partnerItemId) as string, ["box_item_id"]: toString(queryParams.boxItemId) as string, ["box_item_type"]: toString(queryParams.boxItemType) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/integration_mappings/teams") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createTeamsIntegrationMapping(requestBody: IntegrationMappingTeamsCreateRequest, optionalsInput: CreateTeamsIntegrationMappingOptionalsInput = {}): Promise<IntegrationMappingTeams> {
        const optionals: CreateTeamsIntegrationMappingOptionals = new CreateTeamsIntegrationMappingOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/integration_mappings/teams") as string, method: "POST", headers: headersMap, data: serializeIntegrationMappingTeamsCreateRequest(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<IntegrationMappingTeams>}
     */
    async updateTeamsIntegrationMappingById(integrationMappingId: string, optionalsInput: UpdateTeamsIntegrationMappingByIdOptionalsInput = {}): Promise<IntegrationMappingTeams> {
        const optionals: UpdateTeamsIntegrationMappingByIdOptionals = new UpdateTeamsIntegrationMappingByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const requestBody: any = optionals.requestBody;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/integration_mappings/teams/", toString(integrationMappingId) as string) as string, method: "PUT", headers: headersMap, data: serializeUpdateTeamsIntegrationMappingByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeIntegrationMappingTeams(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<undefined>}
     */
    async deleteTeamsIntegrationMappingById(integrationMappingId: string, optionalsInput: DeleteTeamsIntegrationMappingByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteTeamsIntegrationMappingByIdOptionals = new DeleteTeamsIntegrationMappingByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
...
export function serializeGetSlackIntegrationMappingQueryParamsPartnerItemTypeField(val: GetSlackIntegrationMappingQueryParamsPartnerItemTypeField): SerializedData {
    return val;
}
export function deserializeGetSlackIntegrationMappingQueryParamsPartnerItemTypeField(val: SerializedData): GetSlackIntegrationMappingQueryParamsPartnerItemTypeField {
    if (val == "channel") {
        return val;
    }
    if (sdIsString(val)) {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetSlackIntegrationMappingQueryParamsPartnerItemTypeField" });
}
export function serializeGetSlackIntegrationMappingQueryParamsBoxItemTypeField(val: GetSlackIntegrationMappingQueryParamsBoxItemTypeField): SerializedData {
    return val;
}
export function deserializeGetSlackIntegrationMappingQueryParamsBoxItemTypeField(val: SerializedData): GetSlackIntegrationMappingQueryParamsBoxItemTypeField {
    if (val == "folder") {
        return val;
    }
    if (sdIsString(val)) {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetSlackIntegrationMappingQueryParamsBoxItemTypeField" });
}
export function serializeUpdateSlackIntegrationMappingByIdRequestBody(val: UpdateSlackIntegrationMappingByIdRequestBody): SerializedData {
    return { ["box_item"]: val.boxItem == void 0 ? val.boxItem : serializeIntegrationMappingBoxItemSlack(val.boxItem), ["options"]: val.options == void 0 ? val.options : serializeIntegrationMappingSlackOptions(val.options) };
}
export function deserializeUpdateSlackIntegrationMappingByIdRequestBody(val: SerializedData): UpdateSlackIntegrationMappingByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateSlackIntegrationMappingByIdRequestBody\"" });
    }
    ...
    return { boxItem: boxItem, options: options } satisfies UpdateSlackIntegrationMappingByIdRequestBody;
}
export function serializeGetTeamsIntegrationMappingQueryParamsPartnerItemTypeField(val: GetTeamsIntegrationMappingQueryParamsPartnerItemTypeField): SerializedData {
    return val;
}
export function deserializeGetTeamsIntegrationMappingQueryParamsPartnerItemTypeField(val: SerializedData): GetTeamsIntegrationMappingQueryParamsPartnerItemTypeField {
    if (val == "channel") {
        return val;
    }
    if (val == "team") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetTeamsIntegrationMappingQueryParamsPartnerItemTypeField" });
}
export function serializeGetTeamsIntegrationMappingQueryParamsBoxItemTypeField(val: GetTeamsIntegrationMappingQueryParamsBoxItemTypeField): SerializedData {
    return val;
}
export function deserializeGetTeamsIntegrationMappingQueryParamsBoxItemTypeField(val: SerializedData): GetTeamsIntegrationMappingQueryParamsBoxItemTypeField {
    if (val == "folder") {
        return val;
    }
    if (sdIsString(val)) {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetTeamsIntegrationMappingQueryParamsBoxItemTypeField" });
}
export function serializeUpdateTeamsIntegrationMappingByIdRequestBody(val: UpdateTeamsIntegrationMappingByIdRequestBody): SerializedData {
    return { ["box_item"]: val.boxItem == void 0 ? val.boxItem : serializeFolderReference(val.boxItem) };
}
export function deserializeUpdateTeamsIntegrationMappingByIdRequestBody(val: SerializedData): UpdateTeamsIntegrationMappingByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateTeamsIntegrationMappingByIdRequestBody\"" });
    }
    const boxItem: undefined | FolderReference = val.box_item == void 0 ? void 0 : deserializeFolderReference(val.box_item);
    return { boxItem: boxItem } satisfies UpdateTeamsIntegrationMappingByIdRequestBody;
}
