...
export class GetZipDownloadContentOptionals {
    readonly headers: GetZipDownloadContentHeaders = new GetZipDownloadContentHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetZipDownloadStatusOptionals {
    readonly headers: GetZipDownloadStatusHeaders = new GetZipDownloadStatusHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ZipDownloadsManager {
     ...
     */
    async createZipDownload(requestBody: ZipDownloadRequest, optionalsInput: CreateZipDownloadOptionalsInput = {}): Promise<ZipDownload> {
        const optionals: CreateZipDownloadOptionals = new CreateZipDownloadOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/zip_downloads") as string, method: "POST", headers: headersMap, data: serializeZipDownloadRequest(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getZipDownloadContent(downloadUrl: string, optionalsInput: GetZipDownloadContentOptionalsInput = {}): Promise<ByteStream> {
        const optionals: GetZipDownloadContentOptionals = new GetZipDownloadContentOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: downloadUrl, method: "GET", headers: headersMap, responseFormat: "binary" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
     ...
     */
    async getZipDownloadStatus(statusUrl: string, optionalsInput: GetZipDownloadStatusOptionalsInput = {}): Promise<ZipDownloadStatus> {
        const optionals: GetZipDownloadStatusOptionals = new GetZipDownloadStatusOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: statusUrl, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<ByteStream>}
     */
    async downloadZip(requestBody: ZipDownloadRequest, optionalsInput: DownloadZipOptionalsInput = {}): Promise<ByteStream> {
        const optionals: DownloadZipOptionals = new DownloadZipOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const zipDownloadSession: ZipDownload = await this.createZipDownload({ items: requestBody.items, downloadFileName: requestBody.downloadFileName } satisfies ZipDownloadRequest, { headers: new CreateZipDownloadHeaders({ extraHeaders: headers.extraHeaders }), cancellationToken: cancellationToken } satisfies CreateZipDownloadOptionalsInput);
        return await this.getZipDownloadContent(zipDownloadSession.downloadUrl!, { headers: new GetZipDownloadContentHeaders({ extraHeaders: headers.extraHeaders }), cancellationToken: cancellationToken } satisfies GetZipDownloadContentOptionalsInput);
    }
}
