...
export class GetShieldInformationBarrierByIdOptionals {
    readonly headers: GetShieldInformationBarrierByIdHeaders = new GetShieldInformationBarrierByIdHeaders({});
...
export class UpdateShieldInformationBarrierStatusOptionals {
    readonly headers: UpdateShieldInformationBarrierStatusHeaders = new UpdateShieldInformationBarrierStatusHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateShieldInformationBarrierOptionals {
    readonly headers: CreateShieldInformationBarrierHeaders = new CreateShieldInformationBarrierHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ShieldInformationBarriersManager {
     ...
     */
    async getShieldInformationBarrierById(shieldInformationBarrierId: string, optionalsInput: GetShieldInformationBarrierByIdOptionalsInput = {}): Promise<ShieldInformationBarrier> {
        const optionals: GetShieldInformationBarrierByIdOptionals = new GetShieldInformationBarrierByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barriers/", toString(shieldInformationBarrierId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<ShieldInformationBarrier>}
     */
    async updateShieldInformationBarrierStatus(requestBody: UpdateShieldInformationBarrierStatusRequestBody, optionalsInput: UpdateShieldInformationBarrierStatusOptionalsInput = {}): Promise<ShieldInformationBarrier> {
        const optionals: UpdateShieldInformationBarrierStatusOptionals = new UpdateShieldInformationBarrierStatusOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     */
    async getShieldInformationBarriers(queryParams: GetShieldInformationBarriersQueryParams = {} satisfies GetShieldInformationBarriersQueryParams, headersInput: GetShieldInformationBarriersHeadersInput = new GetShieldInformationBarriersHeaders({}), cancellationToken?: CancellationToken): Promise<ShieldInformationBarriers> {
        const headers: GetShieldInformationBarriersHeaders = new GetShieldInformationBarriersHeaders({ extraHeaders: headersInput.extraHeaders });
     ...
     * @returns {Promise<ShieldInformationBarrier>}
     */
    async createShieldInformationBarrier(requestBody: CreateShieldInformationBarrierRequestBody, optionalsInput: CreateShieldInformationBarrierOptionalsInput = {}): Promise<ShieldInformationBarrier> {
        const optionals: CreateShieldInformationBarrierOptionals = new CreateShieldInformationBarrierOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barriers") as string, method: "POST", headers: headersMap, data: serializeCreateShieldInformationBarrierRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeShieldInformationBarrier(response.data!),
            rawData: response.data!
        };
...
export function serializeUpdateShieldInformationBarrierStatusRequestBodyStatusField(val: UpdateShieldInformationBarrierStatusRequestBodyStatusField): SerializedData {
    return val;
}
export function deserializeUpdateShieldInformationBarrierStatusRequestBodyStatusField(val: SerializedData): UpdateShieldInformationBarrierStatusRequestBodyStatusField {
    if (val == "pending") {
        return val;
    }
    if (val == "disabled") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize UpdateShieldInformationBarrierStatusRequestBodyStatusField" });
}
export function serializeUpdateShieldInformationBarrierStatusRequestBody(val: UpdateShieldInformationBarrierStatusRequestBody): SerializedData {
    return { ["id"]: val.id, ["status"]: serializeUpdateShieldInformationBarrierStatusRequestBodyStatusField(val.status) };
}
export function deserializeUpdateShieldInformationBarrierStatusRequestBody(val: SerializedData): UpdateShieldInformationBarrierStatusRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateShieldInformationBarrierStatusRequestBody\"" });
    }
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"UpdateShieldInformationBarrierStatusRequestBody\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UpdateShieldInformationBarrierStatusRequestBody\"" });
    }
    const id: string = val.id;
    if (val.status == void 0) {
        throw new BoxSdkError({ message: "Expecting \"status\" of type \"UpdateShieldInformationBarrierStatusRequestBody\" to be defined" });
    }
    const status: UpdateShieldInformationBarrierStatusRequestBodyStatusField = deserializeUpdateShieldInformationBarrierStatusRequestBodyStatusField(val.status);
    return { id: id, status: status } satisfies UpdateShieldInformationBarrierStatusRequestBody;
}
export function serializeCreateShieldInformationBarrierRequestBody(val: CreateShieldInformationBarrierRequestBody): SerializedData {
    return { ["enterprise"]: serializeEnterpriseBase(val.enterprise) };
}
export function deserializeCreateShieldInformationBarrierRequestBody(val: SerializedData): CreateShieldInformationBarrierRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateShieldInformationBarrierRequestBody\"" });
    }
    if (val.enterprise == void 0) {
        throw new BoxSdkError({ message: "Expecting \"enterprise\" of type \"CreateShieldInformationBarrierRequestBody\" to be defined" });
    }
    const enterprise: EnterpriseBase = deserializeEnterpriseBase(val.enterprise);
    return { enterprise: enterprise } satisfies CreateShieldInformationBarrierRequestBody;
}
