...
export class GetDocgenJobByIdV2025R0Optionals {
    readonly headers: GetDocgenJobByIdV2025R0Headers = new GetDocgenJobByIdV2025R0Headers({});
...
export class GetDocgenBatchJobByIdV2025R0Optionals {
    readonly queryParams: GetDocgenBatchJobByIdV2025R0QueryParams = {} satisfies GetDocgenBatchJobByIdV2025R0QueryParams;
    readonly headers: GetDocgenBatchJobByIdV2025R0Headers = new GetDocgenBatchJobByIdV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateDocgenBatchV2025R0Optionals {
    readonly headers: CreateDocgenBatchV2025R0Headers = new CreateDocgenBatchV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DocgenManager {
     ...
     */
    async getDocgenJobByIdV2025R0(jobId: string, optionalsInput: GetDocgenJobByIdV2025R0OptionalsInput = {}): Promise<DocGenJobV2025R0> {
        const optionals: GetDocgenJobByIdV2025R0Optionals = new GetDocgenJobByIdV2025R0Optionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_jobs/", toString(jobId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getDocgenJobsV2025R0(queryParams: GetDocgenJobsV2025R0QueryParams = {} satisfies GetDocgenJobsV2025R0QueryParams, headersInput: GetDocgenJobsV2025R0HeadersInput = new GetDocgenJobsV2025R0Headers({}), cancellationToken?: CancellationToken): Promise<DocGenJobsFullV2025R0> {
        const headers: GetDocgenJobsV2025R0Headers = new GetDocgenJobsV2025R0Headers({ boxVersion: headersInput.boxVersion, extraHeaders: headersInput.extraHeaders });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_jobs") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getDocgenBatchJobByIdV2025R0(batchId: string, optionalsInput: GetDocgenBatchJobByIdV2025R0OptionalsInput = {}): Promise<DocGenJobsV2025R0> {
        const optionals: GetDocgenBatchJobByIdV2025R0Optionals = new GetDocgenBatchJobByIdV2025R0Optionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_batch_jobs/", toString(batchId) as string) as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createDocgenBatchV2025R0(requestBody: DocGenBatchCreateRequestV2025R0, optionalsInput: CreateDocgenBatchV2025R0OptionalsInput = {}): Promise<DocGenBatchBaseV2025R0> {
        const optionals: CreateDocgenBatchV2025R0Optionals = new CreateDocgenBatchV2025R0Optionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_batches") as string, method: "POST", headers: headersMap, data: serializeDocGenBatchCreateRequestV2025R0(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
