...
export class GetMetadataCascadePoliciesOptionals {
    readonly headers: GetMetadataCascadePoliciesHeaders = new GetMetadataCascadePoliciesHeaders({});
...
export class CreateMetadataCascadePolicyOptionals {
    readonly headers: CreateMetadataCascadePolicyHeaders = new CreateMetadataCascadePolicyHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetMetadataCascadePolicyByIdOptionals {
    readonly headers: GetMetadataCascadePolicyByIdHeaders = new GetMetadataCascadePolicyByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteMetadataCascadePolicyByIdOptionals {
    readonly headers: DeleteMetadataCascadePolicyByIdHeaders = new DeleteMetadataCascadePolicyByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ApplyMetadataCascadePolicyOptionals {
    readonly headers: ApplyMetadataCascadePolicyHeaders = new ApplyMetadataCascadePolicyHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class MetadataCascadePoliciesManager {
     ...
     */
    async getMetadataCascadePolicies(queryParams: GetMetadataCascadePoliciesQueryParams, optionalsInput: GetMetadataCascadePoliciesOptionalsInput = {}): Promise<MetadataCascadePolicies> {
        const optionals: GetMetadataCascadePoliciesOptionals = new GetMetadataCascadePoliciesOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["folder_id"]: toString(queryParams.folderId) as string, ["owner_enterprise_id"]: toString(queryParams.ownerEnterpriseId) as string, ["marker"]: toString(queryParams.marker) as string, ["offset"]: toString(queryParams.offset) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createMetadataCascadePolicy(requestBody: CreateMetadataCascadePolicyRequestBody, optionalsInput: CreateMetadataCascadePolicyOptionalsInput = {}): Promise<MetadataCascadePolicy> {
        const optionals: CreateMetadataCascadePolicyOptionals = new CreateMetadataCascadePolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies") as string, method: "POST", headers: headersMap, data: serializeCreateMetadataCascadePolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<MetadataCascadePolicy>}
     */
    async getMetadataCascadePolicyById(metadataCascadePolicyId: string, optionalsInput: GetMetadataCascadePolicyByIdOptionalsInput = {}): Promise<MetadataCascadePolicy> {
        const optionals: GetMetadataCascadePolicyByIdOptionals = new GetMetadataCascadePolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", toString(metadataCascadePolicyId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeMetadataCascadePolicy(response.data!),
            rawData: response.data!
        };
     ...
     */
    async deleteMetadataCascadePolicyById(metadataCascadePolicyId: string, optionalsInput: DeleteMetadataCascadePolicyByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteMetadataCascadePolicyByIdOptionals = new DeleteMetadataCascadePolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", toString(metadataCascadePolicyId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     * @returns {Promise<undefined>}
     */
    async applyMetadataCascadePolicy(metadataCascadePolicyId: string, requestBody: ApplyMetadataCascadePolicyRequestBody, optionalsInput: ApplyMetadataCascadePolicyOptionalsInput = {}): Promise<undefined> {
        const optionals: ApplyMetadataCascadePolicyOptionals = new ApplyMetadataCascadePolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_cascade_policies/", toString(metadataCascadePolicyId) as string, "/apply") as string, method: "POST", headers: headersMap, data: serializeApplyMetadataCascadePolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeCreateMetadataCascadePolicyRequestBodyScopeField(val: CreateMetadataCascadePolicyRequestBodyScopeField): SerializedData {
    return val;
}
export function deserializeCreateMetadataCascadePolicyRequestBodyScopeField(val: SerializedData): CreateMetadataCascadePolicyRequestBodyScopeField {
    if (val == "global") {
        return val;
    }
    if (val == "enterprise") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize CreateMetadataCascadePolicyRequestBodyScopeField" });
}
export function serializeCreateMetadataCascadePolicyRequestBody(val: CreateMetadataCascadePolicyRequestBody): SerializedData {
    return { ["folder_id"]: val.folderId, ["scope"]: serializeCreateMetadataCascadePolicyRequestBodyScopeField(val.scope), ["templateKey"]: val.templateKey };
}
export function deserializeCreateMetadataCascadePolicyRequestBody(val: SerializedData): CreateMetadataCascadePolicyRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateMetadataCascadePolicyRequestBody\"" });
    }
    if (val.folder_id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"folder_id\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    if (!sdIsString(val.folder_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"CreateMetadataCascadePolicyRequestBody\"" });
    }
    const folderId: string = val.folder_id;
    if (val.scope == void 0) {
        throw new BoxSdkError({ message: "Expecting \"scope\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    const scope: CreateMetadataCascadePolicyRequestBodyScopeField = deserializeCreateMetadataCascadePolicyRequestBodyScopeField(val.scope);
    if (val.templateKey == void 0) {
        throw new BoxSdkError({ message: "Expecting \"templateKey\" of type \"CreateMetadataCascadePolicyRequestBody\" to be defined" });
    }
    if (!sdIsString(val.templateKey)) {
        throw new BoxSdkError({ message: "Expecting string for \"templateKey\" of type \"CreateMetadataCascadePolicyRequestBody\"" });
    }
    const templateKey: string = val.templateKey;
    return { folderId: folderId, scope: scope, templateKey: templateKey } satisfies CreateMetadataCascadePolicyRequestBody;
}
export function serializeApplyMetadataCascadePolicyRequestBodyConflictResolutionField(val: ApplyMetadataCascadePolicyRequestBodyConflictResolutionField): SerializedData {
    return val;
}
export function deserializeApplyMetadataCascadePolicyRequestBodyConflictResolutionField(val: SerializedData): ApplyMetadataCascadePolicyRequestBodyConflictResolutionField {
    if (val == "none") {
        return val;
    }
    if (val == "overwrite") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize ApplyMetadataCascadePolicyRequestBodyConflictResolutionField" });
}
export function serializeApplyMetadataCascadePolicyRequestBody(val: ApplyMetadataCascadePolicyRequestBody): SerializedData {
    return { ["conflict_resolution"]: serializeApplyMetadataCascadePolicyRequestBodyConflictResolutionField(val.conflictResolution) };
}
export function deserializeApplyMetadataCascadePolicyRequestBody(val: SerializedData): ApplyMetadataCascadePolicyRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ApplyMetadataCascadePolicyRequestBody\"" });
    }
    if (val.conflict_resolution == void 0) {
        throw new BoxSdkError({ message: "Expecting \"conflict_resolution\" of type \"ApplyMetadataCascadePolicyRequestBody\" to be defined" });
    }
    const conflictResolution: ApplyMetadataCascadePolicyRequestBodyConflictResolutionField = deserializeApplyMetadataCascadePolicyRequestBodyConflictResolutionField(val.conflict_resolution);
    return { conflictResolution: conflictResolution } satisfies ApplyMetadataCascadePolicyRequestBody;
}
