...
export class GetFileCollaborationsOptionals {
    readonly queryParams: GetFileCollaborationsQueryParams = {} satisfies GetFileCollaborationsQueryParams;
    readonly headers: GetFileCollaborationsHeaders = new GetFileCollaborationsHeaders({});
...
export class GetFolderCollaborationsOptionals {
    readonly queryParams: GetFolderCollaborationsQueryParams = {} satisfies GetFolderCollaborationsQueryParams;
    readonly headers: GetFolderCollaborationsHeaders = new GetFolderCollaborationsHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetGroupCollaborationsOptionals {
    readonly queryParams: GetGroupCollaborationsQueryParams = {} satisfies GetGroupCollaborationsQueryParams;
    readonly headers: GetGroupCollaborationsHeaders = new GetGroupCollaborationsHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ListCollaborationsManager {
     ...
     */
    async getFileCollaborations(fileId: string, optionalsInput: GetFileCollaborationsOptionalsInput = {}): Promise<Collaborations> {
        const optionals: GetFileCollaborationsOptionals = new GetFileCollaborationsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["fields"]: queryParams.fields ? queryParams.fields.map(toString).join(",") : undefined, ["limit"]: toString(queryParams.limit) as string, ["marker"]: toString(queryParams.marker) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", toString(fileId) as string, "/collaborations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<Collaborations>}
     */
    async getFolderCollaborations(folderId: string, optionalsInput: GetFolderCollaborationsOptionalsInput = {}): Promise<Collaborations> {
        const optionals: GetFolderCollaborationsOptionals = new GetFolderCollaborationsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/collaborations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeCollaborations(response.data!),
            rawData: response.data!
        };
     ...
     */
    async getCollaborations(queryParams: GetCollaborationsQueryParams, optionalsInput: GetCollaborationsOptionalsInput = {}): Promise<CollaborationsOffsetPaginated> {
        const optionals: GetCollaborationsOptionals = new GetCollaborationsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["status"]: toString(queryParams.status) as string, ["fields"]: queryParams.fields ? queryParams.fields.map(toString).join(",") : undefined, ["offset"]: toString(queryParams.offset) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/collaborations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<CollaborationsOffsetPaginated>}
     */
    async getGroupCollaborations(groupId: string, optionalsInput: GetGroupCollaborationsOptionalsInput = {}): Promise<CollaborationsOffsetPaginated> {
        const optionals: GetGroupCollaborationsOptionals = new GetGroupCollaborationsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/groups/", toString(groupId) as string, "/collaborations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeCollaborationsOffsetPaginated(response.data!),
            rawData: response.data!
        };
...
export function serializeGetCollaborationsQueryParamsStatusField(val: GetCollaborationsQueryParamsStatusField): SerializedData {
    return val;
}
export function deserializeGetCollaborationsQueryParamsStatusField(val: SerializedData): GetCollaborationsQueryParamsStatusField {
    if (val == "pending") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize GetCollaborationsQueryParamsStatusField" });
}
