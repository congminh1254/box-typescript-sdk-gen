...
export class GetFileAppItemAssociationsOptionals {
    readonly queryParams: GetFileAppItemAssociationsQueryParams = {} satisfies GetFileAppItemAssociationsQueryParams;
    readonly headers: GetFileAppItemAssociationsHeaders = new GetFileAppItemAssociationsHeaders({});
...
export class GetFolderAppItemAssociationsOptionals {
    readonly queryParams: GetFolderAppItemAssociationsQueryParams = {} satisfies GetFolderAppItemAssociationsQueryParams;
    readonly headers: GetFolderAppItemAssociationsHeaders = new GetFolderAppItemAssociationsHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class AppItemAssociationsManager {
     ...
     */
    async getFileAppItemAssociations(fileId: string, optionalsInput: GetFileAppItemAssociationsOptionalsInput = {}): Promise<AppItemAssociations> {
        const optionals: GetFileAppItemAssociationsOptionals = new GetFileAppItemAssociationsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["limit"]: toString(queryParams.limit) as string, ["marker"]: toString(queryParams.marker) as string, ["application_type"]: toString(queryParams.applicationType) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", toString(fileId) as string, "/app_item_associations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<AppItemAssociations>}
     */
    async getFolderAppItemAssociations(folderId: string, optionalsInput: GetFolderAppItemAssociationsOptionalsInput = {}): Promise<AppItemAssociations> {
        const optionals: GetFolderAppItemAssociationsOptionals = new GetFolderAppItemAssociationsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/app_item_associations") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeAppItemAssociations(response.data!),
            rawData: response.data!
        };
