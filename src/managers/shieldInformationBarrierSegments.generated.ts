...
export class GetShieldInformationBarrierSegmentByIdOptionals {
    readonly headers: GetShieldInformationBarrierSegmentByIdHeaders = new GetShieldInformationBarrierSegmentByIdHeaders({});
...
export class DeleteShieldInformationBarrierSegmentByIdOptionals {
    readonly headers: DeleteShieldInformationBarrierSegmentByIdHeaders = new DeleteShieldInformationBarrierSegmentByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class UpdateShieldInformationBarrierSegmentByIdOptionals {
    readonly requestBody: UpdateShieldInformationBarrierSegmentByIdRequestBody = {} satisfies UpdateShieldInformationBarrierSegmentByIdRequestBody;
    readonly headers: UpdateShieldInformationBarrierSegmentByIdHeaders = new UpdateShieldInformationBarrierSegmentByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetShieldInformationBarrierSegmentsOptionals {
    readonly headers: GetShieldInformationBarrierSegmentsHeaders = new GetShieldInformationBarrierSegmentsHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateShieldInformationBarrierSegmentOptionals {
    readonly headers: CreateShieldInformationBarrierSegmentHeaders = new CreateShieldInformationBarrierSegmentHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ShieldInformationBarrierSegmentsManager {
     ...
     */
    async getShieldInformationBarrierSegmentById(shieldInformationBarrierSegmentId: string, optionalsInput: GetShieldInformationBarrierSegmentByIdOptionalsInput = {}): Promise<ShieldInformationBarrierSegment> {
        const optionals: GetShieldInformationBarrierSegmentByIdOptionals = new GetShieldInformationBarrierSegmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     */
    async deleteShieldInformationBarrierSegmentById(shieldInformationBarrierSegmentId: string, optionalsInput: DeleteShieldInformationBarrierSegmentByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteShieldInformationBarrierSegmentByIdOptionals = new DeleteShieldInformationBarrierSegmentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     * @returns {Promise<ShieldInformationBarrierSegment>}
     */
    async updateShieldInformationBarrierSegmentById(shieldInformationBarrierSegmentId: string, optionalsInput: UpdateShieldInformationBarrierSegmentByIdOptionalsInput = {}): Promise<ShieldInformationBarrierSegment> {
        const optionals: UpdateShieldInformationBarrierSegmentByIdOptionals = new UpdateShieldInformationBarrierSegmentByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     */
    async getShieldInformationBarrierSegments(queryParams: GetShieldInformationBarrierSegmentsQueryParams, optionalsInput: GetShieldInformationBarrierSegmentsOptionalsInput = {}): Promise<ShieldInformationBarrierSegments> {
        const optionals: GetShieldInformationBarrierSegmentsOptionals = new GetShieldInformationBarrierSegmentsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["shield_information_barrier_id"]: toString(queryParams.shieldInformationBarrierId) as string, ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barrier_segments") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<ShieldInformationBarrierSegment>}
     */
    async createShieldInformationBarrierSegment(requestBody: CreateShieldInformationBarrierSegmentRequestBody, optionalsInput: CreateShieldInformationBarrierSegmentOptionalsInput = {}): Promise<ShieldInformationBarrierSegment> {
        const optionals: CreateShieldInformationBarrierSegmentOptionals = new CreateShieldInformationBarrierSegmentOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
...
export function serializeUpdateShieldInformationBarrierSegmentByIdRequestBody(val: UpdateShieldInformationBarrierSegmentByIdRequestBody): SerializedData {
    return { ["name"]: val.name, ["description"]: val.description };
}
export function deserializeUpdateShieldInformationBarrierSegmentByIdRequestBody(val: SerializedData): UpdateShieldInformationBarrierSegmentByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateShieldInformationBarrierSegmentByIdRequestBody\"" });
    }
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"UpdateShieldInformationBarrierSegmentByIdRequestBody\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateShieldInformationBarrierSegmentByIdRequestBody\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    return { name: name, description: description } satisfies UpdateShieldInformationBarrierSegmentByIdRequestBody;
}
export function serializeCreateShieldInformationBarrierSegmentRequestBody(val: CreateShieldInformationBarrierSegmentRequestBody): SerializedData {
...
export function deserializeCreateShieldInformationBarrierSegmentRequestBody(val: SerializedData): CreateShieldInformationBarrierSegmentRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateShieldInformationBarrierSegmentRequestBody\"" });
    }
    if (val.shield_information_barrier == void 0) {
        throw new BoxSdkError({ message: "Expecting \"shield_information_barrier\" of type \"CreateShieldInformationBarrierSegmentRequestBody\" to be defined" });
    }
    ...
    if (val.name == void 0) {
        throw new BoxSdkError({ message: "Expecting \"name\" of type \"CreateShieldInformationBarrierSegmentRequestBody\" to be defined" });
    }
    if (!sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"CreateShieldInformationBarrierSegmentRequestBody\"" });
    }
    const name: string = val.name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateShieldInformationBarrierSegmentRequestBody\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    return { shieldInformationBarrier: shieldInformationBarrier, name: name, description: description } satisfies CreateShieldInformationBarrierSegmentRequestBody;
}
