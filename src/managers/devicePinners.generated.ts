...
export class DeleteDevicePinnerByIdOptionals {
    readonly headers: DeleteDevicePinnerByIdHeaders = new DeleteDevicePinnerByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetEnterpriseDevicePinnersOptionals {
    readonly queryParams: GetEnterpriseDevicePinnersQueryParams = {} satisfies GetEnterpriseDevicePinnersQueryParams;
    readonly headers: GetEnterpriseDevicePinnersHeaders = new GetEnterpriseDevicePinnersHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DevicePinnersManager {
     ...
     */
    async getDevicePinnerById(devicePinnerId: string, optionalsInput: GetDevicePinnerByIdOptionalsInput = {}): Promise<DevicePinner> {
        const optionals: GetDevicePinnerByIdOptionals = new GetDevicePinnerByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/device_pinners/", toString(devicePinnerId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async deleteDevicePinnerById(devicePinnerId: string, optionalsInput: DeleteDevicePinnerByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteDevicePinnerByIdOptionals = new DeleteDevicePinnerByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/device_pinners/", toString(devicePinnerId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     */
    async getEnterpriseDevicePinners(enterpriseId: string, optionalsInput: GetEnterpriseDevicePinnersOptionalsInput = {}): Promise<DevicePinners> {
        const optionals: GetEnterpriseDevicePinnersOptionals = new GetEnterpriseDevicePinnersOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string, ["direction"]: toString(queryParams.direction) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/enterprises/", toString(enterpriseId) as string, "/device_pinners") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
...
export function serializeGetEnterpriseDevicePinnersQueryParamsDirectionField(val: GetEnterpriseDevicePinnersQueryParamsDirectionField): SerializedData {
    return val;
}
export function deserializeGetEnterpriseDevicePinnersQueryParamsDirectionField(val: SerializedData): GetEnterpriseDevicePinnersQueryParamsDirectionField {
    if (val == "ASC") {
        return val;
    }
    if (val == "DESC") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetEnterpriseDevicePinnersQueryParamsDirectionField" });
}
