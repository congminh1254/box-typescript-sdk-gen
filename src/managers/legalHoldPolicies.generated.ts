...
export class CreateLegalHoldPolicyOptionals {
    readonly headers: CreateLegalHoldPolicyHeaders = new CreateLegalHoldPolicyHeaders({});
...
export class GetLegalHoldPolicyByIdOptionals {
    readonly headers: GetLegalHoldPolicyByIdHeaders = new GetLegalHoldPolicyByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class UpdateLegalHoldPolicyByIdOptionals {
    readonly requestBody: UpdateLegalHoldPolicyByIdRequestBody = {} satisfies UpdateLegalHoldPolicyByIdRequestBody;
    readonly headers: UpdateLegalHoldPolicyByIdHeaders = new UpdateLegalHoldPolicyByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteLegalHoldPolicyByIdOptionals {
    readonly headers: DeleteLegalHoldPolicyByIdHeaders = new DeleteLegalHoldPolicyByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class LegalHoldPoliciesManager {
     ...
     */
    async getLegalHoldPolicies(queryParams: GetLegalHoldPoliciesQueryParams = {} satisfies GetLegalHoldPoliciesQueryParams, headersInput: GetLegalHoldPoliciesHeadersInput = new GetLegalHoldPoliciesHeaders({}), cancellationToken?: CancellationToken): Promise<LegalHoldPolicies> {
        const headers: GetLegalHoldPoliciesHeaders = new GetLegalHoldPoliciesHeaders({ extraHeaders: headersInput.extraHeaders });
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["policy_name"]: toString(queryParams.policyName) as string, ["fields"]: queryParams.fields ? queryParams.fields.map(toString).join(",") : undefined, ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createLegalHoldPolicy(requestBody: CreateLegalHoldPolicyRequestBody, optionalsInput: CreateLegalHoldPolicyOptionalsInput = {}): Promise<LegalHoldPolicy> {
        const optionals: CreateLegalHoldPolicyOptionals = new CreateLegalHoldPolicyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies") as string, method: "POST", headers: headersMap, data: serializeCreateLegalHoldPolicyRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<LegalHoldPolicy>}
     */
    async getLegalHoldPolicyById(legalHoldPolicyId: string, optionalsInput: GetLegalHoldPolicyByIdOptionalsInput = {}): Promise<LegalHoldPolicy> {
        const optionals: GetLegalHoldPolicyByIdOptionals = new GetLegalHoldPolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", toString(legalHoldPolicyId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeLegalHoldPolicy(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<LegalHoldPolicy>}
     */
    async updateLegalHoldPolicyById(legalHoldPolicyId: string, optionalsInput: UpdateLegalHoldPolicyByIdOptionalsInput = {}): Promise<LegalHoldPolicy> {
        const optionals: UpdateLegalHoldPolicyByIdOptionals = new UpdateLegalHoldPolicyByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", toString(legalHoldPolicyId) as string) as string, method: "PUT", headers: headersMap, data: serializeUpdateLegalHoldPolicyByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeLegalHoldPolicy(response.data!),
            rawData: response.data!
        };
     ...
     */
    async deleteLegalHoldPolicyById(legalHoldPolicyId: string, optionalsInput: DeleteLegalHoldPolicyByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteLegalHoldPolicyByIdOptionals = new DeleteLegalHoldPolicyByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/legal_hold_policies/", toString(legalHoldPolicyId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeCreateLegalHoldPolicyRequestBody(val: CreateLegalHoldPolicyRequestBody): SerializedData {
    return { ["policy_name"]: val.policyName, ["description"]: val.description, ["filter_started_at"]: val.filterStartedAt == void 0 ? val.filterStartedAt : serializeDateTime(val.filterStartedAt), ["filter_ended_at"]: val.filterEndedAt == void 0 ? val.filterEndedAt : serializeDateTime(val.filterEndedAt), ["is_ongoing"]: val.isOngoing };
}
export function deserializeCreateLegalHoldPolicyRequestBody(val: SerializedData): CreateLegalHoldPolicyRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateLegalHoldPolicyRequestBody\"" });
    }
    if (val.policy_name == void 0) {
        throw new BoxSdkError({ message: "Expecting \"policy_name\" of type \"CreateLegalHoldPolicyRequestBody\" to be defined" });
    }
    if (!sdIsString(val.policy_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const policyName: string = val.policy_name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    if (!(val.filter_started_at == void 0) && !sdIsString(val.filter_started_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"filter_started_at\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const filterStartedAt: undefined | DateTime = val.filter_started_at == void 0 ? void 0 : deserializeDateTime(val.filter_started_at);
    if (!(val.filter_ended_at == void 0) && !sdIsString(val.filter_ended_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"filter_ended_at\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const filterEndedAt: undefined | DateTime = val.filter_ended_at == void 0 ? void 0 : deserializeDateTime(val.filter_ended_at);
    if (!(val.is_ongoing == void 0) && !sdIsBoolean(val.is_ongoing)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_ongoing\" of type \"CreateLegalHoldPolicyRequestBody\"" });
    }
    const isOngoing: undefined | boolean = val.is_ongoing == void 0 ? void 0 : val.is_ongoing;
    return { policyName: policyName, description: description, filterStartedAt: filterStartedAt, filterEndedAt: filterEndedAt, isOngoing: isOngoing } satisfies CreateLegalHoldPolicyRequestBody;
}
export function serializeUpdateLegalHoldPolicyByIdRequestBody(val: UpdateLegalHoldPolicyByIdRequestBody): SerializedData {
    return { ["policy_name"]: val.policyName, ["description"]: val.description, ["release_notes"]: val.releaseNotes };
}
export function deserializeUpdateLegalHoldPolicyByIdRequestBody(val: SerializedData): UpdateLegalHoldPolicyByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    if (!(val.policy_name == void 0) && !sdIsString(val.policy_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    const policyName: undefined | string = val.policy_name == void 0 ? void 0 : val.policy_name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    if (!(val.release_notes == void 0) && !sdIsString(val.release_notes)) {
        throw new BoxSdkError({ message: "Expecting string for \"release_notes\" of type \"UpdateLegalHoldPolicyByIdRequestBody\"" });
    }
    const releaseNotes: undefined | string = val.release_notes == void 0 ? void 0 : val.release_notes;
    return { policyName: policyName, description: description, releaseNotes: releaseNotes } satisfies UpdateLegalHoldPolicyByIdRequestBody;
}
