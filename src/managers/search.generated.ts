...
export class SearchByMetadataQueryOptionals {
    readonly headers: SearchByMetadataQueryHeaders = new SearchByMetadataQueryHeaders({});
...
export class SearchManager {
     ...
     */
    async searchByMetadataQuery(requestBody: MetadataQuery, optionalsInput: SearchByMetadataQueryOptionalsInput = {}): Promise<MetadataQueryResults> {
        const optionals: SearchByMetadataQueryOptionals = new SearchByMetadataQueryOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/metadata_queries/execute_read") as string, method: "POST", headers: headersMap, data: serializeMetadataQuery(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async searchForContent(queryParams: SearchForContentQueryParams = {} satisfies SearchForContentQueryParams, headersInput: SearchForContentHeadersInput = new SearchForContentHeaders({}), cancellationToken?: CancellationToken): Promise<SearchResultsOrSearchResultsWithSharedLinks> {
        const headers: SearchForContentHeaders = new SearchForContentHeaders({ extraHeaders: headersInput.extraHeaders });
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["query"]: toString(queryParams.query) as string, ["scope"]: toString(queryParams.scope) as string, ["file_extensions"]: queryParams.fileExtensions ? queryParams.fileExtensions.map(toString).join(",") : undefined, ["created_at_range"]: queryParams.createdAtRange ? queryParams.createdAtRange.map(toString).join(",") : undefined, ["updated_at_range"]: queryParams.updatedAtRange ? queryParams.updatedAtRange.map(toString).join(",") : undefined, ["size_range"]: queryParams.sizeRange ? queryParams.sizeRange.map(toString).join(",") : undefined, ["owner_user_ids"]: queryParams.ownerUserIds ? queryParams.ownerUserIds.map(toString).join(",") : undefined, ["recent_updater_user_ids"]: queryParams.recentUpdaterUserIds ? queryParams.recentUpdaterUserIds.map(toString).join(",") : undefined, ["ancestor_folder_ids"]: queryParams.ancestorFolderIds ? queryParams.ancestorFolderIds.map(toString).join(",") : undefined, ["content_types"]: queryParams.contentTypes ? queryParams.contentTypes.map(toString).join(",") : undefined, ["type"]: toString(queryParams.type) as string, ["trash_content"]: toString(queryParams.trashContent) as string, ["mdfilters"]: queryParams.mdfilters ? sdToJson(queryParams.mdfilters.map(serializeMetadataFilter)) : undefined, ["sort"]: toString(queryParams.sort) as string, ["direction"]: toString(queryParams.direction) as string, ["limit"]: toString(queryParams.limit) as string, ["include_recent_shared_links"]: toString(queryParams.includeRecentSharedLinks) as string, ["fields"]: queryParams.fields ? queryParams.fields.map(toString).join(",") : undefined, ["offset"]: toString(queryParams.offset) as string, ["deleted_user_ids"]: queryParams.deletedUserIds ? queryParams.deletedUserIds.map(toString).join(",") : undefined, ["deleted_at_range"]: queryParams.deletedAtRange ? queryParams.deletedAtRange.map(toString).join(",") : undefined });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/search") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
...
export function serializeSearchForContentQueryParamsScopeField(val: SearchForContentQueryParamsScopeField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsScopeField(val: SerializedData): SearchForContentQueryParamsScopeField {
    if (val == "user_content") {
        return val;
    }
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsScopeField" });
}
export function serializeSearchForContentQueryParamsContentTypesField(val: SearchForContentQueryParamsContentTypesField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsContentTypesField(val: SerializedData): SearchForContentQueryParamsContentTypesField {
    if (val == "name") {
        return val;
    }
    if (val == "description") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsContentTypesField" });
}
export function serializeSearchForContentQueryParamsTypeField(val: SearchForContentQueryParamsTypeField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsTypeField(val: SerializedData): SearchForContentQueryParamsTypeField {
    if (val == "file") {
        return val;
    }
    if (val == "folder") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsTypeField" });
}
export function serializeSearchForContentQueryParamsTrashContentField(val: SearchForContentQueryParamsTrashContentField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsTrashContentField(val: SerializedData): SearchForContentQueryParamsTrashContentField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsTrashContentField" });
}
export function serializeSearchForContentQueryParamsSortField(val: SearchForContentQueryParamsSortField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsSortField(val: SerializedData): SearchForContentQueryParamsSortField {
    if (val == "modified_at") {
        return val;
    }
    if (val == "relevance") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsSortField" });
}
export function serializeSearchForContentQueryParamsDirectionField(val: SearchForContentQueryParamsDirectionField): SerializedData {
    return val;
}
export function deserializeSearchForContentQueryParamsDirectionField(val: SerializedData): SearchForContentQueryParamsDirectionField {
    if (val == "DESC") {
        return val;
    }
    if (val == "ASC") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchForContentQueryParamsDirectionField" });
}
