...
export class CreateUserEmailAliasOptionals {
    readonly headers: CreateUserEmailAliasHeaders = new CreateUserEmailAliasHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteUserEmailAliasByIdOptionals {
    readonly headers: DeleteUserEmailAliasByIdHeaders = new DeleteUserEmailAliasByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class EmailAliasesManager {
     ...
     */
    async getUserEmailAliases(userId: string, optionalsInput: GetUserEmailAliasesOptionalsInput = {}): Promise<EmailAliases> {
        const optionals: GetUserEmailAliasesOptionals = new GetUserEmailAliasesOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/users/", toString(userId) as string, "/email_aliases") as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createUserEmailAlias(userId: string, requestBody: CreateUserEmailAliasRequestBody, optionalsInput: CreateUserEmailAliasOptionalsInput = {}): Promise<EmailAlias> {
        const optionals: CreateUserEmailAliasOptionals = new CreateUserEmailAliasOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/users/", toString(userId) as string, "/email_aliases") as string, method: "POST", headers: headersMap, data: serializeCreateUserEmailAliasRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async deleteUserEmailAliasById(userId: string, emailAliasId: string, optionalsInput: DeleteUserEmailAliasByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteUserEmailAliasByIdOptionals = new DeleteUserEmailAliasByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/users/", toString(userId) as string, "/email_aliases/", toString(emailAliasId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeCreateUserEmailAliasRequestBody(val: CreateUserEmailAliasRequestBody): SerializedData {
    return { ["email"]: val.email };
}
export function deserializeCreateUserEmailAliasRequestBody(val: SerializedData): CreateUserEmailAliasRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CreateUserEmailAliasRequestBody\"" });
    }
    if (val.email == void 0) {
        throw new BoxSdkError({ message: "Expecting \"email\" of type \"CreateUserEmailAliasRequestBody\" to be defined" });
    }
    if (!sdIsString(val.email)) {
        throw new BoxSdkError({ message: "Expecting string for \"email\" of type \"CreateUserEmailAliasRequestBody\"" });
    }
