...
export class GetShieldInformationBarrierReportsOptionals {
    readonly headers: GetShieldInformationBarrierReportsHeaders = new GetShieldInformationBarrierReportsHeaders({});
...
export class CreateShieldInformationBarrierReportOptionals {
    readonly headers: CreateShieldInformationBarrierReportHeaders = new CreateShieldInformationBarrierReportHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetShieldInformationBarrierReportByIdOptionals {
    readonly headers: GetShieldInformationBarrierReportByIdHeaders = new GetShieldInformationBarrierReportByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class ShieldInformationBarrierReportsManager {
     ...
     */
    async getShieldInformationBarrierReports(queryParams: GetShieldInformationBarrierReportsQueryParams, optionalsInput: GetShieldInformationBarrierReportsOptionalsInput = {}): Promise<ShieldInformationBarrierReports> {
        const optionals: GetShieldInformationBarrierReportsOptionals = new GetShieldInformationBarrierReportsOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barrier_reports") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createShieldInformationBarrierReport(requestBody: ShieldInformationBarrierReference, optionalsInput: CreateShieldInformationBarrierReportOptionalsInput = {}): Promise<ShieldInformationBarrierReport> {
        const optionals: CreateShieldInformationBarrierReportOptionals = new CreateShieldInformationBarrierReportOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barrier_reports") as string, method: "POST", headers: headersMap, data: serializeShieldInformationBarrierReference(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<ShieldInformationBarrierReport>}
     */
    async getShieldInformationBarrierReportById(shieldInformationBarrierReportId: string, optionalsInput: GetShieldInformationBarrierReportByIdOptionalsInput = {}): Promise<ShieldInformationBarrierReport> {
        const optionals: GetShieldInformationBarrierReportByIdOptionals = new GetShieldInformationBarrierReportByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/shield_information_barrier_reports/", toString(shieldInformationBarrierReportId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeShieldInformationBarrierReport(response.data!),
            rawData: response.data!
        };
