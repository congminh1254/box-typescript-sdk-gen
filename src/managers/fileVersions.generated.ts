...
export class GetFileVersionsOptionals {
    readonly queryParams: GetFileVersionsQueryParams = {} satisfies GetFileVersionsQueryParams;
...
export class GetFileVersionByIdOptionals {
    readonly queryParams: GetFileVersionByIdQueryParams = {} satisfies GetFileVersionByIdQueryParams;
...
export class DeleteFileVersionByIdOptionals {
    readonly headers: DeleteFileVersionByIdHeaders = new DeleteFileVersionByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class UpdateFileVersionByIdOptionals {
    readonly requestBody: UpdateFileVersionByIdRequestBody = {} satisfies UpdateFileVersionByIdRequestBody;
    readonly headers: UpdateFileVersionByIdHeaders = new UpdateFileVersionByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class PromoteFileVersionOptionals {
    readonly requestBody: PromoteFileVersionRequestBody = {} satisfies PromoteFileVersionRequestBody;
    readonly queryParams: PromoteFileVersionQueryParams = {} satisfies PromoteFileVersionQueryParams;
...
export class FileVersionsManager {
     ...
     */
    async getFileVersions(fileId: string, optionalsInput: GetFileVersionsOptionalsInput = {}): Promise<FileVersions> {
        const optionals: GetFileVersionsOptionals = new GetFileVersionsOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", toString(fileId) as string, "/versions") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getFileVersionById(fileId: string, fileVersionId: string, optionalsInput: GetFileVersionByIdOptionalsInput = {}): Promise<FileVersionFull> {
        const optionals: GetFileVersionByIdOptionals = new GetFileVersionByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
     ...
     */
    async deleteFileVersionById(fileId: string, fileVersionId: string, optionalsInput: DeleteFileVersionByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteFileVersionByIdOptionals = new DeleteFileVersionByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     * @returns {Promise<FileVersionFull>}
     */
    async updateFileVersionById(fileId: string, fileVersionId: string, optionalsInput: UpdateFileVersionByIdOptionalsInput = {}): Promise<FileVersionFull> {
        const optionals: UpdateFileVersionByIdOptionals = new UpdateFileVersionByIdOptionals({ requestBody: optionalsInput.requestBody, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", toString(fileId) as string, "/versions/", toString(fileVersionId) as string) as string, method: "PUT", headers: headersMap, data: serializeUpdateFileVersionByIdRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeFileVersionFull(response.data!),
            rawData: response.data!
        };
     ...
     * @returns {Promise<FileVersionFull>}
     */
    async promoteFileVersion(fileId: string, optionalsInput: PromoteFileVersionOptionalsInput = {}): Promise<FileVersionFull> {
        const optionals: PromoteFileVersionOptionals = new PromoteFileVersionOptionals({ requestBody: optionalsInput.requestBody, queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const requestBody: any = optionals.requestBody;
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/files/", toString(fileId) as string, "/versions/current") as string, method: "POST", params: queryParamsMap, headers: headersMap, data: serializePromoteFileVersionRequestBody(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeFileVersionFull(response.data!),
            rawData: response.data!
        };
...
export function serializeUpdateFileVersionByIdRequestBody(val: UpdateFileVersionByIdRequestBody): SerializedData {
    return { ["trashed_at"]: val.trashedAt };
}
export function deserializeUpdateFileVersionByIdRequestBody(val: SerializedData): UpdateFileVersionByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateFileVersionByIdRequestBody\"" });
    }
    if (!(val.trashed_at == void 0) && !sdIsString(val.trashed_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"UpdateFileVersionByIdRequestBody\"" });
    }
...
export function serializePromoteFileVersionRequestBodyTypeField(val: PromoteFileVersionRequestBodyTypeField): SerializedData {
    return val;
}
export function deserializePromoteFileVersionRequestBodyTypeField(val: SerializedData): PromoteFileVersionRequestBodyTypeField {
    if (val == "file_version") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize PromoteFileVersionRequestBodyTypeField" });
}
export function serializePromoteFileVersionRequestBody(val: PromoteFileVersionRequestBody): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializePromoteFileVersionRequestBodyTypeField(val.type) };
}
export function deserializePromoteFileVersionRequestBody(val: SerializedData): PromoteFileVersionRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"PromoteFileVersionRequestBody\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"PromoteFileVersionRequestBody\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | PromoteFileVersionRequestBodyTypeField = val.type == void 0 ? void 0 : deserializePromoteFileVersionRequestBodyTypeField(val.type);
