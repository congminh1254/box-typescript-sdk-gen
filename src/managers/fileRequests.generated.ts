...
export class UpdateFileRequestByIdOptionals {
    readonly headers: UpdateFileRequestByIdHeaders = new UpdateFileRequestByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteFileRequestByIdOptionals {
    readonly headers: DeleteFileRequestByIdHeaders = new DeleteFileRequestByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateFileRequestCopyOptionals {
    readonly headers: CreateFileRequestCopyHeaders = new CreateFileRequestCopyHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class FileRequestsManager {
     ...
     */
    async getFileRequestById(fileRequestId: string, optionalsInput: GetFileRequestByIdOptionalsInput = {}): Promise<FileRequest> {
        const optionals: GetFileRequestByIdOptionals = new GetFileRequestByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/file_requests/", toString(fileRequestId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<FileRequest>}
     */
    async updateFileRequestById(fileRequestId: string, requestBody: FileRequestUpdateRequest, optionalsInput: UpdateFileRequestByIdOptionalsInput = {}): Promise<FileRequest> {
        const optionals: UpdateFileRequestByIdOptionals = new UpdateFileRequestByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     */
    async deleteFileRequestById(fileRequestId: string, optionalsInput: DeleteFileRequestByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteFileRequestByIdOptionals = new DeleteFileRequestByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/file_requests/", toString(fileRequestId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     * @returns {Promise<FileRequest>}
     */
    async createFileRequestCopy(fileRequestId: string, requestBody: FileRequestCopyRequest, optionalsInput: CreateFileRequestCopyOptionalsInput = {}): Promise<FileRequest> {
        const optionals: CreateFileRequestCopyOptionals = new CreateFileRequestCopyOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
