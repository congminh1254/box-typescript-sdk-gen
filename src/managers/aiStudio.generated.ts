...
export class GetAiAgentByIdOptionals {
    readonly queryParams: GetAiAgentByIdQueryParams = {} satisfies GetAiAgentByIdQueryParams;
...
export class AiStudioManager {
     ...
     */
    async getAiAgents(queryParams: GetAiAgentsQueryParams = {} satisfies GetAiAgentsQueryParams, headersInput: GetAiAgentsHeadersInput = new GetAiAgentsHeaders({}), cancellationToken?: CancellationToken): Promise<AiMultipleAgentResponse> {
        const headers: GetAiAgentsHeaders = new GetAiAgentsHeaders({ extraHeaders: headersInput.extraHeaders });
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["mode"]: queryParams.mode ? queryParams.mode.map(toString).join(",") : undefined, ["fields"]: queryParams.fields ? queryParams.fields.map(toString).join(",") : undefined, ["agent_state"]: queryParams.agentState ? queryParams.agentState.map(toString).join(",") : undefined, ["include_box_default"]: toString(queryParams.includeBoxDefault) as string, ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/ai_agents") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async createAiAgent(requestBodyInput: CreateAiAgentInput, optionalsInput: CreateAiAgentOptionalsInput = {}): Promise<AiSingleAgentResponseFull> {
        const requestBody: CreateAiAgent = new CreateAiAgent({ type: requestBodyInput.type, name: requestBodyInput.name, accessState: requestBodyInput.accessState, iconReference: requestBodyInput.iconReference, allowedEntities: requestBodyInput.allowedEntities, ask: requestBodyInput.ask, textGen: requestBodyInput.textGen, extract: requestBodyInput.extract });
        const optionals: CreateAiAgentOptionals = new CreateAiAgentOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
     ...
     * @returns {Promise<AiSingleAgentResponseFull>}
     */
    async updateAiAgentById(agentId: string, requestBodyInput: CreateAiAgentInput, optionalsInput: UpdateAiAgentByIdOptionalsInput = {}): Promise<AiSingleAgentResponseFull> {
        const requestBody: CreateAiAgent = new CreateAiAgent({ type: requestBodyInput.type, name: requestBodyInput.name, accessState: requestBodyInput.accessState, iconReference: requestBodyInput.iconReference, allowedEntities: requestBodyInput.allowedEntities, ask: requestBodyInput.ask, textGen: requestBodyInput.textGen, extract: requestBodyInput.extract });
        const optionals: UpdateAiAgentByIdOptionals = new UpdateAiAgentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     * @returns {Promise<AiSingleAgentResponseFull>}
     */
    async getAiAgentById(agentId: string, optionalsInput: GetAiAgentByIdOptionalsInput = {}): Promise<AiSingleAgentResponseFull> {
        const optionals: GetAiAgentByIdOptionals = new GetAiAgentByIdOptionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/ai_agents/", toString(agentId) as string) as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeAiSingleAgentResponseFull(response.data!),
            rawData: response.data!
        };
     ...
     */
    async deleteAiAgentById(agentId: string, optionalsInput: DeleteAiAgentByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteAiAgentByIdOptionals = new DeleteAiAgentByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/ai_agents/", toString(agentId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
