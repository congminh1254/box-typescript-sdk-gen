...
export class GetFolderMetadataByIdOptionals {
    readonly headers: GetFolderMetadataByIdHeaders = new GetFolderMetadataByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateFolderMetadataByIdOptionals {
    readonly headers: CreateFolderMetadataByIdHeaders = new CreateFolderMetadataByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class UpdateFolderMetadataByIdOptionals {
    readonly headers: UpdateFolderMetadataByIdHeaders = new UpdateFolderMetadataByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class DeleteFolderMetadataByIdOptionals {
    readonly headers: DeleteFolderMetadataByIdHeaders = new DeleteFolderMetadataByIdHeaders({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class FolderMetadataManager {
     ...
     */
    async getFolderMetadata(folderId: string, optionalsInput: GetFolderMetadataOptionalsInput = {}): Promise<Metadatas> {
        const optionals: GetFolderMetadataOptionals = new GetFolderMetadataOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/metadata") as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getFolderMetadataById(folderId: string, scope: GetFolderMetadataByIdScope, templateKey: string, optionalsInput: GetFolderMetadataByIdOptionalsInput = {}): Promise<MetadataFull> {
        const optionals: GetFolderMetadataByIdOptionals = new GetFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/metadata/", toString(scope) as string, "/", toString(templateKey) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     * @returns {Promise<MetadataFull>}
     */
    async createFolderMetadataById(folderId: string, scope: CreateFolderMetadataByIdScope, templateKey: string, requestBody: CreateFolderMetadataByIdRequestBody, optionalsInput: CreateFolderMetadataByIdOptionalsInput = {}): Promise<MetadataFull> {
        const optionals: CreateFolderMetadataByIdOptionals = new CreateFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
     ...
     * @returns {Promise<MetadataFull>}
     */
    async updateFolderMetadataById(folderId: string, scope: UpdateFolderMetadataByIdScope, templateKey: string, requestBody: readonly UpdateFolderMetadataByIdRequestBody[], optionalsInput: UpdateFolderMetadataByIdOptionalsInput = {}): Promise<MetadataFull> {
        const optionals: UpdateFolderMetadataByIdOptionals = new UpdateFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/metadata/", toString(scope) as string, "/", toString(templateKey) as string) as string, method: "PUT", headers: headersMap, data: requestBody.map(serializeUpdateFolderMetadataByIdRequestBody) as readonly any[], contentType: "application/json-patch+json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
            ...deserializeMetadataFull(response.data!),
            rawData: response.data!
        };
     ...
     */
    async deleteFolderMetadataById(folderId: string, scope: DeleteFolderMetadataByIdScope, templateKey: string, optionalsInput: DeleteFolderMetadataByIdOptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteFolderMetadataByIdOptionals = new DeleteFolderMetadataByIdOptionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{}, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/folders/", toString(folderId) as string, "/metadata/", toString(scope) as string, "/", toString(templateKey) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
}
...
export function serializeGetFolderMetadataByIdScope(val: GetFolderMetadataByIdScope): SerializedData {
    return val;
}
export function deserializeGetFolderMetadataByIdScope(val: SerializedData): GetFolderMetadataByIdScope {
    if (val == "global") {
        return val;
    }
    if (val == "enterprise") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GetFolderMetadataByIdScope" });
}
export function serializeCreateFolderMetadataByIdScope(val: CreateFolderMetadataByIdScope): SerializedData {
    return val;
}
export function deserializeCreateFolderMetadataByIdScope(val: SerializedData): CreateFolderMetadataByIdScope {
    if (val == "global") {
        return val;
    }
    if (val == "enterprise") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize CreateFolderMetadataByIdScope" });
}
export function serializeCreateFolderMetadataByIdRequestBody(val: CreateFolderMetadataByIdRequestBody): SerializedData {
...
export function deserializeCreateFolderMetadataByIdRequestBody(val: SerializedData): CreateFolderMetadataByIdRequestBody {
...
export function serializeUpdateFolderMetadataByIdScope(val: UpdateFolderMetadataByIdScope): SerializedData {
    return val;
}
export function deserializeUpdateFolderMetadataByIdScope(val: SerializedData): UpdateFolderMetadataByIdScope {
    if (val == "global") {
        return val;
    }
    if (val == "enterprise") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize UpdateFolderMetadataByIdScope" });
}
export function serializeUpdateFolderMetadataByIdRequestBodyOpField(val: UpdateFolderMetadataByIdRequestBodyOpField): SerializedData {
    return val;
}
export function deserializeUpdateFolderMetadataByIdRequestBodyOpField(val: SerializedData): UpdateFolderMetadataByIdRequestBodyOpField {
    if (val == "add") {
        return val;
    }
    if (val == "replace") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize UpdateFolderMetadataByIdRequestBodyOpField" });
}
export function serializeUpdateFolderMetadataByIdRequestBody(val: UpdateFolderMetadataByIdRequestBody): SerializedData {
    return { ["op"]: val.op == void 0 ? val.op : serializeUpdateFolderMetadataByIdRequestBodyOpField(val.op), ["path"]: val.path, ["value"]: val.value, ["from"]: val.from };
}
export function deserializeUpdateFolderMetadataByIdRequestBody(val: SerializedData): UpdateFolderMetadataByIdRequestBody {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const op: undefined | UpdateFolderMetadataByIdRequestBodyOpField = val.op == void 0 ? void 0 : deserializeUpdateFolderMetadataByIdRequestBodyOpField(val.op);
    if (!(val.path == void 0) && !sdIsString(val.path)) {
        throw new BoxSdkError({ message: "Expecting string for \"path\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const path: undefined | string = val.path == void 0 ? void 0 : val.path;
    if (!(val.value == void 0) && !sdIsString(val.value)) {
        throw new BoxSdkError({ message: "Expecting string for \"value\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const value: undefined | string = val.value == void 0 ? void 0 : val.value;
    if (!(val.from == void 0) && !sdIsString(val.from)) {
        throw new BoxSdkError({ message: "Expecting string for \"from\" of type \"UpdateFolderMetadataByIdRequestBody\"" });
    }
    const from: undefined | string = val.from == void 0 ? void 0 : val.from;
    return { op: op, path: path, value: value, from: from } satisfies UpdateFolderMetadataByIdRequestBody;
}
export function serializeDeleteFolderMetadataByIdScope(val: DeleteFolderMetadataByIdScope): SerializedData {
    return val;
}
export function deserializeDeleteFolderMetadataByIdScope(val: SerializedData): DeleteFolderMetadataByIdScope {
    if (val == "global") {
        return val;
    }
    if (val == "enterprise") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize DeleteFolderMetadataByIdScope" });
}
