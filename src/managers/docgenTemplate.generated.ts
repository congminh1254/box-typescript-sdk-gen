...
export class CreateDocgenTemplateV2025R0Optionals {
    readonly headers: CreateDocgenTemplateV2025R0Headers = new CreateDocgenTemplateV2025R0Headers({});
...
export class DeleteDocgenTemplateByIdV2025R0Optionals {
    readonly headers: DeleteDocgenTemplateByIdV2025R0Headers = new DeleteDocgenTemplateByIdV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetDocgenTemplateByIdV2025R0Optionals {
    readonly headers: GetDocgenTemplateByIdV2025R0Headers = new GetDocgenTemplateByIdV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetDocgenTemplateTagsV2025R0Optionals {
    readonly queryParams: GetDocgenTemplateTagsV2025R0QueryParams = {} satisfies GetDocgenTemplateTagsV2025R0QueryParams;
    readonly headers: GetDocgenTemplateTagsV2025R0Headers = new GetDocgenTemplateTagsV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class GetDocgenTemplateJobByIdV2025R0Optionals {
    readonly queryParams: GetDocgenTemplateJobByIdV2025R0QueryParams = {} satisfies GetDocgenTemplateJobByIdV2025R0QueryParams;
    readonly headers: GetDocgenTemplateJobByIdV2025R0Headers = new GetDocgenTemplateJobByIdV2025R0Headers({});
    readonly cancellationToken?: CancellationToken = void 0;
...
export class CreateDocgenTemplateV2025R0Headers {
    /**
     * Version header */
    readonly boxVersion: BoxVersionHeaderV2025R0 = "2025.0" as BoxVersionHeaderV2025R0;
    /**
...
export class DocgenTemplateManager {
     ...
     */
    async createDocgenTemplateV2025R0(requestBody: DocGenTemplateCreateRequestV2025R0, optionalsInput: CreateDocgenTemplateV2025R0OptionalsInput = {}): Promise<DocGenTemplateBaseV2025R0> {
        const optionals: CreateDocgenTemplateV2025R0Optionals = new CreateDocgenTemplateV2025R0Optionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_templates") as string, method: "POST", headers: headersMap, data: serializeDocGenTemplateCreateRequestV2025R0(requestBody), contentType: "application/json", responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getDocgenTemplatesV2025R0(queryParams: GetDocgenTemplatesV2025R0QueryParams = {} satisfies GetDocgenTemplatesV2025R0QueryParams, headersInput: GetDocgenTemplatesV2025R0HeadersInput = new GetDocgenTemplatesV2025R0Headers({}), cancellationToken?: CancellationToken): Promise<DocGenTemplatesV2025R0> {
        const headers: GetDocgenTemplatesV2025R0Headers = new GetDocgenTemplatesV2025R0Headers({ boxVersion: headersInput.boxVersion, extraHeaders: headersInput.extraHeaders });
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_templates") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async deleteDocgenTemplateByIdV2025R0(templateId: string, optionalsInput: DeleteDocgenTemplateByIdV2025R0OptionalsInput = {}): Promise<undefined> {
        const optionals: DeleteDocgenTemplateByIdV2025R0Optionals = new DeleteDocgenTemplateByIdV2025R0Optionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_templates/", toString(templateId) as string) as string, method: "DELETE", headers: headersMap, responseFormat: "no_content" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return void 0;
    }
    /**
     ...
     */
    async getDocgenTemplateByIdV2025R0(templateId: string, optionalsInput: GetDocgenTemplateByIdV2025R0OptionalsInput = {}): Promise<DocGenTemplateV2025R0> {
        const optionals: GetDocgenTemplateByIdV2025R0Optionals = new GetDocgenTemplateByIdV2025R0Optionals({ headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_templates/", toString(templateId) as string) as string, method: "GET", headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getDocgenTemplateTagsV2025R0(templateId: string, optionalsInput: GetDocgenTemplateTagsV2025R0OptionalsInput = {}): Promise<DocGenTagsV2025R0> {
        const optionals: GetDocgenTemplateTagsV2025R0Optionals = new GetDocgenTemplateTagsV2025R0Optionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
            readonly [key: string]: string;
        } = prepareParams({ ["template_version_id"]: toString(queryParams.templateVersionId) as string, ["marker"]: toString(queryParams.marker) as string, ["limit"]: toString(queryParams.limit) as string });
        const headersMap: {
            readonly [key: string]: string;
        } = prepareParams({ ...{ ["box-version"]: toString(headers.boxVersion) as string }, ...headers.extraHeaders });
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_templates/", toString(templateId) as string, "/tags") as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
     ...
     */
    async getDocgenTemplateJobByIdV2025R0(templateId: string, optionalsInput: GetDocgenTemplateJobByIdV2025R0OptionalsInput = {}): Promise<DocGenJobsV2025R0> {
        const optionals: GetDocgenTemplateJobByIdV2025R0Optionals = new GetDocgenTemplateJobByIdV2025R0Optionals({ queryParams: optionalsInput.queryParams, headers: optionalsInput.headers, cancellationToken: optionalsInput.cancellationToken });
        const queryParams: any = optionals.queryParams;
        const headers: any = optionals.headers;
        const cancellationToken: any = optionals.cancellationToken;
        const queryParamsMap: {
        ...
        const response: FetchResponse = await this.networkSession.networkClient.fetch(new FetchOptions({ url: "".concat(this.networkSession.baseUrls.baseUrl, "/2.0/docgen_template_jobs/", toString(templateId) as string) as string, method: "GET", params: queryParamsMap, headers: headersMap, responseFormat: "json" as ResponseFormat, auth: this.auth, networkSession: this.networkSession, cancellationToken: cancellationToken }));
        return {
