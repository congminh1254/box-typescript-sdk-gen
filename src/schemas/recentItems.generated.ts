...
export function serializeRecentItems(val: RecentItems): SerializedData {
    return { ["limit"]: val.limit, ["next_marker"]: val.nextMarker, ["prev_marker"]: val.prevMarker, ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item: RecentItem): SerializedData {
...
export function deserializeRecentItems(val: SerializedData): RecentItems {
    ...
    if (!(val.limit == void 0) && !sdIsNumber(val.limit)) {
        throw new BoxSdkError({ message: "Expecting number for \"limit\" of type \"RecentItems\"" });
    }
    const limit: undefined | number = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !sdIsString(val.next_marker)) {
        throw new BoxSdkError({ message: "Expecting string for \"next_marker\" of type \"RecentItems\"" });
    }
    const nextMarker: undefined | string = val.next_marker == void 0 ? void 0 : val.next_marker;
    if (!(val.prev_marker == void 0) && !sdIsString(val.prev_marker)) {
        throw new BoxSdkError({ message: "Expecting string for \"prev_marker\" of type \"RecentItems\"" });
    }
    const prevMarker: undefined | string = val.prev_marker == void 0 ? void 0 : val.prev_marker;
    if (!(val.entries == void 0) && !sdIsList(val.entries)) {
        throw new BoxSdkError({ message: "Expecting array for \"entries\" of type \"RecentItems\"" });
    }
    const entries: undefined | readonly RecentItem[] = val.entries == void 0 ? void 0 : sdIsList(val.entries) ? val.entries.map(function (itm: SerializedData): RecentItem {
