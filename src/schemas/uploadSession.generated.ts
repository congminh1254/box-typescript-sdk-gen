...
export function serializeUploadSessionTypeField(val: UploadSessionTypeField): SerializedData {
    return val;
}
export function deserializeUploadSessionTypeField(val: SerializedData): UploadSessionTypeField {
    if (val == "upload_session") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize UploadSessionTypeField" });
}
export function serializeUploadSessionSessionEndpointsField(val: UploadSessionSessionEndpointsField): SerializedData {
...
export function deserializeUploadSessionSessionEndpointsField(val: SerializedData): UploadSessionSessionEndpointsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UploadSessionSessionEndpointsField\"" });
    }
    if (!(val.upload_part == void 0) && !sdIsString(val.upload_part)) {
        throw new BoxSdkError({ message: "Expecting string for \"upload_part\" of type \"UploadSessionSessionEndpointsField\"" });
    }
    ...
    if (!(val.commit == void 0) && !sdIsString(val.commit)) {
        throw new BoxSdkError({ message: "Expecting string for \"commit\" of type \"UploadSessionSessionEndpointsField\"" });
    }
    const commit: undefined | string = val.commit == void 0 ? void 0 : val.commit;
    if (!(val.abort == void 0) && !sdIsString(val.abort)) {
        throw new BoxSdkError({ message: "Expecting string for \"abort\" of type \"UploadSessionSessionEndpointsField\"" });
    }
    const abort: undefined | string = val.abort == void 0 ? void 0 : val.abort;
    if (!(val.list_parts == void 0) && !sdIsString(val.list_parts)) {
        throw new BoxSdkError({ message: "Expecting string for \"list_parts\" of type \"UploadSessionSessionEndpointsField\"" });
    }
    const listParts: undefined | string = val.list_parts == void 0 ? void 0 : val.list_parts;
    if (!(val.status == void 0) && !sdIsString(val.status)) {
        throw new BoxSdkError({ message: "Expecting string for \"status\" of type \"UploadSessionSessionEndpointsField\"" });
    }
...
export function serializeUploadSession(val: UploadSession): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeUploadSessionTypeField(val.type), ["session_expires_at"]: val.sessionExpiresAt == void 0 ? val.sessionExpiresAt : serializeDateTime(val.sessionExpiresAt), ["part_size"]: val.partSize, ["total_parts"]: val.totalParts, ["num_parts_processed"]: val.numPartsProcessed, ["session_endpoints"]: val.sessionEndpoints == void 0 ? val.sessionEndpoints : serializeUploadSessionSessionEndpointsField(val.sessionEndpoints) };
}
export function deserializeUploadSession(val: SerializedData): UploadSession {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UploadSession\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | UploadSessionTypeField = val.type == void 0 ? void 0 : deserializeUploadSessionTypeField(val.type);
    if (!(val.session_expires_at == void 0) && !sdIsString(val.session_expires_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"session_expires_at\" of type \"UploadSession\"" });
    }
    const sessionExpiresAt: undefined | DateTime = val.session_expires_at == void 0 ? void 0 : deserializeDateTime(val.session_expires_at);
    if (!(val.part_size == void 0) && !sdIsNumber(val.part_size)) {
        throw new BoxSdkError({ message: "Expecting number for \"part_size\" of type \"UploadSession\"" });
    }
    ...
    if (!(val.total_parts == void 0) && !sdIsNumber(val.total_parts)) {
        throw new BoxSdkError({ message: "Expecting number for \"total_parts\" of type \"UploadSession\"" });
    }
    const totalParts: undefined | number = val.total_parts == void 0 ? void 0 : val.total_parts;
    if (!(val.num_parts_processed == void 0) && !sdIsNumber(val.num_parts_processed)) {
        throw new BoxSdkError({ message: "Expecting number for \"num_parts_processed\" of type \"UploadSession\"" });
    }
