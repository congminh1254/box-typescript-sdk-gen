...
export function deserializeWebLinkMini(val: SerializedData): WebLinkMini {
    ...
    if (!(val.url == void 0) && !sdIsString(val.url)) {
        throw new BoxSdkError({ message: "Expecting string for \"url\" of type \"WebLinkMini\"" });
    }
    const url: undefined | string = val.url == void 0 ? void 0 : val.url;
    if (!(val.sequence_id == void 0) && !sdIsString(val.sequence_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"WebLinkMini\"" });
    }
    const sequenceId: undefined | string = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"WebLinkMini\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"WebLinkMini\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"WebLinkMini\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"WebLinkMini\" to be defined" });
    }
    const type: WebLinkBaseTypeField = deserializeWebLinkBaseTypeField(val.type);
    if (!(val.etag == void 0) && !sdIsString(val.etag)) {
        throw new BoxSdkError({ message: "Expecting string for \"etag\" of type \"WebLinkMini\"" });
    }
