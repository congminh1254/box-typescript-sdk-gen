...
export function serializeMetadataFull(val: MetadataFull): SerializedData {
    ...
    return { ...base, ...{ ...{ ["$canEdit"]: val.canEdit, ["$id"]: val.id, ["$type"]: val.type, ["$typeVersion"]: val.typeVersion }, ...val.extraData } };
}
export function deserializeMetadataFull(val: SerializedData): MetadataFull {
    ...
    if (!(val.$canEdit == void 0) && !sdIsBoolean(val.$canEdit)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"$canEdit\" of type \"MetadataFull\"" });
    }
    const canEdit: undefined | boolean = val.$canEdit == void 0 ? void 0 : val.$canEdit;
    if (!(val.$id == void 0) && !sdIsString(val.$id)) {
        throw new BoxSdkError({ message: "Expecting string for \"$id\" of type \"MetadataFull\"" });
    }
    const id: undefined | string = val.$id == void 0 ? void 0 : val.$id;
    if (!(val.$type == void 0) && !sdIsString(val.$type)) {
        throw new BoxSdkError({ message: "Expecting string for \"$type\" of type \"MetadataFull\"" });
    }
    const type: undefined | string = val.$type == void 0 ? void 0 : val.$type;
    if (!(val.$typeVersion == void 0) && !sdIsNumber(val.$typeVersion)) {
        throw new BoxSdkError({ message: "Expecting number for \"$typeVersion\" of type \"MetadataFull\"" });
    }
    const typeVersion: undefined | number = val.$typeVersion == void 0 ? void 0 : val.$typeVersion;
    if (!(val == void 0) && !sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting object for \"extraData\" of type \"MetadataFull\"" });
    }
