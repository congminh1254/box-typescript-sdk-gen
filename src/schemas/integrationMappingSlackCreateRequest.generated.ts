...
export function serializeIntegrationMappingSlackCreateRequest(val: IntegrationMappingSlackCreateRequest): SerializedData {
    return { ["partner_item"]: serializeIntegrationMappingPartnerItemSlack(val.partnerItem), ["box_item"]: serializeIntegrationMappingBoxItemSlack(val.boxItem), ["options"]: val.options == void 0 ? val.options : serializeIntegrationMappingSlackOptions(val.options) };
}
export function deserializeIntegrationMappingSlackCreateRequest(val: SerializedData): IntegrationMappingSlackCreateRequest {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"IntegrationMappingSlackCreateRequest\"" });
    }
    if (val.partner_item == void 0) {
        throw new BoxSdkError({ message: "Expecting \"partner_item\" of type \"IntegrationMappingSlackCreateRequest\" to be defined" });
    }
    ...
    if (val.box_item == void 0) {
        throw new BoxSdkError({ message: "Expecting \"box_item\" of type \"IntegrationMappingSlackCreateRequest\" to be defined" });
    }
