...
export function serializeTemplateSignerRoleField(val: TemplateSignerRoleField): SerializedData {
    return val;
}
export function deserializeTemplateSignerRoleField(val: SerializedData): TemplateSignerRoleField {
    if (val == "signer") {
        return val;
    }
    if (val == "approver") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize TemplateSignerRoleField" });
}
export function serializeTemplateSigner(val: TemplateSigner): SerializedData {
    return { ["inputs"]: val.inputs == void 0 ? val.inputs : val.inputs.map(function (item: TemplateSignerInput): SerializedData {
            return serializeTemplateSignerInput(item);
        }) as readonly any[], ["email"]: val.email, ["role"]: val.role == void 0 ? val.role : serializeTemplateSignerRoleField(val.role), ["is_in_person"]: val.isInPerson, ["order"]: val.order, ["signer_group_id"]: val.signerGroupId, ["label"]: val.label, ["public_id"]: val.publicId };
}
export function deserializeTemplateSigner(val: SerializedData): TemplateSigner {
    ...
    if (!(val.inputs == void 0) && !sdIsList(val.inputs)) {
        throw new BoxSdkError({ message: "Expecting array for \"inputs\" of type \"TemplateSigner\"" });
    }
    const inputs: undefined | readonly TemplateSignerInput[] = val.inputs == void 0 ? void 0 : sdIsList(val.inputs) ? val.inputs.map(function (itm: SerializedData): TemplateSignerInput {
        return deserializeTemplateSignerInput(itm);
    }) as readonly any[] : [];
    if (!(val.email == void 0) && !sdIsString(val.email)) {
        throw new BoxSdkError({ message: "Expecting string for \"email\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.is_in_person == void 0) && !sdIsBoolean(val.is_in_person)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_in_person\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.order == void 0) && !sdIsNumber(val.order)) {
        throw new BoxSdkError({ message: "Expecting number for \"order\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.signer_group_id == void 0) && !sdIsString(val.signer_group_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"signer_group_id\" of type \"TemplateSigner\"" });
    }
    ...
    if (!(val.label == void 0) && !sdIsString(val.label)) {
        throw new BoxSdkError({ message: "Expecting string for \"label\" of type \"TemplateSigner\"" });
    }
    const label: undefined | string = val.label == void 0 ? void 0 : val.label;
    if (!(val.public_id == void 0) && !sdIsString(val.public_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"public_id\" of type \"TemplateSigner\"" });
    }
    const publicId: undefined | string = val.public_id == void 0 ? void 0 : val.public_id;
    return { inputs: inputs, email: email, role: role, isInPerson: isInPerson, order: order, signerGroupId: signerGroupId, label: label, publicId: publicId } satisfies TemplateSigner;
}
