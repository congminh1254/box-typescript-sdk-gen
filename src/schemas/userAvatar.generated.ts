...
export function serializeUserAvatarPicUrlsField(val: UserAvatarPicUrlsField): SerializedData {
    return { ["small"]: val.small, ["large"]: val.large, ["preview"]: val.preview };
}
export function deserializeUserAvatarPicUrlsField(val: SerializedData): UserAvatarPicUrlsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UserAvatarPicUrlsField\"" });
    }
    if (!(val.small == void 0) && !sdIsString(val.small)) {
        throw new BoxSdkError({ message: "Expecting string for \"small\" of type \"UserAvatarPicUrlsField\"" });
    }
    const small: undefined | string = val.small == void 0 ? void 0 : val.small;
    if (!(val.large == void 0) && !sdIsString(val.large)) {
        throw new BoxSdkError({ message: "Expecting string for \"large\" of type \"UserAvatarPicUrlsField\"" });
    }
    const large: undefined | string = val.large == void 0 ? void 0 : val.large;
    if (!(val.preview == void 0) && !sdIsString(val.preview)) {
        throw new BoxSdkError({ message: "Expecting string for \"preview\" of type \"UserAvatarPicUrlsField\"" });
    }
...
export function serializeUserAvatar(val: UserAvatar): SerializedData {
    return { ["pic_urls"]: val.picUrls == void 0 ? val.picUrls : serializeUserAvatarPicUrlsField(val.picUrls) };
}
