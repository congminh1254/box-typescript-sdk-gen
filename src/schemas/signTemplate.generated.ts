...
export function serializeSignTemplateTypeField(val: SignTemplateTypeField): SerializedData {
    return val;
}
export function deserializeSignTemplateTypeField(val: SerializedData): SignTemplateTypeField {
    if (val == "sign-template") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize SignTemplateTypeField" });
}
export function serializeSignTemplateAdditionalInfoNonEditableField(val: SignTemplateAdditionalInfoNonEditableField): SerializedData {
    return val;
}
export function deserializeSignTemplateAdditionalInfoNonEditableField(val: SerializedData): SignTemplateAdditionalInfoNonEditableField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SignTemplateAdditionalInfoNonEditableField" });
}
export function serializeSignTemplateAdditionalInfoRequiredSignersField(val: SignTemplateAdditionalInfoRequiredSignersField): SerializedData {
    return val;
}
export function deserializeSignTemplateAdditionalInfoRequiredSignersField(val: SerializedData): SignTemplateAdditionalInfoRequiredSignersField {
    if (val == "email") {
        return val;
    }
    if (sdIsString(val)) {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SignTemplateAdditionalInfoRequiredSignersField" });
}
export function serializeSignTemplateAdditionalInfoRequiredField(val: SignTemplateAdditionalInfoRequiredField): SerializedData {
    return { ["signers"]: val.signers == void 0 ? val.signers : val.signers.map(function (item: readonly SignTemplateAdditionalInfoRequiredSignersField[]): SerializedData {
            return item.map(function (item: SignTemplateAdditionalInfoRequiredSignersField): SerializedData {
                return serializeSignTemplateAdditionalInfoRequiredSignersField(item);
            }) as readonly any[];
        }) as readonly any[] };
}
export function deserializeSignTemplateAdditionalInfoRequiredField(val: SerializedData): SignTemplateAdditionalInfoRequiredField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignTemplateAdditionalInfoRequiredField\"" });
    }
    if (!(val.signers == void 0) && !sdIsList(val.signers)) {
        throw new BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignTemplateAdditionalInfoRequiredField\"" });
    }
    const signers: undefined | readonly (readonly SignTemplateAdditionalInfoRequiredSignersField[])[] = val.signers == void 0 ? void 0 : sdIsList(val.signers) ? val.signers.map(function (itm: SerializedData): readonly SignTemplateAdditionalInfoRequiredSignersField[] {
        return sdIsList(itm) ? itm.map(function (itm: SerializedData): SignTemplateAdditionalInfoRequiredSignersField {
...
export function serializeSignTemplateAdditionalInfoField(val: SignTemplateAdditionalInfoField): SerializedData {
    return { ["non_editable"]: val.nonEditable == void 0 ? val.nonEditable : val.nonEditable.map(function (item: SignTemplateAdditionalInfoNonEditableField): SerializedData {
            return serializeSignTemplateAdditionalInfoNonEditableField(item);
        }) as readonly any[], ["required"]: val.required == void 0 ? val.required : serializeSignTemplateAdditionalInfoRequiredField(val.required) };
}
export function deserializeSignTemplateAdditionalInfoField(val: SerializedData): SignTemplateAdditionalInfoField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignTemplateAdditionalInfoField\"" });
    }
    if (!(val.non_editable == void 0) && !sdIsList(val.non_editable)) {
        throw new BoxSdkError({ message: "Expecting array for \"non_editable\" of type \"SignTemplateAdditionalInfoField\"" });
    }
    const nonEditable: undefined | readonly SignTemplateAdditionalInfoNonEditableField[] = val.non_editable == void 0 ? void 0 : sdIsList(val.non_editable) ? val.non_editable.map(function (itm: SerializedData): SignTemplateAdditionalInfoNonEditableField {
        return deserializeSignTemplateAdditionalInfoNonEditableField(itm);
    }) as readonly any[] : [];
    const required: undefined | SignTemplateAdditionalInfoRequiredField = val.required == void 0 ? void 0 : deserializeSignTemplateAdditionalInfoRequiredField(val.required);
    return { nonEditable: nonEditable, required: required } satisfies SignTemplateAdditionalInfoField;
}
export function serializeSignTemplateReadySignLinkField(val: SignTemplateReadySignLinkField): SerializedData {
...
export function deserializeSignTemplateReadySignLinkField(val: SerializedData): SignTemplateReadySignLinkField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignTemplateReadySignLinkField\"" });
    }
    if (!(val.url == void 0) && !sdIsString(val.url)) {
        throw new BoxSdkError({ message: "Expecting string for \"url\" of type \"SignTemplateReadySignLinkField\"" });
    }
    const url: undefined | string = val.url == void 0 ? void 0 : val.url;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"SignTemplateReadySignLinkField\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.instructions == void 0) && !sdIsString(val.instructions)) {
        throw new BoxSdkError({ message: "Expecting string for \"instructions\" of type \"SignTemplateReadySignLinkField\"" });
    }
    ...
    if (!(val.folder_id == void 0) && !sdIsString(val.folder_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"folder_id\" of type \"SignTemplateReadySignLinkField\"" });
    }
    const folderId: undefined | string = val.folder_id == void 0 ? void 0 : val.folder_id;
    if (!(val.is_notification_disabled == void 0) && !sdIsBoolean(val.is_notification_disabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_notification_disabled\" of type \"SignTemplateReadySignLinkField\"" });
    }
    ...
    if (!(val.is_active == void 0) && !sdIsBoolean(val.is_active)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_active\" of type \"SignTemplateReadySignLinkField\"" });
    }
...
export function serializeSignTemplateCustomBrandingField(val: SignTemplateCustomBrandingField): SerializedData {
...
export function deserializeSignTemplateCustomBrandingField(val: SerializedData): SignTemplateCustomBrandingField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignTemplateCustomBrandingField\"" });
    }
    if (!(val.company_name == void 0) && !sdIsString(val.company_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"company_name\" of type \"SignTemplateCustomBrandingField\"" });
    }
    ...
    if (!(val.logo_uri == void 0) && !sdIsString(val.logo_uri)) {
        throw new BoxSdkError({ message: "Expecting string for \"logo_uri\" of type \"SignTemplateCustomBrandingField\"" });
    }
    ...
    if (!(val.branding_color == void 0) && !sdIsString(val.branding_color)) {
        throw new BoxSdkError({ message: "Expecting string for \"branding_color\" of type \"SignTemplateCustomBrandingField\"" });
    }
    const brandingColor: undefined | string = val.branding_color == void 0 ? void 0 : val.branding_color;
    if (!(val.email_footer_text == void 0) && !sdIsString(val.email_footer_text)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_footer_text\" of type \"SignTemplateCustomBrandingField\"" });
    }
...
export function serializeSignTemplate(val: SignTemplate): SerializedData {
    return { ["type"]: val.type == void 0 ? val.type : serializeSignTemplateTypeField(val.type), ["id"]: val.id, ["name"]: val.name, ["email_subject"]: val.emailSubject, ["email_message"]: val.emailMessage, ["days_valid"]: val.daysValid, ["parent_folder"]: val.parentFolder == void 0 ? val.parentFolder : serializeFolderMini(val.parentFolder), ["source_files"]: val.sourceFiles == void 0 ? val.sourceFiles : val.sourceFiles.map(function (item: FileMini): SerializedData {
            return serializeFileMini(item);
        }) as readonly any[], ["are_fields_locked"]: val.areFieldsLocked, ["are_options_locked"]: val.areOptionsLocked, ["are_recipients_locked"]: val.areRecipientsLocked, ["are_email_settings_locked"]: val.areEmailSettingsLocked, ["are_files_locked"]: val.areFilesLocked, ["signers"]: val.signers == void 0 ? val.signers : val.signers.map(function (item: TemplateSigner): SerializedData {
            return serializeTemplateSigner(item);
        }) as readonly any[], ["additional_info"]: val.additionalInfo == void 0 ? val.additionalInfo : serializeSignTemplateAdditionalInfoField(val.additionalInfo), ["ready_sign_link"]: val.readySignLink == void 0 ? val.readySignLink : serializeSignTemplateReadySignLinkField(val.readySignLink), ["custom_branding"]: val.customBranding == void 0 ? val.customBranding : serializeSignTemplateCustomBrandingField(val.customBranding) };
}
export function deserializeSignTemplate(val: SerializedData): SignTemplate {
    ...
    const type: undefined | SignTemplateTypeField = val.type == void 0 ? void 0 : deserializeSignTemplateTypeField(val.type);
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"SignTemplate\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"SignTemplate\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.email_subject == void 0) && !sdIsString(val.email_subject)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_subject\" of type \"SignTemplate\"" });
    }
    ...
    if (!(val.email_message == void 0) && !sdIsString(val.email_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_message\" of type \"SignTemplate\"" });
    }
    ...
    if (!(val.days_valid == void 0) && !sdIsNumber(val.days_valid)) {
        throw new BoxSdkError({ message: "Expecting number for \"days_valid\" of type \"SignTemplate\"" });
    }
    ...
    if (!(val.source_files == void 0) && !sdIsList(val.source_files)) {
        throw new BoxSdkError({ message: "Expecting array for \"source_files\" of type \"SignTemplate\"" });
    }
    const sourceFiles: undefined | readonly FileMini[] = val.source_files == void 0 ? void 0 : sdIsList(val.source_files) ? val.source_files.map(function (itm: SerializedData): FileMini {
        return deserializeFileMini(itm);
    }) as readonly any[] : [];
    if (!(val.are_fields_locked == void 0) && !sdIsBoolean(val.are_fields_locked)) {
    ...
    if (!(val.are_options_locked == void 0) && !sdIsBoolean(val.are_options_locked)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_options_locked\" of type \"SignTemplate\"" });
    }
    const areOptionsLocked: undefined | boolean = val.are_options_locked == void 0 ? void 0 : val.are_options_locked;
    if (!(val.are_recipients_locked == void 0) && !sdIsBoolean(val.are_recipients_locked)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_recipients_locked\" of type \"SignTemplate\"" });
    }
    const areRecipientsLocked: undefined | boolean = val.are_recipients_locked == void 0 ? void 0 : val.are_recipients_locked;
    if (!(val.are_email_settings_locked == void 0) && !sdIsBoolean(val.are_email_settings_locked)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_email_settings_locked\" of type \"SignTemplate\"" });
    }
    ...
    if (!(val.signers == void 0) && !sdIsList(val.signers)) {
        throw new BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignTemplate\"" });
    }
    const signers: undefined | readonly TemplateSigner[] = val.signers == void 0 ? void 0 : sdIsList(val.signers) ? val.signers.map(function (itm: SerializedData): TemplateSigner {
