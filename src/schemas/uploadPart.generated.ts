...
export function deserializeUploadPart(val: SerializedData): UploadPart {
    ...
    if (!(val.sha1 == void 0) && !sdIsString(val.sha1)) {
        throw new BoxSdkError({ message: "Expecting string for \"sha1\" of type \"UploadPart\"" });
    }
    const sha1: undefined | string = val.sha1 == void 0 ? void 0 : val.sha1;
    if (!(val.part_id == void 0) && !sdIsString(val.part_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"part_id\" of type \"UploadPart\"" });
    }
    const partId: undefined | string = val.part_id == void 0 ? void 0 : val.part_id;
    if (!(val.offset == void 0) && !sdIsNumber(val.offset)) {
        throw new BoxSdkError({ message: "Expecting number for \"offset\" of type \"UploadPart\"" });
    }
    const offset: undefined | number = val.offset == void 0 ? void 0 : val.offset;
    if (!(val.size == void 0) && !sdIsNumber(val.size)) {
        throw new BoxSdkError({ message: "Expecting number for \"size\" of type \"UploadPart\"" });
    }
