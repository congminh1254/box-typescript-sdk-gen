...
export function serializeAiResponseFull(val: AiResponseFull): SerializedData {
    ...
    return { ...base, ...{ ["citations"]: val.citations == void 0 ? val.citations : val.citations.map(function (item: AiCitation): SerializedData {
...
export function deserializeAiResponseFull(val: SerializedData): AiResponseFull {
    ...
    if (!(val.citations == void 0) && !sdIsList(val.citations)) {
        throw new BoxSdkError({ message: "Expecting array for \"citations\" of type \"AiResponseFull\"" });
    }
    const citations: undefined | readonly AiCitation[] = val.citations == void 0 ? void 0 : sdIsList(val.citations) ? val.citations.map(function (itm: SerializedData): AiCitation {
        return deserializeAiCitation(itm);
    }) as readonly any[] : [];
    if (val.answer == void 0) {
        throw new BoxSdkError({ message: "Expecting \"answer\" of type \"AiResponseFull\" to be defined" });
    }
    if (!sdIsString(val.answer)) {
        throw new BoxSdkError({ message: "Expecting string for \"answer\" of type \"AiResponseFull\"" });
    }
    const answer: string = val.answer;
    if (val.created_at == void 0) {
        throw new BoxSdkError({ message: "Expecting \"created_at\" of type \"AiResponseFull\" to be defined" });
    }
    if (!sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"AiResponseFull\"" });
    }
    ...
    if (!(val.completion_reason == void 0) && !sdIsString(val.completion_reason)) {
        throw new BoxSdkError({ message: "Expecting string for \"completion_reason\" of type \"AiResponseFull\"" });
    }
    ...
    return { citations: citations, answer: answer, createdAt: createdAt, completionReason: completionReason, aiAgentInfo: aiAgentInfo } satisfies AiResponseFull;
}
