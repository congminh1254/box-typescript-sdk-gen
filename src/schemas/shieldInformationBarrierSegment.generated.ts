...
export function serializeShieldInformationBarrierSegmentTypeField(val: ShieldInformationBarrierSegmentTypeField): SerializedData {
    return val;
}
export function deserializeShieldInformationBarrierSegmentTypeField(val: SerializedData): ShieldInformationBarrierSegmentTypeField {
    if (val == "shield_information_barrier_segment") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierSegmentTypeField" });
}
export function serializeShieldInformationBarrierSegment(val: ShieldInformationBarrierSegment): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeShieldInformationBarrierSegmentTypeField(val.type), ["shield_information_barrier"]: val.shieldInformationBarrier == void 0 ? val.shieldInformationBarrier : serializeShieldInformationBarrierBase(val.shieldInformationBarrier), ["name"]: val.name, ["description"]: val.description, ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserBase(val.createdBy), ["updated_at"]: val.updatedAt == void 0 ? val.updatedAt : serializeDateTime(val.updatedAt), ["updated_by"]: val.updatedBy == void 0 ? val.updatedBy : serializeUserBase(val.updatedBy) };
}
export function deserializeShieldInformationBarrierSegment(val: SerializedData): ShieldInformationBarrierSegment {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegment\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegment\"" });
    }
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"ShieldInformationBarrierSegment\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"ShieldInformationBarrierSegment\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrierSegment\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !sdIsString(val.updated_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrierSegment\"" });
    }
