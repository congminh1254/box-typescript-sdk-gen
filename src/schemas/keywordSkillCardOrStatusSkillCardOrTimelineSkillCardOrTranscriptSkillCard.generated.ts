...
export function serializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard(val: any): SerializedData {
...
export function deserializeKeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard(val: SerializedData): KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard\"" });
    }
    ...
    throw new BoxSdkError({ message: "Can't deserialize KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard" });
}
