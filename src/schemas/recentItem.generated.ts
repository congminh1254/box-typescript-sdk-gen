...
export function serializeRecentItemInteractionTypeField(val: RecentItemInteractionTypeField): SerializedData {
    return val;
}
export function deserializeRecentItemInteractionTypeField(val: SerializedData): RecentItemInteractionTypeField {
    if (val == "item_preview") {
        return val;
    }
    if (val == "item_upload") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize RecentItemInteractionTypeField" });
}
export function serializeRecentItem(val: RecentItem): SerializedData {
    return { ["type"]: val.type, ["item"]: val.item == void 0 ? val.item : serializeFileFullOrFolderFullOrWebLink(val.item), ["interaction_type"]: val.interactionType == void 0 ? val.interactionType : serializeRecentItemInteractionTypeField(val.interactionType), ["interacted_at"]: val.interactedAt == void 0 ? val.interactedAt : serializeDateTime(val.interactedAt), ["interaction_shared_link"]: val.interactionSharedLink };
}
export function deserializeRecentItem(val: SerializedData): RecentItem {
    ...
    if (!(val.type == void 0) && !sdIsString(val.type)) {
        throw new BoxSdkError({ message: "Expecting string for \"type\" of type \"RecentItem\"" });
    }
    const type: undefined | string = val.type == void 0 ? void 0 : val.type;
    const item: undefined | FileFullOrFolderFullOrWebLink = val.item == void 0 ? void 0 : deserializeFileFullOrFolderFullOrWebLink(val.item);
    ...
    if (!(val.interacted_at == void 0) && !sdIsString(val.interacted_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"interacted_at\" of type \"RecentItem\"" });
    }
    const interactedAt: undefined | DateTime = val.interacted_at == void 0 ? void 0 : deserializeDateTime(val.interacted_at);
    if (!(val.interaction_shared_link == void 0) && !sdIsString(val.interaction_shared_link)) {
        throw new BoxSdkError({ message: "Expecting string for \"interaction_shared_link\" of type \"RecentItem\"" });
    }
