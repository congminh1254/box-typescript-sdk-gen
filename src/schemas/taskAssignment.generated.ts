...
export function serializeTaskAssignmentTypeField(val: TaskAssignmentTypeField): SerializedData {
    return val;
}
export function deserializeTaskAssignmentTypeField(val: SerializedData): TaskAssignmentTypeField {
    if (val == "task_assignment") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize TaskAssignmentTypeField" });
}
export function serializeTaskAssignmentResolutionStateField(val: TaskAssignmentResolutionStateField): SerializedData {
    return val;
}
export function deserializeTaskAssignmentResolutionStateField(val: SerializedData): TaskAssignmentResolutionStateField {
    if (val == "completed") {
        return val;
    }
    if (val == "incomplete") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize TaskAssignmentResolutionStateField" });
}
export function serializeTaskAssignment(val: TaskAssignment): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeTaskAssignmentTypeField(val.type), ["item"]: val.item == void 0 ? val.item : serializeFileMini(val.item), ["assigned_to"]: val.assignedTo == void 0 ? val.assignedTo : serializeUserMini(val.assignedTo), ["message"]: val.message, ["completed_at"]: val.completedAt == void 0 ? val.completedAt : serializeDateTime(val.completedAt), ["assigned_at"]: val.assignedAt == void 0 ? val.assignedAt : serializeDateTime(val.assignedAt), ["reminded_at"]: val.remindedAt == void 0 ? val.remindedAt : serializeDateTime(val.remindedAt), ["resolution_state"]: val.resolutionState == void 0 ? val.resolutionState : serializeTaskAssignmentResolutionStateField(val.resolutionState), ["assigned_by"]: val.assignedBy == void 0 ? val.assignedBy : serializeUserMini(val.assignedBy) };
}
export function deserializeTaskAssignment(val: SerializedData): TaskAssignment {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.completed_at == void 0) && !sdIsString(val.completed_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"completed_at\" of type \"TaskAssignment\"" });
    }
    const completedAt: undefined | DateTime = val.completed_at == void 0 ? void 0 : deserializeDateTime(val.completed_at);
    if (!(val.assigned_at == void 0) && !sdIsString(val.assigned_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"assigned_at\" of type \"TaskAssignment\"" });
    }
    ...
    if (!(val.reminded_at == void 0) && !sdIsString(val.reminded_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"reminded_at\" of type \"TaskAssignment\"" });
    }
    const remindedAt: undefined | DateTime = val.reminded_at == void 0 ? void 0 : deserializeDateTime(val.reminded_at);
