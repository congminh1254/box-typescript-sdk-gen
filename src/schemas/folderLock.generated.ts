...
export function serializeFolderLockLockedOperationsField(val: FolderLockLockedOperationsField): SerializedData {
    return { ["move"]: val.move, ["delete"]: val.delete };
}
export function deserializeFolderLockLockedOperationsField(val: SerializedData): FolderLockLockedOperationsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FolderLockLockedOperationsField\"" });
    }
    if (val.move == void 0) {
        throw new BoxSdkError({ message: "Expecting \"move\" of type \"FolderLockLockedOperationsField\" to be defined" });
    }
    if (!sdIsBoolean(val.move)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"move\" of type \"FolderLockLockedOperationsField\"" });
    }
    const move: boolean = val.move;
    if (val.delete == void 0) {
        throw new BoxSdkError({ message: "Expecting \"delete\" of type \"FolderLockLockedOperationsField\" to be defined" });
    }
    if (!sdIsBoolean(val.delete)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"delete\" of type \"FolderLockLockedOperationsField\"" });
    }
...
export function deserializeFolderLock(val: SerializedData): FolderLock {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FolderLock\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    if (!(val.type == void 0) && !sdIsString(val.type)) {
        throw new BoxSdkError({ message: "Expecting string for \"type\" of type \"FolderLock\"" });
    }
    const type: undefined | string = val.type == void 0 ? void 0 : val.type;
    const createdBy: undefined | UserBase = val.created_by == void 0 ? void 0 : deserializeUserBase(val.created_by);
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FolderLock\"" });
    }
    ...
    if (!(val.lock_type == void 0) && !sdIsString(val.lock_type)) {
        throw new BoxSdkError({ message: "Expecting string for \"lock_type\" of type \"FolderLock\"" });
    }
