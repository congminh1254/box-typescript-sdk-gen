...
export function serializeAiAgentExtractStructuredOrAiAgentReference(val: any): SerializedData {
...
export function deserializeAiAgentExtractStructuredOrAiAgentReference(val: SerializedData): AiAgentExtractStructuredOrAiAgentReference {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiAgentExtractStructuredOrAiAgentReference\"" });
    }
    if (val.type == "ai_agent_extract_structured") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize AiAgentExtractStructuredOrAiAgentReference" });
}
