...
export function serializeFileFullPermissionsField(val: FileFullPermissionsField): SerializedData {
...
export function deserializeFileFullPermissionsField(val: SerializedData): FileFullPermissionsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullPermissionsField\"" });
    }
    if (val.can_delete == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_delete\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_delete)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_delete\" of type \"FileFullPermissionsField\"" });
    }
    const canDelete: boolean = val.can_delete;
    if (val.can_download == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_download\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_download)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"FileFullPermissionsField\"" });
    }
    const canDownload: boolean = val.can_download;
    if (val.can_invite_collaborator == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_invite_collaborator\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_invite_collaborator)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_invite_collaborator\" of type \"FileFullPermissionsField\"" });
    }
    const canInviteCollaborator: boolean = val.can_invite_collaborator;
    if (val.can_rename == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_rename\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_rename)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_rename\" of type \"FileFullPermissionsField\"" });
    }
    const canRename: boolean = val.can_rename;
    if (val.can_set_share_access == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_set_share_access\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_set_share_access)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_set_share_access\" of type \"FileFullPermissionsField\"" });
    }
    const canSetShareAccess: boolean = val.can_set_share_access;
    if (val.can_share == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_share\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_share)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_share\" of type \"FileFullPermissionsField\"" });
    }
    const canShare: boolean = val.can_share;
    if (val.can_annotate == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_annotate\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_annotate)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_annotate\" of type \"FileFullPermissionsField\"" });
    }
    const canAnnotate: boolean = val.can_annotate;
    if (val.can_comment == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_comment\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_comment)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_comment\" of type \"FileFullPermissionsField\"" });
    }
    const canComment: boolean = val.can_comment;
    if (val.can_preview == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_preview\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_preview)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_preview\" of type \"FileFullPermissionsField\"" });
    }
    const canPreview: boolean = val.can_preview;
    if (val.can_upload == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_upload\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_upload)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_upload\" of type \"FileFullPermissionsField\"" });
    }
    const canUpload: boolean = val.can_upload;
    if (val.can_view_annotations_all == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_view_annotations_all\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_view_annotations_all)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_view_annotations_all\" of type \"FileFullPermissionsField\"" });
    }
    const canViewAnnotationsAll: boolean = val.can_view_annotations_all;
    if (val.can_view_annotations_self == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_view_annotations_self\" of type \"FileFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_view_annotations_self)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_view_annotations_self\" of type \"FileFullPermissionsField\"" });
    }
...
export function serializeFileFullLockTypeField(val: FileFullLockTypeField): SerializedData {
    return val;
}
export function deserializeFileFullLockTypeField(val: SerializedData): FileFullLockTypeField {
    if (val == "lock") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize FileFullLockTypeField" });
}
export function serializeFileFullLockAppTypeField(val: FileFullLockAppTypeField): SerializedData {
    return val;
}
export function deserializeFileFullLockAppTypeField(val: SerializedData): FileFullLockAppTypeField {
    if (val == "gsuite") {
        return val;
    }
    if (val == "office_wopi") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FileFullLockAppTypeField" });
}
export function serializeFileFullLockField(val: FileFullLockField): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeFileFullLockTypeField(val.type), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["expired_at"]: val.expiredAt == void 0 ? val.expiredAt : serializeDateTime(val.expiredAt), ["is_download_prevented"]: val.isDownloadPrevented, ["app_type"]: val.appType == void 0 ? val.appType : serializeFileFullLockAppTypeField(val.appType) };
}
export function deserializeFileFullLockField(val: SerializedData): FileFullLockField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullLockField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FileFullLockField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | FileFullLockTypeField = val.type == void 0 ? void 0 : deserializeFileFullLockTypeField(val.type);
    const createdBy: undefined | UserMini = val.created_by == void 0 ? void 0 : deserializeUserMini(val.created_by);
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FileFullLockField\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.expired_at == void 0) && !sdIsString(val.expired_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"expired_at\" of type \"FileFullLockField\"" });
    }
    const expiredAt: undefined | DateTime = val.expired_at == void 0 ? void 0 : deserializeDateTime(val.expired_at);
    if (!(val.is_download_prevented == void 0) && !sdIsBoolean(val.is_download_prevented)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_download_prevented\" of type \"FileFullLockField\"" });
    }
    const isDownloadPrevented: undefined | boolean = val.is_download_prevented == void 0 ? void 0 : val.is_download_prevented;
    const appType: undefined | FileFullLockAppTypeField = val.app_type == void 0 ? void 0 : deserializeFileFullLockAppTypeField(val.app_type);
...
export function serializeFileFullExpiringEmbedLinkTokenTypeField(val: FileFullExpiringEmbedLinkTokenTypeField): SerializedData {
    return val;
}
export function deserializeFileFullExpiringEmbedLinkTokenTypeField(val: SerializedData): FileFullExpiringEmbedLinkTokenTypeField {
    if (val == "bearer") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize FileFullExpiringEmbedLinkTokenTypeField" });
}
export function serializeFileFullExpiringEmbedLinkField(val: FileFullExpiringEmbedLinkField): SerializedData {
    return { ["access_token"]: val.accessToken, ["expires_in"]: val.expiresIn, ["token_type"]: val.tokenType == void 0 ? val.tokenType : serializeFileFullExpiringEmbedLinkTokenTypeField(val.tokenType), ["restricted_to"]: val.restrictedTo == void 0 ? val.restrictedTo : val.restrictedTo.map(function (item: FileOrFolderScope): SerializedData {
            return serializeFileOrFolderScope(item);
        }) as readonly any[], ["url"]: val.url };
}
export function deserializeFileFullExpiringEmbedLinkField(val: SerializedData): FileFullExpiringEmbedLinkField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullExpiringEmbedLinkField\"" });
    }
    if (!(val.access_token == void 0) && !sdIsString(val.access_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"access_token\" of type \"FileFullExpiringEmbedLinkField\"" });
    }
    ...
    if (!(val.expires_in == void 0) && !sdIsNumber(val.expires_in)) {
        throw new BoxSdkError({ message: "Expecting number for \"expires_in\" of type \"FileFullExpiringEmbedLinkField\"" });
    }
    const expiresIn: undefined | number = val.expires_in == void 0 ? void 0 : val.expires_in;
    const tokenType: undefined | FileFullExpiringEmbedLinkTokenTypeField = val.token_type == void 0 ? void 0 : deserializeFileFullExpiringEmbedLinkTokenTypeField(val.token_type);
    if (!(val.restricted_to == void 0) && !sdIsList(val.restricted_to)) {
        throw new BoxSdkError({ message: "Expecting array for \"restricted_to\" of type \"FileFullExpiringEmbedLinkField\"" });
    }
    const restrictedTo: undefined | readonly FileOrFolderScope[] = val.restricted_to == void 0 ? void 0 : sdIsList(val.restricted_to) ? val.restricted_to.map(function (itm: SerializedData): FileOrFolderScope {
        return deserializeFileOrFolderScope(itm);
    }) as readonly any[] : [];
    if (!(val.url == void 0) && !sdIsString(val.url)) {
        throw new BoxSdkError({ message: "Expecting string for \"url\" of type \"FileFullExpiringEmbedLinkField\"" });
    }
...
export function serializeFileFullWatermarkInfoField(val: FileFullWatermarkInfoField): SerializedData {
    return { ["is_watermarked"]: val.isWatermarked };
}
export function deserializeFileFullWatermarkInfoField(val: SerializedData): FileFullWatermarkInfoField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullWatermarkInfoField\"" });
    }
    if (!(val.is_watermarked == void 0) && !sdIsBoolean(val.is_watermarked)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_watermarked\" of type \"FileFullWatermarkInfoField\"" });
    }
...
export function serializeFileFullAllowedInviteeRolesField(val: FileFullAllowedInviteeRolesField): SerializedData {
    return val;
}
export function deserializeFileFullAllowedInviteeRolesField(val: SerializedData): FileFullAllowedInviteeRolesField {
    if (val == "editor") {
        return val;
    }
    if (val == "viewer") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FileFullAllowedInviteeRolesField" });
}
export function serializeFileFullMetadataField(val: FileFullMetadataField): SerializedData {
    return { ...{}, ...val.extraData };
}
export function deserializeFileFullMetadataField(val: SerializedData): FileFullMetadataField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullMetadataField\"" });
    }
    if (!(val == void 0) && !sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting object for \"extraData\" of type \"FileFullMetadataField\"" });
    }
    const extraData: undefined | {
        readonly [key: string]: {
            readonly [key: string]: MetadataFull;
        };
    } = val == void 0 ? void 0 : sdIsMap(val) ? Object.fromEntries(Object.entries(val).map(([k, v]: [
        string,
        any
    ]) => [k, function (v: any): any {
            return sdIsMap(v) ? Object.fromEntries(Object.entries(v).map(([k, v]: [
                string,
                any
            ]) => [k, deserializeMetadataFull(v)])) as {
...
export function serializeFileFullRepresentationsEntriesContentField(val: FileFullRepresentationsEntriesContentField): SerializedData {
    return { ["url_template"]: val.urlTemplate };
}
export function deserializeFileFullRepresentationsEntriesContentField(val: SerializedData): FileFullRepresentationsEntriesContentField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsEntriesContentField\"" });
    }
    if (!(val.url_template == void 0) && !sdIsString(val.url_template)) {
        throw new BoxSdkError({ message: "Expecting string for \"url_template\" of type \"FileFullRepresentationsEntriesContentField\"" });
    }
    const urlTemplate: undefined | string = val.url_template == void 0 ? void 0 : val.url_template;
    return { urlTemplate: urlTemplate } satisfies FileFullRepresentationsEntriesContentField;
}
export function serializeFileFullRepresentationsEntriesInfoField(val: FileFullRepresentationsEntriesInfoField): SerializedData {
    return { ["url"]: val.url };
}
export function deserializeFileFullRepresentationsEntriesInfoField(val: SerializedData): FileFullRepresentationsEntriesInfoField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsEntriesInfoField\"" });
    }
    if (!(val.url == void 0) && !sdIsString(val.url)) {
        throw new BoxSdkError({ message: "Expecting string for \"url\" of type \"FileFullRepresentationsEntriesInfoField\"" });
    }
    const url: undefined | string = val.url == void 0 ? void 0 : val.url;
    return { url: url } satisfies FileFullRepresentationsEntriesInfoField;
}
export function serializeFileFullRepresentationsEntriesPropertiesField(val: FileFullRepresentationsEntriesPropertiesField): SerializedData {
    return { ["dimensions"]: val.dimensions, ["paged"]: val.paged, ["thumb"]: val.thumb };
}
export function deserializeFileFullRepresentationsEntriesPropertiesField(val: SerializedData): FileFullRepresentationsEntriesPropertiesField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsEntriesPropertiesField\"" });
    }
    if (!(val.dimensions == void 0) && !sdIsString(val.dimensions)) {
        throw new BoxSdkError({ message: "Expecting string for \"dimensions\" of type \"FileFullRepresentationsEntriesPropertiesField\"" });
    }
    const dimensions: undefined | string = val.dimensions == void 0 ? void 0 : val.dimensions;
    if (!(val.paged == void 0) && !sdIsBoolean(val.paged)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"paged\" of type \"FileFullRepresentationsEntriesPropertiesField\"" });
    }
    const paged: undefined | boolean = val.paged == void 0 ? void 0 : val.paged;
    if (!(val.thumb == void 0) && !sdIsBoolean(val.thumb)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"thumb\" of type \"FileFullRepresentationsEntriesPropertiesField\"" });
    }
    const thumb: undefined | boolean = val.thumb == void 0 ? void 0 : val.thumb;
    return { dimensions: dimensions, paged: paged, thumb: thumb } satisfies FileFullRepresentationsEntriesPropertiesField;
}
export function serializeFileFullRepresentationsEntriesStatusStateField(val: FileFullRepresentationsEntriesStatusStateField): SerializedData {
    return val;
}
export function deserializeFileFullRepresentationsEntriesStatusStateField(val: SerializedData): FileFullRepresentationsEntriesStatusStateField {
    if (val == "success") {
        return val;
    }
    if (val == "viewable") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FileFullRepresentationsEntriesStatusStateField" });
}
export function serializeFileFullRepresentationsEntriesStatusField(val: FileFullRepresentationsEntriesStatusField): SerializedData {
    return { ["state"]: val.state == void 0 ? val.state : serializeFileFullRepresentationsEntriesStatusStateField(val.state) };
}
export function deserializeFileFullRepresentationsEntriesStatusField(val: SerializedData): FileFullRepresentationsEntriesStatusField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsEntriesStatusField\"" });
    }
    const state: undefined | FileFullRepresentationsEntriesStatusStateField = val.state == void 0 ? void 0 : deserializeFileFullRepresentationsEntriesStatusStateField(val.state);
    return { state: state } satisfies FileFullRepresentationsEntriesStatusField;
}
export function serializeFileFullRepresentationsEntriesField(val: FileFullRepresentationsEntriesField): SerializedData {
    return { ["content"]: val.content == void 0 ? val.content : serializeFileFullRepresentationsEntriesContentField(val.content), ["info"]: val.info == void 0 ? val.info : serializeFileFullRepresentationsEntriesInfoField(val.info), ["properties"]: val.properties == void 0 ? val.properties : serializeFileFullRepresentationsEntriesPropertiesField(val.properties), ["representation"]: val.representation, ["status"]: val.status == void 0 ? val.status : serializeFileFullRepresentationsEntriesStatusField(val.status) };
}
export function deserializeFileFullRepresentationsEntriesField(val: SerializedData): FileFullRepresentationsEntriesField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsEntriesField\"" });
    }
    const content: undefined | FileFullRepresentationsEntriesContentField = val.content == void 0 ? void 0 : deserializeFileFullRepresentationsEntriesContentField(val.content);
    const info: undefined | FileFullRepresentationsEntriesInfoField = val.info == void 0 ? void 0 : deserializeFileFullRepresentationsEntriesInfoField(val.info);
    const properties: undefined | FileFullRepresentationsEntriesPropertiesField = val.properties == void 0 ? void 0 : deserializeFileFullRepresentationsEntriesPropertiesField(val.properties);
    if (!(val.representation == void 0) && !sdIsString(val.representation)) {
        throw new BoxSdkError({ message: "Expecting string for \"representation\" of type \"FileFullRepresentationsEntriesField\"" });
    }
    const representation: undefined | string = val.representation == void 0 ? void 0 : val.representation;
    const status: undefined | FileFullRepresentationsEntriesStatusField = val.status == void 0 ? void 0 : deserializeFileFullRepresentationsEntriesStatusField(val.status);
    return { content: content, info: info, properties: properties, representation: representation, status: status } satisfies FileFullRepresentationsEntriesField;
}
export function serializeFileFullRepresentationsField(val: FileFullRepresentationsField): SerializedData {
    return { ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item: FileFullRepresentationsEntriesField): SerializedData {
            return serializeFileFullRepresentationsEntriesField(item);
        }) as readonly any[] };
}
export function deserializeFileFullRepresentationsField(val: SerializedData): FileFullRepresentationsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullRepresentationsField\"" });
    }
    if (!(val.entries == void 0) && !sdIsList(val.entries)) {
        throw new BoxSdkError({ message: "Expecting array for \"entries\" of type \"FileFullRepresentationsField\"" });
    }
    const entries: undefined | readonly FileFullRepresentationsEntriesField[] = val.entries == void 0 ? void 0 : sdIsList(val.entries) ? val.entries.map(function (itm: SerializedData): FileFullRepresentationsEntriesField {
...
export function deserializeFileFullClassificationField(val: SerializedData): FileFullClassificationField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullClassificationField\"" });
    }
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"FileFullClassificationField\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.definition == void 0) && !sdIsString(val.definition)) {
        throw new BoxSdkError({ message: "Expecting string for \"definition\" of type \"FileFullClassificationField\"" });
    }
    const definition: undefined | string = val.definition == void 0 ? void 0 : val.definition;
    if (!(val.color == void 0) && !sdIsString(val.color)) {
        throw new BoxSdkError({ message: "Expecting string for \"color\" of type \"FileFullClassificationField\"" });
    }
...
export function serializeFileFullSharedLinkPermissionOptionsField(val: FileFullSharedLinkPermissionOptionsField): SerializedData {
    return val;
}
export function deserializeFileFullSharedLinkPermissionOptionsField(val: SerializedData): FileFullSharedLinkPermissionOptionsField {
    if (val == "can_preview") {
        return val;
    }
    if (val == "can_download") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FileFullSharedLinkPermissionOptionsField" });
}
...
export function deserializeFileFull(val: SerializedData): FileFull {
    ...
    if (!(val.version_number == void 0) && !sdIsString(val.version_number)) {
        throw new BoxSdkError({ message: "Expecting string for \"version_number\" of type \"FileFull\"" });
    }
    ...
    if (!(val.comment_count == void 0) && !sdIsNumber(val.comment_count)) {
        throw new BoxSdkError({ message: "Expecting number for \"comment_count\" of type \"FileFull\"" });
    }
    ...
    if (!(val.tags == void 0) && !sdIsList(val.tags)) {
        throw new BoxSdkError({ message: "Expecting array for \"tags\" of type \"FileFull\"" });
    }
    const tags: undefined | readonly string[] = val.tags == void 0 ? void 0 : sdIsList(val.tags) ? val.tags.map(function (itm: SerializedData): string {
        if (!sdIsString(itm)) {
            throw new BoxSdkError({ message: "Expecting string for \"FileFull\"" });
        }
        return itm;
    }) as readonly any[] : [];
    ...
    if (!(val.extension == void 0) && !sdIsString(val.extension)) {
        throw new BoxSdkError({ message: "Expecting string for \"extension\" of type \"FileFull\"" });
    }
    ...
    if (!(val.is_package == void 0) && !sdIsBoolean(val.is_package)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_package\" of type \"FileFull\"" });
    }
    ...
    if (!(val.is_accessible_via_shared_link == void 0) && !sdIsBoolean(val.is_accessible_via_shared_link)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_accessible_via_shared_link\" of type \"FileFull\"" });
    }
    ...
    if (!(val.allowed_invitee_roles == void 0) && !sdIsList(val.allowed_invitee_roles)) {
        throw new BoxSdkError({ message: "Expecting array for \"allowed_invitee_roles\" of type \"FileFull\"" });
    }
    const allowedInviteeRoles: undefined | readonly FileFullAllowedInviteeRolesField[] = val.allowed_invitee_roles == void 0 ? void 0 : sdIsList(val.allowed_invitee_roles) ? val.allowed_invitee_roles.map(function (itm: SerializedData): FileFullAllowedInviteeRolesField {
        return deserializeFileFullAllowedInviteeRolesField(itm);
    }) as readonly any[] : [];
    if (!(val.is_externally_owned == void 0) && !sdIsBoolean(val.is_externally_owned)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_externally_owned\" of type \"FileFull\"" });
    }
    const isExternallyOwned: undefined | boolean = val.is_externally_owned == void 0 ? void 0 : val.is_externally_owned;
    if (!(val.has_collaborations == void 0) && !sdIsBoolean(val.has_collaborations)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"has_collaborations\" of type \"FileFull\"" });
    }
    ...
    if (!(val.expires_at == void 0) && !sdIsString(val.expires_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"FileFull\"" });
    }
    const expiresAt: undefined | DateTime = val.expires_at == void 0 ? void 0 : deserializeDateTime(val.expires_at);
    ...
    if (!(val.uploader_display_name == void 0) && !sdIsString(val.uploader_display_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"uploader_display_name\" of type \"FileFull\"" });
    }
    ...
    if (!(val.disposition_at == void 0) && !sdIsString(val.disposition_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"disposition_at\" of type \"FileFull\"" });
    }
    const dispositionAt: undefined | DateTime = val.disposition_at == void 0 ? void 0 : deserializeDateTime(val.disposition_at);
    if (!(val.shared_link_permission_options == void 0) && !sdIsList(val.shared_link_permission_options)) {
        throw new BoxSdkError({ message: "Expecting array for \"shared_link_permission_options\" of type \"FileFull\"" });
    }
    const sharedLinkPermissionOptions: undefined | readonly FileFullSharedLinkPermissionOptionsField[] = val.shared_link_permission_options == void 0 ? void 0 : sdIsList(val.shared_link_permission_options) ? val.shared_link_permission_options.map(function (itm: SerializedData): FileFullSharedLinkPermissionOptionsField {
        return deserializeFileFullSharedLinkPermissionOptionsField(itm);
    }) as readonly any[] : [];
    if (!(val.is_associated_with_app_item == void 0) && !sdIsBoolean(val.is_associated_with_app_item)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_associated_with_app_item\" of type \"FileFull\"" });
    }
    const isAssociatedWithAppItem: undefined | boolean = val.is_associated_with_app_item == void 0 ? void 0 : val.is_associated_with_app_item;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"FileFull\"" });
    }
    const description: undefined | string = val.description == void 0 ? void 0 : val.description;
    if (!(val.size == void 0) && !sdIsNumber(val.size)) {
        throw new BoxSdkError({ message: "Expecting number for \"size\" of type \"FileFull\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FileFull\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"FileFull\"" });
    }
    const modifiedAt: undefined | DateTime = val.modified_at == void 0 ? void 0 : deserializeDateTime(val.modified_at);
    if (!(val.trashed_at == void 0) && !sdIsString(val.trashed_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"FileFull\"" });
    }
    const trashedAt: undefined | DateTime = val.trashed_at == void 0 ? void 0 : deserializeDateTime(val.trashed_at);
    if (!(val.purged_at == void 0) && !sdIsString(val.purged_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"FileFull\"" });
    }
    const purgedAt: undefined | DateTime = val.purged_at == void 0 ? void 0 : deserializeDateTime(val.purged_at);
    if (!(val.content_created_at == void 0) && !sdIsString(val.content_created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_created_at\" of type \"FileFull\"" });
    }
    const contentCreatedAt: undefined | DateTime = val.content_created_at == void 0 ? void 0 : deserializeDateTime(val.content_created_at);
    if (!(val.content_modified_at == void 0) && !sdIsString(val.content_modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_modified_at\" of type \"FileFull\"" });
    }
    const contentModifiedAt: undefined | DateTime = val.content_modified_at == void 0 ? void 0 : deserializeDateTime(val.content_modified_at);
    const createdBy: undefined | UserMini = val.created_by == void 0 ? void 0 : deserializeUserMini(val.created_by);
    ...
    if (!(val.sequence_id == void 0) && !sdIsString(val.sequence_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"FileFull\"" });
    }
    const sequenceId: undefined | string = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"FileFull\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.sha1 == void 0) && !sdIsString(val.sha1)) {
        throw new BoxSdkError({ message: "Expecting string for \"sha1\" of type \"FileFull\"" });
    }
