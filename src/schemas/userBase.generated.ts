...
export function serializeUserBaseTypeField(val: UserBaseTypeField): SerializedData {
    return val;
}
export function deserializeUserBaseTypeField(val: SerializedData): UserBaseTypeField {
    if (val == "user") {
        return val;
    }
...
export function deserializeUserBase(val: SerializedData): UserBase {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"UserBase\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UserBase\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"UserBase\" to be defined" });
    }
...
export function serializeUserBaseInput(val: UserBaseInput): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeUserBaseTypeField(val.type) };
}
export function deserializeUserBaseInput(val: SerializedData): UserBaseInput {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"UserBaseInput\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UserBaseInput\"" });
    }
    const id: string = val.id;
    const type: undefined | UserBaseTypeField = val.type == void 0 ? void 0 : deserializeUserBaseTypeField(val.type);
