...
export function serializeUserFullRoleField(val: UserFullRoleField): SerializedData {
    return val;
}
export function deserializeUserFullRoleField(val: SerializedData): UserFullRoleField {
    if (val == "admin") {
        return val;
    }
    if (val == "coadmin") {
...
export function deserializeUserFullEnterpriseTypeField(val: SerializedData): UserFullEnterpriseTypeField {
    if (val == "enterprise") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize UserFullEnterpriseTypeField" });
}
export function serializeUserFullEnterpriseField(val: UserFullEnterpriseField): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeUserFullEnterpriseTypeField(val.type), ["name"]: val.name };
}
export function deserializeUserFullEnterpriseField(val: SerializedData): UserFullEnterpriseField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UserFullEnterpriseField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UserFullEnterpriseField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | UserFullEnterpriseTypeField = val.type == void 0 ? void 0 : deserializeUserFullEnterpriseTypeField(val.type);
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"UserFullEnterpriseField\"" });
    }
...
export function deserializeUserFull(val: SerializedData): UserFull {
    ...
    if (!(val.tracking_codes == void 0) && !sdIsList(val.tracking_codes)) {
        throw new BoxSdkError({ message: "Expecting array for \"tracking_codes\" of type \"UserFull\"" });
    }
    ...
    if (!(val.can_see_managed_users == void 0) && !sdIsBoolean(val.can_see_managed_users)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_see_managed_users\" of type \"UserFull\"" });
    }
    ...
    if (!(val.is_sync_enabled == void 0) && !sdIsBoolean(val.is_sync_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_sync_enabled\" of type \"UserFull\"" });
    }
    ...
    if (!(val.is_external_collab_restricted == void 0) && !sdIsBoolean(val.is_external_collab_restricted)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_external_collab_restricted\" of type \"UserFull\"" });
    }
    ...
    if (!(val.is_exempt_from_device_limits == void 0) && !sdIsBoolean(val.is_exempt_from_device_limits)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_exempt_from_device_limits\" of type \"UserFull\"" });
    }
    ...
    if (!(val.my_tags == void 0) && !sdIsList(val.my_tags)) {
        throw new BoxSdkError({ message: "Expecting array for \"my_tags\" of type \"UserFull\"" });
    }
    const myTags: undefined | readonly string[] = val.my_tags == void 0 ? void 0 : sdIsList(val.my_tags) ? val.my_tags.map(function (itm: SerializedData): string {
        if (!sdIsString(itm)) {
            throw new BoxSdkError({ message: "Expecting string for \"UserFull\"" });
        }
        return itm;
    }) as readonly any[] : [];
    if (!(val.hostname == void 0) && !sdIsString(val.hostname)) {
        throw new BoxSdkError({ message: "Expecting string for \"hostname\" of type \"UserFull\"" });
    }
    ...
    if (!(val.is_platform_access_only == void 0) && !sdIsBoolean(val.is_platform_access_only)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_platform_access_only\" of type \"UserFull\"" });
    }
    ...
    if (!(val.external_app_user_id == void 0) && !sdIsString(val.external_app_user_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_app_user_id\" of type \"UserFull\"" });
    }
    const externalAppUserId: undefined | string = val.external_app_user_id == void 0 ? void 0 : val.external_app_user_id;
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"UserFull\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"UserFull\"" });
    }
    ...
    if (!(val.language == void 0) && !sdIsString(val.language)) {
        throw new BoxSdkError({ message: "Expecting string for \"language\" of type \"UserFull\"" });
    }
    const language: undefined | string = val.language == void 0 ? void 0 : val.language;
    if (!(val.timezone == void 0) && !sdIsString(val.timezone)) {
        throw new BoxSdkError({ message: "Expecting string for \"timezone\" of type \"UserFull\"" });
    }
    ...
    if (!(val.space_amount == void 0) && !sdIsNumber(val.space_amount)) {
        throw new BoxSdkError({ message: "Expecting number for \"space_amount\" of type \"UserFull\"" });
    }
    ...
    if (!(val.space_used == void 0) && !sdIsNumber(val.space_used)) {
        throw new BoxSdkError({ message: "Expecting number for \"space_used\" of type \"UserFull\"" });
    }
    ...
    if (!(val.max_upload_size == void 0) && !sdIsNumber(val.max_upload_size)) {
        throw new BoxSdkError({ message: "Expecting number for \"max_upload_size\" of type \"UserFull\"" });
    }
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"UserFull\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.login == void 0) && !sdIsString(val.login)) {
        throw new BoxSdkError({ message: "Expecting string for \"login\" of type \"UserFull\"" });
    }
    const login: undefined | string = val.login == void 0 ? void 0 : val.login;
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"UserFull\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"UserFull\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"UserFull\" to be defined" });
    }
