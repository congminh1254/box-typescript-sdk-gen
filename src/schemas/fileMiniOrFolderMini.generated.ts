...
export function deserializeFileMiniOrFolderMini(val: SerializedData): FileMiniOrFolderMini {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileMiniOrFolderMini\"" });
    }
    if (val.type == "file") {
