...
export function serializeShieldInformationBarrierReportStatusField(val: ShieldInformationBarrierReportStatusField): SerializedData {
    return val;
}
export function deserializeShieldInformationBarrierReportStatusField(val: SerializedData): ShieldInformationBarrierReportStatusField {
    if (val == "pending") {
        return val;
    }
    if (val == "error") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierReportStatusField" });
}
export function serializeShieldInformationBarrierReport(val: ShieldInformationBarrierReport): SerializedData {
    const base: any = serializeShieldInformationBarrierReportBase(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReport\"" });
    }
...
export function deserializeShieldInformationBarrierReport(val: SerializedData): ShieldInformationBarrierReport {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierReport\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrierReport\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !sdIsString(val.updated_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrierReport\"" });
    }
    const updatedAt: undefined | DateTime = val.updated_at == void 0 ? void 0 : deserializeDateTime(val.updated_at);
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierReport\"" });
    }
