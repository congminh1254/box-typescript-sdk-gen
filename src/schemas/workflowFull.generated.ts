...
export function serializeWorkflowFull(val: WorkflowFull): SerializedData {
    ...
    return { ...base, ...{ ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : serializeDateTime(val.modifiedAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserBase(val.createdBy), ["modified_by"]: val.modifiedBy == void 0 ? val.modifiedBy : serializeUserBase(val.modifiedBy) } };
}
export function deserializeWorkflowFull(val: SerializedData): WorkflowFull {
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WorkflowFull\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.flows == void 0) && !sdIsList(val.flows)) {
        throw new BoxSdkError({ message: "Expecting array for \"flows\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowFull\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"WorkflowFull\"" });
    }
    ...
    if (!(val.is_enabled == void 0) && !sdIsBoolean(val.is_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_enabled\" of type \"WorkflowFull\"" });
    }
