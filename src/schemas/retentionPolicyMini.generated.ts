...
export function serializeRetentionPolicyMiniDispositionActionField(val: RetentionPolicyMiniDispositionActionField): SerializedData {
    return val;
}
export function deserializeRetentionPolicyMiniDispositionActionField(val: SerializedData): RetentionPolicyMiniDispositionActionField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize RetentionPolicyMiniDispositionActionField" });
}
export function serializeRetentionPolicyMini(val: RetentionPolicyMini): SerializedData {
    const base: any = serializeRetentionPolicyBase(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RetentionPolicyMini\"" });
    }
    return { ...base, ...{ ["policy_name"]: val.policyName, ["retention_length"]: val.retentionLength, ["disposition_action"]: val.dispositionAction == void 0 ? val.dispositionAction : serializeRetentionPolicyMiniDispositionActionField(val.dispositionAction) } };
}
export function deserializeRetentionPolicyMini(val: SerializedData): RetentionPolicyMini {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RetentionPolicyMini\"" });
    }
    if (!(val.policy_name == void 0) && !sdIsString(val.policy_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"RetentionPolicyMini\"" });
    }
    ...
    if (!(val.retention_length == void 0) && !sdIsString(val.retention_length)) {
        throw new BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"RetentionPolicyMini\"" });
    }
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicyMini\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicyMini\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicyMini\" to be defined" });
    }
