...
export function serializeShieldInformationBarrierTypeField(val: ShieldInformationBarrierTypeField): SerializedData {
    return val;
}
export function deserializeShieldInformationBarrierTypeField(val: SerializedData): ShieldInformationBarrierTypeField {
    if (val == "shield_information_barrier") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierTypeField" });
}
export function serializeShieldInformationBarrierStatusField(val: ShieldInformationBarrierStatusField): SerializedData {
    return val;
}
export function deserializeShieldInformationBarrierStatusField(val: SerializedData): ShieldInformationBarrierStatusField {
    if (val == "draft") {
        return val;
    }
    if (val == "pending") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierStatusField" });
}
export function serializeShieldInformationBarrier(val: ShieldInformationBarrier): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeShieldInformationBarrierTypeField(val.type), ["enterprise"]: val.enterprise == void 0 ? val.enterprise : serializeEnterpriseBase(val.enterprise), ["status"]: val.status == void 0 ? val.status : serializeShieldInformationBarrierStatusField(val.status), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserBase(val.createdBy), ["updated_at"]: val.updatedAt == void 0 ? val.updatedAt : serializeDateTime(val.updatedAt), ["updated_by"]: val.updatedBy == void 0 ? val.updatedBy : serializeUserBase(val.updatedBy), ["enabled_at"]: val.enabledAt == void 0 ? val.enabledAt : serializeDateTime(val.enabledAt), ["enabled_by"]: val.enabledBy == void 0 ? val.enabledBy : serializeUserBase(val.enabledBy) };
}
export function deserializeShieldInformationBarrier(val: SerializedData): ShieldInformationBarrier {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrier\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrier\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrier\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !sdIsString(val.updated_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrier\"" });
    }
    ...
    if (!(val.enabled_at == void 0) && !sdIsString(val.enabled_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"enabled_at\" of type \"ShieldInformationBarrier\"" });
    }
    const enabledAt: undefined | DateTime = val.enabled_at == void 0 ? void 0 : deserializeDateTime(val.enabled_at);
