...
export function serializePostOAuth2TokenGrantTypeField(val: PostOAuth2TokenGrantTypeField): SerializedData {
    return val;
}
export function deserializePostOAuth2TokenGrantTypeField(val: SerializedData): PostOAuth2TokenGrantTypeField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize PostOAuth2TokenGrantTypeField" });
}
export function serializePostOAuth2TokenSubjectTokenTypeField(val: PostOAuth2TokenSubjectTokenTypeField): SerializedData {
    return val;
}
export function deserializePostOAuth2TokenSubjectTokenTypeField(val: SerializedData): PostOAuth2TokenSubjectTokenTypeField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize PostOAuth2TokenSubjectTokenTypeField" });
}
export function serializePostOAuth2TokenActorTokenTypeField(val: PostOAuth2TokenActorTokenTypeField): SerializedData {
    return val;
}
export function deserializePostOAuth2TokenActorTokenTypeField(val: SerializedData): PostOAuth2TokenActorTokenTypeField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize PostOAuth2TokenActorTokenTypeField" });
}
export function serializePostOAuth2TokenBoxSubjectTypeField(val: PostOAuth2TokenBoxSubjectTypeField): SerializedData {
    return val;
}
export function deserializePostOAuth2TokenBoxSubjectTypeField(val: SerializedData): PostOAuth2TokenBoxSubjectTypeField {
    if (val == "enterprise") {
        return val;
    }
    if (val == "user") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize PostOAuth2TokenBoxSubjectTypeField" });
}
...
export function deserializePostOAuth2Token(val: SerializedData): PostOAuth2Token {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"PostOAuth2Token\"" });
    }
    if (val.grant_type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"grant_type\" of type \"PostOAuth2Token\" to be defined" });
    }
    ...
    if (!(val.client_id == void 0) && !sdIsString(val.client_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"client_id\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.client_secret == void 0) && !sdIsString(val.client_secret)) {
        throw new BoxSdkError({ message: "Expecting string for \"client_secret\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.code == void 0) && !sdIsString(val.code)) {
        throw new BoxSdkError({ message: "Expecting string for \"code\" of type \"PostOAuth2Token\"" });
    }
    const code: undefined | string = val.code == void 0 ? void 0 : val.code;
    if (!(val.refresh_token == void 0) && !sdIsString(val.refresh_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"refresh_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.assertion == void 0) && !sdIsString(val.assertion)) {
        throw new BoxSdkError({ message: "Expecting string for \"assertion\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.subject_token == void 0) && !sdIsString(val.subject_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"subject_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.actor_token == void 0) && !sdIsString(val.actor_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"actor_token\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.scope == void 0) && !sdIsString(val.scope)) {
        throw new BoxSdkError({ message: "Expecting string for \"scope\" of type \"PostOAuth2Token\"" });
    }
    const scope: undefined | string = val.scope == void 0 ? void 0 : val.scope;
    if (!(val.resource == void 0) && !sdIsString(val.resource)) {
        throw new BoxSdkError({ message: "Expecting string for \"resource\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.box_subject_id == void 0) && !sdIsString(val.box_subject_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"box_subject_id\" of type \"PostOAuth2Token\"" });
    }
    ...
    if (!(val.box_shared_link == void 0) && !sdIsString(val.box_shared_link)) {
        throw new BoxSdkError({ message: "Expecting string for \"box_shared_link\" of type \"PostOAuth2Token\"" });
    }
