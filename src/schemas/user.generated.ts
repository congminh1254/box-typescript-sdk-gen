...
export function deserializeUserStatusField(val: SerializedData): UserStatusField {
    if (val == "active") {
        return val;
    }
    if (val == "inactive") {
...
export function serializeUserNotificationEmailField(val: UserNotificationEmailField): SerializedData {
    return { ["email"]: val.email, ["is_confirmed"]: val.isConfirmed };
}
export function deserializeUserNotificationEmailField(val: SerializedData): UserNotificationEmailField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"UserNotificationEmailField\"" });
    }
    if (!(val.email == void 0) && !sdIsString(val.email)) {
        throw new BoxSdkError({ message: "Expecting string for \"email\" of type \"UserNotificationEmailField\"" });
    }
    const email: undefined | string = val.email == void 0 ? void 0 : val.email;
    if (!(val.is_confirmed == void 0) && !sdIsBoolean(val.is_confirmed)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_confirmed\" of type \"UserNotificationEmailField\"" });
    }
...
export function serializeUser(val: User): SerializedData {
    ...
    return { ...base, ...{ ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : serializeDateTime(val.modifiedAt), ["language"]: val.language, ["timezone"]: val.timezone, ["space_amount"]: val.spaceAmount, ["space_used"]: val.spaceUsed, ["max_upload_size"]: val.maxUploadSize, ["status"]: val.status == void 0 ? val.status : serializeUserStatusField(val.status), ["job_title"]: val.jobTitle, ["phone"]: val.phone, ["address"]: val.address, ["avatar_url"]: val.avatarUrl, ["notification_email"]: val.notificationEmail == void 0 ? val.notificationEmail : serializeUserNotificationEmailField(val.notificationEmail) } };
}
export function deserializeUser(val: SerializedData): User {
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"User\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"User\"" });
    }
    ...
    if (!(val.language == void 0) && !sdIsString(val.language)) {
        throw new BoxSdkError({ message: "Expecting string for \"language\" of type \"User\"" });
    }
    const language: undefined | string = val.language == void 0 ? void 0 : val.language;
    if (!(val.timezone == void 0) && !sdIsString(val.timezone)) {
        throw new BoxSdkError({ message: "Expecting string for \"timezone\" of type \"User\"" });
    }
    ...
    if (!(val.space_amount == void 0) && !sdIsNumber(val.space_amount)) {
        throw new BoxSdkError({ message: "Expecting number for \"space_amount\" of type \"User\"" });
    }
    ...
    if (!(val.space_used == void 0) && !sdIsNumber(val.space_used)) {
        throw new BoxSdkError({ message: "Expecting number for \"space_used\" of type \"User\"" });
    }
    ...
    if (!(val.max_upload_size == void 0) && !sdIsNumber(val.max_upload_size)) {
        throw new BoxSdkError({ message: "Expecting number for \"max_upload_size\" of type \"User\"" });
    }
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"User\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.login == void 0) && !sdIsString(val.login)) {
        throw new BoxSdkError({ message: "Expecting string for \"login\" of type \"User\"" });
    }
    const login: undefined | string = val.login == void 0 ? void 0 : val.login;
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"User\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"User\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"User\" to be defined" });
    }
