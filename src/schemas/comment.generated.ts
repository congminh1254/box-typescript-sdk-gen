...
export function serializeCommentItemField(val: CommentItemField): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type };
}
export function deserializeCommentItemField(val: SerializedData): CommentItemField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"CommentItemField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"CommentItemField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    if (!(val.type == void 0) && !sdIsString(val.type)) {
        throw new BoxSdkError({ message: "Expecting string for \"type\" of type \"CommentItemField\"" });
    }
...
export function serializeComment(val: Comment): SerializedData {
    ...
    return { ...base, ...{ ["is_reply_comment"]: val.isReplyComment, ["message"]: val.message, ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : serializeDateTime(val.modifiedAt), ["item"]: val.item == void 0 ? val.item : serializeCommentItemField(val.item) } };
}
export function deserializeComment(val: SerializedData): Comment {
    ...
    if (!(val.is_reply_comment == void 0) && !sdIsBoolean(val.is_reply_comment)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_reply_comment\" of type \"Comment\"" });
    }
    const isReplyComment: undefined | boolean = val.is_reply_comment == void 0 ? void 0 : val.is_reply_comment;
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"Comment\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Comment\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"Comment\"" });
    }
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"Comment\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
