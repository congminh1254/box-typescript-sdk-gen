...
export function serializeGroupFullInvitabilityLevelField(val: GroupFullInvitabilityLevelField): SerializedData {
    return val;
}
export function deserializeGroupFullInvitabilityLevelField(val: SerializedData): GroupFullInvitabilityLevelField {
    if (val == "admins_only") {
        return val;
    }
    ...
    throw new BoxSdkError({ message: "Can't deserialize GroupFullInvitabilityLevelField" });
}
export function serializeGroupFullMemberViewabilityLevelField(val: GroupFullMemberViewabilityLevelField): SerializedData {
    return val;
}
export function deserializeGroupFullMemberViewabilityLevelField(val: SerializedData): GroupFullMemberViewabilityLevelField {
    if (val == "admins_only") {
        return val;
    }
    if (val == "admins_and_members") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GroupFullMemberViewabilityLevelField" });
}
export function serializeGroupFullPermissionsField(val: GroupFullPermissionsField): SerializedData {
    return { ["can_invite_as_collaborator"]: val.canInviteAsCollaborator };
}
export function deserializeGroupFullPermissionsField(val: SerializedData): GroupFullPermissionsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"GroupFullPermissionsField\"" });
    }
    if (!(val.can_invite_as_collaborator == void 0) && !sdIsBoolean(val.can_invite_as_collaborator)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_invite_as_collaborator\" of type \"GroupFullPermissionsField\"" });
    }
...
export function serializeGroupFull(val: GroupFull): SerializedData {
    ...
    return { ...base, ...{ ["provenance"]: val.provenance, ["external_sync_identifier"]: val.externalSyncIdentifier, ["description"]: val.description, ["invitability_level"]: val.invitabilityLevel == void 0 ? val.invitabilityLevel : serializeGroupFullInvitabilityLevelField(val.invitabilityLevel), ["member_viewability_level"]: val.memberViewabilityLevel == void 0 ? val.memberViewabilityLevel : serializeGroupFullMemberViewabilityLevelField(val.memberViewabilityLevel), ["permissions"]: val.permissions == void 0 ? val.permissions : serializeGroupFullPermissionsField(val.permissions) } };
}
export function deserializeGroupFull(val: SerializedData): GroupFull {
    ...
    if (!(val.provenance == void 0) && !sdIsString(val.provenance)) {
        throw new BoxSdkError({ message: "Expecting string for \"provenance\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.external_sync_identifier == void 0) && !sdIsString(val.external_sync_identifier)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_sync_identifier\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"GroupFull\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"GroupFull\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"GroupFull\"" });
    }
    const modifiedAt: undefined | DateTime = val.modified_at == void 0 ? void 0 : deserializeDateTime(val.modified_at);
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"GroupFull\"" });
    }
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"GroupFull\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupFull\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"GroupFull\" to be defined" });
    }
