...
export function serializeSignRequestPrefillTag(val: SignRequestPrefillTag): SerializedData {
    return { ["document_tag_id"]: val.documentTagId, ["text_value"]: val.textValue, ["checkbox_value"]: val.checkboxValue, ["date_value"]: val.dateValue == void 0 ? val.dateValue : serializeDate(val.dateValue) };
}
export function deserializeSignRequestPrefillTag(val: SerializedData): SignRequestPrefillTag {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignRequestPrefillTag\"" });
    }
    if (!(val.document_tag_id == void 0) && !sdIsString(val.document_tag_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"document_tag_id\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.text_value == void 0) && !sdIsString(val.text_value)) {
        throw new BoxSdkError({ message: "Expecting string for \"text_value\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.checkbox_value == void 0) && !sdIsBoolean(val.checkbox_value)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"checkbox_value\" of type \"SignRequestPrefillTag\"" });
    }
    ...
    if (!(val.date_value == void 0) && !sdIsString(val.date_value)) {
        throw new BoxSdkError({ message: "Expecting string for \"date_value\" of type \"SignRequestPrefillTag\"" });
    }
