...
export function serializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField(val: ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField): SerializedData {
    return val;
}
export function deserializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField(val: SerializedData): ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField {
    if (val == "shield_information_barrier_segment") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField" });
}
export function serializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField(val: ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField(val.type) };
}
export function deserializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField(val: SerializedData): ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField = val.type == void 0 ? void 0 : deserializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentTypeField(val.type);
    return { id: id, type: type } satisfies ShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField;
}
export function serializeShieldInformationBarrierSegmentMember(val: ShieldInformationBarrierSegmentMember): SerializedData {
    const base: any = serializeShieldInformationBarrierSegmentMemberMini(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentMember\"" });
    }
    return { ...base, ...{ ["shield_information_barrier"]: val.shieldInformationBarrier == void 0 ? val.shieldInformationBarrier : serializeShieldInformationBarrierBase(val.shieldInformationBarrier), ["shield_information_barrier_segment"]: val.shieldInformationBarrierSegment == void 0 ? val.shieldInformationBarrierSegment : serializeShieldInformationBarrierSegmentMemberShieldInformationBarrierSegmentField(val.shieldInformationBarrierSegment), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserBase(val.createdBy), ["updated_at"]: val.updatedAt == void 0 ? val.updatedAt : serializeDateTime(val.updatedAt), ["updated_by"]: val.updatedBy == void 0 ? val.updatedBy : serializeUserBase(val.updatedBy) } };
}
export function deserializeShieldInformationBarrierSegmentMember(val: SerializedData): ShieldInformationBarrierSegmentMember {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ShieldInformationBarrierSegmentMember\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"ShieldInformationBarrierSegmentMember\"" });
    }
    ...
    if (!(val.updated_at == void 0) && !sdIsString(val.updated_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"updated_at\" of type \"ShieldInformationBarrierSegmentMember\"" });
    }
    const updatedAt: undefined | DateTime = val.updated_at == void 0 ? void 0 : deserializeDateTime(val.updated_at);
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ShieldInformationBarrierSegmentMember\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
