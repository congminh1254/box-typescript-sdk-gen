...
export function serializeAiAsk(val: AiAsk): SerializedData {
    return { ["mode"]: serializeAiAskModeField(val.mode), ["prompt"]: val.prompt, ["items"]: val.items.map(function (item: AiItemBase): SerializedData {
        ...
        }) as readonly any[], ["include_citations"]: val.includeCitations, ["ai_agent"]: val.aiAgent == void 0 ? val.aiAgent : serializeAiAgentAsk(val.aiAgent) };
}
export function deserializeAiAsk(val: SerializedData): AiAsk {
    ...
    const aiAgent: undefined | AiAgentAsk = val.ai_agent == void 0 ? void 0 : deserializeAiAgentAsk(val.ai_agent);
