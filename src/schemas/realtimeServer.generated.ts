...
export function deserializeRealtimeServer(val: SerializedData): RealtimeServer {
    ...
    if (!(val.type == void 0) && !sdIsString(val.type)) {
        throw new BoxSdkError({ message: "Expecting string for \"type\" of type \"RealtimeServer\"" });
    }
    const type: undefined | string = val.type == void 0 ? void 0 : val.type;
    if (!(val.url == void 0) && !sdIsString(val.url)) {
        throw new BoxSdkError({ message: "Expecting string for \"url\" of type \"RealtimeServer\"" });
    }
    const url: undefined | string = val.url == void 0 ? void 0 : val.url;
    if (!(val.ttl == void 0) && !sdIsString(val.ttl)) {
        throw new BoxSdkError({ message: "Expecting string for \"ttl\" of type \"RealtimeServer\"" });
    }
    const ttl: undefined | string = val.ttl == void 0 ? void 0 : val.ttl;
    if (!(val.max_retries == void 0) && !sdIsString(val.max_retries)) {
        throw new BoxSdkError({ message: "Expecting string for \"max_retries\" of type \"RealtimeServer\"" });
    }
    const maxRetries: undefined | string = val.max_retries == void 0 ? void 0 : val.max_retries;
    if (!(val.retry_timeout == void 0) && !sdIsNumber(val.retry_timeout)) {
        throw new BoxSdkError({ message: "Expecting number for \"retry_timeout\" of type \"RealtimeServer\"" });
    }
