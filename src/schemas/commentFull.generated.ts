...
export function deserializeCommentFull(val: SerializedData): CommentFull {
    ...
    if (!(val.tagged_message == void 0) && !sdIsString(val.tagged_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"tagged_message\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.is_reply_comment == void 0) && !sdIsBoolean(val.is_reply_comment)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_reply_comment\" of type \"CommentFull\"" });
    }
    const isReplyComment: undefined | boolean = val.is_reply_comment == void 0 ? void 0 : val.is_reply_comment;
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"CommentFull\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"CommentFull\"" });
    }
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"CommentFull\"" });
    }
