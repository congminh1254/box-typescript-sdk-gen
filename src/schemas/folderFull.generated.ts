...
export class FolderFull extends Folder {
    ...
    constructor(fields: FolderFull) {
        ...
        if (fields.isCollaborationRestrictedToEnterprise !== undefined) {
            this.isCollaborationRestrictedToEnterprise = fields.isCollaborationRestrictedToEnterprise;
        }
...
export function serializeFolderFullSyncStateField(val: FolderFullSyncStateField): SerializedData {
    return val;
}
export function deserializeFolderFullSyncStateField(val: SerializedData): FolderFullSyncStateField {
    if (val == "synced") {
        return val;
    }
    if (val == "not_synced") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FolderFullSyncStateField" });
}
export function serializeFolderFullPermissionsField(val: FolderFullPermissionsField): SerializedData {
...
export function deserializeFolderFullPermissionsField(val: SerializedData): FolderFullPermissionsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FolderFullPermissionsField\"" });
    }
    if (val.can_delete == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_delete\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_delete)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_delete\" of type \"FolderFullPermissionsField\"" });
    }
    const canDelete: boolean = val.can_delete;
    if (val.can_download == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_download\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_download)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_download\" of type \"FolderFullPermissionsField\"" });
    }
    const canDownload: boolean = val.can_download;
    if (val.can_invite_collaborator == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_invite_collaborator\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_invite_collaborator)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_invite_collaborator\" of type \"FolderFullPermissionsField\"" });
    }
    const canInviteCollaborator: boolean = val.can_invite_collaborator;
    if (val.can_rename == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_rename\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_rename)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_rename\" of type \"FolderFullPermissionsField\"" });
    }
    const canRename: boolean = val.can_rename;
    if (val.can_set_share_access == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_set_share_access\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_set_share_access)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_set_share_access\" of type \"FolderFullPermissionsField\"" });
    }
    const canSetShareAccess: boolean = val.can_set_share_access;
    if (val.can_share == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_share\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_share)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_share\" of type \"FolderFullPermissionsField\"" });
    }
    const canShare: boolean = val.can_share;
    if (val.can_upload == void 0) {
        throw new BoxSdkError({ message: "Expecting \"can_upload\" of type \"FolderFullPermissionsField\" to be defined" });
    }
    if (!sdIsBoolean(val.can_upload)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_upload\" of type \"FolderFullPermissionsField\"" });
    }
...
export function serializeFolderFullMetadataField(val: FolderFullMetadataField): SerializedData {
    return { ...{}, ...val.extraData };
}
export function deserializeFolderFullMetadataField(val: SerializedData): FolderFullMetadataField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FolderFullMetadataField\"" });
    }
    if (!(val == void 0) && !sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting object for \"extraData\" of type \"FolderFullMetadataField\"" });
    }
...
export function serializeFolderFullAllowedSharedLinkAccessLevelsField(val: FolderFullAllowedSharedLinkAccessLevelsField): SerializedData {
    return val;
}
export function deserializeFolderFullAllowedSharedLinkAccessLevelsField(val: SerializedData): FolderFullAllowedSharedLinkAccessLevelsField {
    if (val == "open") {
        return val;
    }
    if (val == "company") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FolderFullAllowedSharedLinkAccessLevelsField" });
}
export function serializeFolderFullAllowedInviteeRolesField(val: FolderFullAllowedInviteeRolesField): SerializedData {
    return val;
}
export function deserializeFolderFullAllowedInviteeRolesField(val: SerializedData): FolderFullAllowedInviteeRolesField {
    if (val == "editor") {
        return val;
    }
    if (val == "viewer") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FolderFullAllowedInviteeRolesField" });
}
export function serializeFolderFullWatermarkInfoField(val: FolderFullWatermarkInfoField): SerializedData {
    return { ["is_watermarked"]: val.isWatermarked };
}
export function deserializeFolderFullWatermarkInfoField(val: SerializedData): FolderFullWatermarkInfoField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FolderFullWatermarkInfoField\"" });
    }
    if (!(val.is_watermarked == void 0) && !sdIsBoolean(val.is_watermarked)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_watermarked\" of type \"FolderFullWatermarkInfoField\"" });
    }
...
export function serializeFolderFullClassificationField(val: FolderFullClassificationField): SerializedData {
    return { ["name"]: val.name, ["definition"]: val.definition, ["color"]: val.color };
}
export function deserializeFolderFullClassificationField(val: SerializedData): FolderFullClassificationField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FolderFullClassificationField\"" });
    }
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"FolderFullClassificationField\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.definition == void 0) && !sdIsString(val.definition)) {
        throw new BoxSdkError({ message: "Expecting string for \"definition\" of type \"FolderFullClassificationField\"" });
    }
    const definition: undefined | string = val.definition == void 0 ? void 0 : val.definition;
    if (!(val.color == void 0) && !sdIsString(val.color)) {
        throw new BoxSdkError({ message: "Expecting string for \"color\" of type \"FolderFullClassificationField\"" });
    }
...
export function serializeFolderFull(val: FolderFull): SerializedData {
    ...
    return { ...base, ...{ ["sync_state"]: val.syncState == void 0 ? val.syncState : serializeFolderFullSyncStateField(val.syncState), ["has_collaborations"]: val.hasCollaborations, ["permissions"]: val.permissions == void 0 ? val.permissions : serializeFolderFullPermissionsField(val.permissions), ["tags"]: val.tags == void 0 ? val.tags : val.tags.map(function (item: string): SerializedData {
                return item;
            }) as readonly any[], ["can_non_owners_invite"]: val.canNonOwnersInvite, ["is_externally_owned"]: val.isExternallyOwned, ["metadata"]: val.metadata == void 0 ? val.metadata : serializeFolderFullMetadataField(val.metadata), ["is_collaboration_restricted_to_enterprise"]: val.isCollaborationRestrictedToEnterprise, ["allowed_shared_link_access_levels"]: val.allowedSharedLinkAccessLevels == void 0 ? val.allowedSharedLinkAccessLevels : val.allowedSharedLinkAccessLevels.map(function (item: FolderFullAllowedSharedLinkAccessLevelsField): SerializedData {
                return serializeFolderFullAllowedSharedLinkAccessLevelsField(item);
            }) as readonly any[], ["allowed_invitee_roles"]: val.allowedInviteeRoles == void 0 ? val.allowedInviteeRoles : val.allowedInviteeRoles.map(function (item: FolderFullAllowedInviteeRolesField): SerializedData {
                return serializeFolderFullAllowedInviteeRolesField(item);
            }) as readonly any[], ["watermark_info"]: val.watermarkInfo == void 0 ? val.watermarkInfo : serializeFolderFullWatermarkInfoField(val.watermarkInfo), ["is_accessible_via_shared_link"]: val.isAccessibleViaSharedLink, ["can_non_owners_view_collaborators"]: val.canNonOwnersViewCollaborators, ["classification"]: val.classification == void 0 ? val.classification : serializeFolderFullClassificationField(val.classification), ["is_associated_with_app_item"]: val.isAssociatedWithAppItem } };
}
export function deserializeFolderFull(val: SerializedData): FolderFull {
    ...
    if (!(val.has_collaborations == void 0) && !sdIsBoolean(val.has_collaborations)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"has_collaborations\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.tags == void 0) && !sdIsList(val.tags)) {
        throw new BoxSdkError({ message: "Expecting array for \"tags\" of type \"FolderFull\"" });
    }
    const tags: undefined | readonly string[] = val.tags == void 0 ? void 0 : sdIsList(val.tags) ? val.tags.map(function (itm: SerializedData): string {
        if (!sdIsString(itm)) {
            throw new BoxSdkError({ message: "Expecting string for \"FolderFull\"" });
        }
        return itm;
    }) as readonly any[] : [];
    if (!(val.can_non_owners_invite == void 0) && !sdIsBoolean(val.can_non_owners_invite)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_non_owners_invite\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.is_externally_owned == void 0) && !sdIsBoolean(val.is_externally_owned)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_externally_owned\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.is_collaboration_restricted_to_enterprise == void 0) && !sdIsBoolean(val.is_collaboration_restricted_to_enterprise)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_collaboration_restricted_to_enterprise\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.allowed_shared_link_access_levels == void 0) && !sdIsList(val.allowed_shared_link_access_levels)) {
        throw new BoxSdkError({ message: "Expecting array for \"allowed_shared_link_access_levels\" of type \"FolderFull\"" });
    }
    const allowedSharedLinkAccessLevels: undefined | readonly FolderFullAllowedSharedLinkAccessLevelsField[] = val.allowed_shared_link_access_levels == void 0 ? void 0 : sdIsList(val.allowed_shared_link_access_levels) ? val.allowed_shared_link_access_levels.map(function (itm: SerializedData): FolderFullAllowedSharedLinkAccessLevelsField {
    ...
    if (!(val.allowed_invitee_roles == void 0) && !sdIsList(val.allowed_invitee_roles)) {
        throw new BoxSdkError({ message: "Expecting array for \"allowed_invitee_roles\" of type \"FolderFull\"" });
    }
    const allowedInviteeRoles: undefined | readonly FolderFullAllowedInviteeRolesField[] = val.allowed_invitee_roles == void 0 ? void 0 : sdIsList(val.allowed_invitee_roles) ? val.allowed_invitee_roles.map(function (itm: SerializedData): FolderFullAllowedInviteeRolesField {
    ...
    if (!(val.is_accessible_via_shared_link == void 0) && !sdIsBoolean(val.is_accessible_via_shared_link)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_accessible_via_shared_link\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.can_non_owners_view_collaborators == void 0) && !sdIsBoolean(val.can_non_owners_view_collaborators)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"can_non_owners_view_collaborators\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.is_associated_with_app_item == void 0) && !sdIsBoolean(val.is_associated_with_app_item)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_associated_with_app_item\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !sdIsString(val.trashed_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.purged_at == void 0) && !sdIsString(val.purged_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.content_created_at == void 0) && !sdIsString(val.content_created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_created_at\" of type \"FolderFull\"" });
    }
    ...
    if (!(val.content_modified_at == void 0) && !sdIsString(val.content_modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_modified_at\" of type \"FolderFull\"" });
    }
