...
export function serializeSignRequestCreateRequestSignatureColorField(val: SignRequestCreateRequestSignatureColorField): SerializedData {
    return val;
}
export function deserializeSignRequestCreateRequestSignatureColorField(val: SerializedData): SignRequestCreateRequestSignatureColorField {
    if (val == "blue") {
        return val;
    }
    if (val == "black") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SignRequestCreateRequestSignatureColorField" });
}
export function serializeSignRequestCreateRequest(val: SignRequestCreateRequest): SerializedData {
    const base: any = serializeSignRequestBase(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignRequestCreateRequest\"" });
    }
    return { ...base, ...{ ["source_files"]: val.sourceFiles == void 0 ? val.sourceFiles : val.sourceFiles.map(function (item: FileBase): SerializedData {
                return serializeFileBase(item);
            }) as readonly any[], ["signature_color"]: val.signatureColor == void 0 ? val.signatureColor : serializeSignRequestCreateRequestSignatureColorField(val.signatureColor), ["signers"]: val.signers.map(function (item: SignRequestCreateSigner): SerializedData {
                return serializeSignRequestCreateSigner(item);
            }) as readonly any[], ["parent_folder"]: val.parentFolder == void 0 ? val.parentFolder : serializeFolderMini(val.parentFolder) } };
}
export function deserializeSignRequestCreateRequest(val: SerializedData): SignRequestCreateRequest {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignRequestCreateRequest\"" });
    }
    if (!(val.source_files == void 0) && !sdIsList(val.source_files)) {
        throw new BoxSdkError({ message: "Expecting array for \"source_files\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (val.signers == void 0) {
        throw new BoxSdkError({ message: "Expecting \"signers\" of type \"SignRequestCreateRequest\" to be defined" });
    }
    if (!sdIsList(val.signers)) {
        throw new BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignRequestCreateRequest\"" });
    }
    const signers: readonly SignRequestCreateSigner[] = sdIsList(val.signers) ? val.signers.map(function (itm: SerializedData): SignRequestCreateSigner {
    ...
    if (!(val.is_document_preparation_needed == void 0) && !sdIsBoolean(val.is_document_preparation_needed)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_document_preparation_needed\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.redirect_url == void 0) && !sdIsString(val.redirect_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"redirect_url\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.declined_redirect_url == void 0) && !sdIsString(val.declined_redirect_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"declined_redirect_url\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.are_text_signatures_enabled == void 0) && !sdIsBoolean(val.are_text_signatures_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_text_signatures_enabled\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.email_subject == void 0) && !sdIsString(val.email_subject)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_subject\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.email_message == void 0) && !sdIsString(val.email_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_message\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.are_reminders_enabled == void 0) && !sdIsBoolean(val.are_reminders_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_reminders_enabled\" of type \"SignRequestCreateRequest\"" });
    }
    const areRemindersEnabled: undefined | boolean = val.are_reminders_enabled == void 0 ? void 0 : val.are_reminders_enabled;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"SignRequestCreateRequest\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.prefill_tags == void 0) && !sdIsList(val.prefill_tags)) {
        throw new BoxSdkError({ message: "Expecting array for \"prefill_tags\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.days_valid == void 0) && !sdIsNumber(val.days_valid)) {
        throw new BoxSdkError({ message: "Expecting number for \"days_valid\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.external_id == void 0) && !sdIsString(val.external_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_id\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.template_id == void 0) && !sdIsString(val.template_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"template_id\" of type \"SignRequestCreateRequest\"" });
    }
    ...
    if (!(val.external_system_name == void 0) && !sdIsString(val.external_system_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_system_name\" of type \"SignRequestCreateRequest\"" });
    }
