...
export function serializeDevicePinnerTypeField(val: DevicePinnerTypeField): SerializedData {
    return val;
}
export function deserializeDevicePinnerTypeField(val: SerializedData): DevicePinnerTypeField {
...
export function serializeDevicePinner(val: DevicePinner): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeDevicePinnerTypeField(val.type), ["owned_by"]: val.ownedBy == void 0 ? val.ownedBy : serializeUserMini(val.ownedBy), ["product_name"]: val.productName };
}
export function deserializeDevicePinner(val: SerializedData): DevicePinner {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"DevicePinner\"" });
    }
    ...
    if (!(val.product_name == void 0) && !sdIsString(val.product_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"product_name\" of type \"DevicePinner\"" });
    }
