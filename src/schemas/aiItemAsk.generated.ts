...
export function serializeAiItemAskTypeField(val: AiItemAskTypeField): SerializedData {
    return val;
}
export function deserializeAiItemAskTypeField(val: SerializedData): AiItemAskTypeField {
    if (val == "file") {
        return val;
    }
    if (val == "hubs") {
...
export function serializeAiItemAsk(val: AiItemAsk): SerializedData {
    return { ["id"]: val.id, ["type"]: serializeAiItemAskTypeField(val.type), ["content"]: val.content };
}
export function deserializeAiItemAsk(val: SerializedData): AiItemAsk {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"AiItemAsk\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"AiItemAsk\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"AiItemAsk\" to be defined" });
    }
    const type: AiItemAskTypeField = deserializeAiItemAskTypeField(val.type);
    if (!(val.content == void 0) && !sdIsString(val.content)) {
        throw new BoxSdkError({ message: "Expecting string for \"content\" of type \"AiItemAsk\"" });
    }
