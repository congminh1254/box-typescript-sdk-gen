...
export function serializeWorkflowMiniTypeField(val: WorkflowMiniTypeField): SerializedData {
    return val;
}
export function deserializeWorkflowMiniTypeField(val: SerializedData): WorkflowMiniTypeField {
    if (val == "workflow") {
        return val;
    }
...
export function serializeWorkflowMini(val: WorkflowMini): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeWorkflowMiniTypeField(val.type), ["name"]: val.name, ["description"]: val.description, ["is_enabled"]: val.isEnabled };
}
export function deserializeWorkflowMini(val: SerializedData): WorkflowMini {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"WorkflowMini\"" });
    }
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"WorkflowMini\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"WorkflowMini\"" });
    }
    ...
    if (!(val.is_enabled == void 0) && !sdIsBoolean(val.is_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_enabled\" of type \"WorkflowMini\"" });
    }
