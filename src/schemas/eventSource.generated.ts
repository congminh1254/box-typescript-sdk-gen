...
export function serializeEventSourceItemTypeField(val: EventSourceItemTypeField): SerializedData {
    return val;
}
export function deserializeEventSourceItemTypeField(val: SerializedData): EventSourceItemTypeField {
    if (val == "file") {
        return val;
    }
    if (val == "folder") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize EventSourceItemTypeField" });
}
export function serializeEventSourceClassificationField(val: EventSourceClassificationField): SerializedData {
    return { ["name"]: val.name };
}
export function deserializeEventSourceClassificationField(val: SerializedData): EventSourceClassificationField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"EventSourceClassificationField\"" });
    }
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"EventSourceClassificationField\"" });
    }
...
export function serializeEventSource(val: EventSource): SerializedData {
    return { ["item_type"]: serializeEventSourceItemTypeField(val.itemType), ["item_id"]: val.itemId, ["item_name"]: val.itemName, ["classification"]: val.classification == void 0 ? val.classification : serializeEventSourceClassificationField(val.classification), ["parent"]: val.parent == void 0 ? val.parent : serializeFolderMini(val.parent), ["owned_by"]: val.ownedBy == void 0 ? val.ownedBy : serializeUserMini(val.ownedBy) };
}
export function deserializeEventSource(val: SerializedData): EventSource {
    ...
    if (val.item_type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"item_type\" of type \"EventSource\" to be defined" });
    }
    const itemType: EventSourceItemTypeField = deserializeEventSourceItemTypeField(val.item_type);
    if (val.item_id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"item_id\" of type \"EventSource\" to be defined" });
    }
    if (!sdIsString(val.item_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"item_id\" of type \"EventSource\"" });
    }
    const itemId: string = val.item_id;
    if (val.item_name == void 0) {
        throw new BoxSdkError({ message: "Expecting \"item_name\" of type \"EventSource\" to be defined" });
    }
    if (!sdIsString(val.item_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"item_name\" of type \"EventSource\"" });
    }
