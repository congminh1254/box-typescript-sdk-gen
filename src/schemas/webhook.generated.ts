...
export function serializeWebhookTriggersField(val: WebhookTriggersField): SerializedData {
    return val;
}
export function deserializeWebhookTriggersField(val: SerializedData): WebhookTriggersField {
...
export function serializeWebhook(val: Webhook): SerializedData {
    ...
    return { ...base, ...{ ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["address"]: val.address, ["triggers"]: val.triggers == void 0 ? val.triggers : val.triggers.map(function (item: WebhookTriggersField): SerializedData {
...
export function deserializeWebhook(val: SerializedData): Webhook {
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Webhook\"" });
    }
    ...
    if (!(val.address == void 0) && !sdIsString(val.address)) {
        throw new BoxSdkError({ message: "Expecting string for \"address\" of type \"Webhook\"" });
    }
    const address: undefined | string = val.address == void 0 ? void 0 : val.address;
    if (!(val.triggers == void 0) && !sdIsList(val.triggers)) {
        throw new BoxSdkError({ message: "Expecting array for \"triggers\" of type \"Webhook\"" });
    }
    const triggers: undefined | readonly WebhookTriggersField[] = val.triggers == void 0 ? void 0 : sdIsList(val.triggers) ? val.triggers.map(function (itm: SerializedData): WebhookTriggersField {
        return deserializeWebhookTriggersField(itm);
    }) as readonly any[] : [];
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"Webhook\"" });
    }
