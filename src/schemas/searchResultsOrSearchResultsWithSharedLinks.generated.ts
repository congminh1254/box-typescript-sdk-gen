...
export function serializeSearchResultsOrSearchResultsWithSharedLinks(val: any): SerializedData {
...
export function deserializeSearchResultsOrSearchResultsWithSharedLinks(val: SerializedData): SearchResultsOrSearchResultsWithSharedLinks {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SearchResultsOrSearchResultsWithSharedLinks\"" });
    }
    if (val.type == "search_results_items") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SearchResultsOrSearchResultsWithSharedLinks" });
}
