...
export function serializeZipDownloadNameConflictsTypeField(val: ZipDownloadNameConflictsTypeField): SerializedData {
    return val;
}
export function deserializeZipDownloadNameConflictsTypeField(val: SerializedData): ZipDownloadNameConflictsTypeField {
    if (val == "file") {
        return val;
    }
    if (val == "folder") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize ZipDownloadNameConflictsTypeField" });
}
export function serializeZipDownloadNameConflictsField(val: ZipDownloadNameConflictsField): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeZipDownloadNameConflictsTypeField(val.type), ["original_name"]: val.originalName, ["download_name"]: val.downloadName };
}
export function deserializeZipDownloadNameConflictsField(val: SerializedData): ZipDownloadNameConflictsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ZipDownloadNameConflictsField\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"ZipDownloadNameConflictsField\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    const type: undefined | ZipDownloadNameConflictsTypeField = val.type == void 0 ? void 0 : deserializeZipDownloadNameConflictsTypeField(val.type);
    if (!(val.original_name == void 0) && !sdIsString(val.original_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"original_name\" of type \"ZipDownloadNameConflictsField\"" });
    }
    ...
    if (!(val.download_name == void 0) && !sdIsString(val.download_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"download_name\" of type \"ZipDownloadNameConflictsField\"" });
    }
...
export function serializeZipDownload(val: ZipDownload): SerializedData {
    return { ["download_url"]: val.downloadUrl, ["status_url"]: val.statusUrl, ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : serializeDateTime(val.expiresAt), ["name_conflicts"]: val.nameConflicts == void 0 ? val.nameConflicts : val.nameConflicts.map(function (item: readonly ZipDownloadNameConflictsField[]): SerializedData {
            return item.map(function (item: ZipDownloadNameConflictsField): SerializedData {
...
export function deserializeZipDownload(val: SerializedData): ZipDownload {
    ...
    if (!(val.download_url == void 0) && !sdIsString(val.download_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"download_url\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.status_url == void 0) && !sdIsString(val.status_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"status_url\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.expires_at == void 0) && !sdIsString(val.expires_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"ZipDownload\"" });
    }
    ...
    if (!(val.name_conflicts == void 0) && !sdIsList(val.name_conflicts)) {
        throw new BoxSdkError({ message: "Expecting array for \"name_conflicts\" of type \"ZipDownload\"" });
    }
    const nameConflicts: undefined | readonly (readonly ZipDownloadNameConflictsField[])[] = val.name_conflicts == void 0 ? void 0 : sdIsList(val.name_conflicts) ? val.name_conflicts.map(function (itm: SerializedData): readonly ZipDownloadNameConflictsField[] {
        return sdIsList(itm) ? itm.map(function (itm: SerializedData): ZipDownloadNameConflictsField {
