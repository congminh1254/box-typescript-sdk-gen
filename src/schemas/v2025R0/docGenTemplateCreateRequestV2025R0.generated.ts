...
export function serializeDocGenTemplateCreateRequestV2025R0(val: DocGenTemplateCreateRequestV2025R0): SerializedData {
    return { ["file"]: serializeFileReferenceV2025R0(val.file) };
}
export function deserializeDocGenTemplateCreateRequestV2025R0(val: SerializedData): DocGenTemplateCreateRequestV2025R0 {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"DocGenTemplateCreateRequestV2025R0\"" });
    }
    if (val.file == void 0) {
        throw new BoxSdkError({ message: "Expecting \"file\" of type \"DocGenTemplateCreateRequestV2025R0\" to be defined" });
    }
