...
export function serializeAiAgentBasicGenTool(val: AiAgentBasicGenTool): SerializedData {
    const base: any = serializeAiAgentLongTextToolTextGen(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiAgentBasicGenTool\"" });
    }
    return { ...base, ...{ ["content_template"]: val.contentTemplate } };
}
export function deserializeAiAgentBasicGenTool(val: SerializedData): AiAgentBasicGenTool {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiAgentBasicGenTool\"" });
    }
    if (!(val.content_template == void 0) && !sdIsString(val.content_template)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_template\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.system_message == void 0) && !sdIsString(val.system_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"system_message\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.prompt_template == void 0) && !sdIsString(val.prompt_template)) {
        throw new BoxSdkError({ message: "Expecting string for \"prompt_template\" of type \"AiAgentBasicGenTool\"" });
    }
    const promptTemplate: undefined | string = val.prompt_template == void 0 ? void 0 : val.prompt_template;
    if (!(val.model == void 0) && !sdIsString(val.model)) {
        throw new BoxSdkError({ message: "Expecting string for \"model\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    if (!(val.num_tokens_for_completion == void 0) && !sdIsNumber(val.num_tokens_for_completion)) {
        throw new BoxSdkError({ message: "Expecting number for \"num_tokens_for_completion\" of type \"AiAgentBasicGenTool\"" });
    }
    ...
    return { contentTemplate: contentTemplate, embeddings: embeddings, systemMessage: systemMessage, promptTemplate: promptTemplate, model: model, numTokensForCompletion: numTokensForCompletion, llmEndpointParams: llmEndpointParams } satisfies AiAgentBasicGenTool;
}
