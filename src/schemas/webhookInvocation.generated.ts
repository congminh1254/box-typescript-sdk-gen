...
export function serializeWebhookInvocationTypeField(val: WebhookInvocationTypeField): SerializedData {
    return val;
}
export function deserializeWebhookInvocationTypeField(val: SerializedData): WebhookInvocationTypeField {
    if (val == "webhook_event") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize WebhookInvocationTypeField" });
}
export function serializeWebhookInvocationTriggerField(val: WebhookInvocationTriggerField): SerializedData {
    return val;
}
export function deserializeWebhookInvocationTriggerField(val: SerializedData): WebhookInvocationTriggerField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize WebhookInvocationTriggerField" });
}
export function serializeWebhookInvocation(val: WebhookInvocation): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeWebhookInvocationTypeField(val.type), ["webhook"]: val.webhook == void 0 ? val.webhook : serializeWebhook(val.webhook), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["trigger"]: val.trigger == void 0 ? val.trigger : serializeWebhookInvocationTriggerField(val.trigger), ["source"]: val.source == void 0 ? val.source : serializeFileOrFolder(val.source) };
}
export function deserializeWebhookInvocation(val: SerializedData): WebhookInvocation {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"WebhookInvocation\"" });
    }
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"WebhookInvocation\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"WebhookInvocation\"" });
    }
