...
export function serializeFileBaseTypeField(val: FileBaseTypeField): SerializedData {
    return val;
}
export function deserializeFileBaseTypeField(val: SerializedData): FileBaseTypeField {
    if (val == "file") {
        return val;
    }
...
export function deserializeFileBase(val: SerializedData): FileBase {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"FileBase\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FileBase\"" });
    }
    const id: string = val.id;
    if (!(val.etag == void 0) && !sdIsString(val.etag)) {
        throw new BoxSdkError({ message: "Expecting string for \"etag\" of type \"FileBase\"" });
    }
    const etag: undefined | string = val.etag == void 0 ? void 0 : val.etag;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"FileBase\" to be defined" });
    }
...
export function serializeFileBaseInput(val: FileBaseInput): SerializedData {
    return { ["id"]: val.id, ["etag"]: val.etag, ["type"]: val.type == void 0 ? val.type : serializeFileBaseTypeField(val.type) };
}
export function deserializeFileBaseInput(val: SerializedData): FileBaseInput {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"FileBaseInput\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FileBaseInput\"" });
    }
    const id: string = val.id;
    if (!(val.etag == void 0) && !sdIsString(val.etag)) {
        throw new BoxSdkError({ message: "Expecting string for \"etag\" of type \"FileBaseInput\"" });
    }
    const etag: undefined | string = val.etag == void 0 ? void 0 : val.etag;
    const type: undefined | FileBaseTypeField = val.type == void 0 ? void 0 : deserializeFileBaseTypeField(val.type);
