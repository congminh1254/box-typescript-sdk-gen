...
export function serializeAiAgentAskTypeField(val: AiAgentAskTypeField): SerializedData {
    return val;
}
export function deserializeAiAgentAskTypeField(val: SerializedData): AiAgentAskTypeField {
    if (val == "ai_agent_ask") {
        return val;
    }
...
export function serializeAiAgentAsk(val: AiAgentAsk): SerializedData {
    return { ["type"]: serializeAiAgentAskTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : serializeAiAgentLongTextTool(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : serializeAiAgentBasicTextTool(val.basicText), ["long_text_multi"]: val.longTextMulti == void 0 ? val.longTextMulti : serializeAiAgentLongTextTool(val.longTextMulti), ["basic_text_multi"]: val.basicTextMulti == void 0 ? val.basicTextMulti : serializeAiAgentBasicTextTool(val.basicTextMulti) };
}
export function deserializeAiAgentAsk(val: SerializedData): AiAgentAsk {
    ...
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"AiAgentAsk\" to be defined" });
    }
    ...
    const longTextMulti: undefined | AiAgentLongTextTool = val.long_text_multi == void 0 ? void 0 : deserializeAiAgentLongTextTool(val.long_text_multi);
    const basicTextMulti: undefined | AiAgentBasicTextTool = val.basic_text_multi == void 0 ? void 0 : deserializeAiAgentBasicTextTool(val.basic_text_multi);
    return { type: type, longText: longText, basicText: basicText, longTextMulti: longTextMulti, basicTextMulti: basicTextMulti } satisfies AiAgentAsk;
}
export function serializeAiAgentAskInput(val: AiAgentAskInput): SerializedData {
    return { ["type"]: val.type == void 0 ? val.type : serializeAiAgentAskTypeField(val.type), ["long_text"]: val.longText == void 0 ? val.longText : serializeAiAgentLongTextTool(val.longText), ["basic_text"]: val.basicText == void 0 ? val.basicText : serializeAiAgentBasicTextTool(val.basicText), ["long_text_multi"]: val.longTextMulti == void 0 ? val.longTextMulti : serializeAiAgentLongTextTool(val.longTextMulti), ["basic_text_multi"]: val.basicTextMulti == void 0 ? val.basicTextMulti : serializeAiAgentBasicTextTool(val.basicTextMulti) };
}
export function deserializeAiAgentAskInput(val: SerializedData): AiAgentAskInput {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiAgentAskInput\"" });
    }
    const type: undefined | AiAgentAskTypeField = val.type == void 0 ? void 0 : deserializeAiAgentAskTypeField(val.type);
    const longText: undefined | AiAgentLongTextTool = val.long_text == void 0 ? void 0 : deserializeAiAgentLongTextTool(val.long_text);
    const basicText: undefined | AiAgentBasicTextTool = val.basic_text == void 0 ? void 0 : deserializeAiAgentBasicTextTool(val.basic_text);
    const longTextMulti: undefined | AiAgentLongTextTool = val.long_text_multi == void 0 ? void 0 : deserializeAiAgentLongTextTool(val.long_text_multi);
    const basicTextMulti: undefined | AiAgentBasicTextTool = val.basic_text_multi == void 0 ? void 0 : deserializeAiAgentBasicTextTool(val.basic_text_multi);
    return { type: type, longText: longText, basicText: basicText, longTextMulti: longTextMulti, basicTextMulti: basicTextMulti } satisfies AiAgentAskInput;
}
