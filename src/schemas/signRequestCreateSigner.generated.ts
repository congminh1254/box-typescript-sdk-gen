...
export function serializeSignRequestCreateSigner(val: SignRequestCreateSigner): SerializedData {
    return { ["email"]: val.email, ["role"]: val.role == void 0 ? val.role : serializeSignRequestCreateSignerRoleField(val.role), ["is_in_person"]: val.isInPerson, ["order"]: val.order, ["embed_url_external_user_id"]: val.embedUrlExternalUserId, ["redirect_url"]: val.redirectUrl, ["declined_redirect_url"]: val.declinedRedirectUrl, ["login_required"]: val.loginRequired, ["password"]: val.password, ["signer_group_id"]: val.signerGroupId, ["suppress_notifications"]: val.suppressNotifications };
}
