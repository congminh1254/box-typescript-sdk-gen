...
export function serializeClientErrorTypeField(val: ClientErrorTypeField): SerializedData {
    return val;
}
export function deserializeClientErrorTypeField(val: SerializedData): ClientErrorTypeField {
    if (val == "error") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize ClientErrorTypeField" });
}
export function serializeClientErrorCodeField(val: ClientErrorCodeField): SerializedData {
    return val;
}
export function deserializeClientErrorCodeField(val: SerializedData): ClientErrorCodeField {
    if (val == "created") {
        return val;
    }
    if (val == "accepted") {
...
export function serializeClientError(val: ClientError): SerializedData {
    return { ["type"]: val.type == void 0 ? val.type : serializeClientErrorTypeField(val.type), ["status"]: val.status, ["code"]: val.code == void 0 ? val.code : serializeClientErrorCodeField(val.code), ["message"]: val.message, ["context_info"]: val.contextInfo == void 0 ? val.contextInfo : Object.fromEntries(Object.entries(val.contextInfo).map(([k, v]: [
            string,
            any
            ...
            readonly [key: string]: any;
        }, ["help_url"]: val.helpUrl, ["request_id"]: val.requestId };
}
export function deserializeClientError(val: SerializedData): ClientError {
    ...
    if (!(val.status == void 0) && !sdIsNumber(val.status)) {
        throw new BoxSdkError({ message: "Expecting number for \"status\" of type \"ClientError\"" });
    }
    ...
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"ClientError\"" });
    }
    const message: undefined | string = val.message == void 0 ? void 0 : val.message;
    if (!(val.context_info == void 0) && !sdIsMap(val.context_info)) {
        throw new BoxSdkError({ message: "Expecting object for \"context_info\" of type \"ClientError\"" });
    }
    const contextInfo: undefined | {
        readonly [key: string]: any;
    } = val.context_info == void 0 ? void 0 : sdIsMap(val.context_info) ? Object.fromEntries(Object.entries(val.context_info).map(([k, v]: [
        string,
        any
    ]) => [k, function (v: any): any {
            return v;
    ...
    if (!(val.help_url == void 0) && !sdIsString(val.help_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"help_url\" of type \"ClientError\"" });
    }
    const helpUrl: undefined | string = val.help_url == void 0 ? void 0 : val.help_url;
    if (!(val.request_id == void 0) && !sdIsString(val.request_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"request_id\" of type \"ClientError\"" });
    }
