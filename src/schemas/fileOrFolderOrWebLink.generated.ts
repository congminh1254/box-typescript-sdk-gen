...
export function deserializeFileOrFolderOrWebLink(val: SerializedData): FileOrFolderOrWebLink {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileOrFolderOrWebLink\"" });
    }
    if (val.type == "file") {
