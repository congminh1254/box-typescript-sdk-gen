...
export function deserializeUploadPartMini(val: SerializedData): UploadPartMini {
    ...
    if (!(val.part_id == void 0) && !sdIsString(val.part_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"part_id\" of type \"UploadPartMini\"" });
    }
    const partId: undefined | string = val.part_id == void 0 ? void 0 : val.part_id;
    if (!(val.offset == void 0) && !sdIsNumber(val.offset)) {
        throw new BoxSdkError({ message: "Expecting number for \"offset\" of type \"UploadPartMini\"" });
    }
    const offset: undefined | number = val.offset == void 0 ? void 0 : val.offset;
    if (!(val.size == void 0) && !sdIsNumber(val.size)) {
        throw new BoxSdkError({ message: "Expecting number for \"size\" of type \"UploadPartMini\"" });
    }
