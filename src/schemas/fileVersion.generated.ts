...
export function serializeFileVersion(val: FileVersion): SerializedData {
    ...
    return { ...base, ...{ ["name"]: val.name, ["size"]: val.size, ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : serializeDateTime(val.modifiedAt), ["modified_by"]: val.modifiedBy == void 0 ? val.modifiedBy : serializeUserMini(val.modifiedBy), ["trashed_at"]: val.trashedAt == void 0 ? val.trashedAt : serializeDateTime(val.trashedAt), ["trashed_by"]: val.trashedBy == void 0 ? val.trashedBy : serializeUserMini(val.trashedBy), ["restored_at"]: val.restoredAt == void 0 ? val.restoredAt : serializeDateTime(val.restoredAt), ["restored_by"]: val.restoredBy == void 0 ? val.restoredBy : serializeUserMini(val.restoredBy), ["purged_at"]: val.purgedAt == void 0 ? val.purgedAt : serializeDateTime(val.purgedAt), ["uploader_display_name"]: val.uploaderDisplayName } };
}
export function deserializeFileVersion(val: SerializedData): FileVersion {
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"FileVersion\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.size == void 0) && !sdIsNumber(val.size)) {
        throw new BoxSdkError({ message: "Expecting number for \"size\" of type \"FileVersion\"" });
    }
    const size: undefined | number = val.size == void 0 ? void 0 : val.size;
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"FileVersion\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.trashed_at == void 0) && !sdIsString(val.trashed_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"trashed_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.restored_at == void 0) && !sdIsString(val.restored_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"restored_at\" of type \"FileVersion\"" });
    }
    const restoredAt: undefined | DateTime = val.restored_at == void 0 ? void 0 : deserializeDateTime(val.restored_at);
    ...
    if (!(val.purged_at == void 0) && !sdIsString(val.purged_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"purged_at\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.uploader_display_name == void 0) && !sdIsString(val.uploader_display_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"uploader_display_name\" of type \"FileVersion\"" });
    }
    ...
    if (!(val.sha1 == void 0) && !sdIsString(val.sha1)) {
        throw new BoxSdkError({ message: "Expecting string for \"sha1\" of type \"FileVersion\"" });
    }
    const sha1: undefined | string = val.sha1 == void 0 ? void 0 : val.sha1;
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"FileVersion\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FileVersion\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"FileVersion\" to be defined" });
    }
