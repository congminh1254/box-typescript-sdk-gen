...
export function serializeRetentionPolicyPolicyTypeField(val: RetentionPolicyPolicyTypeField): SerializedData {
    return val;
}
export function deserializeRetentionPolicyPolicyTypeField(val: SerializedData): RetentionPolicyPolicyTypeField {
    if (val == "finite") {
        return val;
    }
    if (val == "indefinite") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize RetentionPolicyPolicyTypeField" });
}
export function serializeRetentionPolicyRetentionTypeField(val: RetentionPolicyRetentionTypeField): SerializedData {
    return val;
}
export function deserializeRetentionPolicyRetentionTypeField(val: SerializedData): RetentionPolicyRetentionTypeField {
    if (val == "modifiable") {
        return val;
    }
    ...
    throw new BoxSdkError({ message: "Can't deserialize RetentionPolicyRetentionTypeField" });
}
export function serializeRetentionPolicyStatusField(val: RetentionPolicyStatusField): SerializedData {
    return val;
}
export function deserializeRetentionPolicyStatusField(val: SerializedData): RetentionPolicyStatusField {
    if (val == "active") {
        return val;
    }
    if (val == "retired") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize RetentionPolicyStatusField" });
}
export function serializeRetentionPolicyAssignmentCountsField(val: RetentionPolicyAssignmentCountsField): SerializedData {
    return { ["enterprise"]: val.enterprise, ["folder"]: val.folder, ["metadata_template"]: val.metadataTemplate };
}
export function deserializeRetentionPolicyAssignmentCountsField(val: SerializedData): RetentionPolicyAssignmentCountsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RetentionPolicyAssignmentCountsField\"" });
    }
    if (!(val.enterprise == void 0) && !sdIsNumber(val.enterprise)) {
        throw new BoxSdkError({ message: "Expecting number for \"enterprise\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
    const enterprise: undefined | number = val.enterprise == void 0 ? void 0 : val.enterprise;
    if (!(val.folder == void 0) && !sdIsNumber(val.folder)) {
        throw new BoxSdkError({ message: "Expecting number for \"folder\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
    const folder: undefined | number = val.folder == void 0 ? void 0 : val.folder;
    if (!(val.metadata_template == void 0) && !sdIsNumber(val.metadata_template)) {
        throw new BoxSdkError({ message: "Expecting number for \"metadata_template\" of type \"RetentionPolicyAssignmentCountsField\"" });
    }
...
export function serializeRetentionPolicy(val: RetentionPolicy): SerializedData {
    ...
    return { ...base, ...{ ["description"]: val.description, ["policy_type"]: val.policyType == void 0 ? val.policyType : serializeRetentionPolicyPolicyTypeField(val.policyType), ["retention_type"]: val.retentionType == void 0 ? val.retentionType : serializeRetentionPolicyRetentionTypeField(val.retentionType), ["status"]: val.status == void 0 ? val.status : serializeRetentionPolicyStatusField(val.status), ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["modified_at"]: val.modifiedAt == void 0 ? val.modifiedAt : serializeDateTime(val.modifiedAt), ["can_owner_extend_retention"]: val.canOwnerExtendRetention, ["are_owners_notified"]: val.areOwnersNotified, ["custom_notification_recipients"]: val.customNotificationRecipients == void 0 ? val.customNotificationRecipients : val.customNotificationRecipients.map(function (item: UserMini): SerializedData {
                return serializeUserMini(item);
            }) as readonly any[], ["assignment_counts"]: val.assignmentCounts == void 0 ? val.assignmentCounts : serializeRetentionPolicyAssignmentCountsField(val.assignmentCounts) } };
}
export function deserializeRetentionPolicy(val: SerializedData): RetentionPolicy {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"RetentionPolicy\"" });
    }
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"RetentionPolicy\"" });
    }
    const createdAt: undefined | DateTime = val.created_at == void 0 ? void 0 : deserializeDateTime(val.created_at);
    if (!(val.modified_at == void 0) && !sdIsString(val.modified_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"modified_at\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.are_owners_notified == void 0) && !sdIsBoolean(val.are_owners_notified)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_owners_notified\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.custom_notification_recipients == void 0) && !sdIsList(val.custom_notification_recipients)) {
        throw new BoxSdkError({ message: "Expecting array for \"custom_notification_recipients\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.policy_name == void 0) && !sdIsString(val.policy_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"policy_name\" of type \"RetentionPolicy\"" });
    }
    ...
    if (!(val.retention_length == void 0) && !sdIsString(val.retention_length)) {
        throw new BoxSdkError({ message: "Expecting string for \"retention_length\" of type \"RetentionPolicy\"" });
    }
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"RetentionPolicy\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"RetentionPolicy\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"RetentionPolicy\" to be defined" });
    }
