...
export function serializeEventEventTypeField(val: EventEventTypeField): SerializedData {
    return val;
}
export function deserializeEventEventTypeField(val: SerializedData): EventEventTypeField {
...
export function serializeEventAdditionalDetailsField(val: EventAdditionalDetailsField): SerializedData {
    return {};
}
export function deserializeEventAdditionalDetailsField(val: SerializedData): EventAdditionalDetailsField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"EventAdditionalDetailsField\"" });
    }
    return {} satisfies EventAdditionalDetailsField;
}
export function serializeEvent(val: Event): SerializedData {
    return { ["type"]: val.type, ["created_at"]: val.createdAt == void 0 ? val.createdAt : serializeDateTime(val.createdAt), ["recorded_at"]: val.recordedAt == void 0 ? val.recordedAt : serializeDateTime(val.recordedAt), ["event_id"]: val.eventId, ["created_by"]: val.createdBy == void 0 ? val.createdBy : serializeUserMini(val.createdBy), ["event_type"]: val.eventType == void 0 ? val.eventType : serializeEventEventTypeField(val.eventType), ["session_id"]: val.sessionId, ["source"]: val.source == void 0 ? val.source : serializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(val.source), ["additional_details"]: val.additionalDetails == void 0 ? val.additionalDetails : serializeEventAdditionalDetailsField(val.additionalDetails) };
}
export function deserializeEvent(val: SerializedData): Event {
    ...
    if (!(val.type == void 0) && !sdIsString(val.type)) {
        throw new BoxSdkError({ message: "Expecting string for \"type\" of type \"Event\"" });
    }
    const type: undefined | string = val.type == void 0 ? void 0 : val.type;
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Event\"" });
    }
    ...
    const recordedAt: undefined | DateTime = val.recorded_at == void 0 ? void 0 : deserializeDateTime(val.recorded_at);
    if (!(val.event_id == void 0) && !sdIsString(val.event_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"event_id\" of type \"Event\"" });
    }
    ...
    if (!(val.session_id == void 0) && !sdIsString(val.session_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"session_id\" of type \"Event\"" });
    }
    const sessionId: undefined | string = val.session_id == void 0 ? void 0 : val.session_id;
    const source: undefined | AppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser = val.source == void 0 ? void 0 : deserializeAppItemEventSourceOrEventSourceOrFileOrFolderOrGenericSourceOrUser(val.source);
