...
export function serializeAiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen(val: any): SerializedData {
...
export function deserializeAiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen(val: SerializedData): AiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen\"" });
    }
    if (val.type == "ai_agent_ask") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize AiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen" });
}
