...
export function serializeGroupMiniGroupTypeField(val: GroupMiniGroupTypeField): SerializedData {
    return val;
}
export function deserializeGroupMiniGroupTypeField(val: SerializedData): GroupMiniGroupTypeField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize GroupMiniGroupTypeField" });
}
export function serializeGroupMini(val: GroupMini): SerializedData {
    ...
    return { ...base, ...{ ["name"]: val.name, ["group_type"]: val.groupType == void 0 ? val.groupType : serializeGroupMiniGroupTypeField(val.groupType) } };
}
export function deserializeGroupMini(val: SerializedData): GroupMini {
    ...
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"GroupMini\"" });
    }
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"GroupMini\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupMini\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"GroupMini\" to be defined" });
    }
