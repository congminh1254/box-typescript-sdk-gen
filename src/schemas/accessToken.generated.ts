...
export function serializeAccessTokenTokenTypeField(val: AccessTokenTokenTypeField): SerializedData {
    return val;
}
export function deserializeAccessTokenTokenTypeField(val: SerializedData): AccessTokenTokenTypeField {
    if (val == "bearer") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize AccessTokenTokenTypeField" });
}
export function serializeAccessTokenIssuedTokenTypeField(val: AccessTokenIssuedTokenTypeField): SerializedData {
    return val;
}
export function deserializeAccessTokenIssuedTokenTypeField(val: SerializedData): AccessTokenIssuedTokenTypeField {
    if (val == "urn:ietf:params:oauth:token-type:access_token") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize AccessTokenIssuedTokenTypeField" });
}
export function serializeAccessToken(val: AccessToken): SerializedData {
    return { ["access_token"]: val.accessToken, ["expires_in"]: val.expiresIn, ["token_type"]: val.tokenType == void 0 ? val.tokenType : serializeAccessTokenTokenTypeField(val.tokenType), ["restricted_to"]: val.restrictedTo == void 0 ? val.restrictedTo : val.restrictedTo.map(function (item: FileOrFolderScope): SerializedData {
            return serializeFileOrFolderScope(item);
        }) as readonly any[], ["refresh_token"]: val.refreshToken, ["issued_token_type"]: val.issuedTokenType == void 0 ? val.issuedTokenType : serializeAccessTokenIssuedTokenTypeField(val.issuedTokenType) };
}
export function deserializeAccessToken(val: SerializedData): AccessToken {
    ...
    if (!(val.access_token == void 0) && !sdIsString(val.access_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"access_token\" of type \"AccessToken\"" });
    }
    ...
    if (!(val.expires_in == void 0) && !sdIsNumber(val.expires_in)) {
        throw new BoxSdkError({ message: "Expecting number for \"expires_in\" of type \"AccessToken\"" });
    }
    ...
    if (!(val.restricted_to == void 0) && !sdIsList(val.restricted_to)) {
        throw new BoxSdkError({ message: "Expecting array for \"restricted_to\" of type \"AccessToken\"" });
    }
    ...
    if (!(val.refresh_token == void 0) && !sdIsString(val.refresh_token)) {
        throw new BoxSdkError({ message: "Expecting string for \"refresh_token\" of type \"AccessToken\"" });
    }
