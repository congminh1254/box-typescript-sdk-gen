...
export function serializeConflictErrorContextInfoField(val: ConflictErrorContextInfoField): SerializedData {
    return { ["conflicts"]: val.conflicts == void 0 ? val.conflicts : val.conflicts.map(function (item: FileConflict): SerializedData {
            return serializeFileConflict(item);
        }) as readonly any[] };
}
export function deserializeConflictErrorContextInfoField(val: SerializedData): ConflictErrorContextInfoField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"ConflictErrorContextInfoField\"" });
    }
    if (!(val.conflicts == void 0) && !sdIsList(val.conflicts)) {
        throw new BoxSdkError({ message: "Expecting array for \"conflicts\" of type \"ConflictErrorContextInfoField\"" });
    }
    const conflicts: undefined | readonly FileConflict[] = val.conflicts == void 0 ? void 0 : sdIsList(val.conflicts) ? val.conflicts.map(function (itm: SerializedData): FileConflict {
...
export function deserializeConflictError(val: SerializedData): ConflictError {
    ...
    if (!(val.status == void 0) && !sdIsNumber(val.status)) {
        throw new BoxSdkError({ message: "Expecting number for \"status\" of type \"ConflictError\"" });
    }
    ...
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"ConflictError\"" });
    }
    const message: undefined | string = val.message == void 0 ? void 0 : val.message;
    if (!(val.context_info == void 0) && !sdIsMap(val.context_info)) {
        throw new BoxSdkError({ message: "Expecting object for \"context_info\" of type \"ConflictError\"" });
    }
    ...
    if (!(val.help_url == void 0) && !sdIsString(val.help_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"help_url\" of type \"ConflictError\"" });
    }
    const helpUrl: undefined | string = val.help_url == void 0 ? void 0 : val.help_url;
    if (!(val.request_id == void 0) && !sdIsString(val.request_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"request_id\" of type \"ConflictError\"" });
    }
