...
export function serializeWorkflows(val: Workflows): SerializedData {
    return { ["limit"]: val.limit, ["next_marker"]: val.nextMarker, ["prev_marker"]: val.prevMarker, ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item: Workflow): SerializedData {
...
export function deserializeWorkflows(val: SerializedData): Workflows {
    ...
    if (!(val.limit == void 0) && !sdIsNumber(val.limit)) {
        throw new BoxSdkError({ message: "Expecting number for \"limit\" of type \"Workflows\"" });
    }
    ...
    if (!(val.prev_marker == void 0) && !sdIsString(val.prev_marker)) {
        throw new BoxSdkError({ message: "Expecting string for \"prev_marker\" of type \"Workflows\"" });
    }
    const prevMarker: undefined | string = val.prev_marker == void 0 ? void 0 : val.prev_marker;
    if (!(val.entries == void 0) && !sdIsList(val.entries)) {
        throw new BoxSdkError({ message: "Expecting array for \"entries\" of type \"Workflows\"" });
    }
    const entries: undefined | readonly Workflow[] = val.entries == void 0 ? void 0 : sdIsList(val.entries) ? val.entries.map(function (itm: SerializedData): Workflow {
