...
export function serializeSignRequestTypeField(val: SignRequestTypeField): SerializedData {
    return val;
}
export function deserializeSignRequestTypeField(val: SerializedData): SignRequestTypeField {
    if (val == "sign-request") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize SignRequestTypeField" });
}
export function serializeSignRequestStatusField(val: SignRequestStatusField): SerializedData {
    return val;
}
export function deserializeSignRequestStatusField(val: SerializedData): SignRequestStatusField {
    if (val == "converting") {
        return val;
    }
    if (val == "created") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize SignRequestStatusField" });
}
export function serializeSignRequestSignFilesField(val: SignRequestSignFilesField): SerializedData {
    return { ["files"]: val.files == void 0 ? val.files : val.files.map(function (item: FileMini): SerializedData {
            return serializeFileMini(item);
        }) as readonly any[], ["is_ready_for_download"]: val.isReadyForDownload };
}
export function deserializeSignRequestSignFilesField(val: SerializedData): SignRequestSignFilesField {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"SignRequestSignFilesField\"" });
    }
    if (!(val.files == void 0) && !sdIsList(val.files)) {
        throw new BoxSdkError({ message: "Expecting array for \"files\" of type \"SignRequestSignFilesField\"" });
    }
    const files: undefined | readonly FileMini[] = val.files == void 0 ? void 0 : sdIsList(val.files) ? val.files.map(function (itm: SerializedData): FileMini {
        return deserializeFileMini(itm);
    }) as readonly any[] : [];
    if (!(val.is_ready_for_download == void 0) && !sdIsBoolean(val.is_ready_for_download)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_ready_for_download\" of type \"SignRequestSignFilesField\"" });
    }
...
export function serializeSignRequest(val: SignRequest): SerializedData {
    ...
    return { ...base, ...{ ["type"]: val.type == void 0 ? val.type : serializeSignRequestTypeField(val.type), ["source_files"]: val.sourceFiles == void 0 ? val.sourceFiles : val.sourceFiles.map(function (item: FileBase): SerializedData {
                return serializeFileBase(item);
            }) as readonly any[], ["signers"]: val.signers == void 0 ? val.signers : val.signers.map(function (item: SignRequestSigner): SerializedData {
                return serializeSignRequestSigner(item);
            }) as readonly any[], ["signature_color"]: val.signatureColor, ["id"]: val.id, ["prepare_url"]: val.prepareUrl, ["signing_log"]: val.signingLog == void 0 ? val.signingLog : serializeFileMini(val.signingLog), ["status"]: val.status == void 0 ? val.status : serializeSignRequestStatusField(val.status), ["sign_files"]: val.signFiles == void 0 ? val.signFiles : serializeSignRequestSignFilesField(val.signFiles), ["auto_expire_at"]: val.autoExpireAt == void 0 ? val.autoExpireAt : serializeDateTime(val.autoExpireAt), ["parent_folder"]: val.parentFolder == void 0 ? val.parentFolder : serializeFolderMini(val.parentFolder), ["collaborator_level"]: val.collaboratorLevel, ["sender_email"]: val.senderEmail, ["sender_id"]: val.senderId } };
}
export function deserializeSignRequest(val: SerializedData): SignRequest {
    ...
    if (!(val.source_files == void 0) && !sdIsList(val.source_files)) {
        throw new BoxSdkError({ message: "Expecting array for \"source_files\" of type \"SignRequest\"" });
    }
    const sourceFiles: undefined | readonly FileBase[] = val.source_files == void 0 ? void 0 : sdIsList(val.source_files) ? val.source_files.map(function (itm: SerializedData): FileBase {
        return deserializeFileBase(itm);
    }) as readonly any[] : [];
    if (!(val.signers == void 0) && !sdIsList(val.signers)) {
        throw new BoxSdkError({ message: "Expecting array for \"signers\" of type \"SignRequest\"" });
    }
    const signers: undefined | readonly SignRequestSigner[] = val.signers == void 0 ? void 0 : sdIsList(val.signers) ? val.signers.map(function (itm: SerializedData): SignRequestSigner {
        return deserializeSignRequestSigner(itm);
    }) as readonly any[] : [];
    if (!(val.signature_color == void 0) && !sdIsString(val.signature_color)) {
        throw new BoxSdkError({ message: "Expecting string for \"signature_color\" of type \"SignRequest\"" });
    }
    const signatureColor: undefined | string = val.signature_color == void 0 ? void 0 : val.signature_color;
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"SignRequest\"" });
    }
    const id: undefined | string = val.id == void 0 ? void 0 : val.id;
    if (!(val.prepare_url == void 0) && !sdIsString(val.prepare_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"prepare_url\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.auto_expire_at == void 0) && !sdIsString(val.auto_expire_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"auto_expire_at\" of type \"SignRequest\"" });
    }
    const autoExpireAt: undefined | DateTime = val.auto_expire_at == void 0 ? void 0 : deserializeDateTime(val.auto_expire_at);
    const parentFolder: undefined | FolderMini = val.parent_folder == void 0 ? void 0 : deserializeFolderMini(val.parent_folder);
    if (!(val.collaborator_level == void 0) && !sdIsString(val.collaborator_level)) {
        throw new BoxSdkError({ message: "Expecting string for \"collaborator_level\" of type \"SignRequest\"" });
    }
    const collaboratorLevel: undefined | string = val.collaborator_level == void 0 ? void 0 : val.collaborator_level;
    if (!(val.sender_email == void 0) && !sdIsString(val.sender_email)) {
        throw new BoxSdkError({ message: "Expecting string for \"sender_email\" of type \"SignRequest\"" });
    }
    const senderEmail: undefined | string = val.sender_email == void 0 ? void 0 : val.sender_email;
    if (!(val.sender_id == void 0) && !sdIsNumber(val.sender_id)) {
        throw new BoxSdkError({ message: "Expecting number for \"sender_id\" of type \"SignRequest\"" });
    }
    const senderId: undefined | number = val.sender_id == void 0 ? void 0 : val.sender_id;
    if (!(val.is_document_preparation_needed == void 0) && !sdIsBoolean(val.is_document_preparation_needed)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_document_preparation_needed\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.redirect_url == void 0) && !sdIsString(val.redirect_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"redirect_url\" of type \"SignRequest\"" });
    }
    const redirectUrl: undefined | string = val.redirect_url == void 0 ? void 0 : val.redirect_url;
    if (!(val.declined_redirect_url == void 0) && !sdIsString(val.declined_redirect_url)) {
        throw new BoxSdkError({ message: "Expecting string for \"declined_redirect_url\" of type \"SignRequest\"" });
    }
    const declinedRedirectUrl: undefined | string = val.declined_redirect_url == void 0 ? void 0 : val.declined_redirect_url;
    if (!(val.are_text_signatures_enabled == void 0) && !sdIsBoolean(val.are_text_signatures_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_text_signatures_enabled\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.email_subject == void 0) && !sdIsString(val.email_subject)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_subject\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.email_message == void 0) && !sdIsString(val.email_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"email_message\" of type \"SignRequest\"" });
    }
    const emailMessage: undefined | string = val.email_message == void 0 ? void 0 : val.email_message;
    if (!(val.are_reminders_enabled == void 0) && !sdIsBoolean(val.are_reminders_enabled)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"are_reminders_enabled\" of type \"SignRequest\"" });
    }
    const areRemindersEnabled: undefined | boolean = val.are_reminders_enabled == void 0 ? void 0 : val.are_reminders_enabled;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"SignRequest\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (!(val.prefill_tags == void 0) && !sdIsList(val.prefill_tags)) {
        throw new BoxSdkError({ message: "Expecting array for \"prefill_tags\" of type \"SignRequest\"" });
    }
    const prefillTags: undefined | readonly SignRequestPrefillTag[] = val.prefill_tags == void 0 ? void 0 : sdIsList(val.prefill_tags) ? val.prefill_tags.map(function (itm: SerializedData): SignRequestPrefillTag {
        return deserializeSignRequestPrefillTag(itm);
    }) as readonly any[] : [];
    if (!(val.days_valid == void 0) && !sdIsNumber(val.days_valid)) {
        throw new BoxSdkError({ message: "Expecting number for \"days_valid\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.external_id == void 0) && !sdIsString(val.external_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_id\" of type \"SignRequest\"" });
    }
    ...
    if (!(val.template_id == void 0) && !sdIsString(val.template_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"template_id\" of type \"SignRequest\"" });
    }
    const templateId: undefined | string = val.template_id == void 0 ? void 0 : val.template_id;
    if (!(val.external_system_name == void 0) && !sdIsString(val.external_system_name)) {
        throw new BoxSdkError({ message: "Expecting string for \"external_system_name\" of type \"SignRequest\"" });
    }
    const externalSystemName: undefined | string = val.external_system_name == void 0 ? void 0 : val.external_system_name;
