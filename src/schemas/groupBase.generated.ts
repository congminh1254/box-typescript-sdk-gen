...
export function serializeGroupBaseTypeField(val: GroupBaseTypeField): SerializedData {
    return val;
}
export function deserializeGroupBaseTypeField(val: SerializedData): GroupBaseTypeField {
    if (val == "group") {
        return val;
    }
...
export function deserializeGroupBase(val: SerializedData): GroupBase {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"GroupBase\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupBase\"" });
    }
    const id: string = val.id;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"GroupBase\" to be defined" });
    }
...
export function serializeGroupBaseInput(val: GroupBaseInput): SerializedData {
    return { ["id"]: val.id, ["type"]: val.type == void 0 ? val.type : serializeGroupBaseTypeField(val.type) };
}
export function deserializeGroupBaseInput(val: SerializedData): GroupBaseInput {
    ...
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"GroupBaseInput\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"GroupBaseInput\"" });
    }
    const id: string = val.id;
