...
export function serializeMetadataQueryResults(val: MetadataQueryResults): SerializedData {
    return { ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item: FileFullOrFolderFull): SerializedData {
            return serializeFileFullOrFolderFull(item);
        }) as readonly any[], ["limit"]: val.limit, ["next_marker"]: val.nextMarker };
}
export function deserializeMetadataQueryResults(val: SerializedData): MetadataQueryResults {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"MetadataQueryResults\"" });
    }
    if (!(val.entries == void 0) && !sdIsList(val.entries)) {
        throw new BoxSdkError({ message: "Expecting array for \"entries\" of type \"MetadataQueryResults\"" });
    }
    const entries: undefined | readonly FileFullOrFolderFull[] = val.entries == void 0 ? void 0 : sdIsList(val.entries) ? val.entries.map(function (itm: SerializedData): FileFullOrFolderFull {
        return deserializeFileFullOrFolderFull(itm);
    }) as readonly any[] : [];
    if (!(val.limit == void 0) && !sdIsNumber(val.limit)) {
        throw new BoxSdkError({ message: "Expecting number for \"limit\" of type \"MetadataQueryResults\"" });
    }
    const limit: undefined | number = val.limit == void 0 ? void 0 : val.limit;
    if (!(val.next_marker == void 0) && !sdIsString(val.next_marker)) {
        throw new BoxSdkError({ message: "Expecting string for \"next_marker\" of type \"MetadataQueryResults\"" });
    }
