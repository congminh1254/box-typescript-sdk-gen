...
export function serializeAiStudioAgentBasicGenTool(val: AiStudioAgentBasicGenTool): SerializedData {
    const base: any = serializeAiAgentBasicGenTool(val);
    if (!sdIsMap(base)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiStudioAgentBasicGenTool\"" });
    }
    return { ...base, ...{ ["is_custom_instructions_included"]: val.isCustomInstructionsIncluded } };
}
export function deserializeAiStudioAgentBasicGenTool(val: SerializedData): AiStudioAgentBasicGenTool {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"AiStudioAgentBasicGenTool\"" });
    }
    if (!(val.is_custom_instructions_included == void 0) && !sdIsBoolean(val.is_custom_instructions_included)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_custom_instructions_included\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    const isCustomInstructionsIncluded: undefined | boolean = val.is_custom_instructions_included == void 0 ? void 0 : val.is_custom_instructions_included;
    if (!(val.content_template == void 0) && !sdIsString(val.content_template)) {
        throw new BoxSdkError({ message: "Expecting string for \"content_template\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    const contentTemplate: undefined | string = val.content_template == void 0 ? void 0 : val.content_template;
    ...
    if (!(val.system_message == void 0) && !sdIsString(val.system_message)) {
        throw new BoxSdkError({ message: "Expecting string for \"system_message\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    ...
    if (!(val.prompt_template == void 0) && !sdIsString(val.prompt_template)) {
        throw new BoxSdkError({ message: "Expecting string for \"prompt_template\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    const promptTemplate: undefined | string = val.prompt_template == void 0 ? void 0 : val.prompt_template;
    if (!(val.model == void 0) && !sdIsString(val.model)) {
        throw new BoxSdkError({ message: "Expecting string for \"model\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    ...
    if (!(val.num_tokens_for_completion == void 0) && !sdIsNumber(val.num_tokens_for_completion)) {
        throw new BoxSdkError({ message: "Expecting number for \"num_tokens_for_completion\" of type \"AiStudioAgentBasicGenTool\"" });
    }
    ...
    return { isCustomInstructionsIncluded: isCustomInstructionsIncluded, contentTemplate: contentTemplate, embeddings: embeddings, systemMessage: systemMessage, promptTemplate: promptTemplate, model: model, numTokensForCompletion: numTokensForCompletion, llmEndpointParams: llmEndpointParams } satisfies AiStudioAgentBasicGenTool;
}
