...
export function serializeFileRequestUpdateRequestStatusField(val: FileRequestUpdateRequestStatusField): SerializedData {
    return val;
}
export function deserializeFileRequestUpdateRequestStatusField(val: SerializedData): FileRequestUpdateRequestStatusField {
    if (val == "active") {
        return val;
    }
    if (val == "inactive") {
    ...
    throw new BoxSdkError({ message: "Can't deserialize FileRequestUpdateRequestStatusField" });
}
export function serializeFileRequestUpdateRequest(val: FileRequestUpdateRequest): SerializedData {
    return { ["title"]: val.title, ["description"]: val.description, ["status"]: val.status == void 0 ? val.status : serializeFileRequestUpdateRequestStatusField(val.status), ["is_email_required"]: val.isEmailRequired, ["is_description_required"]: val.isDescriptionRequired, ["expires_at"]: val.expiresAt == void 0 ? val.expiresAt : serializeDateTime(val.expiresAt) };
}
export function deserializeFileRequestUpdateRequest(val: SerializedData): FileRequestUpdateRequest {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileRequestUpdateRequest\"" });
    }
    if (!(val.title == void 0) && !sdIsString(val.title)) {
        throw new BoxSdkError({ message: "Expecting string for \"title\" of type \"FileRequestUpdateRequest\"" });
    }
    const title: undefined | string = val.title == void 0 ? void 0 : val.title;
    if (!(val.description == void 0) && !sdIsString(val.description)) {
        throw new BoxSdkError({ message: "Expecting string for \"description\" of type \"FileRequestUpdateRequest\"" });
    }
    ...
    if (!(val.is_email_required == void 0) && !sdIsBoolean(val.is_email_required)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_email_required\" of type \"FileRequestUpdateRequest\"" });
    }
    ...
    if (!(val.is_description_required == void 0) && !sdIsBoolean(val.is_description_required)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_description_required\" of type \"FileRequestUpdateRequest\"" });
    }
    ...
    if (!(val.expires_at == void 0) && !sdIsString(val.expires_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"expires_at\" of type \"FileRequestUpdateRequest\"" });
    }
