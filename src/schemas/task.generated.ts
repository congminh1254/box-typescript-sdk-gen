...
export function deserializeTaskActionField(val: SerializedData): TaskActionField {
    if (val == "review") {
        return val;
    }
    if (val == "complete") {
...
export function serializeTaskCompletionRuleField(val: TaskCompletionRuleField): SerializedData {
    return val;
}
export function deserializeTaskCompletionRuleField(val: SerializedData): TaskCompletionRuleField {
    ...
    throw new BoxSdkError({ message: "Can't deserialize TaskCompletionRuleField" });
}
...
export function deserializeTask(val: SerializedData): Task {
    ...
    if (!(val.id == void 0) && !sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"Task\"" });
    }
    ...
    if (!(val.due_at == void 0) && !sdIsString(val.due_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"due_at\" of type \"Task\"" });
    }
    ...
    if (!(val.message == void 0) && !sdIsString(val.message)) {
        throw new BoxSdkError({ message: "Expecting string for \"message\" of type \"Task\"" });
    }
    ...
    if (!(val.is_completed == void 0) && !sdIsBoolean(val.is_completed)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"is_completed\" of type \"Task\"" });
    }
    ...
    if (!(val.created_at == void 0) && !sdIsString(val.created_at)) {
        throw new BoxSdkError({ message: "Expecting string for \"created_at\" of type \"Task\"" });
    }
