...
export function serializeClassificationTemplateField(val: ClassificationTemplateField): SerializedData {
    return val;
}
export function deserializeClassificationTemplateField(val: SerializedData): ClassificationTemplateField {
    if (val == "securityClassification-6VMVochwUWo") {
        return val;
    }
    throw new BoxSdkError({ message: "Can't deserialize ClassificationTemplateField" });
}
...
export function deserializeClassification(val: SerializedData): Classification {
    ...
    if (!(val.Box__Security__Classification__Key == void 0) && !sdIsString(val.Box__Security__Classification__Key)) {
        throw new BoxSdkError({ message: "Expecting string for \"Box__Security__Classification__Key\" of type \"Classification\"" });
    }
    ...
    if (!(val.$parent == void 0) && !sdIsString(val.$parent)) {
        throw new BoxSdkError({ message: "Expecting string for \"$parent\" of type \"Classification\"" });
    }
    ...
    if (!(val.$scope == void 0) && !sdIsString(val.$scope)) {
        throw new BoxSdkError({ message: "Expecting string for \"$scope\" of type \"Classification\"" });
    }
    const scope: undefined | string = val.$scope == void 0 ? void 0 : val.$scope;
    if (!(val.$version == void 0) && !sdIsNumber(val.$version)) {
        throw new BoxSdkError({ message: "Expecting number for \"$version\" of type \"Classification\"" });
    }
    const version: undefined | number = val.$version == void 0 ? void 0 : val.$version;
    if (!(val.$type == void 0) && !sdIsString(val.$type)) {
        throw new BoxSdkError({ message: "Expecting string for \"$type\" of type \"Classification\"" });
    }
    const type: undefined | string = val.$type == void 0 ? void 0 : val.$type;
    if (!(val.$typeVersion == void 0) && !sdIsNumber(val.$typeVersion)) {
        throw new BoxSdkError({ message: "Expecting number for \"$typeVersion\" of type \"Classification\"" });
    }
    ...
    if (!(val.$canEdit == void 0) && !sdIsBoolean(val.$canEdit)) {
        throw new BoxSdkError({ message: "Expecting boolean for \"$canEdit\" of type \"Classification\"" });
    }
