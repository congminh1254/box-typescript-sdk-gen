...
export function deserializeFileFullOrFolderFull(val: SerializedData): FileFullOrFolderFull {
    if (!sdIsMap(val)) {
        throw new BoxSdkError({ message: "Expecting a map for \"FileFullOrFolderFull\"" });
    }
    if (val.type == "file") {
