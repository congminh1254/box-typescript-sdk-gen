...
export function serializeMetadatas(val: Metadatas): SerializedData {
    return { ["entries"]: val.entries == void 0 ? val.entries : val.entries.map(function (item: Metadata): SerializedData {
...
export function deserializeMetadatas(val: SerializedData): Metadatas {
    ...
    if (!(val.entries == void 0) && !sdIsList(val.entries)) {
        throw new BoxSdkError({ message: "Expecting array for \"entries\" of type \"Metadatas\"" });
    }
    const entries: undefined | readonly Metadata[] = val.entries == void 0 ? void 0 : sdIsList(val.entries) ? val.entries.map(function (itm: SerializedData): Metadata {
        return deserializeMetadata(itm);
    }) as readonly any[] : [];
    if (!(val.limit == void 0) && !sdIsNumber(val.limit)) {
        throw new BoxSdkError({ message: "Expecting number for \"limit\" of type \"Metadatas\"" });
    }
