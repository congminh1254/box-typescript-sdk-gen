...
export function deserializeFolderMini(val: SerializedData): FolderMini {
    ...
    if (!(val.sequence_id == void 0) && !sdIsString(val.sequence_id)) {
        throw new BoxSdkError({ message: "Expecting string for \"sequence_id\" of type \"FolderMini\"" });
    }
    const sequenceId: undefined | string = val.sequence_id == void 0 ? void 0 : val.sequence_id;
    if (!(val.name == void 0) && !sdIsString(val.name)) {
        throw new BoxSdkError({ message: "Expecting string for \"name\" of type \"FolderMini\"" });
    }
    const name: undefined | string = val.name == void 0 ? void 0 : val.name;
    if (val.id == void 0) {
        throw new BoxSdkError({ message: "Expecting \"id\" of type \"FolderMini\" to be defined" });
    }
    if (!sdIsString(val.id)) {
        throw new BoxSdkError({ message: "Expecting string for \"id\" of type \"FolderMini\"" });
    }
    const id: string = val.id;
    if (!(val.etag == void 0) && !sdIsString(val.etag)) {
        throw new BoxSdkError({ message: "Expecting string for \"etag\" of type \"FolderMini\"" });
    }
    const etag: undefined | string = val.etag == void 0 ? void 0 : val.etag;
    if (val.type == void 0) {
        throw new BoxSdkError({ message: "Expecting \"type\" of type \"FolderMini\" to be defined" });
    }
