...
test("testListFileAppItemAssocations", async function testListFileAppItemAssocations(): Promise<any> {
    ...
    const fileAppItemAssociations: AppItemAssociations = await client.appItemAssociations.getFileAppItemAssociations(fileId);
    ...
    const file: FileFull = await client.files.getFileById(fileId, { queryParams: { fields: ["is_associated_with_app_item" as string] } satisfies GetFileByIdQueryParams } satisfies GetFileByIdOptionalsInput);
...
test("testListFolderAppItemAssocations", async function testListFolderAppItemAssocations(): Promise<any> {
    ...
    const folderAppItemAssociations: AppItemAssociations = await client.appItemAssociations.getFolderAppItemAssociations(folderId);
    ...
    const folder: FolderFull = await client.folders.getFolderById(folderId, { queryParams: { fields: ["is_associated_with_app_item" as string] } satisfies GetFolderByIdQueryParams } satisfies GetFolderByIdOptionalsInput);
