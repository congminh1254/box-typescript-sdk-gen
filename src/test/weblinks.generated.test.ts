...
test("test_createGetDeleteWeblink", async function test_createGetDeleteWeblink(): Promise<any> {
    ...
    const deletedWeblink: WebLink = await client.webLinks.getWebLinkById(weblink.id);
