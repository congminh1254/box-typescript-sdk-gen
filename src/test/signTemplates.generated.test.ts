...
test("testGetSignTemplates", async function testGetSignTemplates(): Promise<any> {
    ...
    const signTemplates: SignTemplates = await client.signTemplates.getSignTemplates({ limit: 2 } satisfies GetSignTemplatesQueryParams);
...
test("testGetSignTemplate", async function testGetSignTemplate(): Promise<any> {
    ...
    if (signTemplates.entries!.length > 0) {
        const signTemplate: SignTemplate = await client.signTemplates.getSignTemplateById(signTemplates.entries![0].id!);
